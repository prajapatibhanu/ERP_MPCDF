                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtPackgngSz" runat="server" CssClass="form-control" placeholder="Enter Packing Size" MaxLength="50">                                   
                                </asp:TextBox>
                            </div>
                        </div>
                    ...
                    <div class="row" style="display: none;">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Remarks</label>
                                <asp:TextBox ID="txtItemBrand" autocomplete="off" runat="server" placeholder="Remarks" CssClass="form-control" MaxLength="100"></asp:TextBox>

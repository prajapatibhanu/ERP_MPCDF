<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeFile="MilkProductionEntry.aspx.cs" Inherits="mis_dailyplan_MilkProductionEntry" %>
            ...
            <div class="modal" id="VarientModel_FinalSheet">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content" style="height: 580px; width: 1024px;">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td colspan="2">
                                                                    ...
                                                                    <fieldset>
                                                                        ...
                                                                        <table class="datatable table table-striped table-bordered table-hover" runat="server" visible="false" id="FSTanker_R">
                                                                            <tr>
                                                                                <td>
                                                                ...
                                                                <td colspan="2">
                                                                    ...
                                                                    <fieldset>
                                                                        ...
                                                                        <table class="datatable table table-striped table-bordered table-hover" runat="server" visible="false" id="FSTanker_I">
                                                                            <tr>
                                                                                <td>
                                                                                    ...
                                                                                    <div class="col-md-12">
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <asp:DropDownList ID="ddlTankerNo_Issue" CssClass="form-control select2" runat="server" OnSelectedIndexChanged="ddlTankerNo_Issue_SelectedIndexChanged" AutoPostBack="true">
                                                                                            </asp:DropDownList>
                                                                                        </div>
                                                                                    </div>
                        ...
                        <div class="modal-footer">
                            <asp:Button ID="btnFinalPopup" OnClientClick="return ValidateT_Final()" runat="server" ValidationGroup="a" CssClass="btn btn-primary" Text="Save" />
                        </div>
                    </div>
                    <!-- /.modal-content -->
                </div>
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content" style="height: 500px; width: 1024px">
                        ...
                        <div class="modal-footer">
                            ...
                            <asp:Button ID="btnrorrsheet" Enabled="false" OnClientClick="return ValidateT_Final_RR()" runat="server" ValidationGroup="b" CssClass="btn btn-primary" Text="Save" />
                        </div>
                    </div>
                    <!-- /.modal-content -->
                </div>

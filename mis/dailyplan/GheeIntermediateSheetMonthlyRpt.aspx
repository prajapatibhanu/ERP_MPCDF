<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="GheeIntermediateSheetMonthlyRpt.aspx.cs" Inherits="mis_dailyplan_GheeIntermediateSheetMonthlyRpt" %>
        ...
        <section class="content">
            ...
            <div class="box box-success">
                ...
                <div class="box-header">
                    <h3 class="box-title">Monthly Ghee Intermediate Sheet</h3>
                </div>
                <div class="box-body">
                    <div class="row noprint">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <span class="pull-right">
                                    <asp:RequiredFieldValidator ID="rfvFromDate" runat="server" Display="Dynamic" ControlToValidate="txtFromDate" Text="<i class='fa fa-exclamation-circle' title='Enter Date!'></i>" ErrorMessage="Enter Date" SetFocusOnError="true" ForeColor="Red" ValidationGroup="Submit"></asp:RequiredFieldValidator>
                                </span>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label>To Date</label>
                                <span class="pull-right">
                                    <asp:RequiredFieldValidator ID="rfvToDate" runat="server" Display="Dynamic" ControlToValidate="txtToDate" Text="<i class='fa fa-exclamation-circle' title='Enter To Date!'></i>" ErrorMessage="Enter Date" SetFocusOnError="true" ForeColor="Red" ValidationGroup="Submit"></asp:RequiredFieldValidator>
                                </span>
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <asp:Button ID="btnSearch" runat="server" style="margin-top:22px;" CssClass="btn btn-success" Text="Search" ValidationGroup="Submit" OnClick="btnSearch_Click"/>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row">
                            ...
                            <table class="table table-bordered">
                                <tr class="text-center">
                                    <th colspan="10">
                                        <asp:Label ID="lblProductNameInner" Text="GHEE INTERMEDIATE ACCOUNT" runat="server"></asp:Label><br/><span id="spn" runat="server"></span></th>
                                </tr>
                                <tr>
                                </tr>
                                <tr>
                                        ...
                                        <asp:GridView ID="GVVariantDetail_In" runat="server" AutoGenerateColumns="false" CssClass="datatable table table-striped table-bordered table-hover"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Sour Milk Recvd" HeaderStyle-Width="10%">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblSourMilkRcvd"  runat="server" Text='<%# Eval("SourMilkRcvd") %>' onkeypress="return validateDecUnit(this,event)"></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                 <asp:TemplateField HeaderText="Curd Milk Recvd" HeaderStyle-Width="10%">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblCurdMilkRcvd"  runat="server" Text='<%# Eval("CurdleMilkRcvd") %>' onkeypress="return validateDecUnit(this,event)"></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Cream Recvd" HeaderStyle-Width="10%">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblCreamRcvd"  runat="server" Text='<%# Eval("CreamMilkRcvd") %>' onkeypress="return validateDecUnit(this,event)"></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                        ...
                                        <asp:GridView ID="GVVariantDetail_Out" runat="server" AutoGenerateColumns="false" CssClass="datatable table table-striped table-bordered table-hover"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Ghee Mfg from Butter" HeaderStyle-Width="8%">
                                                    <ItemTemplate>
                                                        <asp:Label ID="txtGheeMfg" oncopy="return false" onpaste="return false"  autocomplete="off" onkeypress="return validateDecUnit(this,event)" runat="server" Text='<%# Eval("GheeMfgfromButter") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                  <asp:TemplateField HeaderText="Ghee Mfg from Sour" HeaderStyle-Width="8%">
                                                    <ItemTemplate>
                                                        <asp:Label ID="txtGheeMfgfromSour" oncopy="return false" onpaste="return false"  autocomplete="off" onkeypress="return validateDecUnit(this,event)" runat="server" Text='<%# Eval("GheeMfgfromSour") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                  <asp:TemplateField HeaderText="Ghee Mfg from Curdle" HeaderStyle-Width="8%">
                                                    <ItemTemplate>
                                                        <asp:Label ID="txtGheeMfgfromCurdle" oncopy="return false" onpaste="return false"  autocomplete="off" onkeypress="return validateDecUnit(this,event)" runat="server" Text='<%# Eval("GheeMfgfromCurdle") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                  <asp:TemplateField HeaderText="Ghee Mfg from Cream" HeaderStyle-Width="8%">
                                                    <ItemTemplate>
                                                        <asp:Label ID="txtGheeMfgfromCream" oncopy="return false" onpaste="return false"  autocomplete="off" onkeypress="return validateDecUnit(this,event)" runat="server" Text='<%# Eval("GheeMfgfromCream") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="Ghee Issue for Packing" HeaderStyle-Width="8%">
                                                    <ItemTemplate>
                                                        <asp:Label ID="txtGheeIssueForPacking" oncopy="return false" onpaste="return false"  autocomplete="off" onkeypress="return validateDec(this,event)" runat="server" Text='<%# Eval("GheeIssueForPacking") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                              <asp:TemplateField HeaderText="Sample" HeaderStyle-Width="8%">
                                                    <ItemTemplate>
                                                        <asp:Label ID="txtSample" oncopy="return false" onpaste="return false"  autocomplete="off" onkeypress="return validateDec(this,event)" runat="server" Text='<%# Eval("Sample") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>

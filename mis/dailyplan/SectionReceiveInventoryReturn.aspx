<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="SectionReceiveInventoryReturn.aspx.cs" Inherits="mis_dailyplan_SectionReceiveInventoryReturn" %>
        ...
        <section class="content">
            <div class="box box-success">
                <div class="box-header">
                    <h3 class="box-title">Reverse Inventory / Item / Ingredients To Store</h3>
                </div>
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                                        ...
                                        <table cellspacing="0" rules="all" class="table table-hover table-bordered table-striped pagination-ys " border="1" id="GridView1" style="border-collapse: collapse;">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <th scope="col" style="width:100px">Received Quantity In Section</th>
                                                    <th scope="col" style="width:100px">Reverse Quantity To Store</th>
                                                ...
                                                <tr>
                                                    ...
                                                    <td scope="col">
                                                        <div class="form-group">
                                                            <input id="" type="textbox" class="form-control" />
                                                        </div>
                                                    </td>
                                                </tr>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <asp:Button ID="btnSave" runat="server" Text="Reverse" class="btn btn-block btn-success" OnClick="btnSave_Click" />
                                </div>
                            </div>
                        </div>
                    </div>

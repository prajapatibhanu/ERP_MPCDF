...
public partial class mis_dailyplan_ShiftWiseMilkSheetSummaryRpt : System.Web.UI.Page
{
    DataSet ds;
    ...
    private void ViewFinalDisposalSheet()
    {
        ...
        try
        {
            ...
            ds = objdb.ByProcedure("Usp_Production_Milk_InOutProcess_New",
               new string[] { "flag", "Office_ID", "Shift_Id", "Date", "ProductSection_ID","OfficeType_ID" },
               new string[] { "4", objdb.Office_ID(), ddlShift.SelectedValue, Fdate, ddlPSection.SelectedValue,objdb.OfficeType_ID() }, "dataset");
            if(ds != null && ds.Tables.Count > 0)
            {
                ...
                sb.Append("<tr>");
                sb.Append("<td colspan='4' style='text-align:center;'><b>SHIFT WISE FAT/SNF ACCOUNT OF PROCESSING SECTION<b></td>");
                sb.Append("</tr>");
                sb.Append("<tr>");
                sb.Append("<td colspan='4'><b>Date:" + txtDate.Text + "</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Shift:" + ddlShift.SelectedItem.Text + "</b></td>");
                sb.Append("</tr>");
                sb.Append("<tr>");
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Response.Clear();
            Response.AddHeader("content-disposition", "attachment;filename=" + "ShiftWiseMilkSheetSummaryReport" + DateTime.Now + ".xls");
            Response.Charset = "";

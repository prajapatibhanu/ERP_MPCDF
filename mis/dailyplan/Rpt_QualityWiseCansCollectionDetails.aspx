<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="Rpt_QualityWiseCansCollectionDetails.aspx.cs" Inherits="mis_dailyplan_Rpt_QualityWiseCansCollectionDetails" %>
        ...
        <section class="content">
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title">Quality Wise Cans Collection Report</h3>
                </div>
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-2 no-print">
                            <div class="form-group">
                                <label>Milk Quality<span class="text-danger">*</span></label>
                                <asp:DropDownList ID="ddlMilkQuality" runat="server" CssClass="form-control">
                                    <asp:ListItem Value="All">All</asp:ListItem>
                                    <asp:ListItem Value="Good">Good</asp:ListItem>
                                    <asp:ListItem Value="Sour">Sour</asp:ListItem>
                                    <asp:ListItem Value="Curdle">Curdle</asp:ListItem>
                                </asp:DropDownList>
                                <small><span id="valddlMilkQuality" class="text-danger"></span></small>
                            </div>
                        </div>
                        <div class="col-md-2 no-print">
                            <div class="form-group">

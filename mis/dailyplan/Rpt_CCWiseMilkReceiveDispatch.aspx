<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="Rpt_CCWiseMilkReceiveDispatch.aspx.cs" Inherits="mis_dailyplan_Rpt_CCWiseMilkReceiveDispatch" %>
        ...
        <section class="content">
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title">CC Wise Milk Receive / Dispatch Report</h3>
                </div>
                    ...
                    <div class="row">
                        <div class="col-md-2 no-print">
                            <div class="form-group">
                                ...
                                <span class="pull-right">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" Display="Dynamic" ControlToValidate="ddlType" Text="<i class='fa fa-exclamation-circle' title='Select Type!'></i>" InitialValue="0" ErrorMessage="Select Type" SetFocusOnError="true" ForeColor="Red" ValidationGroup="Submit"></asp:RequiredFieldValidator>
                                </span>

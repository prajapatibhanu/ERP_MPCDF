...
public partial class mis_dailyplan_SectionReceiveInventory : System.Web.UI.Page
{
    DataSet ds;
    ...
    protected void FillGrid()
    {
        try
        {
            ...
            ds = objdb.ByProcedure("spProductionItemStock", new string[] { "flag", "SenderOffice_ID", "ReceiverSection_ID", "TranDt", "Shift_ID" }, new string[] { "3", ddlDS.SelectedValue.ToString(), ddlProductSection.SelectedValue.ToString(), ViewState["TranDt"].ToString(), ViewState["Shift_ID"].ToString() }, "dataset");
            if (ds != null && ds.Tables[0].Rows.Count != 0)
            {

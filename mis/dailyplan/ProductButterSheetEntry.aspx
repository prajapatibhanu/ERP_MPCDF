<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="ProductButterSheetEntry.aspx.cs" Inherits="mis_dailyplan_ProductButterSheetEntry" %>
        ...
        <section class="content">
            ...
            <div class="box box-success">
                ...
                <div class="box-body">
                    ...
                    <fieldset>
                        <legend>Butter Mfd. Entry</legend>
                        <div class="row">
                            <div class="col-md-12">
                        ...
                        <div class="row">
                                ...
                                <asp:GridView ID="GVVariantDetail_In" runat="server" AutoGenerateColumns="false" CssClass="datatable table table-striped table-bordered table-hover"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Opening Balance" HeaderStyle-Width="10%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblCC_Opening" runat="server" Text='<%# Eval("ButterCCOpening") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        ...
                                        <%-- <asp:TemplateField HeaderText="(b) Loose" HeaderStyle-Width="10%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblLoose_Opening" runat="server" Text='<%# Eval("ButterLooseClosing") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>

                                        <asp:TemplateField HeaderText="(c) -VE 2" HeaderStyle-Width="10%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblVE2_Opening" runat="server" Text='<%# Eval("ButterVE2Closing") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>

                                        <asp:TemplateField HeaderText="(d) -VE 1" HeaderStyle-Width="10%">
                                            <ItemTemplate>
                                                <asp:Label ID="lblVE1_Opening" runat="server" Text='<%# Eval("ButterVE1Closing") %>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>--%>
                            ...
                            <fieldset >
                                <legend>Receipt Entry(In Flow)</legend>
                                <div class="col-lg-12">

                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label>Rcvd. From<span style="color: red;"> *</span></label>
                                            <span class="pull-right">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator6" ValidationGroup="b"
                                                    InitialValue="0" ErrorMessage="Select Mfd. From" Text="<i class='fa fa-exclamation-circle' title='Select Mfd. From !'></i>"
                                                    ControlToValidate="ddlmfdfrom" ForeColor="Red" Display="Dynamic" runat="server">
                                                </asp:RequiredFieldValidator></span>
                                            <asp:DropDownList ID="ddlmfdfrom" runat="server" CssClass="form-control select2" AutoPostBack="true" OnSelectedIndexChanged="ddlmfdfrom_SelectedIndexChanged" ClientIDMode="Static">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label>CC/Plant Name<span style="color: red;"> *</span></label>
                                            <span class="pull-right">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ValidationGroup="b"
                                                    InitialValue="0" ErrorMessage="Select CC/Plant Name" Text="<i class='fa fa-exclamation-circle' title='Select CC/Plant Name !'></i>"
                                                    ControlToValidate="ddlccdetails" ForeColor="Red" Display="Dynamic" runat="server">
                                                </asp:RequiredFieldValidator></span>
                                            <asp:DropDownList ID="ddlccdetails" runat="server" CssClass="form-control select2" ClientIDMode="Static">
                                                <asp:ListItem Value="0">Select</asp:ListItem>
                                            </asp:DropDownList>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <span class="pull-right">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator7" ValidationGroup="b"
                                                    InitialValue="0" ErrorMessage="Select Mfd. Milk Type" Text="<i class='fa fa-exclamation-circle' title='Select Mfd. Milk Type !'></i>"
                                                    ControlToValidate="ddlMilkType" ForeColor="Red" Display="Dynamic" runat="server">
                                                </asp:RequiredFieldValidator></span>
                                            <asp:DropDownList ID="ddlMilkType" runat="server" CssClass="form-control select2" ClientIDMode="Static">
                                                ...
                                                <asp:ListItem Value="2">Sour</asp:ListItem>
                                            </asp:DropDownList>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label>Quantity In Kg<span style="color: red;"> *</span></label>
                                            <span class="pull-right">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" ValidationGroup="b"
                                                    ErrorMessage="Enter Quantity In Kg" ForeColor="Red" Text="<i class='fa fa-exclamation-circle' title='Enter Quantity In Kg !'></i>"
                                                    ControlToValidate="txtQuantityInKg" Display="Dynamic" runat="server">
                                                </asp:RequiredFieldValidator>
                                            </span>
                                            <asp:TextBox autocomplete="off" oncopy="return false" onpaste="return false" onkeypress="return validateDecUnit(this,event)" runat="server" CssClass="form-control" ID="txtQuantityInKg" MaxLength="10" placeholder="Enter Quantity In Kg"></asp:TextBox>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <span class="pull-right">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ValidationGroup="b"
                                                    ErrorMessage="Enter Fat In Kg" ForeColor="Red" Text="<i class='fa fa-exclamation-circle' title='Enter Fat In Kg !'></i>"
                                                    ControlToValidate="txtFatInKg" Display="Dynamic" runat="server">
                                                </asp:RequiredFieldValidator>
                                            </span>
                                            <asp:TextBox autocomplete="off" oncopy="return false" onpaste="return false" onkeypress="return validateDecUnit(this,event)" runat="server" CssClass="form-control" ID="txtFatInKg" MaxLength="10" placeholder="Enter Fat In Kg"></asp:TextBox>
                                        </div>
                                    </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <span class="pull-right">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" ValidationGroup="b"
                                                    ErrorMessage="Enter Snf In Kg" ForeColor="Red" Text="<i class='fa fa-exclamation-circle' title='Enter Snf In Kg !'></i>"
                                                    ControlToValidate="txtSnfInKg" Display="Dynamic" runat="server">
                                                </asp:RequiredFieldValidator>

                                            </span>
                                            <asp:TextBox autocomplete="off" oncopy="return false" onpaste="return false" onkeypress="return validateDecUnit(this,event)" runat="server" CssClass="form-control" ID="txtSnfInKg" MaxLength="10" placeholder="Enter Snf In Kg"></asp:TextBox>
                                        </div>
                                    </div>

                                    <div class="col-md-1">
                                        <div class="form-group">
                                            <asp:Button runat="server" CssClass="btn btn-primary" OnClick="btnAddcc_Click" Style="margin-top: 5px;" ValidationGroup="b" ID="btnAddcc" Text="Add" />
                                        </div>
                                    </div>


                                    <asp:GridView ID="GVVariantDetail_CC" runat="server" ShowFooter="true" AutoGenerateColumns="false" CssClass="datatable table table-striped table-bordered table-hover"
                                        EmptyDataText="No Record Found.">
                                        <Columns>
                                            <asp:TemplateField HeaderText="Name">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblName" runat="server" Text='<%# Eval("Name") %>'></asp:Label>
                                                    <asp:Label ID="lblMdfId" Visible="false" runat="server" Text='<%# Eval("MdfId") %>'></asp:Label>
                                                    <asp:Label ID="lblMdfOfficeId" Visible="false" runat="server" Text='<%# Eval("MdfOfficeId") %>'></asp:Label>
                                                    <asp:Label ID="lblMdftypeId" Visible="false" runat="server" Text='<%# Eval("MdftypeId") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                    ...
                                    <td>
                                        <asp:GridView ID="GVVariantDetail_Out" runat="server" AutoGenerateColumns="false" CssClass="datatable table table-striped table-bordered table-hover"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="C.B" HeaderStyle-Width="10%">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtCL_Closing" oncopy="return false" onpaste="return false" CssClass="form-control" autocomplete="off" Text='<%# Eval("ButterCCClosing") %>'  onkeypress="return validateDecUnit(this,event)" runat="server"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <%-- <asp:TemplateField HeaderText="Loose" HeaderStyle-Width="10%">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtLOOSE_Closing" oncopy="return false" onpaste="return false" CssClass="form-control" autocomplete="off" onkeypress="return validateDecUnit(this,event)" runat="server"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>


                                                <asp:TemplateField HeaderText="-VE 2" HeaderStyle-Width="10%">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtVE2_Closing" oncopy="return false" onpaste="return false" CssClass="form-control" autocomplete="off" onkeypress="return validateDecUnit(this,event)" runat="server"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>

                                                <asp:TemplateField HeaderText="-VE 1" HeaderStyle-Width="10%">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtVE1_Closing" oncopy="return false" onpaste="return false" CssClass="form-control" autocomplete="off" onkeypress="return validateDecUnit(this,event)" runat="server"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>--%>

<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="RptSectionReceiveInventory.aspx.cs" Inherits="mis_dailyplan_RptSectionReceiveInventory" %>
        ...
        <section class="content">
            <div class="box box-success">
                <div class="box-header">
                    <h3 class="box-title">Received Inventory / Item / Ingredients For Production</h3>
                </div>
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="col-md-8">
                                        <div class="table">
                                            <h5><asp:Label ID="lblSeletedInfo" runat="server" CssClass="lblSeletedInfo" Text=""></asp:Label></h5>

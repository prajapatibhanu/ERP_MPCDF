...
public partial class mis_dailyplan_EditMilkProductionEntry : System.Web.UI.Page
{
    DataSet ds;
        ...
        if (Session["Emp_ID"] != null)
        {
            try
            {
                ...
                if (!IsPostBack)
                {
                    ...
                    GetSectionView();
                    FillShift();
                    DataTable dtRRSheetInfo = new DataTable();

                    dtRRSheetInfo.Columns.Add("MilkProductionProcessRRS_Id", typeof(string));
                    dtRRSheetInfo.Columns.Add("RR_OpeningBalance", typeof(string));
                    dtRRSheetInfo.Columns.Add("RR_Obtained", typeof(string));
                    dtRRSheetInfo.Columns.Add("RR_Total", typeof(string));
                    dtRRSheetInfo.Columns.Add("RR_Toning", typeof(string));
                    dtRRSheetInfo.Columns.Add("RR_MaintainingSNF", typeof(string));
                    dtRRSheetInfo.Columns.Add("RR_IssuedForProductSection", typeof(string));
                    dtRRSheetInfo.Columns.Add("RR_TotalIssued", typeof(string));
                    dtRRSheetInfo.Columns.Add("RR_ClosingBalance", typeof(string));

                    ViewState["dtRRSheetInfo"] = dtRRSheetInfo;
                    ...
                    if (Session["IsSuccessMilkEntry"] != null)
                    {
                        if ((Boolean)Session["IsSuccessMilkEntry"] == true)
                        {
                            Session["IsSuccessMilkEntry"] = false;
                            Page.ClientScript.RegisterStartupScript(this.GetType(), "CallMyFunction", "alert('Record Updated Successfully');", true);
                        }
                    }
                    if (Session["NoRecordFound"] != null)
                    {
                        if ((Boolean)Session["NoRecordFound"] == true)
                        {
                            Session["NoRecordFound"] = false;
    ...
    protected void FillContainer()
    {
        ...
        ds = objdb.ByProcedure("SpProductionProduct_Milk_InOutEdit", new string[] { "flag", "Office_ID" }, new string[] { "7", objdb.Office_ID() }, "dataset");
        if (ds != null && ds.Tables.Count > 0)
        {
            ...
            if (ds.Tables[1].Rows.Count > 0)
            {
                ...
                ddlTankerNo_Issue.DataSource = ds.Tables[1];
    ...
    protected void lnkbtnVN_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            Response.Redirect("EditMilkProductionEntry_frm.aspx", true);
    ...
    protected void lbFInalSheet_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (ds != null && ds.Tables[3].Rows.Count > 0)
            {
                ViewState["MilkProductionProcessWMS_Id"] = ds.Tables[3].Rows[0]["MilkProductionProcessWMS_Id"].ToString();
            ...
            if (ds != null && ds.Tables[6].Rows.Count > 0)
            {
                if (ds != null && ds.Tables[3].Rows.Count > 0)
                {
                    ...
                    {
                        Label lblI_MCID = (Label)row.FindControl("lblI_MCID");
                        Label lblV_MCName = (Label)row.FindControl("lblV_MCName");
                        ...
                        if (QtyInKg != 0)
                        {
                            dr = dt.NewRow();
                            dr[0] = lblI_MCID.Text;
                            dr[1] = lblV_MCName.Text;
                            dr[2] = txtQtyInKgCM.Text;
                            dt.Rows.Add(dr);
                        }


                    }
                    ViewState["InsertRecord3"] = dt;
                }
                else
                {
                    GV_CD_WM.DataSource = string.Empty;
            ...
            if (ds != null && ds.Tables[7].Rows.Count > 0)
            {
                ...
                if (ds != null && ds.Tables[3].Rows.Count > 0)
                {
                    ...
                    foreach (GridViewRow row in GV_TDetail_WM_Receipt.Rows)
                    {
                        ...
                        {
                            dr = dt.NewRow();
                            dr[0] = lblI_TankerID.Text;
                            dr[1] = lblV_VehicleNo.Text;
                            dr[2] = txtQtyInLtr.Text;
                            dt.Rows.Add(dr);
                        }
        ...
        try
        {
            if (ViewState["UPageTokan"].ToString() == Session["PageTokan"].ToString())
            {
                ...
                ds = objdb.ByProcedure("SpProductionProduct_Milk_InOut",
                                          ...
                                          new string[] { "20"
                                              ,ViewState["MilkProductionProcessWMS_Id"].ToString()
                                              ,objdb.Office_ID()
                                              ,Convert.ToDateTime(txtDate.Text, cult).ToString("yyyy/MM/dd")
                                              ,ddlShift.SelectedValue.ToString()
                                              ,ddlPSection.SelectedValue
    ...
    protected void btnRecombinationRecombination_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            DataSet dsRR_Child = objdb.ByProcedure("SpProductionProduct_Milk_InOutEdit",
            new string[] { "flag", "Office_ID", "Date", "Shift_Id", "ProductSection_ID", "Ghee_RR", "Cream_RR", "Butter_RR", "SMP_RR" },
            new string[] { "5", objdb.Office_ID(), Fdate, ddlShift.SelectedValue, "2", objdb.LooseGheeItemTypeId_ID(), objdb.LooseCreamItemTypeId_ID(), objdb.LooseButterItemTypeId_ID(), objdb.LooseSMPItemTypeId_ID() }, "dataset");
            ...
            DataSet dsNextData = objdb.ByProcedure("SpProductionProduct_Milk_InOutEdit", new string[] { "flag", "Date", "Office_ID", "ProductSection_ID", "Shift_Id" }, new string[] { "4", Convert.ToDateTime(lblDate_RAR.Text, cult).ToString("yyyy/MM/dd"), objdb.Office_ID(), "2", ddlShift.SelectedValue }, "dataset");
            if (dsNextData != null && dsNextData.Tables.Count > 0)
            {
                if (dsNextData.Tables[0].Rows.Count > 0)
                {
                    ...
                    {
                        btnNextRRsheet.Visible = true;
                        btnrorrsheet.Visible = false;
                        ...
                        ViewState["ShiftName"] = dsNextData.Tables[0].Rows[0]["ShiftName"].ToString();
                    }
                    else
                    {
                        btnNextRRsheet.Visible = false;
                        btnrorrsheet.Visible = true;
                    }
                }
            }
    ...
    protected void btnsaveRR_Click(object sender, EventArgs e)
    {
        try
        {
            if (ViewState["UPageTokan"].ToString() == Session["PageTokan"].ToString())
            {
                GetRRSheetInfo();
                lblerrorPopR.Text = "";
                DataTable dtIDF = (DataTable)ViewState["dtRRSheetInfo"];
                ...
                if (dtIDF.Rows.Count > 0)
                {
                    ...
                    ds = objdb.ByProcedure("SpProductionProduct_Milk_InOutEdit",
                                             ...
                                             new string[] { "type_UpdateProduction_Milk_InOutProcessRRSheet" },
    ...
    protected void btnNextRRsheet_Click(object sender, EventArgs e)
    {
        NextTotal();
        GetRRSheetInfo();
        Page.ClientScript.RegisterStartupScript(this.GetType(), "CallMyFunction", "RecombinationReconstitution_Final()", true);
        ...
        lblName_RAR.Text = "Recombination & Reconstitution";
        lblDate_RAR.Text = ViewState["NextDate"].ToString();
        lblShift_RAR.Text = ViewState["ShiftName"].ToString();
        lblsection_RAR.Text = ddlPSection.SelectedItem.Text;

        DataSet dsRR_Child = objdb.ByProcedure("SpProductionProduct_Milk_InOutEdit",
        new string[] { "flag", "Office_ID", "Date", "Shift_Id", "ProductSection_ID", "Ghee_RR", "Cream_RR", "Butter_RR", "SMP_RR" },
        new string[] { "5", objdb.Office_ID(), Convert.ToDateTime(lblDate_RAR.Text, cult).ToString("yyyy/MM/dd"), ViewState["NextShift_Id"].ToString(), "2", objdb.LooseGheeItemTypeId_ID(), objdb.LooseCreamItemTypeId_ID(), objdb.LooseButterItemTypeId_ID(), objdb.LooseSMPItemTypeId_ID() }, "dataset");
        ...
        if (dsRR_Child != null && dsRR_Child.Tables[0].Rows.Count > 0)
        {
            ...
            foreach (GridViewRow row in GVRRSheet.Rows)
            {
                ...
                Label lblItemType_id = (Label)row.FindControl("lblItemType_id");
                TextBox txtBalance_BFRR = (TextBox)row.FindControl("txtBalance_BFRR");
                if (lblItemType_id.Text == "107")
                {
                    txtBalance_BFRR.Text =  ViewState["SMP"].ToString();
                }
                if (lblItemType_id.Text == "103")
                {
                    txtBalance_BFRR.Text = ViewState["Cream"].ToString();
                }
                if (lblItemType_id.Text == "104")
                {
                    txtBalance_BFRR.Text = ViewState["Butter"].ToString();
                }
        ...
        DataSet dsNextData = objdb.ByProcedure("SpProductionProduct_Milk_InOutEdit", new string[] { "flag", "Date", "Office_ID", "ProductSection_ID", "Shift_Id" }, new string[] { "4", Convert.ToDateTime(lblDate_RAR.Text, cult).ToString("yyyy/MM/dd"), objdb.Office_ID(), "2", ViewState["NextShift_Id"].ToString() }, "dataset");
        if (dsNextData != null && dsNextData.Tables.Count > 0)
        {
            if (dsNextData.Tables[0].Rows.Count > 0)
            {
    ...
    protected void txtRRObtained_TextChanged(object sender, EventArgs e)
    {
        btnGetTotal_Click(sender, e);
    }
    protected void txtRRToning_TextChanged(object sender, EventArgs e)
    {
        btnGetTotal_Click(sender, e);
    }
    protected void txtRRMaintainingSNF_TextChanged(object sender, EventArgs e)
    {
        btnGetTotal_Click(sender, e);
    }
    protected void txtRRIssueforproductionsection_TextChanged(object sender, EventArgs e)
    {
        btnGetTotal_Click(sender, e);
    }
    protected void NextTotal()
    {
        ViewState["SMP"] = "0";
        ViewState["Cream"] = "0";
        ViewState["Butter"] = "0";
        foreach (GridViewRow row in GVRRSheet.Rows)
        {
            ...
            if (lblItemType_id.Text == "107")
            {
                ViewState["SMP"] = txtRRClosingBalance.Text;
            }
            if (lblItemType_id.Text == "103")
            {
                ViewState["Cream"] = txtRRClosingBalance.Text;
            }
            if (lblItemType_id.Text == "104")
            {
                ViewState["Butter"] = txtRRClosingBalance.Text;
            }

        }
    }
    protected void GetRRSheetInfo()
    {
        DataTable dtRRSheetInfo = (DataTable)ViewState["dtRRSheetInfo"];
        ...
        foreach (GridViewRow row in GVRRSheet.Rows)
        {
            ...
            Label lblMilkProductionProcessRRS_Id = (Label)row.FindControl("lblMilkProductionProcessRRS_Id");
            TextBox txtBalance_BFRR = (TextBox)row.FindControl("txtBalance_BFRR");
            TextBox txtRRObtained = (TextBox)row.FindControl("txtRRObtained");
            TextBox txtRRTotal = (TextBox)row.FindControl("txtRRTotal");
            TextBox txtRRToning = (TextBox)row.FindControl("txtRRToning");
            ...
            TextBox txtRRTotalIssued = (TextBox)row.FindControl("txtRRTotalIssued");
            TextBox txtRRClosingBalance = (TextBox)row.FindControl("txtRRClosingBalance");
            dtRRSheetInfo.Rows.Add(lblMilkProductionProcessRRS_Id.Text
                                  , txtBalance_BFRR.Text
                                  , txtRRObtained.Text
                                  , txtRRTotal.Text
                                  , txtRRToning.Text
                                  , txtRRMaintainingSNF.Text
                                  , txtRRIssueforproductionsection.Text
                                  , txtRRTotalIssued.Text
                                  , txtRRClosingBalance.Text);

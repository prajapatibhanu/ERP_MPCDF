<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="SectionReceiveInventorySupplementry.aspx.cs" Inherits="mis_dailyplan_SectionReceiveInventorySupplementry" %>
        ...
        <section class="content">
            <div class="box box-success">
                <div class="box-header">
                    <h3 class="box-title">Supplementary Demand Of Inventory / Item / Ingredients To Store In Case of Addition Of Demand at Last Moment</h3>
                </div>
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                                        ...
                                        <table cellspacing="0" rules="all" class="table table-hover table-bordered table-striped pagination-ys " border="1" id="GridView1" style="border-collapse: collapse;">
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <th scope="col" style="width:100px">Buffer Stock</th>
                                                    <th scope="col" style="width:100px">Supplementry Quantity</th>
                                                </tr>
                                                <tr>
                                                    <td scope="col">
                                                        <input id="checkAll" type="checkbox" /></td>
                                                    <td scope="col">1</td>
                                                    <td scope="col">Tetra Packet 1 Kg</td>
                                                    <td scope="col">150</td>
                                                    <td scope="col">
                                                        <div class="form-group">
                                                 ...
                                                 <tr>
                                                    <td scope="col">
                                                        <input id="checkAll" type="checkbox" /></td>
                                                    <td scope="col">2</td>
                                                    <td scope="col">Tetra Packet 5 Kg</td>
                                                    <td scope="col">150</td>
                                                    <td scope="col">
                                                        <div class="form-group">
                                                            <input id="" type="text" class="form-control" />
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <asp:Button ID="btnSave" runat="server" Text="Send Demand" class="btn btn-block btn-success" OnClick="btnSave_Click" />
                                </div>
                            </div>
                        </div>
                    </div>

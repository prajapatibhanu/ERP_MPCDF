<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="ProductGheeSheetEntry.aspx.cs" Inherits="mis_dailyplan_ProductGheeSheetEntry" %>
                    ...
                    <div class="modal-dialog modal-lg" style="width: 90%;">
                        <div class="modal-content" style="height: 600px;">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="row" style="height: 460px; overflow: scroll;">
                                            <div class="col-md-12">
                                                                    ...
                                                                    <td style="width: 50%;">
                                                                        ...
                                                                        <asp:GridView ID="GVVariantDetail_In" runat="server" AutoGenerateColumns="false" CssClass="datatable table table-striped table-bordered table-hover"
                                                                            ...
                                                                            <Columns>
                                                                                ...
                                                                                <asp:TemplateField HeaderText="B.F." HeaderStyle-Width="5%">
                                                                                    <ItemTemplate>
                                                                                        <asp:Label ID="lblBalance_BF" runat="server" Text='<%# Eval("ClosingBalance") %>'></asp:Label>
                                                                                    </ItemTemplate>
                                                                                </asp:TemplateField>

                                                                                <asp:TemplateField HeaderText="Butter" HeaderStyle-Width="10%">
                                                                                    <ItemTemplate>
                                                                                        <asp:TextBox ID="txtFrom_Butter" oncopy="return false" onpaste="return false" CssClass="form-control" autocomplete="off" onkeypress="return validateDec(this,event)" runat="server"></asp:TextBox>
                                                                                    </ItemTemplate>
                                                                                </asp:TemplateField>

                                                                                <asp:TemplateField HeaderText="Sour" HeaderStyle-Width="10%">
                                                                                    <ItemTemplate>
                                                                                        <asp:TextBox ID="txtSour_Milk" oncopy="return false" onpaste="return false" CssClass="form-control" autocomplete="off" onkeypress="return validateDec(this,event)" runat="server"></asp:TextBox>
                                                                                    </ItemTemplate>
                                                                                </asp:TemplateField>

                                                                                <asp:TemplateField HeaderText="Curdle" HeaderStyle-Width="10%">
                                                                                    <ItemTemplate>
                                                                                        <asp:TextBox ID="txtCurdle_Milk" oncopy="return false" onpaste="return false" CssClass="form-control" autocomplete="off" onkeypress="return validateDec(this,event)" runat="server"></asp:TextBox>
                                                                                    </ItemTemplate>
                                                                                </asp:TemplateField>
                                                                                <asp:TemplateField HeaderText="Batch No" HeaderStyle-Width="10%">
                                                                                    <ItemTemplate>
                                                                                        <asp:TextBox ID="txtBatchNo" oncopy="return false" onpaste="return false" CssClass="form-control" autocomplete="off"  runat="server"></asp:TextBox>
                                                                                    </ItemTemplate>
                                                                                </asp:TemplateField>
                                                                                <asp:TemplateField HeaderText="Total" HeaderStyle-Width="15%">
                                                                                    <ItemTemplate>
                                                                    ...
                                                                    <td style="width: 50%;">
                                                                        <asp:GridView ID="GVVariantDetail_Out" runat="server" AutoGenerateColumns="false" CssClass="datatable table table-striped table-bordered table-hover"
                                                                            ...
                                                                            <Columns>
                                                                                ...
                                                                                <asp:TemplateField HeaderText="IssueTo Store" HeaderStyle-Width="15%">
                                                                                    <ItemTemplate>
                                                                                        <asp:TextBox ID="txtIssueTo_Store" oncopy="return false" onpaste="return false" CssClass="form-control" autocomplete="off" onkeypress="return validateDec(this,event)" runat="server"></asp:TextBox>
                                                                                    </ItemTemplate>
                                                                                </asp:TemplateField>

                                                                                <asp:TemplateField HeaderText="IssueTo Plant" HeaderStyle-Width="5%">
                                                                                    <ItemTemplate>
                                                                                        <asp:TextBox ID="txtIssueTo_Plant" oncopy="return false" onpaste="return false" CssClass="form-control" autocomplete="off" onkeypress="return validateDec(this,event)" runat="server"></asp:TextBox>
                                                                                    </ItemTemplate>
                                                                                </asp:TemplateField>

                                                                                <asp:TemplateField HeaderText="Packing Losses" HeaderStyle-Width="10%">
                                                                                    <ItemTemplate>
                                                                                        <asp:TextBox ID="txtPackingLosses" oncopy="return false" onpaste="return false" CssClass="form-control" autocomplete="off" onkeypress="return validateDec(this,event)" runat="server"></asp:TextBox>
                                                                                    </ItemTemplate>
                                                                                </asp:TemplateField>

<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="RptItemWiseTest.aspx.cs" Inherits="mis_dailyplan_RptItemWiseTest" %>
        ...
        <section class="content">
            <div class="box box-success">
                <div class="box-header">
                    <h3 class="box-title">Product / Item Name Wise Testing Report</h3>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddlProduct" runat="server" CssClass="form-control select2" ClientIDMode="Static">
                                </asp:DropDownList>
                            </div>
                        </div>
                         <div class="col-md-2">
                                    ...
                                    <asp:GridView ID="GridView1" runat="server" Visible="true" class="table table-hover table-bordered table-striped " ShowHeaderWhenEmpty="true" EmptyDataText="No Record Found" ClientIDMode="Static"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Section Name">
                                                <ItemTemplate>
                                                    <asp:Label ID="ProductSection_Name" runat="server" Text='<%# Eval("ProductSection_Name") %>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>

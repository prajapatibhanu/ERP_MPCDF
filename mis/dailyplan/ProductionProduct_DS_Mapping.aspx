<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="ProductionProduct_DS_Mapping.aspx.cs" Inherits="mis_dailyplan_ProductionProduct_DS_Mapping" %>
        ...
        <section class="content">
            ...
            <div class="box box-success">
                ...
                <div class="box-header">
                    <h3 class="box-title">Production Section VS Product Mapping</h3>
                </div>
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-3">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <fieldset>
                                <legend>
                                    <asp:CheckBox ID="chkAllItem" runat="server" Text="ALL Item" onclick="CheckAllItem();" /></legend>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <a href="ProductionProduct_DS_Mapping.aspx" class="btn btn-block btn-default">Clear</a>
                            </div>
                        </div>

...
public partial class mis_dailyplan_MonthlyCreamAndButterSheetReport : System.Web.UI.Page
{
    DataSet ds;
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            ds = objdb.ByProcedure("SpProductionProduct_Milk_InOut_ProductSheet",
                  ...
                  new string[] { "18", ddlDS.SelectedValue, Fdate,Tdate, objdb.LooseCreamItemTypeId_ID(), objdb.LooseButterItemTypeId_ID() }, "dataset");
    ...
    public void GetButterData()
    {
        try
        {
                ...
                new string[] { "17", objdb.Office_ID(), Convert.ToDateTime(txtFDate.Text,cult).ToString("yyyy/MM/dd"),Convert.ToDateTime(txtFDate.Text,cult).ToString("yyyy/MM/dd"), ddlPSection.SelectedValue,objdb.LooseButterItemTypeId_ID() }, "dataset");
                ...
                if (dsVD_Child_Rpt_Butter != null && dsVD_Child_Rpt_Butter.Tables[0].Rows.Count > 0)
                {
                    ...
                    htmlStr.Append("<div class='col-md-12' style='text-align:center'>Date:" + txtFDate.Text + " - " + txtTDate.Text + "</div>");
    ...
    public void GetCreamData()
    {
        ...
        try
        {
                ...
                new string[] { "flag", "Office_ID", "FDate","TDate", "ProductSection_ID", "ItemType_id" },
                new string[] { "16", objdb.Office_ID(), Convert.ToDateTime(txtFDate.Text,cult).ToString("yyyy/MM/dd"),Convert.ToDateTime(txtTDate.Text,cult).ToString("yyyy/MM/dd"), ddlPSection.SelectedValue,objdb.LooseCreamItemTypeId_ID() }, "dataset");
        ...
        try
        {
                ...
                if (dsVD_Child_Rpt != null && dsVD_Child_Rpt.Tables[0].Rows.Count > 0)
                {
                    ...
                    //lblTopTitle.Text = strTypeName;
                        ...
                        DataSet dsVD_Child_Rpt_Butter = objdb.ByProcedure("SpProductionProduct_Milk_InOut_ProductSheet",
                new string[] { "flag", "Office_ID", "FDate","TDate", "ProductSection_ID", "ItemType_id"},
                new string[] { "17", objdb.Office_ID(), Convert.ToDateTime(txtFDate.Text,cult).ToString("yyyy/MM/dd"),Convert.ToDateTime(txtTDate.Text,cult).ToString("yyyy/MM/dd"), ddlPSection.SelectedValue,objdb.LooseButterItemTypeId_ID()}, "dataset");
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Response.Clear();
            Response.AddHeader("content-disposition", "attachment;filename=" + "Cream&ButterMonthlySheet" + DateTime.Now + ".xls");
            Response.Charset = "";

...
public partial class mis_dailyplan_Rpt_CCWiseMilkReceiveDispatch : System.Web.UI.Page
{
    DataSet ds;
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            ds = objdb.ByProcedure("Usp_Production_Milk_InOutProcess_New",
                new string[] { "flag", "Office_ID", "ProductSection_ID", "CCOfficeId", "FromDate", "Todate", "Status" },
                new string[] { "25", ddlDS.SelectedValue, ddlPSection.SelectedValue, ddlCCName.SelectedValue, Convert.ToDateTime(txtFromDate.Text, cult).ToString("yyyy/MM/dd"), Convert.ToDateTime(txtToDate.Text, cult).ToString("yyyy/MM/dd"), ddlType.SelectedValue.ToString() }, "dataset");
            if (ds != null && ds.Tables[0].Rows.Count > 0)
            {
                ...
                for (int i = 0; i < Count; i++)
                {
                    ...
                    sb.Append("<td>" + ds.Tables[0].Rows[i]["V_VehicleNo"].ToString() + "</td>");
					sb.Append("<td>" + ds.Tables[0].Rows[i]["ChallanNo"].ToString() + "</td>");
                ...
                sb.Append("<tr>");
                sb.Append("<td colspan='5' style='text-align:right'><b>GRAND TOTAL</td>");

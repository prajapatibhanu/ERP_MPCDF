<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="Rpt_RouteWiseBMCMilkCollectionDetails.aspx.cs" Inherits="mis_dailyplan_Rpt_RouteWiseBMCMilkCollectionDetails" %>
        ...
        <section class="content">
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title">Route Wise BMC/DCS Milk Collection Report</h3>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 no-print">
                            <div class="form-group">
                                ...
                                <asp:ListBox ID="ddlRoute" runat="server" CssClass="form-control" SelectionMode="Multiple">                          
                                </asp:ListBox>

...
public partial class mis_dailyplan_Rpt_TypeWiseIssuetoIceCreamDetails : System.Web.UI.Page
{
    DataSet ds;
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            ds = objdb.ByProcedure("Usp_Production_Milk_InOutProcess_New",
                new string[] { "flag", "Office_ID", "ProductSection_ID", "Type", "FromDate", "Todate" },
                new string[] { "32", ddlDS.SelectedValue, ddlPSection.SelectedValue, ddlType.SelectedValue, Convert.ToDateTime(txtFromDate.Text, cult).ToString("yyyy/MM/dd"), Convert.ToDateTime(txtToDate.Text, cult).ToString("yyyy/MM/dd")}, "dataset");
            if (ds != null && ds.Tables[0].Rows.Count > 0)
            {
                ...
                for (int i = 0; i < Count; i++)
                {
                    ...
                    sb.Append("<td>" + ds.Tables[0].Rows[i]["Type"].ToString() + "</td>");

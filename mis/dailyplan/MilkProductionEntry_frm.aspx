<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="MilkProductionEntry_frm.aspx.cs" Inherits="mis_dailyplan_MilkProductionEntry_frm" %>
        ...
        <section class="content">
            ...
            <div class="box box-success">
                ...
                <div class="box-header">
                    <h3 class="box-title">Daily Disposal Sheet Entry
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="MilkProductionEntry.aspx">Go Back</a></li>
                                <li class="breadcrumb-item active">Daily Disposal Sheet Entry</li>
                            </ol>
                        </div>
                    </div>

<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="ProductionQCMaster.aspx.cs" Inherits="mis_dailyplan_ProductionQCMaster" %>
        ...
        <section class="content">
            ...
            <div class="box box-success">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtProdSecName" runat="server" placeholder="Parameter Name" CssClass="form-control" MaxLength="255" ClientIDMode="Static"></asp:TextBox>
                  ...
                  <%-- <div class="col-md-3">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <fieldset>
                                <legend>
                                    <asp:CheckBox ID="chkDugdhSangh" runat="server" Text="ALL Products" onclick="CheckOfficeAllDugdhSangh();" /></legend>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <a href="ProductionQCMaster.aspx" class="btn btn-block btn-default">Clear</a>
                            </div>
                        </div>
                ...
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-12">
                            <asp:GridView ID="GridView1" runat="server" CssClass="datatable table table-bordered table-condensed"
                                 AutoGenerateColumns="false" DataKeyNames="QCParameterID" EmptyDataText="No Record Found" 

<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="Rpt_ThirdPartyMilkReceiveDispatch.aspx.cs" Inherits="mis_dailyplan_Rpt_ThirdPartyMilkReceiveDispatch" %>
        ...
        <section class="content">
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title">Third Party Milk Receive / Dispatch Report</h3>
                </div>
                ...
                <div class="box-body">
                    <div class="row">
                         ...
                         <div class="col-md-2 no-print">
                            <div class="form-group">
                                ...
                                <span class="pull-right">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" Display="Dynamic" ControlToValidate="ddlType" Text="<i class='fa fa-exclamation-circle' title='Select Type!'></i>" InitialValue="0" ErrorMessage="Select Type" SetFocusOnError="true" ForeColor="Red" ValidationGroup="Submit"></asp:RequiredFieldValidator>
                                </span>
                        ...
                        <div class="col-md-2 no-print">
                            <div class="form-group">
                                <label>Third Party/Union<span class="text-danger">*</span></label>
                                <asp:DropDownList ID="ddlThirdUnion" runat="server" CssClass="form-control select2"></asp:DropDownList>
                                <small><span id="valddlThirdUnion" class="text-danger"></span></small>
                            </div>
                        </div>
						  <div class="col-md-2 no-print">
                            <div class="form-group">

...
public partial class mis_dailyplan_RptDateWiseInward : System.Web.UI.Page
{
    DataSet ds, ds2;
    ...
    protected void FillGrid()
    {
        try
        {
            ...
            ds = objdb.ByProcedure("spProductionRpt_LabTesting",
                new string[] { "flag", "Office_ID ", "Section_ID", "FromDate", "ToDate", "Shift_id" },
                new string[] { "4", SenderOffice_ID, SenderSection_ID, Convert.ToDateTime(txtFromDate.Text, cult).ToString("yyyy/MM/dd"), Convert.ToDateTime(txtToDate.Text, cult).ToString("yyyy/MM/dd"), ddlShift.SelectedValue.ToString() }, "dataset");

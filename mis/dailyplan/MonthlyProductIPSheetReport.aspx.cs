...
public partial class mis_dailyplan_MonthlyProductIPSheetReport : System.Web.UI.Page
{
    DataSet ds;
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        ds = objdb.ByProcedure("Usp_Production_ProductIPSheetMaster", new string[] { "flag", "FDate","TDate", "Office_ID" }, new string[] { "10", Convert.ToDateTime(txtFDate.Text, cult).ToString("yyyy/MM/dd"),Convert.ToDateTime(txtTDate.Text, cult).ToString("yyyy/MM/dd"), objdb.Office_ID() }, "dataset");
        if (ds != null && ds.Tables.Count > 0)
        {
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                sb.Append("<div class='col-md-12' style='text-align:center'><h3 style='font-weight: 800; font-size: 20px;'>" + Session["Office_Name"] + "</h3><h5 style='font-weight: 500; font-size: 13px;'>DAIRY PLANT</h5><h5 style='font-weight: 800; font-size: 20px;'>MONTHLY IP SHEET REPORT</h5></div>");

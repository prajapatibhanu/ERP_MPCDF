<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="DistOrSSwiseInvoiveGeneration_BDS_Fin.aspx.cs" Inherits="mis_DemandSupply_DistOrSSwiseInvoiveGeneration_BDS_Fin" %>
                ...
                <div class="col-md-12">
                    <div class="box box-Manish">
                        <div class="box-header">
                            <h3 class="box-title">Distributor Milk Invoice</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <fieldset>
                                <legend>Distributor Milk Invoice
                                </legend>
                                <div class="row">
                                    <div class="col-lg-12">

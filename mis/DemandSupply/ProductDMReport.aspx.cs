...
public partial class mis_DemandSupply_ProductDMReport : System.Web.UI.Page
{
    APIProcedure objdb = new APIProcedure();
    CommanddlFill objddl = new CommanddlFill();
    DataSet ds2, ds3, ds4, ds5 = new DataSet();
    double sum1 = 0,sum2=0,sum3=0,pc=0,tcsamt=0,fa=0;
        ...
        try
        {
            ...
            ds2 = objdb.ByProcedure("USP_Trn_ProductDM",
                     new string[] { "flag", "Delivary_Date", "DelivaryShift_id", "ItemCat_id", "AreaId", "RouteId", "Office_ID" },
                       new string[] { "6", deliverydate, ddlShift.SelectedValue, objdb.GetProductCatId(), ddlLocation.SelectedValue, ddlRoute.SelectedValue, objdb.Office_ID() }, "dataset");
            ...
            if (ds2.Tables[0].Rows.Count != 0)
            {
                ...
                //pnltcstaxamt.Visible = true;
                //pnlfinalamt.Visible = true;
                ...
                foreach (DataRow drow in dt.Rows)
                {
                    ...
                    {
                        if (column.ToString() != "OrderId" && column.ToString() != "DName" && column.ToString() != "Total Pkt" && column.ToString() != "Cost of Product" && column.ToString() != "TcsTax Amt" && column.ToString() != "Final Amt")
                        {
                ...
                if (dtcrate.Rows.Count > 0)
                {
                    ...
                    sbtable.Append("<tr>");
                    sbtable.Append("<td style='border: 1px solid #000000 !important;text-align:right;'> <b>CRATES/BOX</b>");
                    sbtable.Append("</td>");
                    for (int i = 0; i < Rowcount; i++)
                    {
                        sbtable.Append("<td style='text-align: center;border: 1px solid #000000 !important;'>" + dtcrate.Rows[i]["CrateQty"].ToString() + "</td>");


                    }
                    sbtable.Append("<td style='border: 1px solid #000000 !important;text-align:center;width: 20px;'><b>" + cratetotal.ToString()+"</td>");
                ...
                int rowcount = GridView1.FooterRow.Cells.Count - 6;  // previous default is : 4
              ...
              //  GridView1.FooterRow.Cells[rowcount + 6].Visible = false;
                ...
                for (int j = 0; j < ColCount; j++)
                {
                    ...
                    if (ds2.Tables[0].Columns[j].ToString() != "OrderId" && ds2.Tables[0].Columns[j].ToString() != "DName" && ds2.Tables[0].Columns[j].ToString() != "Total Pkt" && ds2.Tables[0].Columns[j].ToString() != "Cost of Product" && ds2.Tables[0].Columns[j].ToString() != "TcsTax Amt" && ds2.Tables[0].Columns[j].ToString() != "Final Amt")
                    {
                ...
                for (int i = 0; i < Count; i++)
                {
                    ...
                    {
                        if (ds2.Tables[0].Columns[K].ToString() != "OrderId" && ds2.Tables[0].Columns[K].ToString() != "DName" && ds2.Tables[0].Columns[K].ToString() != "Total Pkt" && ds2.Tables[0].Columns[K].ToString() != "Cost of Product" && ds2.Tables[0].Columns[K].ToString() != "TcsTax Amt" && ds2.Tables[0].Columns[K].ToString() != "Final Amt")
                        {
                ...
                sb.Append("<tr>");
                int ColumnCount = GridView1.FooterRow.Cells.Count -6;
                ...
                sb.Append("</tr>");
                sb.Append("</table>");
                //sb.Append("<b><span style='padding-top:20px;'>Total Pkt:  " + lblTotalSupplyValue.Text + "</span><br></b>");
                //sb.Append("<b><span style='padding-top:20px;'>Total Cost Of Product :  " + lblCostOfProduct.Text + "</span><br></b>");
                //sb.Append("<b><span style='padding-top:20px;'>Total TcsTax Amt:  " + lblTotalSupplyValue.Text + "</span><br></b>");
                //sb.Append("<b><span style='padding-top:20px;'>Total Final Amt :  " + lblCostOfProduct.Text + "</span></b>");
            ...
            else
            {
                ...
                //pnltcstaxamt.Visible = false;
                //pnlfinalamt.Visible = false;
    ...
    protected void btnExportAll_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Response.Clear();
            Response.AddHeader("content-disposition", "attachment; filename=" + "RegularDemand-Location-" + ddlLocation.SelectedItem.Text + "Route-" + DateTime.Now + ".xls");
            Response.Charset = "";

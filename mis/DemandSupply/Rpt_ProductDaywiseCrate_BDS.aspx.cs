...
public partial class mis_DemandSupply_Rpt_ProductDaywiseCrate_BDS : System.Web.UI.Page
{
        ...
        try
        {
                ...
                ddlRoute.DataSource = objdb.ByProcedure("USP_Mst_DistributorRouteMapping",
                 new string[] { "flag", "AreaId", "ItemCat_id", "Office_ID" },
                   new string[] { "12", ddlLocation.SelectedValue, objdb.GetProductCatId(), objdb.Office_ID() }, "dataset");
        ...
        try
        {
            ...
            ds1 = objdb.ByProcedure("USP_Trn_ProductCrateMgmt",
                     new string[] { "flag", "FromDate", "ToDate", "AreaID", "RouteId", "Office_ID", "ShiftId", "ItemCat_id" },
                       new string[] { "4", fromdat, todat, ddlLocation.SelectedValue, ddlRoute.SelectedValue, objdb.Office_ID(), objdb.GetShiftMorId(), objdb.GetProductCatId() }, "dataset");
            ...
            if (ds1.Tables[0].Rows.Count > 0)
            {
                ...
                sb.Append("<td style='text-align:center'>CRATE REPORT DAYWISE</td>");
                sb.Append("</tr>");
                sb.Append("<tr>");
                ...
                for (int i = 0; i < Count; i++)
                {
                    ...
                    sb.Append("<td>" + dt1.Rows[i]["DRName"] + "</td>");

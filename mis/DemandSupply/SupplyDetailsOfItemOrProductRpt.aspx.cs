...
public partial class mis_DemandSupply_SupplyDetailsOfItemOrProductRpt : System.Web.UI.Page
{
    APIProcedure objdb = new APIProcedure();
    CommanddlFill objddl = new CommanddlFill();
    DataSet ds, ds1, ds2, ds3, ds4,ds5 = new DataSet();
    double sum1, sum2 = 0, sum3, sum4 = 0;
        ...
        try
        {
            ...
            ds1 = objdb.ByProcedure("USP_Trn_MilkOrProductDemandForSupply",
                     new string[] { "flag", "Office_ID", "Shift_id", "ItemCat_id", "Delivery_Date","AreaId" },
                       new string[] { "5", objdb.Office_ID(), ddlShift.SelectedValue, objdb.GetMilkCatId(), deliverydate,ddlLocation.SelectedValue }, "dataset");
            ...
            if (ds1.Tables[0].Rows.Count != 0)
            {
                ...
                GridView1.FooterRow.Cells[1].Text = "Total Supply";
                ...
                foreach (DataColumn column in dt.Columns)
                {
                    if (column.ToString() == "Total Supply")
                    {
                        ...
                        GridView1.FooterRow.Cells[cellIndex].Font.Bold = true;
                        cellIndex = cellIndex + 1;
                        lblTotalSupplyValue.Text = dsum11.ToString();
                    }
                }
                    foreach (DataColumn column in dt.Columns)
                    {
                        if (column.ToString() == "Total Supply in Litre")
                        {
                            ...
                            GridView1.FooterRow.Cells[cellIndex].Text = sum1.ToString("0.00");
                            GridView1.FooterRow.Cells[cellIndex].Font.Bold = true;
                            cellIndex = cellIndex + 1;

                            lblTotalSaleInLtrValue.Text = sum1.ToString("0.00");
                        }
                    }
    ...
    private void GetPrintAll()
    {
        ...
        sb.Append("<td style='padding: 2px 5px;'></td>");
        sb.Append("<td style='padding: 2px 5px;'></td>");
        sb.Append("<td style='padding: 2px 5px;text-align: center;'><b>DAY: " + s + "(" + objdb.GetMilkCategoryName() + " SALE)<b></td>");
        sb.Append("<td style='padding: 2px 5px;'></td>");
        sb.Append("</tr>");
        ...
        for (int j = 0; j < ColCount; j++)
        {
            ...
            //if (dt1.Columns[j].ToString() != "S.No." && dt1.Columns[j].ToString() != "RouteId" && dt1.Columns[j].ToString() != "Route" && dt1.Columns[j].ToString() != "Total Supply" && dt1.Columns[j].ToString() != "Total Crate" && dt1.Columns[j].ToString() != "Total Supply in Litre")
            if (dt1.Columns[j].ToString() != "S.No." && dt1.Columns[j].ToString() != "RouteId" && dt1.Columns[j].ToString() != "Route" && dt1.Columns[j].ToString() != "Total Supply" && dt1.Columns[j].ToString() != "Total Supply in Litre")
            {
        ...
        sb.Append("<td style='border: 1px solid #000000 !important;'><b>Total Supply</b></td>");
        ...
        for (int i = 0; i < Count; i++)
        {
            ...
            sb.Append("<td style='border: 1px solid #000000 !important;'>" + dt1.Rows[i]["Route"] + "</td>");
            for (int K = 0; K < ColCount; K++)
            {
                //if (dt1.Columns[K].ToString() != "S.No." && dt1.Columns[K].ToString() != "RouteId" && dt1.Columns[K].ToString() != "Route" && dt1.Columns[K].ToString() != "Total Supply" && dt1.Columns[K].ToString() != "Total Crate" && dt1.Columns[K].ToString() != "Total Supply in Litre")
                if (dt1.Columns[K].ToString() != "S.No." && dt1.Columns[K].ToString() != "RouteId" && dt1.Columns[K].ToString() != "Route" && dt1.Columns[K].ToString() != "Total Supply" && dt1.Columns[K].ToString() != "Total Supply in Litre")
                {
            ...
            sb.Append("<td style='border: 1px solid #000000 !important;'>" + dt1.Rows[i]["Total Supply"].ToString() + "</td>");
            sb.Append("<td style='border: 1px solid #000000 !important;'>" + dt1.Rows[i]["Total Supply in Litre"].ToString() + "</td>");
        ...
        sb.Append("</tr>");
        sb.Append("</table>");
        sb.Append("<b><span style='padding-top:20px;'>Total Supply:  " + lblTotalSupplyValue.Text + "</span><br></b>");
        sb.Append("<b><span style='padding-top:20px;'>Sale In Ltr :  " + lblTotalSaleInLtrValue.Text + "</span></b>");
    ...
    private void GetBoothandOrganizationDetails(string rid, string did, string oid)
    {
        try
        {
            lblMsg.Text = "";
            ...
            ds4 = objdb.ByProcedure("USP_Trn_MilkOrProductDemandForSupply",
                     new string[] { "flag", "Office_ID", "Shift_id", "ItemCat_id", "Delivery_Date",
                       ...
                       new string[] { "8", objdb.Office_ID(),ddlShift.SelectedValue,objdb.GetMilkCatId(), deliverydate
                           , rid ,did,oid,retailertypeid,ddlLocation.SelectedValue}, "dataset");
            ...
            if (ds4.Tables[0].Rows.Count != 0)
            {
                ...
                foreach (DataRow drow in dt1.Rows)
                {
                    ...
                    {
                        //if (column.ToString() != "S.No." && column.ToString() != "tmp_MilkOrProductDemandId" && column.ToString() != "tmp_ChallanNo" && column.ToString() != "BandOName" && column.ToString() != "Total Supply" && column.ToString() != "Total Crate" && column.ToString() != "Total Supply in Litre")
                        if (column.ToString() != "S.No." && column.ToString() != "tmp_MilkOrProductDemandId" && column.ToString() != "tmp_ChallanNo" && column.ToString() != "BandOName" && column.ToString() != "Total Supply")
                        {
                ...
                GridView4.FooterRow.Cells[2].Text = "Total Supply";
                GridView4.FooterRow.Cells[2].Font.Bold = true;
                ...
                foreach (DataColumn column in dt1.Columns)
                {
                    ...
                    if (column.ToString() != "S.No." && column.ToString() != "tmp_MilkOrProductDemandId" && column.ToString() != "tmp_ChallanNo" && column.ToString() != "BandOName" && column.ToString() != "Total Supply")
                    {
                        ...
                        if (dt1.Rows.Count > 0)
                        {
                            ...
                            new string[] { "7", objdb.GetMilkCatId(), column.ToString(), objdb.Office_ID(), deliverydate }, "dataset");
                    ...
                    sbtable.Append("<td style='border: 1px solid #000000 !important;text-align:center;' colspan='" + (Rowcount + 1) + "'><b>TOTAL</b>");
                    sbtable.Append("</td>");
                    sbtable.Append("</tr>");
                    ...
                    sbtable.Append("<td style='border: 1px solid #000000 !important;text-align:center;' colspan='" + (Rowcount + 1) + "'>" + cratetotal.ToString());
                ...
                foreach (DataColumn column in dt1.Columns)
                {
                    if (column.ToString() == "Total Supply")
                    {
                        ...
                        GridView4.FooterRow.Cells[cellIndexboothOrg].Text = dsum44.ToString();
                        GridView4.FooterRow.Cells[cellIndexboothOrg].Font.Bold = true;
                        cellIndexboothOrg = cellIndexboothOrg + 1;
                    }
                }
                ...
                for (int i = 0; i < Count; i++)
                {
                    string ChallNo = ds4.Tables[0].Rows[i]["tmp_ChallanNo"].ToString();
                    string [] OrderNo = ChallNo.Split('C','H');
                    sb.Append("<table style='width:100%; height:100%'>");
                    sb.Append("<tr>");
                    sb.Append("<td style='padding: 2px 5px;'><b>OrdNo: " + OrderNo[2].ToString() + "</b></td>");
                    sb.Append("<td style='padding: 2px 5px;'><b>" + ViewState["Office_Name"].ToString() + "</b></td>");
                    sb.Append("<td style='padding: 2px 5px;'><b>Challan: " + ds4.Tables[0].Rows[i]["tmp_ChallanNo"].ToString() + "</b></td>");
                    sb.Append("</tr>");
                    sb.Append("<tr>");
                    sb.Append("<td style='padding: 2px 5px;'></td>");
                    ...
                    sb.Append("</tr>");
                    sb.Append("<tr>");
                    sb.Append("<td style='padding: 2px 5px;'><b>Retailer Name: " + modalRootOrDistName.InnerText + "</b></td>");
                    ...
                    sb.Append("</tr>");
                    sb.Append("<tr>");
                    string BandOName = ds4.Tables[0].Rows[i]["BandOName"].ToString();
                    string[] Booth = BandOName.Split('[');
                    string[] BN0 = Booth[1].Split(']');
                    sb.Append("<td><b>Booth Name:  " + Booth[0].ToString() + "</b></td>");
                    sb.Append("<td></td>");
                    sb.Append("<td><b>(Bno): " + BN0[0].ToString() + "</b></td>");
                    sb.Append("</tr>");
                    sb.Append("</table>");
                    ...
                    for (int j = 0; j < ColCount; j++)
                    {
                        //if (ds4.Tables[0].Columns[j].ToString() != "S.No." && ds4.Tables[0].Columns[j].ToString() != "tmp_MilkOrProductDemandId" && ds4.Tables[0].Columns[j].ToString() != "tmp_ChallanNo" && ds4.Tables[0].Columns[j].ToString() != "BandOName" && ds4.Tables[0].Columns[j].ToString() != "Total Supply" && ds4.Tables[0].Columns[j].ToString() != "Total Crate" && ds4.Tables[0].Columns[j].ToString() != "Total Supply in Litre")
                        if (ds4.Tables[0].Columns[j].ToString() != "S.No." && ds4.Tables[0].Columns[j].ToString() != "tmp_MilkOrProductDemandId" && ds4.Tables[0].Columns[j].ToString() != "tmp_ChallanNo" && ds4.Tables[0].Columns[j].ToString() != "BandOName" && ds4.Tables[0].Columns[j].ToString() != "Total Supply")
                        {
                    ...
                    for (int K = 0; K < ColCount; K++)
                    {
                        //if (ds4.Tables[0].Columns[K].ToString() != "S.No." && ds4.Tables[0].Columns[K].ToString() != "tmp_MilkOrProductDemandId" && ds4.Tables[0].Columns[K].ToString() != "tmp_ChallanNo" && ds4.Tables[0].Columns[K].ToString() != "BandOName" && ds4.Tables[0].Columns[K].ToString() != "Total Supply" && ds4.Tables[0].Columns[K].ToString() != "Total Crate" && ds4.Tables[0].Columns[K].ToString() != "Total Supply in Litre")
                        if (ds4.Tables[0].Columns[K].ToString() != "S.No." && ds4.Tables[0].Columns[K].ToString() != "tmp_MilkOrProductDemandId" && ds4.Tables[0].Columns[K].ToString() != "tmp_ChallanNo" && ds4.Tables[0].Columns[K].ToString() != "BandOName" && ds4.Tables[0].Columns[K].ToString() != "Total Supply")
                        {
                            string ColName = ds4.Tables[0].Columns[K].ToString();
                            sb.Append("<td style='border: 1px solid #000000 !important;'>" + ds4.Tables[0].Rows[i][ColName].ToString() + "</td>");
                    ...
                    sb.Append("</tr>");
                    sb.Append("</table>");
                    //sb.Append("<span style='padding-top:20px;'>Crate Issue:  "+ds4.Tables[0].Rows[i]["Total Crate"].ToString()+"</span>");
                ...
                sb1.Append("<td style='padding: 2px 5px;text-align: right;'><b>Date  :-" + txtDeliveryDate.Text + "</b></td>");
                sb1.Append("</tr>");
                sb1.Append("<tr>");
                sb1.Append("<td style='padding: 2px 5px;'><b>" + modalRootOrDistName.InnerHtml + "</b></td>");
                sb1.Append("<td style='padding: 2px 5px;'></td>");
                sb1.Append("<td style='padding: 2px 5px;text-align: center;'><b>DAY:(" + objdb.GetMilkCategoryName() + " SALE)</b></td>");
             //   sb1.Append("<td class='text-right'>Vehicle No:" + modalVehicleNo.InnerText + "</td>");
                ...
                sb1.Append("<td style='border: 1px solid #000000 !important;'><b>Challan No.</b></td>");
                ...
                sb1.Append("<td style='border: 1px solid #000000 !important;'><b>Total Supply</b></td>");
                //sb1.Append("<td>Total Crate</td>");
                //sb1.Append("<td>Total Sale in LIT</td>");
                sb1.Append("</thead>");
                ...
                for (int i = 0; i < Count; i++)
                {
                    ...
                    sb1.Append("<td style='border: 1px solid #000000 !important;'>" + ds4.Tables[0].Rows[i]["tmp_ChallanNo"] + "</td>");
                    ...
                    sb1.Append("<td style='border: 1px solid #000000 !important;'>" + ds4.Tables[0].Rows[i]["Total Supply"].ToString() + "</td>");
                    //sb1.Append("<td>" + ds4.Tables[0].Rows[i]["Total Crate"].ToString() + "</td>");
                    //sb1.Append("<td>" + ds4.Tables[0].Rows[i]["Total Supply in Litre"].ToString() + "</td>");
        ...
        try
        {
            if (e.CommandName == "RoutwiseBooth")
            {
                ...
                if (ctrl != null)
                {
                    ...
                    modaldate.InnerHtml = txtDeliveryDate.Text;
                    modelShift.InnerHtml = ddlShift.SelectedItem.Text;
                    GetBoothandOrganizationDetails(e.CommandArgument.ToString(), "0", "0");
    ...
    protected void btnExportAll_Click(object sender, EventArgs e)
    {
        try
        {
            GetPrintAll();
            Response.Clear();
            Response.AddHeader("content-disposition", "attachment; filename=" + "SupplyStatusReport" + DateTime.Now + ".xls");
            Response.Charset = "";

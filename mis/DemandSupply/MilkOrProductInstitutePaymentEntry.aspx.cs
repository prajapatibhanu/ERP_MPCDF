...
public partial class mis_DemandSupply_MilkOrProductInstitutePaymentEntry : System.Web.UI.Page
{
    ...
    private void GetInstitution()
    {
        try
        {
            ...
            dsInst = objdb.ByProcedure("USP_Trn_MilkOrProductInvoiceDetail_Institute",
                new string[] { "flag", "Office_ID", "AreaId"},
                  new string[] { "1", objdb.Office_ID(), ddlLocation.SelectedValue }, "dataset");
            ddlInstitute.Items.Clear();
            if (dsInst.Tables[0].Rows.Count > 0)
            {
                ddlInstitute.DataTextField = "BName";
                ddlInstitute.DataValueField = "InstNRId";
                ddlInstitute.DataSource = dsInst.Tables[0];
                ddlInstitute.DataBind();
                ddlInstitute.Items.Insert(0, new ListItem("Select", "0"));
            }
            else
            {
                ddlInstitute.Items.Insert(0, new ListItem("No Record Found.", "0"));
            }
    ...
    private void GetSSByLocationOrCategory()
    {
        try
        {
            ...
            ds7 = objdb.ByProcedure("USP_Trn_MilkOrProductInvoiceDetail_Institute",
               new string[] { "flag", "Office_ID", "AreaId" },
                 new string[] { "1", objdb.Office_ID(), ddlLocation.SelectedValue }, "dataset");
            ddlFilterInstitute.Items.Clear();
            if (ds7.Tables[0].Rows.Count > 0)
            {
                
                ddlFilterInstitute.DataTextField = "BName";
                ddlFilterInstitute.DataValueField = "InstNRId";
                ddlFilterInstitute.DataSource = ds7.Tables[0];
                ddlFilterInstitute.DataBind();
                ddlFilterInstitute.Items.Insert(0, new ListItem("All", "0"));
            }
            else
            {
                ddlFilterInstitute.Items.Insert(0, new ListItem("No Record Found.", "0"));
            }
    ...
    private void PaymentMode()
    {
        ...
        {
            lblMsg.Text = "";
            ds5 = objdb.ByProcedure("USP_Trn_InstitutePaymentSheet", new string[] { "flag" }, new string[] { "6" }, "dataset");
    ...
    private void FillGridMilk()
    {
        try
        {
            ...
            string disid = "";
            if (ddlFilterInstitute.SelectedValue == "0")
            {
                disid = "0";
            }
            else
            {
                string[] SSRDId = ddlFilterInstitute.SelectedValue.Split('-');
                disid = SSRDId[1];
            }
            ds4 = objdb.ByProcedure("USP_Trn_InstitutePaymentSheet",
    ...
    private void GetProductPaymentDetails()
    {
        try
        {
            ...
            ds1 = objdb.ByProcedure("USP_Trn_ProductPaymentSheet_Institute",
    ...
    private void GetMilkAmount()
    {
        try
        {
            ...
            {
                string[] InstBRAId = ddlInstitute.SelectedValue.Split('-');
                ViewState["InstId"] = InstBRAId[0];
                ViewState["InstRId"] = InstBRAId[1];
            }
            string istitute_ID = ViewState["InstId"].ToString();

            ds1 = objdb.ByProcedure("USP_Trn_MilkOrProductInvoiceDetail_Institute",
           new string[] { "Flag", "Delivary_Date", "ItemCat_id", "OrganizationId", "Office_ID" },
           new string[] { "2", delidate, objdb.GetMilkCatId(), ViewState["InstId"].ToString(), objdb.Office_ID() }, "dataset");
    ...
    private void GetProductAmount()
    {
        try
        {
            ...
            {
                string[] SSRDId = ddlInstitute.SelectedValue.Split('-');
                disid = SSRDId[2];
                routeid = SSRDId[1];
            }
            ds6 = objdb.ByProcedure("USP_Trn_ProductPaymentSheet_Institute",
        ...
        try
        {
            ...
            if (e.CommandName == "EditRecord")
            {
                ...
                if (ctrl != null)
                {
                    ...
                    DisplayMilkOrProductPanel();
                    ddlInstitute.SelectedValue = lblSSRDId.Text;
        ...
        try
        {
            ...
            if (e.CommandName == "RecordUpdate")
            {
                ...
                if (ctrl != null)
                {
                    ...
                    DisplayMilkOrProductPanel();
                    ddlInstitute.SelectedValue = PlblSSRDId.Text;
    ...
    private void InserMilkPayment()
    {
        ...
        string[] FSSRDId = ddlInstitute.SelectedValue.Split('-');
        if (btnSave.Text == "Save")
        {
            ds7 = objdb.ByProcedure("USP_Trn_InstitutePaymentSheet"
                , new string[] {"flag","AreaId", "RouteId","DistributorId","ItemCat_id" ,
                    ...
                    "PaymentModeId4","PaymentNo4", "PaymentAmount4","PaymentDate4","SuperStockistId","OrganizationId"}
               , new string[] {"1" ,ddlLocation.SelectedValue,FSSRDId[1].ToString(),"0"
                   ...
                   ddlPaymentMode4.SelectedValue,txtPaymentNo4.Text.Trim(),P4.ToString(),pd44,"0",FSSRDId[0].ToString()}, "dataset");
        ...
        else if (btnSave.Text == "Update")
        {
            ds7 = objdb.ByProcedure("USP_Trn_InstitutePaymentSheet"
                , new string[] {"Flag","DistPaymentSheet_ID","AreaId", "RouteId","DistributorId","ItemCat_id" ,
                        ...
                        "PaymentModeId3","PaymentNo3", "PaymentAmount3","PaymentDate3" ,
                     "PaymentModeId4","PaymentNo4", "PaymentAmount4","PaymentDate4","SuperStockistId","OrganizationId"}
               , new string[] {"4" ,ViewState["rowid"].ToString(),ddlLocation.SelectedValue,FSSRDId[1].ToString(),"0"
                       ,objdb.GetMilkCatId(),deliverydate,
                       txtMilkAmount.Text.Trim(),Balance.ToString(),txtRemark.Text.Trim()
                       ,objdb.Office_ID(),objdb.createdBy() ,IPAddress
                       ,ddlPaymentMode1.SelectedValue,txtPaymentNo1.Text.Trim(),P1.ToString(),pd11,
    ...
    private void InsertProductPayment()
    {
        ...
        if (btnSave.Text == "Save")
        {
            ...
            ds7 = objdb.ByProcedure("USP_Trn_ProductPaymentSheet_Institute"

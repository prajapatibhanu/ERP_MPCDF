<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="Rpt_ProductReturnOrReplace_JBL.aspx.cs" Inherits="mis_DemandSupply_Rpt_ProductReturnOrReplace_JBL" %>
                ...
                <div class="col-md-12">
                    <div class="box box-Manish">
                        <div class="box-header">
                            <h3 class="box-title">Product Return Or Replace Report</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">

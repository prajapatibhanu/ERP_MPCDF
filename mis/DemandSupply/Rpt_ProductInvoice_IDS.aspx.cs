...
public partial class mis_DemandSupply_Rpt_ProductInvoice_IDS : System.Web.UI.Page
{
    ...
    private void GetInvoiceDetails()
    {
        try
        {
            ...
            ds1 = objdb.ByProcedure("USP_Trn_ProductDM",
                     new string[] { "flag", "FromDate", "ToDate", "ItemCat_id", "AreaId", "SuperStockistId", "Office_ID", "Shift_id","IsActive" },
                       new string[] { "15", fromdat, todat, objdb.GetProductCatId(), ddlLocation.SelectedValue, ssid.ToString(), objdb.Office_ID(), ddlShift.SelectedValue,"1" }, "dataset");

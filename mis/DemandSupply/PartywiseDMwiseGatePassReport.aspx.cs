...
public partial class mis_DemandSupply_PartywiseDMwiseGatePassReport : System.Web.UI.Page
{
        ...
        try
        {
            ...
            ds5 = objdb.ByProcedure("USP_Trn_ProductDM",
                     new string[] { "flag", "FromDate", "ToDate", "DelivaryShift_id", "ItemCat_id", "AreaId", "DistributorId", "Office_ID" },
                       new string[] { "25", fromdat, todat, ddlShift.SelectedValue, objdb.GetProductCatId(), ddlLocation.SelectedValue, ddlDitributor.SelectedValue, objdb.Office_ID() }, "dataset");

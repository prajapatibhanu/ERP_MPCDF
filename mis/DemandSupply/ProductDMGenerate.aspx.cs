...
public partial class mis_DemandSupply_ProductDMGenerate : System.Web.UI.Page
{
    APIProcedure objdb = new APIProcedure();
    DataSet ds1, ds2, ds3, ds4, ds9, ds5, ds8 = new DataSet();
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (objdb.createdBy() != null && objdb.Office_ID() != null)
        {
            if (!Page.IsPostBack)
            {
                ...
                //GetVendorType();
                //GetVehicleNo();
                if (Request.QueryString["DSA"] != null && Request.QueryString["DSR"] != null && Request.QueryString["DSD"] != null && Request.QueryString["DSS"] != null && Request.QueryString["DSMPId"] != null)
                {
    ...
    private void GetRoute()
    {
        try
        {
            ...
            ddlRoute.DataSource = objdb.ByProcedure("USP_Trn_ProductDM",
                 ...
                 new string[] { "17", objdb.Office_ID(), ddlLocation.SelectedValue, objdb.GetProductCatId(), ddlShift.SelectedValue, "0", odat.ToString() }, "dataset");
            ddlRoute.DataTextField = "RName";
            ddlRoute.DataValueField = "RouteId";
            ddlRoute.DataBind();
            ddlRoute.Items.Insert(0, new ListItem("All", "0"));
            ...
            if (txtDate.Text != "" && ddlRoute.SelectedValue != "0")
            {
                ...
                ds5 = objdb.ByProcedure("USP_Trn_ProductDM",
                      new string[] { "Flag", "Delivary_Date", "DelivaryShift_id", "ItemCat_id", "RouteId", "Office_ID" },
                        new string[] { "13", odat, ddlShift.SelectedValue, objdb.GetProductCatId(), ddlRoute.SelectedValue, objdb.Office_ID() }, "dataset");
    ...
    private void GetSupplyDetails()
    {
        try
        {
            ...
            ds1 = objdb.ByProcedure("USP_Trn_ProductDM",
                     ...
                     new string[] { "5", deliverydate, ddlShift.SelectedValue, objdb.GetProductCatId(), ddlRoute.SelectedValue, ddlOrderNo.SelectedValue, objdb.Office_ID() }, "dataset");
    ...
    protected void btnClear_Click(object sender, EventArgs e)
    {
        ...
        string url = "ProductDMGenerate.aspx";
                ...
                if (ds1.Tables.Count > 0)
                {
                    if (ds1.Tables[0].Rows.Count > 0)
                    {
                        ...
                        if (btnSubmit.Text == "Save")
                        {
                                ...
                                if (ViewState["TAmount"].ToString() != "0" && ViewState["TAmount"].ToString() != "" && ViewState["Tval"].ToString() != "")
                                {
                                    ...
                                    ds2 = objdb.ByProcedure("USP_Trn_ProductDispDeliveryChallan_Insert",
                                                         new string[] { "flag","AreaId", "RouteId", "ItemCat_id", "DeliveryShift_id", "Delivary_Date"
                                                          ,"VehicleMilkOrProduct_ID","TotalIssueCrate","Office_ID","CreatedBy",
                                                          "IPAddress","DistributorId","ProductDMStatus","MilkOrProductDemandId",
                                                          "TcsTaxPer","TotalIssueBox","TotalQtyInLtr","PONumber" ,"PODdate",
                                                          "CreatedRemark","EMP_Name"},
                                                         new string[] { "0",ddlLocation.SelectedValue, ddlRoute.SelectedValue, objdb.GetProductCatId(), ddlShift.SelectedValue, dat, 
                                                ddlVehicleNo.SelectedValue, ViewState["TotalIssueCrate"].ToString(),objdb.Office_ID()
                                                ,objdb.createdBy(), IPAddress,ddlDitributor.SelectedValue,"0"
                                                ,ddlOrderNo.SelectedValue,ViewState["Tval"].ToString(),
                                               ...
                                               // var httpWebRequestP = (HttpWebRequest)WebRequest.Create("http://localhost:54453/api/data/PostGheeStock");
                                                ...
                                                using (var streamWriter = new StreamWriter(httpWebRequestP.GetRequestStream()))
                                                {
                                                    string json = "{\"DS_Office_ID\":\"" + objdb.Office_ID() + "\"," +
                                                                   "\"StockDate\":\"" + deliverydate.ToString() + "\"," +
                            ...
                            {
                                lblMsg.Text = objdb.Alert("fa-warning", "alert-warning", "Warning!", " Please select Vehicle No. ");
                                return;
                            }

<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="RejectProductInvoice_IDS.aspx.cs" Inherits="mis_DemandSupply_RejectProductInvoice_IDS" %>
        ...
        <section class="content noprint">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-Manish">
                        <div class="box-header">
                            <h3 class="box-title">Reject Product Invoice</h3>
                                     ...
                                     <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList ID="ddlStatus" runat="server" CssClass="form-control select">
                                                ...
                                                <asp:ListItem Value="1">Generated</asp:ListItem>
                ...
                <div class="col-md-12" id="pnldata" runat="server" visible="false">
                    <div class="box box-Manish">
                        <div class="box-header">
                            <h3 class="box-title">Reject Product Invoice Details</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <div class="row">
                                        ...
                                        <asp:GridView ID="GridView1" runat="server" OnRowCommand="GridView1_RowCommand" class="datatable table table-striped table-bordered" AllowPaging="false"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Invoice No." HeaderStyle-Width="5px">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblInvoiceNo" Text='<%#Eval("DMChallanNo") %>' runat="server" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Date" HeaderStyle-Width="5px">
                                                  ...
                                                  <asp:TemplateField HeaderText="Distributor Name" HeaderStyle-Width="5px">
                                                    <ItemTemplate>
                                                          <asp:Label ID="lblSSName" Text='<%# (Session["Office_ID"].ToString()=="6"? (Eval("SSName") + " -" + Eval("BCName")): Eval("SSName") ) %>' runat="server" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="Action" HeaderStyle-Width="5px">
                                                    <ItemTemplate>
                                                        &nbsp;&nbsp;<asp:LinkButton ID="lnkInvoice" CssClass="button button-mini button-green" CommandName="RecordPrintInvoice" CommandArgument='<%#Eval("ProductDispDeliveryChallanId") %>' runat="server" ToolTip="Invoice Print"><i class="btn btn-success fa fa-print"> Invoice </i></asp:LinkButton>
                                                        &nbsp;&nbsp;&nbsp; <asp:LinkButton ID="lnkReject" Visible='<%# Eval("Status").ToString() == "Generated" ? true : false  %>' CssClass="btn btn-danger" OnClientClick="return confirm('Are you sure to Reject Order ?')" CommandName="RecordReject" CommandArgument='<%#Eval("ProductDispDeliveryChallanId") %>' runat="server" ToolTip="Reject"><i class="fa fa-trash"> Reject</i></asp:LinkButton>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        </asp:GridView>
        ...
        $('.datatable').DataTable({
            ...
            buttons: {
                buttons: [{
                    ...
                    title: ('Product Invoice Details').bold().fontsize(3).toUpperCase(),
                    exportOptions: {
                        columns: [0, 1, 2, 3, 4]
                    },
                    footer: false,
                    ...
                    extend: 'excel',
                    title: ('Product Invoice Details').bold().fontsize(3).toUpperCase(),
                    filename: 'ProductInvoiceDetails',

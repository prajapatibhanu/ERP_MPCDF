<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="Rpt_ProductDaywiseCrate_BDS.aspx.cs" Inherits="mis_DemandSupply_Rpt_ProductDaywiseCrate_BDS" %>
                ...
                <div class="col-md-12">
                    <div class="box box-Manish">
                        <div class="box-header">
                            <h3 class="box-title">Crate Report Daywise</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <fieldset>
                                <legend>Crate Report Daywise
                                </legend>
                                <div class="row">
                                    <div class="col-lg-12">
                    ...
                    <div class="box box-Manish">
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <fieldset>
                                        <legend><span>Crate Report Daywise</span></legend>
                                                ...
                                                <asp:GridView ID="GridView1" runat="server" OnRowDataBound="GridView1_RowDataBound" ShowFooter="true" class="datatable table table-striped table-bordered" AllowPaging="false"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Distributor">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblDRName" Text='<%# Eval("DRName")  %>' runat="server" />
                                                            </ItemTemplate>
                                                            <FooterTemplate>

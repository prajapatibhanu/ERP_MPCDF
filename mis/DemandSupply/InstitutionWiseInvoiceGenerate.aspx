<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="InstitutionWiseInvoiceGenerate.aspx.cs" Inherits="mis_DemandSupply_InstitutionWiseInvoiceGenerate" %>
                ...
                <div class="col-md-12">
                    <div class="box box-Manish">
                        <div class="box-header">
                            <h3 class="box-title">Institution Wise Invoice Generate</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <fieldset>
                                <legend>Institution Wise Invoice Generate
                                </legend>
                                <div class="row">
                                    <div class="col-lg-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <asp:ListBox runat="server" ID="ddlInstitution" ClientIDMode="Static" CssClass="form-control" SelectionMode="Multiple"></asp:ListBox>
                                        </div>
                                    </div>

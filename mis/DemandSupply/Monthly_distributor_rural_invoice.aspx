<%@ Page Language="C#"  MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="Monthly_distributor_rural_invoice.aspx.cs" Inherits="mis_DemandSupply_Monthly_distributor_rural_invoice" %>
        ...
        <section class="content noprint">
            ...
            <div class="row">
                <div class="col-md-12 no-print">
                                ...
                                <div class="row no-print">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <span class="pull-right">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ValidationGroup="a"
                                                    ErrorMessage="Enter from Date" ForeColor="Red" Text="<i class='fa fa-exclamation-circle' title='Enter Date !'></i>"
                                            ...
                                            <asp:TextBox runat="server" autocomplete="off" CssClass="form-control" ID="txtfromDate" MaxLength="10" placeholder="Select Date" data-provide="datepicker" onpaste="return false ;" onkeypress="return false;" data-date-format="dd/mm/yyyy" data-date-autoclose="true" ClientIDMode="Static"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <span class="pull-right">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" ValidationGroup="a"
                                                    ErrorMessage="Enter To Date" ForeColor="Red" Text="<i class='fa fa-exclamation-circle' title='Enter Date !'></i>"
                                    ...
                                    <div class="col-md-1" style="margin-top: 20px;">
                                        <div class="form-group">
                                           ...
                                           <asp:Button ID="Button1" Visible="false" runat="server" Text="Print" CssClass="btn btn-success btn-block no-print" ValidationGroup="a" OnClick="btnPrint_Click" OnClientClick="return ValidatePage();" />
                                        </div>
                                    </div>
                                </div>
                            </fieldset>
                 ...
                 <div class="col-md-12" id="paneldata1" runat="server" visible="false">
                     ...
                     <div id="div_page_contentpage" runat="server" ></div>
                     </div>
                                                            ...
                                                            <Columns>
                                                               ...
                                                               <%-- <asp:TemplateField HeaderText="Qty (In Pkt)">
                                                                ...
                                                                <asp:TemplateField HeaderText="Billing Qty (In Ltr.)">
                                                                 ...
                                                                 <asp:TemplateField HeaderText="Total Milk Sale In LTR.">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblSupplyTotalQtyInLtr" Text='<%# Eval("SupplyTotalQtyInLtr")%>' runat="server" />
                                                                    </ItemTemplate>
                                                                     <FooterTemplate>
                                                                        <asp:Label ID="lblSupplyallTotalQtyInLtr"   runat="server"></asp:Label>
                                                                    </FooterTemplate>
                                                                </asp:TemplateField>
                                                                ...
                                                                <%-- <asp:TemplateField HeaderText="Payble Amount">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblFAmount" Text='<%# Convert.ToDecimal(Eval("Amount")) - Convert.ToDecimal((Eval("AdvCardAmt")))%>' runat="server" />
                                                                    </ItemTemplate>
                                                                    <FooterTemplate>
                                            ...
                                            <div class="col-md-3 pull-right">
                                                <table class="table table1-bordered">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <asp:Label ID="lblrebateper" Font-Bold="true" runat="server" Visible="false"></asp:Label>
                                                           <asp:Label ID="lblrebateamount" Font-Bold="true" runat="server"></asp:Label>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>

<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="Rpt_AdvancedCard.aspx.cs" Inherits="mis_DemandSupply_Rpt_AdvancedCard" %>
                            ...
                            <fieldset>
                                ...
                                <div class="row">
                                    <div class="col-md-12 pull-right">
                                        <div class="form-group">
                                            <asp:Button ID="btnPrintRoutWise" runat="server" style="margin-bottom:10px" Visible="false" CssClass="btn btn-primary pull-right" Text="Print" OnClick="btnPrintRoutWise_Click" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                            ...
                                            <asp:GridView ID="GridView1" runat="server" OnRowDataBound="GridView1_RowDataBound" OnRowCommand="GridView1_RowCommand" ShowFooter="true" class="datatable table table-striped table-bordered" AllowPaging="false"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Route">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnkRouteId" CssClass="btn btn-block btn-secondary" Text='<%#Eval("Route") %>' CommandName="RoutwiseRetailer" CommandArgument='<%#Eval("RouteId") %>' runat="server"></asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                            </asp:GridView>

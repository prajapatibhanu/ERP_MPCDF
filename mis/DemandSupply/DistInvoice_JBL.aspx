<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="DistInvoice_JBL.aspx.cs" Inherits="mis_DemandSupply_DistInvoice_JBL" %>
                ...
                <div class="col-md-12">
                    <div class="box box-Manish">
                        <div class="box-header">
                            <h3 class="box-title">View Distributor Invoice </h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <fieldset>
                                <legend>View Distributor Invoice
                                </legend>
                                <div class="row">
                                    <div class="col-lg-12">

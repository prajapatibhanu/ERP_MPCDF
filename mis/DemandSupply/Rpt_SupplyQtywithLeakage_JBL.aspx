<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="Rpt_SupplyQtywithLeakage_JBL.aspx.cs" Inherits="mis_DemandSupply_Rpt_SupplyQtywithLeakage_JBL" %>
                ...
                <div class="col-md-12">
                    <div class="box box-Manish">
                        <div class="box-header">
                            <h3 class="box-title">Milk Supply and Leakage Report</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="col-md-2">
                                                <div class="form-group">
                                                   ...
                                                   <span class="pull-right">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ValidationGroup="a" ControlToValidate="ddlRoute"

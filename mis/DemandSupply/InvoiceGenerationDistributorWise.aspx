<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="InvoiceGenerationDistributorWise.aspx.cs" Inherits="mis_DemandSupply_InvoiceGenerationDistributorWise" %>
                                            ...
                                            <div class="col-md-12">
                                                        <asp:GridView ID="GridView1" runat="server" Width="100%" ShowFooter="true" class="table table-striped table-bordered" AllowPaging="false"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <%--for tcs & TDS Tax--%>
                                                                <asp:TemplateField HeaderText="AmountNew" Visible="false">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblAmountNew" Text='<%# Eval("AmountNew")%>' runat="server" />
                                                                    </ItemTemplate>
                                                                    <FooterTemplate>
                                                                        <asp:Label ID="lblTAmountNew" runat="server"></asp:Label>
                                                                    </FooterTemplate>
                                                                </asp:TemplateField>
                                                                 <asp:TemplateField HeaderText="Payble AmountNew" Visible="false">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblFAmountNew" Text='<%# Convert.ToDecimal(Eval("AmountNew")) - Convert.ToDecimal((Eval("AdvCardAmt")))%>' runat="server" />
                                                                    </ItemTemplate>
                                                                    <FooterTemplate>
                                                                        <asp:Label ID="lblFinalAmountNew" runat="server"></asp:Label>
                                                                    </FooterTemplate>
                                                                </asp:TemplateField>
                                                            </Columns>
                                                        </asp:GridView>

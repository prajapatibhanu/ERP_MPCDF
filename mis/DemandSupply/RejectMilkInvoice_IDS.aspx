<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="RejectMilkInvoice_IDS.aspx.cs" Inherits="mis_DemandSupply_RejectMilkInvoice_IDS" %>
                ...
                <div class="col-md-12">
                    <div class="box box-Manish">
                        <div class="box-header">
                            <h3 class="box-title">Reject Milk Invoice</h3>
                                                ...
                                                <asp:TemplateField HeaderText="Action" HeaderStyle-Width="5px">
                                                    <ItemTemplate>
                                                        &nbsp;&nbsp;<asp:LinkButton ID="lnkInvoice" CssClass="button button-mini button-green" CommandName="RecordPrintInvoice" CommandArgument='<%#Eval("MilkOrProductInvoiceId") %>' runat="server" ToolTip="Invoice Print"><i class="btn btn-success fa fa-print"> Invoice </i></asp:LinkButton>
                                                          &nbsp;&nbsp;&nbsp; <asp:LinkButton ID="lnkReject" Visible='<%# Eval("Status").ToString() == "Generated" ? true : false  %>' CssClass="btn btn-danger" OnClientClick="return confirm('Are you sure to Reject Order ?')" CommandName="RecordReject" CommandArgument='<%#Eval("MilkOrProductInvoiceId") %>' runat="server" ToolTip="Reject"><i class="fa fa-trash"> Reject</i></asp:LinkButton>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        </asp:GridView>
        ...
        $('.datatable').DataTable({
            ...
            buttons: {
                buttons: [{
                    ...
                    title: ('Reject Milk Invoice Details').bold().fontsize(3).toUpperCase(),
                    exportOptions: {
                        columns: [0, 1, 2, 3, 4, 5]
                    },
                    footer: false,

<%@ Page Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="Merge_dues_report_superstockist_UDS.aspx.cs" Inherits="mis_DemandSupply_Merge_dues_report_superstockist_UDS" %>
                ...
                <div class="col-md-12">
                    <div class="box box-Manish">
                        <div class="box-header">
                            <h3 class="box-title">Milk Or Product Payment Report</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            ...
                            <div class="row">
                                <fieldset>
                                    <legend>Milk Or Product Payment Report
                                    </legend>
                                    <div class="col-md-2">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <asp:ListBox ID="ddlDitributor" runat="server" ClientIDMode="Static" CssClass="form-control" SelectionMode="Multiple">

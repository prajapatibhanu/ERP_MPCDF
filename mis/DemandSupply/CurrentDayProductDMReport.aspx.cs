...
public partial class mis_DemandSupply_CurrentDayProductDMReport : System.Web.UI.Page
{
    ...
    private void CurrentDayProductDM_Report()
    {
        try
        {
            ...
            ds2 = objdb.ByProcedure("USP_Trn_ProductDM",
                     new string[] { "flag", "Delivary_Date", "DelivaryShift_id", "ItemCat_id", "AreaId", "RouteId", "Office_ID", "MultiProductDMStatus" },
                       new string[] { "8", deliverydate, ddlShift.SelectedValue, objdb.GetProductCatId(), ddlLocation.SelectedValue, ddlRoute.SelectedValue, objdb.Office_ID(), multidmtype }, "dataset");
    ...
    protected void btnExportAll_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Response.Clear();
            Response.AddHeader("content-disposition", "attachment; filename=" + "MultiDemand-Location-" + ddlLocation.SelectedItem.Text + DateTime.Now + ".xls");
            Response.Charset = "";

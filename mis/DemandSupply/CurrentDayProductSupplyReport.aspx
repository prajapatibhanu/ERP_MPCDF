<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="CurrentDayProductSupplyReport.aspx.cs" Inherits="mis_DemandSupply_CurrentDayProductSupplyReport" %>
                ...
                <div class="col-md-12">
                    <div class="box box-Manish">
                        <div class="box-header">
                            <h3 class="box-title">Current Day Supply Report </h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <div class="row">
                            ...
                            <fieldset>
                                <legend>Current Day Product Supply Report
                                </legend>
                                <div class="row">
                                      <div class="col-md-2">
                                ...
                                <asp:GridView ID="GridView1" runat="server" OnRowDataBound="GridView1_RowDataBound" ShowFooter="true" class="datatable table table-striped table-bordered" AllowPaging="false"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Party Name">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lnkRetailer" Text='<%#Eval("DName") %>' runat="server"></asp:Label>
                                                            </ItemTemplate>
                                                            <FooterTemplate>
                                                                <asp:Label ID="lblFtext" Font-Bold="true" Text="Total" runat="server"></asp:Label>
                                                            </FooterTemplate>
                                                        </asp:TemplateField>
                                                        ...
                                                        <asp:TemplateField HeaderText="Total Packet">
                                                            <ItemTemplate>

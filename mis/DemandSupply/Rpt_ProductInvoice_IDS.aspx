<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="Rpt_ProductInvoice_IDS.aspx.cs" Inherits="mis_DemandSupply_Rpt_ProductInvoice_IDS" %>
        ...
        <section class="content noprint">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-Manish">
                        <div class="box-header">
                            <h3 class="box-title">Product Invoice Report</h3>
                ...
                <div class="col-md-12" id="pnldata" runat="server" visible="false">
                    <div class="box box-Manish">
                        <div class="box-header">
                            <h3 class="box-title">Product Invoice Details</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <div class="row">
                                        ...
                                        <asp:GridView ID="GridView1" runat="server" OnRowCommand="GridView1_RowCommand" class="datatable table table-striped table-bordered" AllowPaging="false"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Item Detail" HeaderStyle-Width="100px">
                                                 ...
                                                 <asp:TemplateField HeaderText="Gatepass No." HeaderStyle-Width="5px">
                                                    <ItemTemplate>

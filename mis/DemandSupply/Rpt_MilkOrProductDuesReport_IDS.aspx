<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="Rpt_MilkOrProductDuesReport_IDS.aspx.cs" Inherits="mis_DemandSupply_Rpt_MilkOrProductDuesReport_IDS" %>
        ...
        <section class="content noprint">
            ...
            <div class="row">
                <div class="col-md-12" id="pnlData" runat="server" visible="false">
                    ...
                    <div class="box box-Manish">
                        <div class="box-header">
                            <h3 class="box-title">Milk Payment Report</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <div class="row">

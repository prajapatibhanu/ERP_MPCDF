<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="ProductCrateMgmtAtDS.aspx.cs" Inherits="mis_DemandSupply_ProductCrateMgmtAtDS" %>
        ...
        <section class="content">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-Manish">
                        <div class="box-header">
                            <h3 class="box-title">Product Crate Entry</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <fieldset>
                                <legend>Date,Shift,Location,Route 
                                </legend>
                                <div class="row">
                                    <div class="col-lg-12">
                                ...
                                <div class="row">
                                   ...
                                   <%-- <div class="col-md-2">
                                    ...
                                    <div class="col-md-2">
                                     ...
                                     <div class="col-md-4">
                                        <div class="form-group">
                                            <label>DM Challan No.</label>
                                            <span class="pull-right">
                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator7" runat="server" Display="Dynamic" ValidationGroup="a"
                                                    ErrorMessage="Enter Valid DMChallan No. !" ForeColor="Red" Text="<i class='fa fa-exclamation-circle' title='Enter Valid DMChallan No. !'></i>" ControlToValidate="txtDMChallanNo"
                                                    ValidationExpression="^[a-zA-Z0-9\s,./-]+$">
                                                </asp:RegularExpressionValidator>
                                            </span>
                                            <asp:TextBox runat="server" autocomplete="off" CssClass="form-control" ID="txtDMChallanNo" MaxLength="20"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                ...
                <div class="col-md-12">
                    <div class="box box-Manish">
                        <div class="box-header">
                            <h3 class="box-title">Product Crate Entry Details</h3>
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <fieldset>
                                        <legend>Date,Location,Route </legend>
                                        <div class="col-md-12">
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <label>Date<span style="color: red;"> *</span></label>
                                                ...
                                                <asp:GridView ID="GridView1" OnRowCommand="GridView1_RowCommand" runat="server" class="datatable table table-striped table-bordered" AllowPaging="false"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Short / Excess" HeaderStyle-Width="5px">
                                                         ...
                                                         <asp:TemplateField HeaderText="DM Challan No." HeaderStyle-Width="5px">
                                                            <ItemTemplate>

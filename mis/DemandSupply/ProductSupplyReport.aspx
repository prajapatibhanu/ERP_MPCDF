<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="ProductSupplyReport.aspx.cs" Inherits="mis_DemandSupply_ProductSupplyReport" %>
                ...
                <div class="col-md-12">
                    <div class="box box-Manish">
                        <div class="box-header">
                            <h3 class="box-title">Regular Supply Report </h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <div class="row">
                                ...
                                <asp:GridView ID="GridView1" runat="server" OnRowDataBound="GridView1_RowDataBound" ShowFooter="true" class="datatable table table-striped table-bordered" AllowPaging="false"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Distributor Name">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lnkbtnDistributor" Text='<%#Eval("DName") %>' runat="server"></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>

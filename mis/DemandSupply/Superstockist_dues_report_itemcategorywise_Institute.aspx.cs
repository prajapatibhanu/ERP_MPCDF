...
public partial class mis_DemandSupply_Superstockist_dues_report_itemcategorywise_Institute : System.Web.UI.Page
{
    ...
    private void GetInstitute()
    {
        try
        {
            ...
            ds7 = objdb.ByProcedure("USP_Trn_dues_report_categorywise_forInstitute_Indore",
               new string[] { "flag", "Office_ID", "AreaId", "ItemCat_id" },
                 new string[] { "3", objdb.Office_ID(), ddlLocation.SelectedValue, ddlItemCategory.SelectedValue }, "dataset");
            ddlDitributor.Items.Clear();
            if (ds7.Tables[0].Rows.Count > 0)
            {
                ddlDitributor.DataTextField = "BName";
                ddlDitributor.DataValueField = "InstNRId";
    ...
    private void duesPayment_Report()
    {
        try
        {
            ...
            ds2 = objdb.ByProcedure("USP_Trn_dues_report_categorywise_forInstitute_Indore",
            ...
            if (ds2.Tables.Count != 0)
            {
                if (ds2.Tables[0].Rows.Count != 0)
                {
                    ...
                    for (int i = 0; i < Count; i++)
                    {
                        ...
                        sb.Append("<td style='border:1px solid black;'>" + ds2.Tables[0].Rows[i]["InstituteName"] + "</td>");

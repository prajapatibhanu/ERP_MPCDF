<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="ProductPaymentSheet.aspx.cs" Inherits="mis_DemandSupply_ProductPaymentSheet" %>
        ...
        <section class="content">
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title">Product Payment Sheet</h3>
                </div>
                <asp:Label ID="lblMsg" runat="server"></asp:Label>
                <div class="box-body">
                    <fieldset>
                        <legend>Product Payment Sheet</legend>
                        <div class="col-md-12">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox runat="server" autocomplete="off" CssClass="form-control" AutoPostBack="true" OnTextChanged="txtDeliveryDate_TextChanged" ID="txtDeliveryDate" MaxLength="10" placeholder="Select Date" data-provide="datepicker" onpaste="return false ;" onkeypress="return false;" data-date-format="dd/mm/yyyy" data-date-autoclose="true" ClientIDMode="Static"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <span class="pull-right">
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator2" ValidationGroup="a" runat="server" Display="Dynamic" ControlToValidate="txtPaymentDate1"
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <span class="pull-right">
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator4" ValidationGroup="a" runat="server" Display="Dynamic" ControlToValidate="txtPaymentDate2"
                                            ErrorMessage="Invalid Payment Date" Text="<i class='fa fa-exclamation-circle' title='Invalid Payment Date !'></i>" SetFocusOnError="true"
                                            ValidationExpression="^(((0[1-9]|[12]\d|3[01])/(0[13578]|1[02])/((19|[2-9]\d)\d{2}))|((0[1-9]|[12]\d|30)/(0[13456789]|1[012])/((19|[2-9]\d)\d{2}))|((0[1-9]|1\d|2[0-8])/02/((19|[2-9]\d)\d{2}))|(29/02/((1[6-9]|[2-9]\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00))))$"></asp:RegularExpressionValidator>
                                    </span>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <span class="pull-right">
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator5" ValidationGroup="a" runat="server" Display="Dynamic" ControlToValidate="txtPaymentDate3"
                                            ErrorMessage="Invalid Payment Date" Text="<i class='fa fa-exclamation-circle' title='Invalid Payment Date !'></i>" SetFocusOnError="true"
                                            ValidationExpression="^(((0[1-9]|[12]\d|3[01])/(0[13578]|1[02])/((19|[2-9]\d)\d{2}))|((0[1-9]|[12]\d|30)/(0[13456789]|1[012])/((19|[2-9]\d)\d{2}))|((0[1-9]|1\d|2[0-8])/02/((19|[2-9]\d)\d{2}))|(29/02/((1[6-9]|[2-9]\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00))))$"></asp:RegularExpressionValidator>
                                    </span>
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <span class="pull-right">
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator6" ValidationGroup="a" runat="server" Display="Dynamic" ControlToValidate="txtPaymentDate4"
                                            ErrorMessage="Invalid Payment Date" Text="<i class='fa fa-exclamation-circle' title='Invalid Payment Date !'></i>" SetFocusOnError="true"
                                            ValidationExpression="^(((0[1-9]|[12]\d|3[01])/(0[13578]|1[02])/((19|[2-9]\d)\d{2}))|((0[1-9]|[12]\d|30)/(0[13456789]|1[012])/((19|[2-9]\d)\d{2}))|((0[1-9]|1\d|2[0-8])/02/((19|[2-9]\d)\d{2}))|(29/02/((1[6-9]|[2-9]\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00))))$"></asp:RegularExpressionValidator>
                                    </span>
            ...
            <div class="box box-Manish">
                <div class="box-header">
                    <h3 class="box-title">Product Payment Sheet Details</h3>
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <fieldset>
                                <legend>Product Payment Sheet Details</legend>
                                <div class="col-md-12">
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <span class="pull-right">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" ValidationGroup="b"
                                                    ErrorMessage="Enter Date" ForeColor="Red" Text="<i class='fa fa-exclamation-circle' title='Enter Date !'></i>"
                                                    ControlToValidate="txtSearchDate" Display="Dynamic" runat="server">
                                                </asp:RequiredFieldValidator>

                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" ValidationGroup="b" runat="server" Display="Dynamic" ControlToValidate="txtSearchDate"
                                                    ErrorMessage="Invalid Date" Text="<i class='fa fa-exclamation-circle' title='Invalid Date !'></i>" SetFocusOnError="true"
                                                    ValidationExpression="^(((0[1-9]|[12]\d|3[01])/(0[13578]|1[02])/((19|[2-9]\d)\d{2}))|((0[1-9]|[12]\d|30)/(0[13456789]|1[012])/((19|[2-9]\d)\d{2}))|((0[1-9]|1\d|2[0-8])/02/((19|[2-9]\d)\d{2}))|(29/02/((1[6-9]|[2-9]\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00))))$"></asp:RegularExpressionValidator>
                                            </span>
                                            <asp:TextBox runat="server" autocomplete="off" CssClass="form-control" ID="txtSearchDate" MaxLength="10" placeholder="Select Date" data-provide="datepicker" onpaste="return false ;" onkeypress="return false;" data-date-format="dd/mm/yyyy" data-date-autoclose="true" ClientIDMode="Static"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group" style="margin-top: 20px;">
                                            <asp:Button runat="server" CssClass="btn btn-primary" ValidationGroup="b" ID="btnSearch" Text="Search" OnClick="btnSearch_Click" />
                                            <asp:Button runat="server" CssClass="btn btn-success" ID="btnExport" Visible="false" OnClick="btnExport_Click" Text="Export" />
                                ...
                                <div class="col-md-12">
                                    <div class="table-responsive">
                                        <asp:GridView ID="GridView1" OnRowCommand="GridView1_RowCommand" ShowFooter="true" OnRowDataBound="GridView1_RowDataBound" runat="server" class="table table-striped table-bordered" AllowPaging="false"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Date" HeaderStyle-Width="5px">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblDelivary_Date" Text='<%#Eval("Delivary_Date") %>' runat="server"></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="Payment Amt1" HeaderStyle-Width="5px">
                                                    ...
                                                    <FooterTemplate>
                                                        <asp:Label ID="lblFPA1" Font-Bold="true" runat="server"></asp:Label>
                                                    </FooterTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Payment Amt2" HeaderStyle-Width="5px">
                                                    ...
                                                    <FooterTemplate>
                                                        <asp:Label ID="lblFPA2" Font-Bold="true" runat="server"></asp:Label>
                                                    </FooterTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Payment Amt3" HeaderStyle-Width="5px">
                                                    ...
                                                    <FooterTemplate>
                                                        <asp:Label ID="lblFPA3" Font-Bold="true" runat="server"></asp:Label>
                                                    </FooterTemplate>
                                                </asp:TemplateField>
                                                <asp:TemplateField HeaderText="Payment Amt4" HeaderStyle-Width="5px">
                                                    ...
                                                    <FooterTemplate>
                                                        <asp:Label ID="lblFPA4" Font-Bold="true" runat="server"></asp:Label>
                                                    </FooterTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="Total Payment" HeaderStyle-Width="5px">
                                                    ...
                                                    <FooterTemplate>
                                                        <asp:Label ID="lblFTPA" Font-Bold="true" runat="server"></asp:Label>
                                                    </FooterTemplate>
                                                </asp:TemplateField>

<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="MilkChequeSummary_Rpt.aspx.cs" Inherits="mis_DemandSupply_MilkChequeSummary_Rpt" %>
                ...
                <div class="col-md-12">
                    <div class="box box-Manish">
                        <div class="box-header">
                            <h3 class="box-title">Check Summary Report</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <fieldset>
            ...
            <div class="row no-print">
                <div class="col-md-2 pull-right">
                                        <div class="form-group">
                                            ...
                                            <asp:Button ID="btnPrint" runat="server" Visible="false" OnClientClick="window.print()" Text="Print" CssClass="btn btn-success" />

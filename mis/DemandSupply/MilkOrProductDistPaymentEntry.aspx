<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="MilkOrProductDistPaymentEntry.aspx.cs" Inherits="mis_DemandSupply_MilkOrProductDistPaymentEntry" %>
        ...
        <section class="content">
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title">Milk or Product Payment Entry</h3>
                </div>
                <asp:Label ID="lblMsg" runat="server"></asp:Label>
                <div class="box-body">
                    <fieldset>
                        <legend>Milk or Product Payment Entry</legend>
                        <div class="col-md-12">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <asp:DropDownList ID="ddlDitributor" AutoPostBack="true" OnSelectedIndexChanged="ddlDitributor_SelectedIndexChanged"  runat="server" CssClass="form-control select2">
                    ...
                    <fieldset>
                        ...
                        <div class="col-md-2">
                         ...
                         <div class="col-md-2">
                            <div class="form-group">
                                <label>Item Category</label>
                                <asp:DropDownList ID="ddlFilterItemCategory" AutoPostBack="true" OnSelectedIndexChanged="ddlFilterItemCategory_SelectedIndexChanged"  runat="server" CssClass="form-control select2"></asp:DropDownList>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                        ...
                        <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <asp:DropDownList ID="ddlFilterDistributor" runat="server" CssClass="form-control select2">
                                    </asp:DropDownList>
                                </div>
                            </div>
                        <div class="col-md-2">
                                ...
                                <Columns>
                                   ...
                                   <%-- <asp:TemplateField HeaderText="Route">
                                    ...
                                    <asp:TemplateField HeaderText="Distributor">
                                        <ItemTemplate>
                                            <asp:Label ID="lblDistributor" runat="server" Text='<%# Eval("DName") + " -" + Eval("RName") %>'></asp:Label>
                                        </ItemTemplate>
                                        <FooterTemplate>
                                             <b>Total</b>
                                       </FooterTemplate>

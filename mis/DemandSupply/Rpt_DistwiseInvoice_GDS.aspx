<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="Rpt_DistwiseInvoice_GDS.aspx.cs" Inherits="mis_DemandSupply_Rpt_DistwiseInvoice_GDS" %>
                            ...
                            <div class="row">
                                <div id="pnlprint" runat="server" class="">
                                    <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <span class="pull-left">Prepared & Checked by </span><span class="pull-right">For  <asp:Label ID="lblOName2" runat="server"></asp:Label> <%--Bhopal Sahakari Dugdha Sang Maryadit--%></span>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-md-12">

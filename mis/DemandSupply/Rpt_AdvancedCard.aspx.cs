...
public partial class mis_DemandSupply_Rpt_AdvancedCard : System.Web.UI.Page
{
    ...
    private void GetAdvancedCardDetailsRouteWise()
    {
        try
        {
            lblMsg.Text = "";
            ...
            ds1 = objdb.ByProcedure("USP_Trn_MilkAdvancedCardDetails",
                     new string[] { "flag", "RouteId", "Shift_id", "ItemCat_id", "FromDate", "ToDate", "Office_ID", "AreaId" },
                       new string[] { "1", ddlRoute.SelectedValue, ddlShift.SelectedValue, objdb.GetMilkCatId(), fromnonth, tomonth, objdb.Office_ID(), ddlLocation.SelectedValue }, "dataset");
            ...
            if (ds1.Tables[0].Rows.Count != 0)
            {
                ...
                sb.Append("<td colspan='2'  class='text-center'><b>" + ViewState["Office_Name"].ToString() + "<b><br><span>Advanced Card Report</span></td>");
                ...
                for (int j = 0; j < ColCount; j++)
                {
                    ...
                    if (ds1.Tables[0].Columns[j].ToString() != "RouteId" && ds1.Tables[0].Columns[j].ToString() != "Route")
                    {
                ...
                for (int i = 0; i < Count; i++)
                {
                    ...
                    sb.Append("<td>" + ds1.Tables[0].Rows[i]["Route"] + "</td>");
                    for (int K = 0; K < ColCount; K++)
                    {
                        ...
                        if (ds1.Tables[0].Columns[K].ToString() != "RouteId" && ds1.Tables[0].Columns[K].ToString() != "Route")
                        {
        ...
        {
            lblMsg.Text = objdb.Alert("fa-ban", "alert-danger", "Sorry! : Error RouteWise Advanced Card Report ", ex.Message.ToString());
        }
        finally
        {
    ...
    private void GetParlourDetails(string rid)
    {
        try
        {
            string fm = "16/" + txtFromMonth.Text;
            ...
            ds2 = objdb.ByProcedure("USP_Trn_MilkAdvancedCardDetails",
                     new string[] { "flag", "RouteId", "Shift_id", "ItemCat_id", "FromDate", "ToDate", "Office_ID", "AreaId" },
                       new string[] { "2", rid, ddlShift.SelectedValue, "3", fromnonth, tomonth, objdb.Office_ID(), ddlLocation.SelectedValue }, "dataset");
            if (ds2.Tables[0].Rows.Count > 0)
            {
                ...
                sb1.Append("<td colspan='2'  class='text-center'><b>" + ViewState["Office_Name"].ToString() + "<br>Advanced Card Report</b></td>");
                ...
                sb1.Append("</tr>");
                sb1.Append("<tr>");
                sb1.Append("<td>Date  :-" + modaldate.InnerHtml + "</td>");
                ...
                sb1.Append("<td>Retailer/Institution Name</td>");
    ...
    protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            if (e.CommandName == "RoutwiseRetailer")
            {
                ...
                if (ctrl != null)
                {
                    ...
                    LinkButton lnkRouteId = (LinkButton)row.FindControl("lnkRouteId");

                    modalRootOrDistName.InnerHtml = lnkRouteId.Text;
                    ...
                    modaldate.InnerHtml = fm1 + " To " + tm1;
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        if (Page.IsValid)
        {
            GetAdvancedCardDetailsRouteWise();
        }
    }

<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="Rpt_InvoiceDistOrInst_GDS.aspx.cs" Inherits="mis_DemandSupply_Rpt_InvoiceDistOrInst_GDS" %>
                                    ...
                                    <div class="box box-Manish">
                                        ...
                                        <div class="box-body">
                                            ...
                                            <asp:Label ID="lblMsName" runat="server"></asp:Label></b>
                                                        ...
                                                        <div class="row" id="pnltcs" runat="server" visible="true">

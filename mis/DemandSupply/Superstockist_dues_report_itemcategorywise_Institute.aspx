<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="Superstockist_dues_report_itemcategorywise_Institute.aspx.cs" Inherits="mis_DemandSupply_Superstockist_dues_report_itemcategorywise_Institute" %>
                ...
                <div class="col-md-12">
                    <div class="box box-Manish">
                        <div class="box-header">
                            <h3 class="box-title"> Institute Milk Or Product Dues Report</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            ...
                            <div class="row">
                                <fieldset>
                                    <legend>Institute Milk Or Product Dues Report
                                    </legend>
                                    <div class="col-md-2">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="ddlItemCategory"  Enabled="false" OnSelectedIndexChanged="ddlItemCategory_SelectedIndexChanged" AutoPostBack="true" ClientIDMode="Static" runat="server" CssClass="form-control select2"></asp:DropDownList>
                                    </div>
                                </div>
                                    <div class="col-md-2">
                                <div class="form-group">

<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="Rpt_ProductDemandDetails.aspx.cs" Inherits="mis_DemandSupply_Rpt_ProductDemandDetails" %>
                                        ...
                                        <asp:GridView ID="GridView1" runat="server" OnRowCommand="GridView1_RowCommand" class="datatable table table-striped table-bordered" AllowPaging="false"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Action" HeaderStyle-Width="5px">
                                                    ...
                                                    &nbsp;&nbsp;<asp:CheckBox ID="Checkgujrat" Text="For Gujrat" runat="server" Checked="false" Visible='<%#Eval("Office_ID").ToString()=="5" ? true :false %>' />
													</ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        </asp:GridView>
                                                        ...
                                                        <asp:GridView ID="GridView4" runat="server" OnRowCommand="GridView4_RowCommand" OnRowDataBound="GridView4_RowDataBound" EmptyDataText="No Record Found" class="table table-striped table-bordered" AllowPaging="false"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Action">
                                                                    <ItemTemplate>
                                                                        <asp:LinkButton ID="lnkEdit" Visible="false" CommandName="RecordEdit" CommandArgument='<%#Eval("ProductDispDeliveryChallanChildId") %>' runat="server" ToolTip="Edit"><i class="fa fa-pencil"></i></asp:LinkButton>
                                                                        &nbsp;&nbsp;&nbsp;
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <asp:LinkButton ID="lnkUpdateCrate" OnClick="lnkUpdateCrate_Click" ValidationGroup="crateupdate" CssClass="btn btn-success" Text="Update Crate" runat="server"></asp:LinkButton>
                                                        ...
                                                        <asp:GridView ID="GridView3" runat="server" EmptyDataText="No Record Found" class="table table-striped table-bordered" AllowPaging="false"
                                                            ...
                                                            <Columns>
                                                                <asp:TemplateField HeaderText="" ItemStyle-Width="30" ItemStyle-HorizontalAlign="Center">
                                                                    <HeaderTemplate>
                                                                        <asp:CheckBox ID="checkAll" runat="server" onclick="checkAll(this);" />
                                                                        <asp:CustomValidator ID="CustomValidator1" runat="server" ValidationGroup="ItemReplace" ErrorMessage="Please select at least one record."

<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="InvoiceGenerateDistOrInst_JBL.aspx.cs" Inherits="mis_DemandSupply_InvoiceGenerateDistOrInst_JBL" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentBody" runat="Server">
    ...
    <div class="content-wrapper">
                                ...
                                <div class="row no-print">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList ID="ddlInvoiceFor" AutoPostBack="true" OnSelectedIndexChanged="ddlInvoiceFor_SelectedIndexChanged" runat="server" CssClass="form-control select2">
                                                <asp:ListItem Text="Select" Value="0"></asp:ListItem>
                                                <asp:ListItem Text="Distributor/Superstockist" Value="1"></asp:ListItem>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group" style="margin-top: 20px;">
                                            <asp:Button runat="server" CssClass="btn btn-block btn-primary" OnClick="btnSearch_Click" ValidationGroup="a" ID="btnSearch" Text="Generate" />
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                 <div class="col-md-10">
                                      <div class="form-group">
                                     <label>Remark</label>
                                     <asp:TextBox runat="server" autocomplete="off" CssClass="form-control" ID="TxtRemark"  placeholder="Enter Remark"  ></asp:TextBox>
                                </div>
                                           </div>
                                ...
                                <div id="pnlprint" runat="server">
                                    <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                        <asp:GridView ID="GridView1" runat="server" Width="100%" ShowFooter="true" class="table1 table-striped table-bordered" AllowPaging="false"
                                                            ...
                                                            <Columns>
                                                                ...
                                                                <asp:TemplateField HeaderText="Qty (In Pkt)" HeaderStyle-Width="10px">
                                                                    ...
                                                                    <FooterTemplate>
                                                                        <asp:Label ID="lblSupplyTotalQty_tot" runat="server"></asp:Label>
                                                                    </FooterTemplate>
                                                                </asp:TemplateField>
                                                                   <asp:TemplateField HeaderText="Qty (In Ltr.)" HeaderStyle-Width="10px">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblSupplyTotalQtyInLtr" Text='<%# Eval("SupplyTotalQtyInLtr")%>' runat="server" />
                                                                    </ItemTemplate>
                                                                    <FooterTemplate>
                                                                        <asp:Label ID="lblSupplyTotalQtyInLtr_tot" runat="server"></asp:Label>
                                                                    </FooterTemplate>
                                                                </asp:TemplateField>
                                                                 <asp:TemplateField HeaderText="Return Qty (In Pkt.)" HeaderStyle-Width="10px">
                                                                    <ItemTemplate>
                                                                      ...
                                                                      <FooterTemplate>
                                                                        <asp:Label ID="lblTotalReturnQty_tot" runat="server"></asp:Label>
                                                                    </FooterTemplate>
                                                                </asp:TemplateField>
                                                                 <asp:TemplateField HeaderText="Adv. Card Qty (In Pkt.)" HeaderStyle-Width="10px">
                                                                    <ItemTemplate>
                                                                       ...
                                                                       <FooterTemplate>
                                                                        <asp:Label ID="lblTotalAdvCardQty_tot" runat="server"></asp:Label>
                                                                    </FooterTemplate>
                                                                </asp:TemplateField>
                                                                ...
                                                                <asp:TemplateField HeaderText="Adv. Card Margin Amt" HeaderStyle-Width="10px">
                                                                  ...
                                                                  <asp:TemplateField HeaderText="Inst. Qty" HeaderStyle-Width="10px">
                                                                    <ItemTemplate>
                                                                       ...
                                                                       <FooterTemplate>
                                                                        <asp:Label ID="lblInstQty_tot" runat="server"></asp:Label>
                                                                    </FooterTemplate>
                                                                </asp:TemplateField>
                                                                  <asp:TemplateField HeaderText="Inst. Total Amt" HeaderStyle-Width="10px">
                                                                    <ItemTemplate>
                                                                       <%-- <asp:Label ID="lblInstTotalAmt" Text='<%# (Convert.ToDecimal(Eval("TotalInstSupplyQtyInLtr")) * Convert.ToDecimal(Eval("InstRatePerLtr"))).ToString("0.000") %>' runat="server" />--%>
                                                                         <asp:Label ID="lblInstTotalAmt" Text='<%# Eval("TotalInstAmount")%>' runat="server" />
                                                                    </ItemTemplate>
                                                                     <FooterTemplate>
                                                               ...
                                                               <%-- sadhana--%>
                                                                 <asp:TemplateField HeaderText="(Distri. + trans) Margin on cash supply">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lbldisttransmarginrate" Text='<%# Convert.ToDecimal(Eval("DistOrSSComm")) + Convert.ToDecimal(Eval("TransComm")) %>' runat="server" />
                                                                    </ItemTemplate>
                                                                </asp:TemplateField>
                                                                 <asp:TemplateField HeaderText="(Distri. + trans) Margin Amt on cash supply">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lbldisttransmarginamt" Text='<%# (Convert.ToDecimal(Eval("DistOrSSComm")) + Convert.ToDecimal(Eval("TransComm")))*Convert.ToDecimal(Eval("BillingQty")) %>' runat="server" />
                                                                    </ItemTemplate>
                                                                      <FooterTemplate>
                                                                        <asp:Label ID="lbldisttransmarginamt_tot" runat="server"></asp:Label>
                                                                    </FooterTemplate>
                                                                </asp:TemplateField>
                                                                 <%-- sadhana--%>
                                                                 <asp:TemplateField HeaderText="Billing Qty (In Pkt.)">
                                                                    <ItemTemplate>
                                                                      ...
                                                                      <FooterTemplate>
                                                                        <asp:Label ID="lblBillingQty_tot" runat="server"></asp:Label>
                                                                    </FooterTemplate>
                                                                </asp:TemplateField>
                                                                <asp:TemplateField HeaderText="Billing Qty (In Ltr.)">
                                                                    <ItemTemplate>
                                                                     ...
                                                                     <FooterTemplate>
                                                                        <asp:Label ID="lblBillingQtyInLtr_tot" runat="server"></asp:Label>
                                                                    </FooterTemplate>
                                                                </asp:TemplateField>
                                                                ...
                                                                <asp:TemplateField HeaderText="Amount">
                                                                 ...
                                                                 <asp:TemplateField HeaderText="Payble Amount">
                                                                    <ItemTemplate>
                                                                        <asp:Label ID="lblFAmount" Text='<%# Convert.ToDecimal(Eval("Amount")) - Convert.ToDecimal(Eval("AdvCardAmt"))- Convert.ToDecimal(Eval("InstTransCommAmt"))-(Convert.ToDecimal(Eval("DistOrSSComm"))+Convert.ToDecimal(Eval("TransComm")))*Convert.ToDecimal(Eval("BillingQty")) %>' runat="server" />
                                                                    </ItemTemplate>
                                                                    <FooterTemplate>
                                                        ...
                                                        <asp:GridView ID="GridView2" runat="server"  Width="100%" ShowFooter="true" class="table1 table-striped table-bordered" AllowPaging="false"
        ...
        <section class="content">
            ...
            <asp:Label id="lblinvoiceno" Visible="false"  runat="server" ></asp:Label>
        </section>
    </div>
</asp:Content>

...
public partial class mis_DemandSupply_Rpt_ProductRejectedDemandDetails : System.Web.UI.Page
{
    ...
    private void GetDMDetails()
    {
        try
        {
            ...
            ds1 = objdb.ByProcedure("USP_Trn_ProductDM",
                    new string[] { "flag", "FromDate", "ToDate", "DelivaryShift_id", "ItemCat_id", "AreaId", "RouteId", "Office_ID", "MultiProductDMStatus" },
                      new string[] { "27", fromdat, todat, ddlShift.SelectedValue, objdb.GetProductCatId(), ddlLocation.SelectedValue, ddlRoute.SelectedValue, objdb.Office_ID(), multidmtype }, "dataset");

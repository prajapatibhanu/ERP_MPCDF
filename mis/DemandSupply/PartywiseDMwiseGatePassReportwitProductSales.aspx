<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="PartywiseDMwiseGatePassReportwitProductSales.aspx.cs" Inherits="mis_DemandSupply_PartywiseDMwiseGatePassReportwitProductSales" %>
                ...
                <div class="col-md-12">
                    <div class="box box-Manish">
                        <div class="box-header">
                            <h3 class="box-title">Partywise DM Gatepass Report and Product Sales Report</h3>
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                <fieldset>
                                    <legend>Partywise DM Gatepass Report and Product Sales Report
                                    </legend>
                                    <div class="col-md-2">

<%@ Page Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="PartywiseDMwiseGatePassReport.aspx.cs" Inherits="mis_DemandSupply_PartywiseDMwiseGatePassReport" %>
                ...
                <div class="col-md-12">
                    <div class="box box-Manish">
                        <div class="box-header">
                            <h3 class="box-title">Partywise DM Gatepass Report </h3>
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                <fieldset>
                                    <legend>Partywise DM Gatepass Report 
                                    </legend>
                                    <div class="col-md-2">

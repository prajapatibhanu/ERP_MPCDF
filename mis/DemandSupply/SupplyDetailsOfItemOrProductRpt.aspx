<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="SupplyDetailsOfItemOrProductRpt.aspx.cs" Inherits="mis_DemandSupply_SupplyDetailsOfItemOrProductRpt" %>
                ...
                <div class="col-md-12">
                    <div class="box box-Manish">
                        <div class="box-header">
                            <h3 class="box-title">Supply Status Report</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <fieldset>
                                <legend>Supply Status Report 
                                </legend>
                                <div class="row">
                                    <div class="col-lg-12">
                    ...
                    <div class="box box-Manish">
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <fieldset>
                                        <legend>Supply Status Report</legend>
                                        ...
                                        <div class="col-md-12">
                                          ...
                                          <div class="col-md-12" id="pnltotalSaleInLitre" runat="server" visible="false">
                                            <label>Sale In Ltr. : </label>
                                            <asp:Label ID="lblTotalSaleInLtrValue" Font-Bold="true" runat="server"></asp:Label>
                                                            ...
                                                            <asp:GridView ID="GridView4" runat="server" ShowFooter="true" OnRowDataBound="GridView4_RowDataBound" class="datatable table table-striped table-bordered" AllowPaging="false"
                                                                ...
                                                                <Columns>
                                                                    ...
                                                                    <asp:TemplateField HeaderText="Challan No.">
                                                                        <ItemTemplate>
                                                                            <asp:Label ID="lbltmp_ChallanNo" CommandName="ItemOrdered" Text='<%#Eval("tmp_ChallanNo") %>' runat="server"></asp:Label>
                                                                        </ItemTemplate>
                                                                    </asp:TemplateField>

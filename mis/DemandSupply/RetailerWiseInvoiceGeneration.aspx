<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="RetailerWiseInvoiceGeneration.aspx.cs" Inherits="mis_DemandSupply_RetailerWiseInvoiceGeneration" %>
                ...
                <div class="col-md-12">
                    <div class="box box-Manish">
                        <div class="box-header">
                            <h3 class="box-title">Retailer Wise Invoice View</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <fieldset>
                                <legend>Retailer Wise Invoice View
                                </legend>
                                <div class="row">
                                    <div class="col-lg-12">

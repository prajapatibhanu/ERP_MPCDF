<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="Merge_dues_report_New.aspx.cs" Inherits="mis_DemandSupply_Merge_dues_report_New" EnableEventValidation="true" %>
                ...
                <div class="col-md-12">
                    <div class="box box-Manish">
                        <div class="box-header">
                            <h3 class="box-title">Milk And Product Merge Dues Report</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            ...
                            <div class="row">
                                <fieldset>
                                    <legend>Milk And Product Merge Dues Report
                                    </legend>
                                    <div class="col-md-2">

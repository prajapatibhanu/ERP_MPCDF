...
public partial class mis_DemandSupply_PartywiseDMwiseGatePassReportwitProductSales : System.Web.UI.Page
{
        ...
        try
        {
            ...
            ds5 = objdb.ByProcedure("USP_Trn_ProductDM",
                     new string[] { "flag", "FromDate", "ToDate", "DelivaryShift_id", "ItemCat_id", "AreaId", "DistributorId", "Office_ID" },
                       new string[] { "7", fromdat, todat,ddlShift.SelectedValue , objdb.GetProductCatId(), ddlLocation.SelectedValue, ddlDitributor.SelectedValue, objdb.Office_ID() }, "dataset");
            ...
            if (ds5.Tables[0].Rows.Count != 0 && ds5 != null)
            {
                ...
                //    {
                  ...
                  //  }
                    //else if (i == 5)
                    //{
                        sb.Append("<td style='border-top:1px dashed black; border-bottom:1px dashed black;'><b>" + Convert.ToInt32(ds5.Tables[0].AsEnumerable().Sum(r => r.Field<int?>("SupplyQty") ?? 0)) + "</b></td>");
                    //}
                    //else if (i == 6)
                    //{
               ...
               // }
                    ...
                    else
                    {
                        if (ds5.Tables[1].Rows[i]["MOrPSubSection_id"].ToString() == subsubsectionid)
                        {
                            if (GrandTotalNetAmt > 0 && GrandTotalWeight>0)
                            {
                                ...
                                sb1.Append("<td>" + ds5.Tables[1].Rows[i]["SupplyQty"] + "</td>");
                ...
                for (int i = 0; i <= ColCount1; i++)
                {
                    ...
                    {
                        sb1.Append("<td style='border-top:1px dashed black;border-bottom:1px dashed black;'><b>" + Convert.ToInt32(ds5.Tables[1].AsEnumerable().Sum(r => r.Field<int?>("SupplyQty") ?? 0)) + "</b></td>");
                    }
                    else if (i == 3)
                    {

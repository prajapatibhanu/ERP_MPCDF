...
public partial class mis_DemandSupply_Merge_dues_report_superstockist_New : System.Web.UI.Page
{
    ...
    private void GetSS()
    {
        try
        {
            ...
            ds7 = objdb.ByProcedure("USP_Trn_merge_dues_report_superstockist_New",
    ...
    private void MergePayment_Report()
    {
        try
        {
            ...
            ds2 = objdb.ByProcedure("USP_Trn_merge_dues_report_superstockist_New",

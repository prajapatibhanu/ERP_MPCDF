<%@ Page Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="BulkMilkSale_dues_report_itemcategorywise.aspx.cs" Inherits="mis_DemandSupply_BulkMilkSale_dues_report_itemcategorywise" %>
                ...
                <div class="col-md-12">
                    <div class="box box-Manish">
                        <div class="box-header">
                            <h3 class="box-title">Bulk Milk Or Product Dues Report</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            ...
                            <div class="row">
                                <fieldset>
                                    <legend>Bulk Milk Or Product Dues Report
                                    </legend>
                                    <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList ID="ddlItemCategory"  ClientIDMode="Static" runat="server" CssClass="form-control select2"></asp:DropDownList>
                                        </div>
                                    </div>

<%@ Page Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="BulkMilksale_PaymentEntry.aspx.cs" Inherits="mis_DemandSupply_BulkMilksale_PaymentEntry" %>
        ...
        <section class="content">
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title">Bulk Milk Payment Entry</h3>
                </div>
                <asp:Label ID="lblMsg" runat="server"></asp:Label>
                <div class="box-body">
                    <fieldset>
                        <legend>Bulk Milk Sale Payment Entry</legend>
                        <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddlItemCategory" Enabled="true"  AutoPostBack="true" OnSelectedIndexChanged="ddlItemCategory_SelectedIndexChanged" runat="server" CssClass="form-control select2"></asp:DropDownList>
                            </div>
                        </div>
                            ...
                            <div class="col-md-3" id="union" runat="server">
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="ddlUnion" runat="server" CssClass="form-control select2" AutoPostBack="true" OnSelectedIndexChanged="ddlUnion_SelectedIndexChanged"></asp:DropDownList>
                            ...
                            <div class="col-md-3" id="thirdparty" runat="server">
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="ddlThirdparty" runat="server" CssClass="form-control select2" AutoPostBack="true" OnSelectedIndexChanged="ddlUnion_SelectedIndexChanged"></asp:DropDownList>
                            ...
                            <div class="col-md-3" id="MDP" runat="server">
                                <div class="form-group">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="ddlMDP" runat="server" CssClass="form-control select2" AutoPostBack="true" OnSelectedIndexChanged="ddlUnion_SelectedIndexChanged"></asp:DropDownList>
                ...
                <div class="box-body">
                    <fieldset>
                        <legend>Bulk Milk Sale Payment Entry Detail</legend>
                        <div class="row">

                            <div class="col-md-7">
                                <div class="form-group">
                                    <asp:RadioButtonList ID="rbtnsaletofilter" runat="server" RepeatDirection="Horizontal" Style="margin-top: 20px;" OnSelectedIndexChanged="rbtnsaletofilter_SelectedIndexChanged" AutoPostBack="true">
                                        <asp:ListItem Value="1" Selected="True">&nbsp;&nbsp;Union To Union&nbsp;&nbsp;</asp:ListItem>
                                        <asp:ListItem Value="2">&nbsp;&nbsp;Union To Third Party&nbsp;&nbsp;</asp:ListItem>
                                        <asp:ListItem Value="3">&nbsp;&nbsp;Union To CC/MDP</asp:ListItem>
                                    </asp:RadioButtonList>
                        ...
                        <div class="col-md-2">
                         ...
                         <div class="col-md-2">
                            <div class="form-group">
                                <label>Item Category</label>
                                <asp:DropDownList ID="ddlFilterItemCategory" Enabled="true"    runat="server" CssClass="form-control select2"></asp:DropDownList>
                            </div>
                        </div>
                        <%--<div class="col-md-2" style="display:none">
                            <div class="form-group">
                             ...
                             <div class="col-md-3" id="DivUnion" runat="server">
                                <div class="form-group">
                                    <div class="form-group">
                                        <label>Union<span class="text-danger">*</span></label>
                                        <span class="pull-right">
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" Display="Dynamic" InitialValue="0" ControlToValidate="ddlUnionFilter" Text="<i class='fa fa-exclamation-circle' title='Select Union!'></i>" ErrorMessage="Select Union" SetFocusOnError="true" ForeColor="Red" ValidationGroup="Save"></asp:RequiredFieldValidator>
                                        </span>
                                        <asp:DropDownList ID="ddlUnionFilter" runat="server" CssClass="form-control select2" ></asp:DropDownList>
                                        <small><span id="valddlUnionFilter" class="text-danger"></span></small>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3" id="DivThirdParty" runat="server">
                                <div class="form-group">
                                    <div class="form-group">
                                        <label>Third Party<span class="text-danger">*</span></label>
                                        <span class="pull-right">
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" Display="Dynamic" InitialValue="0" ControlToValidate="ddlThirdpartyFilter" Text="<i class='fa fa-exclamation-circle' title='Select Third Party!'></i>" ErrorMessage="Select Third Party" SetFocusOnError="true" ForeColor="Red" ValidationGroup="Save"></asp:RequiredFieldValidator>
                                        </span>
                                        <asp:DropDownList ID="ddlThirdpartyFilter" runat="server" CssClass="form-control select2" ></asp:DropDownList>
                                        <small><span id="valddlThirdpartyFilter" class="text-danger"></span></small>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3" id="DivMDP" runat="server">
                                <div class="form-group">
                                    <div class="form-group">
                                        <label>CC/Mini Dairy Plant<span class="text-danger">*</span></label>
                                        <span class="pull-right">
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" InitialValue="0" Display="Dynamic" ControlToValidate="ddlMDPFilter" Text="<i class='fa fa-exclamation-circle' title='Select CC/Mini Dairy Plant!'></i>" ErrorMessage="Select CC/MPD" SetFocusOnError="true" ForeColor="Red" ValidationGroup="Save"></asp:RequiredFieldValidator>
                                        </span>
                                        <asp:DropDownList ID="ddlMDPFilter" runat="server" CssClass="form-control select2" ></asp:DropDownList>
                                        <small><span id="valddlMDPFilter" class="text-danger"></span></small>
                                    </div>
                                </div>
                            </div>
                        <%--<div class="col-md-3">
                        ...
                        <div class="col-md-12">
                            <asp:GridView ID="GridView1" runat="server" OnRowDataBound="GridView1_RowDataBound"
                                DataKeyNames="BulkMilkPaymentSheet_ID" CssClass="table table-bordered" ShowFooter="true"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="S.No">
                                        <ItemTemplate>
                                           ...
                                           <%--  <asp:Label ID="lblAreaId" Visible="false" Text='<%#Eval("AreaId") %>' runat="server"></asp:Label>
                                            ...
                                            <asp:Label ID="lblSaleToOffice_Id" Visible="false" Text='<%#Eval("SaleToOffice_Id") %>' runat="server"></asp:Label>
                                            <asp:Label ID="lblMilkTrasferType" Visible="false" Text='<%#Eval("MilkTrasferType") %>' runat="server"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                   ...
                                   <%-- <asp:TemplateField HeaderText="Route">
                                    ...
                                    <asp:TemplateField HeaderText="Union/Third Party/CC/MDP">
                                        <ItemTemplate>
                                            <asp:Label ID="lblSaletoOfficeName" runat="server" Text='<%# Eval("SaletoOfficeName")%>'></asp:Label>
                                        </ItemTemplate>
                                        <FooterTemplate>
                                             <b>Total</b>
                                       </FooterTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Milk Amount">
                                        <ItemTemplate>
                                            <asp:Label ID="lblAmount" runat="server" Text='<%# Eval("TotalBillAmount") %>'></asp:Label>
                                             <asp:Label ID="lblTotalGSTAmount" Visible="false" Text='<%#Eval("TotalGSTAmount") %>' runat="server"></asp:Label>
                                            <asp:Label ID="lblTotalTcsTaxAmt" Visible="false" Text='<%#Eval("TotalTcsTaxAmt") %>' runat="server"></asp:Label>
                                        </ItemTemplate>
                                       <FooterTemplate>
                                   ...
                                   <%-- <asp:TemplateField HeaderText="Remark">
                                    ...
                                    <asp:TemplateField HeaderText="Payment Amt3" HeaderStyle-Width="5px">
                                     ...
                                     <asp:TemplateField HeaderText="Payment Amt4" HeaderStyle-Width="5px">
                                      ...
                                      <asp:TemplateField HeaderText="Total Payment" HeaderStyle-Width="5px">
                                        <ItemTemplate>
                                            <asp:Label ID="lblTotalPayment" Text='<%#Eval("TotalPaidAmt") %>' runat="server"></asp:Label>
                                        </ItemTemplate>
                                           <FooterTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Action">
                                        <ItemTemplate>
                                            ...
                                            <asp:LinkButton ID="lnkbtnEdit" runat="server" CommandName="EditRecord" CommandArgument='<%# Eval("BulkMilkPaymentSheet_ID") %>'><i class="fa fa-edit"></i></asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                            ...
                            <%--<asp:GridView ID="GridView2" Visible="false" OnRowCommand="GridView2_RowCommand" ShowFooter="true" OnRowDataBound="GridView2_RowDataBound" runat="server" class="table table-striped table-bordered" AllowPaging="false"

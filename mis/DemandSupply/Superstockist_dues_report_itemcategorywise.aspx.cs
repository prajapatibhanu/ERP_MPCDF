...
public partial class mis_DemandSupply_Superstockist_dues_report_itemcategorywise : System.Web.UI.Page
{
    ...
    private void GetSS()
    {
        try
        {
            ...
            ds7 = objdb.ByProcedure("USP_Trn_merge_dues_report_categorywise_forsuperstockist_New",
               new string[] { "flag", "Office_ID", "AreaId", "ItemCat_id" },
    ...
    private void duesPayment_Report()
    {
        try
        {
            ...
            ds2 = objdb.ByProcedure("USP_Trn_merge_dues_report_categorywise_forsuperstockist_New",

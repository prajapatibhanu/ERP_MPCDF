<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="DistInvoice_GDS.aspx.cs" Inherits="mis_DemandSupply_DistInvoice_GDS" %>
                ...
                <div class="col-md-12">
                    <div class="box box-Manish">
                        <div class="box-header">
                            <h3 class="box-title">View Distributor Invoices </h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <fieldset>
                                <legend>View Distributor Invoices
                                </legend>
                                <div class="row">
                                    <div class="col-lg-12">

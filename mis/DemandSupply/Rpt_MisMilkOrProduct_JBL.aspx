<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="Rpt_MisMilkOrProduct_JBL.aspx.cs" Inherits="mis_DemandSupply_Rpt_MisMilkOrProduct_JBL" %>
                ...
                <div class="col-md-12">
                    <div class="box box-Manish">
                        <div class="box-header">
                            <h3 class="box-title">MIS Report Mkt JDS</h3>
                        ...
                        <div class="box-body">
                            ...
                            <div class="col-md-12">
                                ...
                                <div id="div_page_contnt3" runat="server" class="page_content"></div>
                            </div>
                        </div>
                            </div>
                        </div>

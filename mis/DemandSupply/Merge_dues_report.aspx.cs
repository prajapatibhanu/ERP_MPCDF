...
public partial class mis_DemandSupply_Merge_dues_report : System.Web.UI.Page
{
    ...
    private void GetSS()
    {
        try
        {
            ...
            ds7 = objdb.ByProcedure("USP_Trn_merge_dues_report",
    ...
    private void MergePayment_Report()
    {
        try
        {
            ...
            ds2 = objdb.ByProcedure("USP_Trn_merge_dues_report",
            ...
            if (ds2.Tables[0].Rows.Count != 0)
            {
                ...
                for (int i = 0; i < Count; i++)
                {
                  ...
                  //  DateTime delivery_date = DateTime.ParseExact(ds2.Tables[0].Rows[i]["Delivary_Date"].ToString(), "dd/MM/yyyy", culture);
                    ...
                    sb.Append("<td style='border:1px solid black;'>" + ds2.Tables[0].Rows[i]["DisName"] + "</td>");
    ...
    protected void btnClear_Click(object sender, EventArgs e)
    {
        ...
        Response.Redirect("Merge_dues_report.aspx");
    }

...
public partial class mis_DutyChart_Tanker_Master : System.Web.UI.Page
{
    ...
    protected void btnYes_Click(object sender, EventArgs e)
    {
        try
        {
            if (ViewState["UPageTokan"].ToString() == Session["PageTokan"].ToString())
            {
                ...
                {
                    ds = objdb.ByProcedure("Usp_TankerDetailDutyChartDutyChart",
                        new string[] { "flag", "V_VehicleType", "V_VehicleNo", "I_OfficeID", "I_OfficeTypeID", "D_VehicleCapacity", "V_SingleChambCapacity", "V_DualChambCapacity", "V_VenderName", "V_VendorContactNo", "CreatedBy", "IsActive", "MilkCollectionFrom" },
                        new string[] { "3", ddlTankerDetail.SelectedValue, txtV_VehicleNo.Text, objdb.Office_ID(), objdb.OfficeType_ID(), txtD_VehicleCapacity.Text, txtSingleChamberCapacity.Text, txtDualChamberCapacity.Text, txtV_VenderName.Text, txtV_VendorContactNo.Text, objdb.createdBy(), isactive.ToString(), ddlMilkCollectionFrom.SelectedValue }, "dataset");
                ...
                {
                    ds = objdb.ByProcedure("Usp_TankerDetailDutyChart",
                        new string[] { "flag", "V_VehicleType", "V_VehicleNo", "I_OfficeID", "I_OfficeTypeID", "D_VehicleCapacity", "V_SingleChambCapacity", "V_DualChambCapacity", "V_VenderName", "V_VendorContactNo", "CreatedBy", "IsActive", "I_TankerID", "MilkCollectionFrom" },
                        new string[] { "4", ddlTankerDetail.SelectedValue, txtV_VehicleNo.Text, objdb.Office_ID(), objdb.OfficeType_ID(), txtD_VehicleCapacity.Text, txtSingleChamberCapacity.Text, txtDualChamberCapacity.Text, txtV_VenderName.Text, txtV_VendorContactNo.Text, objdb.createdBy(), isactive.ToString(), ViewState["rowid"].ToString(), ddlMilkCollectionFrom.SelectedValue }, "dataset");
                    if (ds.Tables[0].Rows[0]["Msg"].ToString() == "Ok")
                    {
                        string success = ds.Tables[0].Rows[0]["ErrorMsg"].ToString();
    ...
    protected void GetData()
    {
        try
        {
            gv_TankerDetails.DataSource = objdb.ByProcedure("Usp_TankerDetailDutyChart",

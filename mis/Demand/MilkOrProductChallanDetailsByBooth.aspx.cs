...
public partial class mis_Demand_MilkOrProductChallanDetailsByBooth : System.Web.UI.Page
{
        ...
        try
        {
            ...
            ds = objdb.ByProcedure("USP_Trn_MilkOrProductDemandForSupply",
                     new string[] { "flag", "FromDate", "ToDate", "Shift_id", "ItemCat_id", "BoothId" },
                       new string[] { "10", fromdat, todat, ddlShift.SelectedValue, ddlItemCategory.SelectedValue, objdb.createdBy() }, "dataset");
            ...
            if (e.CommandName == "ChallanNo")
            {
                ...
                if (ctrl != null)
                {
                   ...
                   //     }
                     //   else
                     //   {
                            //int rowcount1 = GridView2.FooterRow.Cells.Count - 4; // previous value 5
                            //GridView2.FooterRow.Cells[rowcount1].Visible = false;
                            //GridView2.FooterRow.Cells[rowcount1 + 1].Visible = false;
                            //GridView2.FooterRow.Cells[rowcount1 + 2].Visible = false;
    ...
    protected void GridView2_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        try
        {
            ...
            {
               // int maxBrowcell1 = e.Row.Cells.Count - 1;
            ...
            {
              //  int maxBheadercell1 = e.Row.Cells.Count - 1;
                e.Row.Cells[1].Visible = false;
                e.Row.Cells[2].Visible = false;
                e.Row.Cells[3].Visible = false;
              //  if (ViewState["ItemCategory"].ToString() != "3")

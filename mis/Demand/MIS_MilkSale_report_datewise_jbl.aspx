<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="MIS_MilkSale_report_datewise_jbl.aspx.cs" Inherits="mis_Demand_MIS_MilkSale_report_datewise_jbl" %>
                ...
                <div class="col-md-12">
                    <div class="box box-Manish">
                        <div class="box-header">
                            <h3 class="box-title">MIS Milk Sale Report</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <fieldset>
                                <legend>MIS Milk Sale Report
                                </legend>
                                <div class="row">
                                    <div class="col-lg-12">
            ...
            <div class="row">
                        ...
                        <div class="box-body">
                           <%-- <div class="col-md-12">--%>
                                ...
                                <div id="div_page_content_morning" runat="server" ></div>
                           <%-- </div>
                            <div class="col-md-12">--%>

<%--                                <div id="div_page_content_Evening" runat="server" ></div>--%>
                           <%-- </div>
                            <div class="col-md-12">--%>

                               <%-- <div id="div_page_content_All" runat="server" ></div>--%>
                         <%--   </div>--%>
                        </div>
                    </div>
        </section>

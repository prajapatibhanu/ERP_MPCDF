<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="CityWiseMIS_BDS.aspx.cs" Inherits="mis_Demand_Rpt_CityWiseMIS_BDS" %>
                ...
                <div class="col-md-12">
                    <div class="box box-Manish">
                        <div class="box-header">
                            <h3 class="box-title">City Wise MIS Report</h3>
                            ...
                            <div class="row">
                                <fieldset>
                                    ...
                                    <div class="col-md-2">
                                         ...
                                         <asp:DropDownList ID="ddlQtyType" CssClass="form-control select2" runat="server">
                                             <asp:ListItem Text="Qty(In Pkt)" Value="1"></asp:ListItem>
                                                 <asp:ListItem Text="Qty(In Ltr)" Value="2"></asp:ListItem>
                                         </asp:DropDownList>
                                        </div>
                                   </div>
                                    <div class="col-md-4">

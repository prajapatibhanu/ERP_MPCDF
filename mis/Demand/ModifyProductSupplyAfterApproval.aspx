<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="ModifyProductSupplyAfterApproval.aspx.cs" Inherits="mis_Demand_ModifyProductSupplyAfterApproval" %>
                ...
                <div class="col-md-12">
                    <div class="box box-Manish">
                        <div class="box-header">
                            <h3 class="box-title">Modify Product Supply After Approval </h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <div class="row">
                            ...
                            <div class="col-md-12" id="pnlsearch" runat="server" visible="false">
                                <fieldset>
                                    <legend>Modify Product Supply After Approval List
                                    </legend>
                                                                        ...
                                                                        <asp:TemplateField HeaderText="Item Category / वस्तु वर्ग">
                                                                            <ItemTemplate>
                                                                                ...
                                                                                <asp:Label ID="lblItemCat_id" Visible="false" Text='<%# Eval("ItemCat_id")%>' runat="server" />
                                                                                 <asp:Label ID="lblDemand_Status" Visible="false" Text='<%# Eval("Demand_Status")%>' runat="server" />
    ...
    <script type="text/javascript">
        ...
        $('.datatable').DataTable({
            ...
            buttons: {
                buttons: [{
                    extend: 'print',
                    title: ('Modify Product Supply After Approval').bold().fontsize(5).toUpperCase(),

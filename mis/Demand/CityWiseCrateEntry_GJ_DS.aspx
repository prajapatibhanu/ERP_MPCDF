<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="CityWiseCrateEntry_GJ_DS.aspx.cs" Inherits="mis_Demand_CityWiseCrateEntry_GJ_DS" %>
                ...
                <div class="col-md-12">
                    <div class="box box-Manish">
                        <div class="box-header">
                            <h3 class="box-title">Crate Return</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <fieldset>
                                                ...
                                                <Columns>
                                                    <asp:TemplateField HeaderText="S.No">
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:Label ID="lblDRAId" Visible="false" Text='<%#Eval("DRAId") %>' runat="server"></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
        ...
        $('.datatable').DataTable({
            ...
            buttons: {
                buttons: [{
                    ...
                    title: ('Crate Return Details').bold().fontsize(3).toUpperCase(),
                    exportOptions: {
                        columns: [0, 1, 2, 3, 4, 5]
                    },
                    footer: false,

<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="Rpt_ProductSummaryDistributorwise.aspx.cs" Inherits="mis_Demand_Rpt_ProductSummaryDistributorwise" %>
                ...
                <div class="col-md-12">
                    <div class="box box-Manish">
                        <div class="box-header">
                            <h3 class="box-title">Distributor Supply Summary</h3>
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                <fieldset>
                                    <legend>Date,Location,Distributor
                                    </legend>
                                    <div class="col-md-2">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label>Location<span style="color: red;"> *</span></label>
                                              <span class="pull-right">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ValidationGroup="a" ControlToValidate="ddlLocation"
                                                    ErrorMessage="Select Location" ForeColor="Red" InitialValue="0" Text="<i class='fa fa-exclamation-circle' title='Select Location !'></i>"
                                                    Display="Dynamic" runat="server">
                                                </asp:RequiredFieldValidator>
                                            </span>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label>Distributor Name<span style="color: red;"> *</span></label>
                                             <span class="pull-right">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ValidationGroup="a" ControlToValidate="ddlDitributor"
                                                    ErrorMessage="Select Distributor" ForeColor="Red" InitialValue="0" Text="<i class='fa fa-exclamation-circle' title='Select Distributor !'></i>"
                                                    Display="Dynamic" runat="server">
                                                </asp:RequiredFieldValidator>
                                            </span>

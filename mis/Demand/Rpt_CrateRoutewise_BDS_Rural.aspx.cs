...
public partial class mis_Demand_Rpt_CrateRoutewise_BDS_Rural : System.Web.UI.Page
{
    ...
    private void GetCityWiseReport()
    {
        try
        {
            ...
            DataSet ds = objdb.ByProcedure("USP_Trn_MilkCrateReport_Rural"
                , new string[] { "flag", "Office_ID", "FromDate", "ToDate", "AreaId" }
                , new string[] { "2", objdb.Office_ID(), fromdate.ToString(), todate.ToString(),"2" }, "dataset");
            if (ds.Tables.Count > 0)
            {
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    sb.Append("</tr>");
                    sb.Append("<tr>");
                    sb.Append("<td colspan='8'style='text-align: center;border:1px solid black;'><b>Routewise Crate Report</b></td>");
                    sb.Append("</tr>");
                    sb.Append("</table>");
                    ...
                    sb.Append("<td style='border:1px solid black;padding: 5px ;'><b>Route</b></td>");
                    ...
                    for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                    {
                        ...
                        sb.Append("<td style='border:1px solid black;text-align: left;padding-right:5px ;'>" + ds.Tables[0].Rows[i]["CityName"] + "</td>");

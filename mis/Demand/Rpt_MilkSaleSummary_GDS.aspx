<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="Rpt_MilkSaleSummary_GDS.aspx.cs" Inherits="mis_Demand_Rpt_MilkSaleSummary_GDS" %>
                ...
                <div class="col-md-12">
                    <div class="box box-Manish">
                        <div class="box-header">
                            <h3 class="box-title">Milk Sale Summary</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">

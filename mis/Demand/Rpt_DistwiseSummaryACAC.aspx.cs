...
public partial class mis_Demand_Rpt_DistwiseSummaryACAC : System.Web.UI.Page
{
        ...
        foreach (ListItem item in ddlDistributor.Items)
        {
            if (item.Selected)
            {
                ...
                ds5 = objdb.ByProcedure("USP_Trn_SupplSummaryACAC",
                         new string[] { "Flag", "FromDate", "ToDate", "ItemCat_id", "RouteId", "Office_ID", "DifferenceInDays", "fdays", "tdays" },
                           new string[] { "1", fromnonth, tomonth, objdb.GetMilkCatId(), routeid, objdb.Office_ID(), differenceInDays.ToString(), fdays.ToString(), tdays.ToString() }, "dataset");
                if (ds5.Tables[0].Rows.Count > 0)
                {
                    ...
                    if (rr == 1)
                    {
                        ...
                        sb1.Append("</tr>");
                        sb1.Append("<tr>");
                        sb1.Append("<td style='border: 1px solid #000000;text-align:center' colspan='" + (ColCount1 + 5) + "'><b>DISTRIBUTOR SUMMARY</b></td>");
                        sb1.Append("</tr>");
                        sb1.Append("<tr>");
                        ...
                        sb1.Append("<td style=' border: 1px solid #000000 !important;'><b>Route</td>");
                        ...
                        for (int i = 0; i < Count1-3; i++)
                        {
                            ...
                            if (i != 4)
                            {
                                ...
                                if (i == 0)
                                {
                                    ...
                                    sb1.Append("<td style='border: 1px solid #000000 !important;' rowspan='4'>" + DRNAme[1] + "</td>");
                                }

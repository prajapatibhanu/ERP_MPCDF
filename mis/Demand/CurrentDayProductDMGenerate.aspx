<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="CurrentDayProductDMGenerate.aspx.cs" Inherits="mis_Demand_CurrentDayProductDMGenerate" %>
                ...
                <div class="col-md-12">
                    <div class="box box-Manish">
                        <div class="box-header">
                            <h3 class="box-title">Current Day DM Generate</h3>
                        ...
                        <div class="box-body">
                            ...
                            <fieldset>
                                    <legend>Current Day DM Generate
                                    </legend>
                            <div class="row">
                                 ...
                                 <div class="col-md-2" id="pnlorderno" runat="server" visible="false">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group" style="margin-top: 20px;">
                                            <asp:Button runat="server" CssClass="btn btn-primary" ValidationGroup="a" OnClick="btnSearch_Click" ID="btnSearch" Text="Search" />
                               ...
                               <div class="col-md-2">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label>PO Date</label>
                                             <span class="pull-right">
                                                <asp:RegularExpressionValidator ID="RegularExpressionValidator5" ValidationGroup="a" runat="server" Display="Dynamic" ControlToValidate="txtPODate"
                                                    ErrorMessage="Invalid Date" Text="<i class='fa fa-exclamation-circle' title='Invalid Date !'></i>" SetFocusOnError="true"
                                                    ValidationExpression="^(((0[1-9]|[12]\d|3[01])/(0[13578]|1[02])/((19|[2-9]\d)\d{2}))|((0[1-9]|[12]\d|30)/(0[13456789]|1[012])/((19|[2-9]\d)\d{2}))|((0[1-9]|1\d|2[0-8])/02/((19|[2-9]\d)\d{2}))|(29/02/((1[6-9]|[2-9]\d)(0[48]|[2468][048]|[13579][26])|((16|[2468][048]|[3579][26])00))))$"></asp:RegularExpressionValidator>
                                            </span>

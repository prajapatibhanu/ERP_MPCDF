...
public partial class mis_Demand_SuperStockistWiseCrate_Rpt_IUSDS : System.Web.UI.Page
{
        ...
        try
        {
            ...
            ds2 = objdb.ByProcedure("USP_Trn_MilkOrProductCrateReturnMgmt",
                     new string[] { "Flag", "FromDate", "ToDate", "Office_ID", "SuperStockistId" },
                       new string[] { "7", fromdat, todat, objdb.Office_ID(), ddlPartyName.SelectedValue }, "dataset");
    ...
    protected void btnExportAll_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Response.Clear();
            Response.AddHeader("content-disposition", "attachment; filename=" + txtFromDate.Text + "-" + txtToDate.Text + "-" + ddlPartyName.SelectedItem.Text + "-" +"SuperStockistWise_Crate_Report.xls");
            Response.Charset = "";

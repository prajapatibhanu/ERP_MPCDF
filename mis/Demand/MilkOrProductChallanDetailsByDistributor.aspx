<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="MilkOrProductChallanDetailsByDistributor.aspx.cs" Inherits="mis_Demand_MilkOrProductChallanDetailsByDistributor" %>
                                    ...
                                    <div class="col-md-2">
                                      ...
                                      <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <%--<asp:DropDownList ID="ddlItemCategory" OnInit="ddlItemCategory_Init" runat="server" CssClass="form-control select2" OnSelectedIndexChanged="ddlItemCategory_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>--%>
        ...
        $('.datatable').DataTable({
            ...
            buttons: {
                buttons: [{
                    ...
                    title: ('View Challan').bold().fontsize(5).toUpperCase(),
                    exportOptions: {
                        columns: [0, 1, 2, 3, 4, 5]
                    },
                    footer: false,
                    ...
                    extend: 'excel',
                    title: ('View Challan').bold().fontsize(5).toUpperCase(),
                    filename: 'Retailer Challan Details',

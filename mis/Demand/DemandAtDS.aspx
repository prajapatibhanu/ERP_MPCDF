<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="DemandAtDS.aspx.cs" Inherits="mis_Demand_DemandAtDS" %>
            ...
            <div class="col-md-6">
                <div class="box box-Manish">
                    <div class="box-header">
                        <h3 class="box-title">Demand By Operator - Daily Place/View Order <%--/ दैनिक आर्डर दें/देखें--%> </h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <fieldset>
                            ...
                            <%--<div class="row" id="panelDist" runat="server" visible="false">
                             ...
                             <div class="row" id="pnlUserType" runat="server" visible="false">
                                ...
                                <div class="form-group">
                                    ...
                                    <span class="pull-right">
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator6" ForeColor="Red" Display="Dynamic" ValidationGroup="d" runat="server" ControlToValidate="ddlRoute" InitialValue="0" ErrorMessage="Select Route." Text="<i class='fa fa-exclamation-circle' title='Select Route Sangh !'></i>"></asp:RequiredFieldValidator>
                                    </span>
                            ...
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddlRetailer" runat="server" CssClass="form-control select2" AutoPostBack="true" OnSelectedIndexChanged="ddlRetailer_SelectedIndexChanged">
                                 ...
                                 <div class="col-md-4" >
                                     ...
                                     <div class="col-md-4" >
                                     <div class="form-group">
                                         <asp:Label runat="server" Visible="false" ID="lbldistributorID"></asp:Label>
                                      <asp:LinkButton ID="lnkPreviousOrderAll" Visible="false" ValidationGroup="a" OnClick="lnkPreviousOrderAll_Click" CssClass="btn btn-success"  runat="server" AccessKey=""><i class="fa fa-backward"></i> Previous Demand All</asp:LinkButton>
                                     </div>
                                      </div>
...
<%--                                <div class="col-md-6" >
            ...
            <div class="col-md-6" id="pnlsearchdata" runat="server" visible="false">
                <div class="box box-Manish">
                    <div class="box-header">
                        <h3 class="box-title">Demand By Operator - View Order Status</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <div class="row">
                                        ...
                                        <asp:GridView ID="GridView3" runat="server" class="datatable table table-striped table-bordered" AllowPaging="false"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="View Details" ItemStyle-HorizontalAlign="Center">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="lnkViewDetails" CssClass="btn btn-xs btn-outline" Visible='<%# Eval("DStatus").ToString() == "Yes" ? true : false %>' CommandName="ItemOrdered" CommandArgument='<%#Eval("tmp_MilkOrProductDemandId") %>' runat="server"><i class="fa fa-eye"></i> View</asp:LinkButton>
                                                    </ItemTemplate>
                                                </asp:TemplateField>

...
public partial class mis_Demand_Rpt_ProductItemWiseSale_IUB : System.Web.UI.Page
{
        ...
        try
        {
            ...
            ds5 = objdb.ByProcedure("USP_Trn_ProductDM",
                     new string[] { "flag", "FromDate", "ToDate", "DelivaryShift_id", "ItemCat_id", "Item_id_Str", "SuperStockistId_Str", "Office_ID" },
                       new string[] { "19", fromdat, todat, ddlShift.SelectedValue, objdb.GetProductCatId(), itemid.ToString(), SSid.ToString(), objdb.Office_ID() }, "dataset");

<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="Rpt_DemandReportAtDisttributor.aspx.cs" Inherits="mis_Demand_Rpt_DemandReportAtDisttributor" %>
            ...
            <div class="col-md-12">
                <div class="box box-Manish">
                    <div class="box-header">
                        <h3 class="box-title">Demand Report</h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="box-body">
                        <fieldset>
                                    ...
                                    <div class="col-md-6" style="margin-top: 22px;">
                                        <div class="form-group">
                                           ...
                                           <%-- <asp:Button ID="btnClear" runat="server" OnClick="btnClear_Click" Text="Clear" CssClass="btn btn-default" />--%>
                                              ...
                                              <asp:Button ID="btnConsRoutePrint" Visible="false" runat="server" OnClick="btnConsRoutePrint_Click"  CssClass="btn btn-warning" Text="Consolidated Print" />
                                             <asp:Button ID="btnCExoprt" Visible="false" runat="server" OnClick="btnCExoprt_Click"  CssClass="btn btn-success" Text="Consolidated Export" />
                                        </div>
                                    </div>  

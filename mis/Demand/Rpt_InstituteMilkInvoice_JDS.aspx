<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="Rpt_InstituteMilkInvoice_JDS.aspx.cs" Inherits="mis_Demand_Rpt_InstituteMilkInvoice_JDS" %>
                ...
                <div class="col-md-12">
                    <div class="box box-Manish">
                        <div class="box-header">
                            <h3 class="box-title">Institute Invoice Report</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            ...
                            <div class="row">
                                <fieldset>
                                    <legend>FromDate,ToDate,Institute
                                    </legend>
                                    <div class="col-md-2">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList ID="ddlInstitution"  runat="server" CssClass="form-control select2" AutoPostBack="true" OnSelectedIndexChanged="ddlInstitution_SelectedIndexChanged">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList ID="ddlItems" runat="server" CssClass="form-control select2">
                                                 <asp:ListItem Text="Select" Value="0"></asp:ListItem>
                                            </asp:DropDownList>
                                        </div>
                                    </div>

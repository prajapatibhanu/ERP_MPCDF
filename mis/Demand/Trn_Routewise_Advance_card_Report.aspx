<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="Trn_Routewise_Advance_card_Report.aspx.cs" Inherits="mis_Demand_Trn_Routewise_Advance_card_Report" %>
                ...
                <div class="col-md-12">
                    <div class="box box-Manish">
                        <div class="box-header">
                            <h3 class="box-title">Online Advance Card Retailer Wise Report</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <asp:DropDownList ID="ddlRout" OnSelectedIndexChanged="ddlRout_SelectedIndexChanged" AutoPostBack="true" runat="server" CssClass="form-control select2">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span class="pull-right">
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ValidationGroup="a"
                                                        ErrorMessage="Select Retailer" InitialValue="0" ForeColor="Red" Text="<i class='fa fa-exclamation-circle' title='Select Retailer !'></i>"

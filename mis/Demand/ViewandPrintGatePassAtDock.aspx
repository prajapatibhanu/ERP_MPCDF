<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="ViewandPrintGatePassAtDock.aspx.cs" Inherits="mis_Demand_ViewandPrintGatePassAtDock" %>
        ...
        <section class="content noprint">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-Manish">
                        <div class="box-header">
                            <h3 class="box-title">View Gate Pass</h3>
                ...
                <div class="col-md-12" id="pnldata" runat="server" visible="false">
                    <div class="box box-Manish">
                        <div class="box-header">
                            <h3 class="box-title">View Gate Pass Details</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <div class="row">
                                    ...
                                    <div class="table-responsive">
                                        <asp:GridView ID="GridView1" runat="server" OnRowCommand="GridView1_RowCommand" class="datatable table table-striped table-bordered" AllowPaging="false"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Print / प्रिंट करें" HeaderStyle-Width="5px">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="lnkprint" CommandName="RecordPrint" CommandArgument='<%#Eval("VehicleDispId") %>' runat="server" ToolTip="Print"><i class="fa fa-print"></i></asp:LinkButton>
                                                        <asp:LinkButton ID="lnkView" Text="View" CommandName="RecordView"  CommandArgument='<%#Eval("VehicleDispId") %>' runat="server" ToolTip="Print"></asp:LinkButton>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        </asp:GridView>
                                        <asp:GridView ID="GridView2" runat="server" OnRowCommand="GridView2_RowCommand" class="datatable table table-striped table-bordered" AllowPaging="false"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Print / प्रिंट करें" HeaderStyle-Width="5px">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="lnkprint" CommandName="RecordPrint" CommandArgument='<%#Eval("ProductGatePassId") %>' runat="server" ToolTip="Print"><i class="fa fa-print"></i></asp:LinkButton>
                                                         <asp:LinkButton ID="lnkView" Text="View" CommandName="RecordView" CommandArgument='<%#Eval("ProductGatePassId") %>' runat="server" ToolTip="Print"></asp:LinkButton>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        </asp:GridView>

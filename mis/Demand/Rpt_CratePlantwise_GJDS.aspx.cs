...
public partial class mis_Demand_Rpt_CratePlantwise_GJDS : System.Web.UI.Page
{
        ...
        try
        {
            ...
            ds5 = objdb.ByProcedure("USP_Trn_MilkOrProductCrateReturnMgmt",
                     new string[] { "Flag", "FromDate", "ToDate", "Office_ID" },
                       new string[] { "12", fromdat, todat, objdb.Office_ID() }, "dataset");
            ...
            if (ds5.Tables[0].Rows.Count > 0)
            {
                ...
                sb.Append("</tr>");
                sb.Append("<tr>");
                sb.Append("<td colspan='5' style='text-align: left;border:1px solid black;'><b>Date  :-" + txtFromDate.Text + " To " + txtToDate.Text + "</b></td>");
                sb.Append("</tr>");
                sb.Append("<tr>");
                sb.Append("<td colspan='5'style='text-align: center;border:1px solid black;'><b>Plant Crate Report</b></td>");
                sb.Append("</tr>");
                sb.Append("</table>");
                ...
                for (int i = 0; i < Count1; i++)
                {
                    ...
                    sb.Append("<td style='border:1px solid black;text-align: center;'>" + ds5.Tables[0].Rows[i]["PWate"] + "</td>");
                    ...
                    sb.Append("<td style='border:1px solid black;text-align: center;'>" + ds5.Tables[0].Rows[i]["CBalance"] + "</td>");
                    sb.Append("</tr>");
                }
                ...
                sb.Append("<td style='border:1px solid black;border-bottom:1px solid black;text-align: center;'><b>" + Convert.ToInt32(ds5.Tables[0].AsEnumerable().Sum(r => r.Field<int?>("CBalance") ?? 0)) + "</b></td>");
                sb.Append("</tr>");
                sb.Append("</table>");
    ...
    protected void btnExportAll_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Response.Clear();
            Response.AddHeader("content-disposition", "attachment; filename=" + txtFromDate.Text + "-" + txtToDate.Text + "-" + "PlantCrateReport.xls");
            Response.Charset = "";

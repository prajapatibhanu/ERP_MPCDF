<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="DistributorProductPaymentReport.aspx.cs" Inherits="mis_Demand_DistributorProductPaymentReport" %>
                ...
                <div class="col-md-12">
                    <div class="box box-Manish">
                        <div class="box-header">
                            <h3 class="box-title">Distributor Product Payment Report</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            ...
                            <div class="row">
                                <fieldset>
                                    <legend>Distributor Product Payment Report
                                    </legend>
                                    <div class="col-md-2">

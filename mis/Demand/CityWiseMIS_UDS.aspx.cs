...
public partial class mis_Demand_CityWiseMIS_UDS : System.Web.UI.Page
{
    ...
    private void CityWiseMilkMIS_Report(string fdate, string tdate, string pdate, string subsid, string mhrid)
    {
        try
        {
            ...
            Print.InnerHtml = "";
            int rr = 0;
            ds5 = objdb.ByProcedure("USP_Trn_MilkOrProduct_MISRpt_UDS",
            ...
            if (ds5.Tables[0].Rows.Count > 0)
            {
                ...
                int Count2 = ds5.Tables[1].Rows.Count;
                int ColCount1 = ds5.Tables[0].Columns.Count;
                int ColCount2 = ds5.Tables[1].Columns.Count;
                ...
                for (int j = 0; j < ColCount1; j++)
                {
                    ...
                    if (ColName == "City" || ColName == "subcity")
                    {
                        sb1.Append("<td colspan='2' style='border: 1px solid #000000;text-align:center;'");
                    }
                ...
                for (int j = 0; j < Count2; j++)
                {
                    ...
                    for (int i = 0; i < Count1; i++)
                    {
                        ...
                        if (ds5.Tables[0].Rows[i]["City"].ToString() == ds5.Tables[1].Rows[j]["City"].ToString())
                        {
                            sb1.Append("<tr>");
                        ...
                        //        if (ColName == "City")
                        //        {
                        //            sb1.Append("<td colspan='2'  style='text-align:center;border: 1px solid #000000 !important;'>" + ((ds5.Tables[1].Rows[j][ColName]).ToString()) + "</td>");
                        //        }
                        //        else
                        //        {
                        //            sb1.Append("<td style='text-align: center;border: 1px solid #000000 !important;'>" + ((ds5.Tables[1].Rows[j][ColName]).ToString() == "" ? "00.00" : (ds5.Tables[1].Rows[j][ColName]).ToString()) + "</td>");
                        //        }
                    ...
                    if (ct > Count1)
                    {
                        ...
                        for (int K = 0; K < ColCount2; K++)
                        {
                            ...
                            if (ColName == "City")
                            {
                                sb1.Append("<td colspan='2'  style='text-align:center;border: 1px solid #000000 !important;'><b>" + ((ds5.Tables[1].Rows[j][ColName]).ToString()) + "</b></td>");
                            }
                            else
                            {
                                sb1.Append("<td style='text-align: center;border: 1px solid #000000 !important;'>" + ((ds5.Tables[1].Rows[j][ColName]).ToString() == "" ? "00.00" : (ds5.Tables[1].Rows[j][ColName]).ToString()) + "</td>");
                ...
                foreach (DataColumn column in dt1.Columns)
                {
                    ...
                    {
                        sb1.Append("<td colspan='2' style='border: 1px solid #000000 !important;'><b>Total</b></td>");

                    }
                    else if (column.ToString() == "subcity")
                    {
                ...
                foreach (DataColumn column in dt2.Columns)
                {
                    ...
                    if (column.ToString() == "City" || column.ToString() == "subcity")
                    {
                        sb1.Append("<td colspan='2' style='border: 1px solid #000000 !important;'");
    ...
    private void CityWiseProductMIS_Report(string fdate, string tdate, string subsid, string mhrid)
    {
        try
        {
            ...
            ds2 = objdb.ByProcedure("USP_Trn_MilkOrProduct_MISRpt_UDS",
    ...
    private void SearchMilkorProductData()
    {
        lblMsg.Text = string.Empty;

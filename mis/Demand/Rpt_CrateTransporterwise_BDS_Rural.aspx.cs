...
public partial class mis_Demand_Rpt_CrateTransporterwise_BDS_Rural : System.Web.UI.Page
{
    ...
    private void GetTransporterWiseReport()
    {
        try
        {
            ...
            ds5 = objdb.ByProcedure("USP_Trn_MilkCrateReport_Rural",
                     new string[] { "Flag", "FromDate", "ToDate", "Office_ID", "AreaId", "ItemCat_id", "DeliveryShift_id", "RouteHeadId" },
                       new string[] { "1", fromdat, todat, objdb.Office_ID(),"2",objdb.GetMilkCatId(),objdb.GetShiftMorId(),ddlTransporter.SelectedValue }, "dataset");

<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="DistributorDMReport.aspx.cs" Inherits="mis_Demand_DistributorDMReport" %>
                ...
                <div class="col-md-12">
                    <div class="box box-Manish">
                        <div class="box-header">
                            <h3 class="box-title">Regular Demand Report </h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <div class="row">
         ...
         <div class="row">
               <div class="col-md-12" id="pnlData" runat="server" visible="false">
                      ...
                      <div class="row">
                                ...
                                <asp:GridView ID="GridView1" runat="server" OnRowDataBound="GridView1_RowDataBound" ShowFooter="true" class="datatable table table-striped table-bordered" AllowPaging="false"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Distributor Name">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblDistributor" Text='<%#Eval("DName") %>' runat="server"></asp:Label>
                                                            </ItemTemplate>
                                                             <FooterTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="TcsTax Amt">
                                                         ...
                                                         <asp:TemplateField HeaderText="Total Pkt">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblTotalPkt" Text='<%#Eval("Total Packet") %>' runat="server"></asp:Label>
                                                            </ItemTemplate>
                                                             <FooterTemplate>
                          ...
                          <div class="col-md-12" id="pnltcstaxamt" runat="server" visible="false">
                                            <label>Total TcsTax Amt : </label>
                                            <asp:Label ID="lblTcsTaxAmt" Font-Bold="true" runat="server"></asp:Label>

                                        </div>
                          <div class="col-md-12" id="pnlfinalamt" runat="server" visible="false">
                                            <label>Toal Final Amt : </label>
                                            <asp:Label ID="lblFinalAmt" Font-Bold="true" runat="server"></asp:Label>

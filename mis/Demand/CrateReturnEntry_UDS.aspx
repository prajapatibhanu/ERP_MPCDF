<%@ Page Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="CrateReturnEntry_UDS.aspx.cs" Inherits="mis_Demand_CrateReturnEntry_UDS" %>
                                        ...
                                        <div class="table-responsive">
                                            ...
                                            <asp:GridView ID="GridView2" Visible="false" ShowFooter="true" OnRowDataBound="GridView2_RowDataBound" OnRowCommand="GridView2_RowCommand" runat="server" class="datatable table table-striped table-bordered" AllowPaging="false"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:TemplateField HeaderText="Date" HeaderStyle-Width="5px">
                                                            <ItemTemplate>
                                                                <asp:Label ID="Label2" Text='<%#Eval("IRDate") %>' runat="server"></asp:Label>
                                                                 <asp:Label ID="Label3" Visible="false" Text='<%#Eval("ItemCat_id") %>' runat="server"></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                          <asp:TemplateField HeaderText="Shift" HeaderStyle-Width="5px">
                                                            <ItemTemplate>
                                                                <asp:Label ID="Label4" Text='<%#Eval("ShiftName") %>' runat="server"></asp:Label>
                                                                <asp:Label ID="Label5" Visible="false" Text='<%#Eval("ShiftId") %>' runat="server"></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Location" HeaderStyle-Width="5px">
                                                            <ItemTemplate>
                                                                <asp:Label ID="Label6" Text='<%#Eval("AreaName") %>' runat="server"></asp:Label>
                                                                <asp:Label ID="Label7" Visible="false" Text='<%#Eval("AreaID") %>' runat="server"></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Route" HeaderStyle-Width="5px">
                                                            <ItemTemplate>
                                                                <asp:Label ID="Label8" Text='<%#Eval("RName") %>' runat="server"></asp:Label>
                                                                <asp:Label ID="Label9" Visible="false" Text='<%#Eval("RouteId") %>' runat="server"></asp:Label>
                                                            </ItemTemplate>
                                                               <FooterTemplate>
                                                            <b>Total</b>
                                                        </FooterTemplate> 
                                                        ...
                                                        <asp:TemplateField HeaderText="Return Crate" HeaderStyle-Width="5px">
                                                            <ItemTemplate>
                                                                <asp:Label ID="Label10" Text='<%#Eval("ReturnCrate") %>' runat="server"></asp:Label>
                                                            </ItemTemplate>
                                                             <FooterTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="Challan No." HeaderStyle-Width="5px">
                                                            <ItemTemplate>
                                                                <asp:Label ID="Label12" Text='<%#Eval("ChallanNo") %>' runat="server"></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                         <asp:TemplateField HeaderText="Remark" HeaderStyle-Width="5px">
                                                            <ItemTemplate>
                                                                <asp:Label ID="Label13" Text='<%#Eval("CrateRemark") %>' runat="server"></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="Actions" HeaderStyle-Width="5px">
                                                            <ItemTemplate>

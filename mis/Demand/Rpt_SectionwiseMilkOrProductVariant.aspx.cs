...
public partial class mis_Demand_Rpt_SectionwiseMilkOrProductVariant : System.Web.UI.Page
{
    ...
    private void MilkSectionVariantwiseRpt(string itemid)
    {
        try
        {
            ...
            ds5 = objdb.ByProcedure("USP_Trn_MilkOrProductSectionwise_MIS",
        ...
        try
        {
            ...
            if (ds5.Tables[0].Rows.Count != 0 && ds5 != null)
            {
                ...
                for (int j = 0; j < ColCount; j++)
                {
                    ...
                    if (ds5.Tables[0].Columns[j].ToString() != "DistributorId" && ds5.Tables[0].Columns[j].ToString() != "DName" && ds5.Tables[0].Columns[j].ToString() != "DCode" && ds5.Tables[0].Columns[j].ToString() != "DMChallanNo" && ds5.Tables[0].Columns[j].ToString() != "VehicleNo" && ds5.Tables[0].Columns[j].ToString() != "DMDate")
                    {
                        string ColName = ds5.Tables[0].Columns[j].ToString();
                        sb1.Append("<td style=' border: 1px solid #000000 !important;'><b>" + ColName + "</b></td>");
                ...
                for (int i = 0; i < Count; i++)
                {
					...
					sb1.Append("<td style=' border: 1px solid #000000 !important;'>" + ds5.Tables[0].Rows[i]["VehicleNo"] + "</td>");
                    sb1.Append("<td style=' border: 1px solid #000000 !important;'>" + ds5.Tables[0].Rows[i]["DMDate"] + "</td>");
                    for (int K = 0; K < ColCount; K++)
                    {
                        if (ds5.Tables[0].Columns[K].ToString() != "DistributorId" && ds5.Tables[0].Columns[K].ToString() != "DName" && ds5.Tables[0].Columns[K].ToString() != "DCode" && ds5.Tables[0].Columns[K].ToString() != "DMChallanNo" && ds5.Tables[0].Columns[K].ToString() != "VehicleNo" && ds5.Tables[0].Columns[K].ToString() != "DMDate")
                        {
                            string ColName = ds5.Tables[0].Columns[K].ToString();
                            sb1.Append("<td style=' border: 1px solid #000000 !important;'>" + (ds5.Tables[0].Rows[i][ColName].ToString() == "" ? "0" : ds5.Tables[0].Rows[i][ColName].ToString()) + "</td>");
                ...
                sb1.Append("<tr>");
                sb1.Append("<td style=' border: 1px solid #000000 !important;text-align:center; 'colspan='6'><b>Total</b></td>");
                DataTable dt = new DataTable();
                dt = ds5.Tables[0];
                int sum11 = 0;
                decimal dsum11 = 0;
                foreach (DataColumn column in dt.Columns)
                {
                    if (column.ToString() != "DistributorId" && column.ToString() != "DName" && column.ToString() != "DCode" && column.ToString() != "DMChallanNo" && column.ToString() != "VehicleNo" && column.ToString() != "DMDate")
                    {

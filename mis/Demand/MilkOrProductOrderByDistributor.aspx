<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" EnableEventValidation="false" AutoEventWireup="true" CodeFile="MilkOrProductOrderByDistributor.aspx.cs" Inherits="mis_Masters_MilkOrProductOrderByDistributor" %>
                            ...
                            <fieldset>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                      ...
                                      <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Vehicle No<span style="color: red;" id="pnlvehicle" visible="false" runat="server"> *</span></label>
                                           <span class="pull-right">
                                                 <asp:RequiredFieldValidator ID="RfvVehicle" ValidationGroup="a"
                                                ...
                                                <asp:RequiredFieldValidator ID="RfvVehicle1" ValidationGroup="b"
                                                    InitialValue="0" ErrorMessage="Select Vehicle" Text="<i class='fa fa-exclamation-circle' title='Select Vehicle !'></i>"
                                                    ControlToValidate="ddlVehicleNo" ForeColor="Red" Display="None" runat="server">
                                                </asp:RequiredFieldValidator>
                                                 <asp:RequiredFieldValidator ID="RfvVehicle2" ValidationGroup="d"
                                                    InitialValue="0" ErrorMessage="Select Vehicle" Text="<i class='fa fa-exclamation-circle' title='Select Vehicle !'></i>"
                                                    ControlToValidate="ddlVehicleNo" ForeColor="Red" Display="None" runat="server">
                                                </asp:RequiredFieldValidator>
                                               </span>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <asp:LinkButton ID="lnkSearch" runat="server" ValidationGroup="a" OnClick="lnkSearch_Click" CssClass="btn btn-secondary" ClientIDMode="Static" AccessKey="V"><i class="fa fa-eye"></i> View Demand</asp:LinkButton>

                                            <asp:LinkButton ID="lnkAddDemand" ValidationGroup="a" runat="server" OnClick="lnkAddDemand_Click" CssClass="btn btn-primary" ClientIDMode="Static" AccessKey="A"><i class="fa fa-plus"></i> Add Demand</asp:LinkButton>
                                           ...
                                           <%--  <asp:LinkButton ID="LinkButton1" ValidationGroup="d" OnClick="LinkButton1_Click" CssClass="btn btn-success"  runat="server" AccessKey=""><i class="fa fa-backward"></i> Previous Demand New</asp:LinkButton>--%>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <asp:TemplateField HeaderText="Order Id" ItemStyle-HorizontalAlign="Center">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="lnkViewDetails" CssClass="btn btn-xs btn-outline" Visible='<%# Eval("DStatus").ToString() == "Yes" ? true : false %>' CommandName="ItemOrdered" CommandArgument='<%#Eval("tmp_MilkOrProductDemandId") %>' runat="server" Text='<%# Eval("tmp_OrderId")%>'></asp:LinkButton>
                                                         &nbsp;&nbsp; <asp:LinkButton ID="lnkAddItem" Visible='<%# Eval("Demand_Status").ToString()=="1" ? true: false %>' CssClass="text-blue" CommandName="AddOrdered" CommandArgument='<%#Eval("tmp_MilkOrProductDemandId") %>' runat="server"><i class="fa fa- fa-cart-plus fa-2x"></i></asp:LinkButton>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                            ...
                            <div class="row">
                                 ...
                                 <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <span class="pull-right">
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator11" ValidationGroup="ModalSave"
                                             ...
                                             <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" Display="Dynamic" ValidationGroup="ModalSave"

<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="DistributorWiseCrate_Rpt_IUS.aspx.cs" Inherits="mis_Demand_DistributorWiseCrate_Rpt_IUS" %>
                                    ...
                                    <div class="col-md-2">
                                     ...
                                     <div class="col-md-2">
                                                <div class="form-group">
                                                   ...
                                                   <span class="pull-right">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" ValidationGroup="a" ControlToValidate="ddlSS"
                                                    ErrorMessage="Select SuperStockist" ForeColor="Red" InitialValue="0" Text="<i class='fa fa-exclamation-circle' title='Select SuperStockist !'></i>"
                                                    Display="Dynamic" runat="server">
                                                </asp:RequiredFieldValidator>
                                            </span>
                                                    <asp:DropDownList ID="ddlSS" OnSelectedIndexChanged="ddlSS_SelectedIndexChanged" AutoPostBack="true" runat="server" CssClass="form-control select2">
                                                    </asp:DropDownList>
                                                </div>

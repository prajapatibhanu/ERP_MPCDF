...
public partial class mis_Demand_DistributorDMReport : System.Web.UI.Page
{
        ...
        try
        {
            ...
            ds2 = objdb.ByProcedure("USP_Trn_ProductDistRpt",
                     new string[] { "flag", "Delivary_Date", "DelivaryShift_id", "ItemCat_id", "DistributorId", "Office_ID" },
                       new string[] { "1", deliverydate, objdb.GetShiftMorId(), objdb.GetProductCatId(),objdb.createdBy(), objdb.Office_ID() }, "dataset");
            ...
            if (ds2.Tables[0].Rows.Count != 0)
            {
                ...
                foreach (DataRow drow in dt.Rows)
                {
                    ...
                    {
                        if (column.ToString() != "OrderId" && column.ToString() != "DName" && column.ToString() != "Total Packet" && column.ToString() != "Cost of Product" && column.ToString() != "TcsTax Amt" && column.ToString() != "Final Amt")
                        {
                ...
                sb.Append("<td style='border: 1px solid #000000 !important;'><b>Total Packet</b></td>");
                ...
                for (int j = 0; j < ColCount; j++)
                {
                    ...
                    if (ds2.Tables[0].Columns[j].ToString() != "OrderId" && ds2.Tables[0].Columns[j].ToString() != "DName" && ds2.Tables[0].Columns[j].ToString() != "Total Packet" && ds2.Tables[0].Columns[j].ToString() != "Cost of Product" && ds2.Tables[0].Columns[j].ToString() != "TcsTax Amt" && ds2.Tables[0].Columns[j].ToString() != "Final Amt")
                    {
                ...
                for (int i = 0; i < Count; i++)
                {
                    ...
                    {
                        if (ds2.Tables[0].Columns[K].ToString() != "OrderId" && ds2.Tables[0].Columns[K].ToString() != "DName" && ds2.Tables[0].Columns[K].ToString() != "Total Packet" && ds2.Tables[0].Columns[K].ToString() != "Cost of Product" && ds2.Tables[0].Columns[K].ToString() != "TcsTax Amt" && ds2.Tables[0].Columns[K].ToString() != "Final Amt")
                        {
                ...
                sb.Append("</tr>");
                sb.Append("</table>");
                //sb.Append("<b><span style='padding-top:20px;'>Total Packet:  " + lblTotalSupplyValue.Text + "</span><br></b>");
    ...
    protected void btnExportAll_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Response.Clear();
            Response.AddHeader("content-disposition", "attachment; filename=" + "DistributorRegularDemand-" + objdb.Emp_Name() + DateTime.Now + ".xls");
            Response.Charset = "";

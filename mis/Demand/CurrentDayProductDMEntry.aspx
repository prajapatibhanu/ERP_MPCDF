<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="CurrentDayProductDMEntry.aspx.cs" Inherits="mis_Demand_CurrentDayProductDMEntry" %>
        ...
        <section class="content">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="box box-Manish">
                        <div class="box-header">
                            <h3 class="box-title">Current Day Demand</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <fieldset>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList ID="ddlDMType" runat="server" TabIndex="4" CssClass="form-control select2">
                                                 ...
                                                 <asp:ListItem Text="Current Ghee Demand" Value="2"></asp:ListItem>
                                            </asp:DropDownList>
                                            </div>
                                    </div>
                                     <div class="col-md-4">
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Quantity / मात्रा">
                                                        <ItemTemplate>
                                                            ...
                                                            <asp:TextBox ID="gv_txtQty" onfocusout="FetchData(this)" onkeypress="return validateNum(event);" runat="server" onfocus="ppclass" autocomplete="off" CssClass="form-control" MaxLength="8" placeholder="Enter Qty"></asp:TextBox>
                                                        </ItemTemplate>
                                                            <FooterTemplate>
                ...
                <div class="col-md-6" id="pnlsearchdata" runat="server" visible="false">
                    <div class="box box-Manish">
                        <div class="box-header">
                            <h3 class="box-title">Current Day Demand - View Order Status</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <div class="row">
                                        ...
                                        <asp:GridView ID="GridView3" runat="server" class="datatable table table-striped table-bordered" AllowPaging="false"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="View Details" ItemStyle-HorizontalAlign="Center">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="lnkViewDetails" Text='<%# Eval("tmp_OrderId")%>' CssClass="btn btn-xs btn-outline" Visible='<%# Eval("DStatus").ToString() == "Yes" ? true : false %>' CommandName="ItemOrdered" CommandArgument='<%#Eval("tmp_MilkOrProductDemandId") %>' runat="server"></asp:LinkButton>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                        ...
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    ...
                                    <h4 class="modal-title">Item Details for <span id="modalBoothName" style="color: red" runat="server"></span>&nbsp;&nbsp;Date :<span id="modaldate" style="color: red" runat="server">
                                    </span>&nbsp;&nbsp;Item Category : <span id="modelCategory" style="color: red" runat="server"></span>

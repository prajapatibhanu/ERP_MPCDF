...
public partial class mis_Demand_SS_CrateReport : System.Web.UI.Page
{
    ...
    private void GetSSCrateReport()
    {
        try
        {
            ...
            ds2 = objdb.ByProcedure("USP_Trn_MilkOrProductCrateReturnMgmt",
                     new string[] { "Flag", "FromDate", "ToDate", "Office_ID", "SuperStockistId" },
                       new string[] { "7", fromdat, todat, objdb.Office_ID(), objdb.createdBy() }, "dataset");
            ...
            if (ds2.Tables[0].Rows.Count > 0)
            {
                ...
                sb.Append("</tr>");
                sb.Append("<tr>");
                sb.Append("<td colspan='5' style='text-align: left;border:1px solid black;'>Date <b>  :" + txtFromDate.Text + " To " + txtToDate.Text + "</b></td>");
                sb.Append("</tr>");
                sb.Append("<tr>");
                sb.Append("<td colspan='5'style='text-align: left;border:1px solid black;'>Party Name : <b>" + objdb.Emp_Name() + "</b></td>");
                sb.Append("</tr>");
                sb.Append("</table>");
                ...
                sb.Append("<tr>");
                sb.Append("<td colspan='2' style='border-top:1px solid black;border-bottom:1px solid black;text-align:right;'><b>Total</b></td>");
    ...
    protected void btnExportAll_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Response.Clear();
            Response.AddHeader("content-disposition", "attachment; filename=" + txtFromDate.Text + "-" + txtToDate.Text + "-" + objdb.Emp_Name() + "-" + "SuperStockistWise_Crate_Report.xls");
            Response.Charset = "";

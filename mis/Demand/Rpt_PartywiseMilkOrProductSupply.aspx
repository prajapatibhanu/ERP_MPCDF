<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="Rpt_PartywiseMilkOrProductSupply.aspx.cs" Inherits="mis_Demand_Rpt_PartywiseMilkOrProductSupply" %>
                ...
                <div class="col-md-12">
                    <div class="box box-Manish">
                        <div class="box-header">
                            <h3 class="box-title">Partywise Supply Report</h3>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label>Party Name<span style="color: red;"> *</span></label>
                                             <span class="pull-right">
                                                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" ValidationGroup="a" ControlToValidate="ddlSuperStockist"
                                                    ErrorMessage="Select Party" ForeColor="Red" InitialValue="0" Text="<i class='fa fa-exclamation-circle' title='Select Party !'></i>"
                                                    Display="Dynamic" runat="server">
                                                </asp:RequiredFieldValidator>
                                            </span>

...
public partial class mis_Demand_Rpt_CitizenAdvancedCard_Distributor : System.Web.UI.Page
{
        ...
        try
        {
            ...
            ds5 = objdb.ByProcedure("USP_Mst_CitizenAdvancedCard_Rpt",
                     new string[] { "flag", "DistributorId", "Shift_id", "ItemCat_id", "FromDate", "ToDate", "Office_ID" },
                       new string[] { "2", objdb.createdBy(), ddlShift.SelectedValue, "3", fromnonth, tomonth, objdb.Office_ID() }, "dataset");

<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="Rpt_CitywiseandItemwiseProductSale.aspx.cs" Inherits="mis_Demand_Rpt_CitywiseandItemwiseProductSale" %>
                ...
                <div class="col-md-12">
                    <div class="box box-Manish">
                        <div class="box-header">
                            <h3 class="box-title">CityWise Product Sale Report</h3>
                                ...
                                <fieldset>
                                    ...
                                    <div class="col-md-2">
                                        ...
                                        <asp:DropDownList ID="ddlType" runat="server" CssClass="form-control select2">
                                            <asp:ListItem Text="In Pkt" Value="1"></asp:ListItem>
                                             <asp:ListItem Text="In Ltr/KG" Value="2"></asp:ListItem>
                                        </asp:DropDownList>
                                              </div>
                                     </div>
                                        </div>

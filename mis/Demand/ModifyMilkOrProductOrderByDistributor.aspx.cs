...
public partial class mis_Demand_ModifyMilkOrProductOrderByDistributor : System.Web.UI.Page
{
        ...
        try
        {
            ...
            ds = objdb.ByProcedure("USP_Trn_MilkOrProductDemand",
                     ...
                     new string[] { "flag", "Demand_Date", "Shift_id", "ItemCat_id", "BoothId", "CreatedBy", "UserTypeId" },
                       new string[] { "6", orderdate.ToString(), ddlShift.SelectedValue, ddlItemCategory.SelectedValue,ddlRetailer.SelectedValue, objdb.createdBy(),objdb.UserTypeID() }, "dataset");
        ...
        try
        {
            if (e.CommandName == "RecordEdit")
            {
                ...
                if (ctrl != null)
                {
                    ...
                    RequiredFieldValidator rfv1 = row.FindControl("rfv2") as RequiredFieldValidator;
                    RegularExpressionValidator rev1 = row.FindControl("rev1") as RegularExpressionValidator;
                    RegularExpressionValidator rev2 = row.FindControl("rev2") as RegularExpressionValidator;

<%@ Page Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="Rpt_CrateTransporterwise_UDS.aspx.cs" Inherits="mis_Demand_Rpt_CrateTransporterwise_UDS" %>
                ...
                <div class="col-md-12">
                    <div class="box box-Manish">
                        <div class="box-header">
                            <h3 class="box-title">Transporter wise Crate Report</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                                ...
                                <fieldset>
                                    ...
                                    <div class="col-md-1" >
                                        <div class="form-group" style="margin-top: 20px;display:none">
                                            <asp:Button runat="server" BackColor="#2e9eff" CssClass="btn btn-block btn-primary" OnClick="btnArchive_Click"  ID="btnArchive" Text="Archive" />
                                        </div>
                                    </div>
                                </fieldset>
                            </div>

<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="Rpt_MilkOrProductOrderBySuperStockist.aspx.cs" Inherits="mis_Demand_Rpt_MilkOrProductOrderBySuperStockist" %>
                ...
                <div class="col-md-12">
                    <div class="box box-Manish">
                        <div class="box-header">
                            <h3 class="box-title">View Demand</h3>
                        </div>
        ...
        $('.datatable').DataTable({
            ...
            buttons: {
                buttons: [{
                    ...
                    title: ('View Demand Report').bold().fontsize(5).toUpperCase(),
                    exportOptions: {
                    ...
                    extend: 'excel',
                    title: ('View Demand Report').bold().fontsize(5).toUpperCase(),
                    filename: 'ParlourwiseOrderedReport',

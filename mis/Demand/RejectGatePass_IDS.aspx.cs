...
public partial class mis_Demand_RejectGatePass_IDS : System.Web.UI.Page
{
    ...
    protected void GetVehicleNoList()
    {
        ...
        {
            lblMsg.Text = "";
            //DateTime date3 = DateTime.ParseExact(txtDate.Text.Trim(), "dd/MM/yyyy", culture);
        ...
        try
        {
            ...
            if (e.CommandName == "RecordReject")
            {
                ...
                if (ctrl != null)
                {
                    ...
                    ds4 = objdb.ByProcedure("USP_Trn_VehicleDispDelivChallan",
                                   new string[] { "Flag", "VehicleDispId", "CreatedBy", "CreatedByIP" },
                                   new string[] { "10", e.CommandArgument.ToString(), objdb.createdBy(), IPAddress }, "TableSave");
            ...
            if (e.CommandName == "RecordReject")
            {
                ...
                if (ctrl != null)
                {
                    ...
                    ds4 = objdb.ByProcedure("USP_Trn_ProductGatePass",
                                   new string[] { "Flag", "ProductGatePassId", "CreatedBy", "CreatedByIP" },
                                   new string[] { "3", e.CommandArgument.ToString(), objdb.createdBy(), IPAddress }, "TableSave");

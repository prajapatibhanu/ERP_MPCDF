<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="SS_MilkOrProductInvoiceRpt.aspx.cs" Inherits="mis_Demand_SS_MilkOrProductInvoiceRpt" %>
        ...
        <section class="content noprint">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="box box-Manish">
                        <div class="box-header">
                            <h3 class="box-title">Milk Or Product Invoice Report</h3>
                ...
                <div class="col-md-12" id="pnldata" runat="server" visible="false">
                    <div class="box box-Manish">
                        <div class="box-header">
                            <h3 class="box-title"><span id="pnlcategoryname" runat="server"></span> Invoice Details</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <div class="row">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Date" HeaderStyle-Width="5px">
                                                  ...
                                                  <asp:TemplateField HeaderText="Party Name" HeaderStyle-Width="5px">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblSSName" Text='<%#Eval("RetailerName") %>' runat="server" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                        ...
                                        <asp:GridView ID="GridView2" runat="server" OnRowCommand="GridView2_RowCommand" class="datatable table table-striped table-bordered" AllowPaging="false"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Date" HeaderStyle-Width="5px">
                                                  ...
                                                  <asp:TemplateField HeaderText="Party Name" HeaderStyle-Width="5px">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblSSName" Text='<%#Eval("SSName") %>' runat="server" />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                  <asp:TemplateField HeaderText="Shift" HeaderStyle-Width="5px">
                                                    <ItemTemplate>
        ...
        $('.datatable').DataTable({
            ...
            buttons: {
                buttons: [{
                    ...
                    title: ('Invoice Details').bold().fontsize(3).toUpperCase(),
                    exportOptions: {
                        columns: [0, 1, 2, 3, 4, 5]
                    },
                    footer: false,

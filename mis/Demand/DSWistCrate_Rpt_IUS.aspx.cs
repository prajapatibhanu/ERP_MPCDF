...
public partial class mis_Demand_DSWistCrate_Rpt_IUS : System.Web.UI.Page
{
    ...
    private void GetPlantWiseReport()
    {
        try
        {
            ...
            ds5 = objdb.ByProcedure("USP_Trn_MilkOrProductCrateReturnMgmt",
                     new string[] { "Flag", "FromDate", "ToDate", "Office_ID" },
                       new string[] { "6", fromdat, todat,objdb.Office_ID() }, "dataset");
            ...
            sb.Append("</tr>");
            sb.Append("<tr>");
            sb.Append("<td colspan='4' style='text-align: left;border:1px solid black;'><b>Date  :-" + txtFromDate.Text + " To " + txtToDate.Text + "</b></td>");
            sb.Append("</tr>");
            sb.Append("<tr>");
            sb.Append("<td colspan='4'style='text-align: center;border:1px solid black;'><b>Plantwise Crate Report</b></td>");
            sb.Append("</tr>");
            sb.Append("</table>");
            ...
            for (int i = 0; i < Count1; i++)
            {
                ...
                sb.Append("<tr>");
                sb.Append("<td style='border-top:1px dashed black;text-align: center;'>" + (i + 1).ToString() + "</b></td>");
                sb.Append("<td style='border-top:1px dashed black;text-align: center;'>" + ds5.Tables[0].Rows[i]["DDate"] + "</td>");
                sb.Append("<td style='border-top:1px dashed black;text-align: center;'>" + ds5.Tables[0].Rows[i]["IssueCrate"] + "</td>");
                sb.Append("<td style='border-top:1px dashed black;text-align: center;'>" + ds5.Tables[0].Rows[i]["ReturnCrate"] + "</td>");
                sb.Append("<td style='border-top:1px dashed black;text-align: center;'>" + ds5.Tables[0].Rows[i]["CBalance"] + "</td>");
                sb.Append("</tr>");
            }

            sb.Append("<tr>");
            sb.Append("<td colspan='2' style='border-top:1px dashed black;border-bottom:1px dashed black;text-align:right;'><b>Total</b></td>");
            sb.Append("<td style='border-top:1px dashed black;border-bottom:1px dashed black;text-align: center;'><b>" + Convert.ToInt32(ds5.Tables[0].AsEnumerable().Sum(r => r.Field<int?>("IssueCrate") ?? 0)) + "</b></td>");
            sb.Append("<td style='border-top:1px dashed black;border-bottom:1px dashed black;text-align: center;'><b>" + Convert.ToInt32(ds5.Tables[0].AsEnumerable().Sum(r => r.Field<int?>("ReturnCrate") ?? 0)) + "</b></td>");
            sb.Append("<td style='border-top:1px dashed black;border-bottom:1px dashed black;text-align: center;'><b>" + Convert.ToInt32(ds5.Tables[0].AsEnumerable().Sum(r => r.Field<int?>("CBalance") ?? 0)) + "</b></td>");
            sb.Append("</tr>");
            sb.Append("</table>");
    ...
    protected void btnExportAll_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Response.Clear();
            Response.AddHeader("content-disposition", "attachment; filename=" + txtFromDate.Text + "-" + txtToDate.Text + "-" + "PlantWiseCrateReport.xls");
            Response.Charset = "";

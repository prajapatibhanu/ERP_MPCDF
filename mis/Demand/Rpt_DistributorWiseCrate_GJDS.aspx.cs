...
public partial class mis_Demand_Rpt_DistributorWiseCrate_GJDS : System.Web.UI.Page
{
        ...
        try
        {
            ...
            ds2 = objdb.ByProcedure("USP_Trn_MilkOrProductCrateReturnMgmt",
                     new string[] { "Flag", "FromDate", "ToDate", "Office_ID", "DistributorId" },
                       new string[] { "11", fromdat, todat, objdb.Office_ID(), distid.ToString() }, "dataset");
            ...
            if (ds2.Tables[0].Rows.Count > 0)
            {
                ...
                sb.Append("</tr>");
                sb.Append("<tr>");
                sb.Append("<td colspan='6'style='text-align: left;border:1px solid black;'>Party Name: <b>" + ddlPartyName.SelectedItem.Text + "</b></td>");
                sb.Append("</tr>");
                sb.Append("</table>");

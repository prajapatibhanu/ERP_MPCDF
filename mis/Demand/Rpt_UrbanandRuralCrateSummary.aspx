<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="Rpt_UrbanandRuralCrateSummary.aspx.cs" Inherits="mis_Demand_Rpt_UrbanandRuralCrateSummary" %>
                ...
                <div class="col-md-12 no-print">
                    <div class="box box-Manish">
                        <div class="box-header">
                            <h3 class="box-title">Cumulative Crate Summary</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <fieldset>

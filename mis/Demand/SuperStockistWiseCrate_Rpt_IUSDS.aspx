<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="SuperStockistWiseCrate_Rpt_IUSDS.aspx.cs" Inherits="mis_Demand_SuperStockistWiseCrate_Rpt_IUSDS" %>
                ...
                <div class="col-md-12">
                    <div class="box box-Manish">
                        <div class="box-header">
                            <h3 class="box-title">SuperStockistWise Crate Report</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            ...
                            <div class="row">
                                <fieldset>
                                    <legend>FromDate,ToDate,SupertStockist
                                    </legend>
                                    <div class="col-md-2">

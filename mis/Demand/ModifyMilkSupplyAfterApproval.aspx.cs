...
public partial class mis_Demand_ModifyMilkSupplyAfterApproval : System.Web.UI.Page
{
        ...
        try
        {
            ...
            ds = objdb.ByProcedure("USP_Trn_MilkOrProductDemand",
                     new string[] { "flag", "Office_ID", "AreaId", "RouteId", "Demand_Date", "Shift_id", "ItemCat_id"},
                       new string[] { "25", objdb.Office_ID(), ddlLocation.SelectedValue, ddlRoute.SelectedValue, orderdate, ddlShift.SelectedValue, objdb.GetMilkCatId() }, "dataset");
                    ...
                    if (ctrl != null)
                    {
                        ...
                        else
                        {
                            ...
                            ds4 = objdb.ByProcedure("USP_Trn_MilkOrProductDemandForSupply",
                             ...
                             new string[] { "19", e.CommandArgument.ToString(), txtSupplyTotalQty.Text.Trim(), txtLeakageQty.Text.Trim(), txtRemarkAtSupply.Text.Trim(), objdb.createdBy(), IPAddress + ":" + objdb.GetMACAddress() }, "TableSave");

<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="Rpt_ProductItemWiseSale_UDS.aspx.cs" Inherits="mis_Demand_Rpt_ProductItemWiseSale_UDS" %>
                ...
                <div class="col-md-12">
                    <div class="box box-Manish">
                        <div class="box-header">
                            <h3 class="box-title">RetailerType wise Item Sale Report</h3>
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                             ...
                             <fieldset>
                                    <legend>Date,Location,Party,category
                                    </legend>
                            <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <asp:HiddenField ID="hfvofficename" runat="server" />
                                        </div>
                                   ...
                                   <div class="col-md-2">
                                      ...
                                      <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList ID="ddlRetailerType" AutoPostBack="true" OnSelectedIndexChanged="ddlRetailerType_SelectedIndexChanged" runat="server" CssClass="form-control select2">
                                            </asp:DropDownList>
                                        </div>
                                    </div>
                                 <div class="col-md-2">
                                    <div class="form-group">
                                      ...
                                      <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList ID="ddlSection" AutoPostBack="true" OnSelectedIndexChanged="ddlSection_SelectedIndexChanged" runat="server" CssClass="form-control select2">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                           ...
                                           <asp:ListBox  ID="ddlSuperStockist" runat="server" ClientIDMode="Static" CssClass="form-control" SelectionMode="Multiple"></asp:ListBox>
                                        </div>
                                    </div>
                                    <div class="col-md-1">
    ...
    <script type="text/javascript">
     ...
     <script>
         ...
         $(function () {
             ...
             $('[id*=ddlSuperStockist]').multiselect({
                 includeSelectAllOption: true,
                 includeSelectAllOption: true,
                 buttonWidth: '100%',

...
public partial class mis_Demand_Rpt_CitizenAdvancedCard_Retailer : System.Web.UI.Page
{
    ...
    private void GetAdvancedCardDetailsRetailerWise()
    {
        try
        {
            lblMsg.Text = "";
            ...
            ds5 = objdb.ByProcedure("USP_Mst_CitizenAdvancedCard_Rpt",
                     new string[] { "flag", "BoothId", "Shift_id", "ItemCat_id", "FromDate", "ToDate", "Office_ID" },
                       new string[] { "1", objdb.createdBy(), ddlShift.SelectedValue, "3", fromnonth, tomonth, objdb.Office_ID() }, "dataset");
            ...
            if (ds5.Tables[0].Rows.Count != 0)
            {
                ...
                sb1.Append("</tr>");
                sb1.Append("<tr>");
                sb1.Append("<td style='padding: 2px 5px;text-align: lefg;'><b>Section  :- Citizen Advanced Card Report (In Pkt)</b></td>");
                ...
                for (int j = 0; j < ColCount; j++)
                {
                    ...
                    if (ds5.Tables[0].Columns[j].ToString() != "CitizenId")
                    {
                ...
                for (int i = 0; i < Count; i++)
                {
                    ...
                    {
                        if (ds5.Tables[0].Columns[K].ToString() != "CitizenId")
                        {
              ...
              //  decimal dsum11 = 0;
                ...
                {
                    if (column.ToString() != "CitizenId" && column.ToString() != "Customer Name")
                    {
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        if (Page.IsValid)
        {
            GetAdvancedCardDetailsRetailerWise();
        }
    }

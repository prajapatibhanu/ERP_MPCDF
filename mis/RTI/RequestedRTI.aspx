<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="RequestedRTI.aspx.cs" Inherits="mis_RTI_RTIOfficerForms_RequestedRTI" %>
                                ...
                                <div class="col-md-12">
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <asp:GridView ID="GridView1" DataKeyNames="RTI_ID" runat="server" class="datatable table table-hover table-bordered pagination-ys" ShowHeaderWhenEmpty="true" EmptyDataText="No Record Found" AutoGenerateColumns="false">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="Edit Detail" ShowHeader="False" ItemStyle-CssClass="text-center">
                                                        <ItemTemplate>

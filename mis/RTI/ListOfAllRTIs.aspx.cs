...
public partial class mis_RTI_ListOfAllRTIs : System.Web.UI.Page
{
    ...
    private void Fillgrid()
    {
        try
        {
            ...
            //    new string[] { "flag", "RTI_RequestType", "RTI_ByOfficeID" },
            //    new string[] { flag, ViewState["RequestType"].ToString(), ViewState["Office_ID"].ToString() }, "dataset");
            ds = objdb.ByProcedure("SpRtiReplyDetail",

<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="PendingRequestedRTI .aspx.cs" Inherits="mis_RTI_RTIOfficerForms_RequestedRTI" %>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="RTI Detail" ShowHeader="False">
                                                    <ItemTemplate>                                                                                                          
                                                        <asp:HyperLink ID="hylnkViewDetail" runat="server" CssClass="label label-default" Text="View Detail" NavigateUrl='<%# "RTIReply.aspx?RTI_ID=" + APIProcedure.Client_Encrypt(Eval("RTI_ID").ToString())%>'></asp:HyperLink> 
                                                    </ItemTemplate>                                                                                                        
                                                </asp:TemplateField>--%>
                                            </Columns>
                                        </asp:GridView>

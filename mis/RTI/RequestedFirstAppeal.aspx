<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="RequestedFirstAppeal.aspx.cs" Inherits="mis_RTI_RTIOfficerForms_RequestedFirstAppeal" %>
                                ...
                                <div class="col-md-12">
                                    <div class="box-body">
                                        <div class="form-group">
                                            ...
                                            <asp:GridView ID="GridView1" DataKeyNames="RTI_ID" runat="server" CssClass="datatable table table-bordered table-hover table-striped datatable pagination-ys"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="RTI Detail" ShowHeader="False" ItemStyle-CssClass="text-center">
                                                        <ItemTemplate>
                                                            <asp:HyperLink ID="hylnkViewDetail" runat="server" CssClass="label label-default" Text="View Detail" NavigateUrl='<%# "FirstAppealReply.aspx?RTI_ID=" + APIProcedure.Client_Encrypt(Eval("RTI_ID").ToString())+"&ShowHide=" + APIProcedure.Client_Encrypt("Show")%>'></asp:HyperLink>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                            </asp:GridView>

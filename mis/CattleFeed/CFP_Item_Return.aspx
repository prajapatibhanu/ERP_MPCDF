<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="CFP_Item_Return.aspx.cs" Inherits="mis_CattleFeed_CFP_Item_Return" %>
                                ...
                                <asp:Panel ID="pnl" runat="server" BorderColor="Black" BorderWidth="2" Width="99%">
                                    <div>
                                        <table align='center' style="width: 100%" border='1'>
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: left;">
                                                    <img src="/images/bdsnew_blacklogo.png" style="border: 1" />
                                                </td>
                                                <td style="text-align: center; width: 90%">&nbsp;पशुआहार संयंत्र, <span id="lblCFP" runat="server">gfgfh</span><br />
                                                    <br />
                                                    &nbsp;CATTLE FEED FACTORY, <span id="lblCFP1" runat="server">gfdgfdg</span><br />
                                                    <br />
                                                    &nbsp; <span id="lblCFPAddress" runat="server">fdf</span><br />
                                                    <br />
                                                    &nbsp; Email:<span id="lblCFPEmail" runat="server">fddg</span>&nbsp;&nbsp;GSTN NO: <span id="lblCFPGSTN" runat="server">fddg</span><br />
                                                </td>
                                        ...
                                        <table align='center' style="width: 100%" border='0'>
                                            <tr>
                                                <td style="text-align: left; width: 175px;">To ,<br />
                                                    <br />
                                                    &nbsp; M/S <span id="lblVendor" runat="server"></span>
                                                    <br />
                                                    &nbsp;<span id="lblVendorAddress" runat="server"></span><br />
                                                    &nbsp;  Email: <span id="lblEmail" runat="server"></span>&nbsp; GSTN No: <span id="lblGSTNNO" runat="server"></span>
                                                    <br />
                                                    <br />
                                            ...
                                            <tr style="text-align: left;">
                                                <td>&nbsp;<span id="lblfirstmessage" runat="server"></span> <span id="lblTender" runat="server"></span>for the supply of raw material required for cattle feef factory at pachama .We &nbsp;confirm to purchase from you the following good subject to terms and condition and specification mentioned in &nbsp;registration document<br />
                                                    <br />
                                                    &nbsp;1. As lay dowm under the terms and condition the registration. Which you have accepted,this approval iof rate will be &nbsp;considered as agreement between the two parties without further neecssity of execting separate agreement<br />
                                                    <br />
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 40%">
                                                    <table align='center' style="width: 100%" border='0'>
                                                        ...
                                                        <tr>
                                                            <td style="width: 50%"><span id="lblfirstsp1dt" runat="server"></span><span id="Span2" runat="server">to </span><span id="lblfirstsp1dt1" runat="server"></span>
                                                                <br />
                                                                <br />
                                                                &nbsp; <span id="lblfirstQty" runat="server"></span>
                                                            </td>
                                                            <td style="width: 50%">
                                                                <span id="lblSecsp1dt1" runat="server"></span><span id="Span1" runat="server">to </span><span id="lblSecsp1dt2" runat="server"></span>
                                                                <br />
                                                                <br />
                                                                &nbsp;  <span id="lblSecQty" runat="server"></span>

                                                            </td>
                                                            <td style="width: 50%">
                                                                <span id="lblThirdsp1dt1" runat="server"></span><span id="Span3" runat="server">to </span><span id="lblThirdsp1dt2" runat="server"></span>
                                                                <br />
                                                                <br />
                                                                &nbsp;  <span id="lblThirdQty" runat="server"></span>

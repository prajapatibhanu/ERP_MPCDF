...
public partial class mis_CattleFeed_CFP_Item_PO_Generate : System.Web.UI.Page
{
    DataSet ds;
        ...
        if (GetTenderCompareDate())
        {
            ...
            if (GetPOEndCompareDate())
            {
                ...
                if (rblpartial.SelectedValue == "1")
                {
                    ...
                    if (txtfirstitemQuantity.Text != string.Empty)
                    {
                        if(txtSecitemQuantity.Text=="")
                        {
                            txtSecitemQuantity.Text = "0";
                        }
                        if(txtThirdItemQuantity.Text=="")
                        {
                            txtThirdItemQuantity.Text = "0";
                        }
                        Double qty = Convert.ToDouble(txtfirstitemQuantity.Text) + Convert.ToDouble(txtSecitemQuantity.Text) + Convert.ToDouble(txtThirdItemQuantity.Text);
                        Double ItemQuantity = Convert.ToDouble(txtItemQuantity.Text);
                        if (qty != ItemQuantity)
                        { sb.Append("First or second or Third Quantity shoud be equal to Item quantity."); }
            ...
            if (ds1 != null)
            {
                if (ds1.Tables[0].Rows.Count > 0)
                {
                    ...
                    if (rblpartial.SelectedValue == "1")
                    {
                        ...
                        if (ds1.Tables[0].Rows[0]["SECFromDate"].ToString() == "01/01/1900")
                        {
                            txtSecfromdt.Text ="";
                        }
                        else
                        ...
                        if (ds1.Tables[0].Rows[0]["SECToDate"].ToString() == "01/01/1900")
                        {
                            txtSecTodt.Text ="";
                        }
                        else
                        ...
                        if (ds1.Tables[0].Rows[0]["THIRDFromDate"].ToString() == "01/01/1900")
                        {
                            txtThirdFromdt.Text ="";
                        }
                        else
                        ...
                        if (ds1.Tables[0].Rows[0]["THIRDToDate"].ToString() == "01/01/1900")
                        {
                            txtThirdTodt.Text = "";
                        }
                        else

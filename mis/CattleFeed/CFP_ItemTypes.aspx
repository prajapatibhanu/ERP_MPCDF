<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="CFP_ItemTypes.aspx.cs" Inherits="mis_CattelFeed_CFP_ItemTypes" %>
            ...
            <div class="row">
                <div class="col-md-4">
                    <div class="box box-Manish">
                        ...
                        <div class="box-body">
                            <fieldset>
                                <legend>Item Type (वस्तु की प्रकार प्रविष्ट)
                                </legend>
                                <div class="row">
                                    <div class="col-lg-12">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList ID="ddlItemCategory" CssClass="form-control select2" runat="server"></asp:DropDownList>
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtItemTypeName" CssClass="form-control" MaxLength="80" runat="server"></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <label>Abbreviation (संक्षिप्त प्रकार)<span style="color: red;"> *</span></label>
                                            <span class="pull-right">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <asp:Button runat="server" ID="btnSubmit" CssClass="btn btn-block btn-primary" ValidationGroup="a" Text="Save" OnClientClick="return ValidatePage();" AccessKey="S" OnClick="btnSubmit_Click" />
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                    ...
                    <div class="box box-Manish">
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="box-body">
                                      <fieldset>
                                <legend>Item Type Detail (प्रविष्टित प्रकार की सूची)
                                </legend>
                                    <div class="table-responsive">
                                        <asp:HiddenField ID="hdnItemtype" runat="server" Value="0" />
                                        <asp:GridView ID="grdlist" runat="server" OnRowCommand="grdlist_RowCommand" AutoGenerateColumns="false" CssClass="datatable table table-striped table-bordered table-hover"
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Actions">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="lnkUpdate" CommandName="RecordUpdate" CommandArgument='<%#Eval("ItemTypeid") %>' runat="server" ToolTip="Update"><i class="fa fa-pencil"></i></asp:LinkButton>
                                                        &nbsp;&nbsp;<asp:LinkButton ID="lnkDelete" CommandArgument='<%#Eval("ItemTypeid") %>' CommandName="RecordDelete" runat="server" ToolTip="Delete" Style="color: red;" OnClientClick="return confirm('Are you sure to Delete?')"><i class="fa fa-trash"></i></asp:LinkButton>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        </asp:GridView>

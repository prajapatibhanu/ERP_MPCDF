<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="RouteHeadandSubRouteHeadMapping.aspx.cs" Inherits="mis_Masters_RouteHeadandSubRouteHeadMapping" %>
        ...
        <section class="content">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="box box-Manish">
                        <div class="box-header">
                            <h3 class="box-title">Route Head & Sub Route Head Mapping</h3>
                        </div>
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-12 ">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <asp:ListBox runat="server" autocomplete="off" CssClass="form-control" SelectionMode="Multiple" ID="ddlSubRouteHead"></asp:ListBox>
                                    </div>
                                </div>
                ...
                <div class="col-md-12">
                    <div class="box box-Manish">
                        <div class="box-header">
                            <h3 class="box-title">Route Head & Sub Route Head Mapping Details</h3>
                        </div>
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-2">
                                ...
                                <div class="col-md-12">
                                    <div class="table-responsive">
                                        <asp:GridView ID="GridView1" OnRowCommand="GridView1_RowCommand" runat="server" AutoGenerateColumns="false" CssClass="datatable table table-striped table-bordered table-hover"
                                            EmptyDataText="No Record Found." DataKeyNames="RouteHeadandSubRouteHeadId">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Sub Route Head">
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="Action">
                                                    <ItemTemplate>
                                                        &nbsp;&nbsp;&nbsp;<asp:LinkButton ID="lnkDelete" CommandArgument='<%#Eval("RouteHeadandSubRouteHeadId") %>' CommandName="RecordDelete" runat="server" ToolTip="Delete" Style="color: red;" OnClientClick="return confirm('Are you sure to Delete?')"><i class="fa fa-trash"></i></asp:LinkButton>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        </asp:GridView>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentFooter" runat="Server">
    ...
    <script>
        $(function () {
            $('[id*=ddlSubRouteHead]').multiselect({
        ...
        $('.datatable').DataTable({
            ...
            buttons: {
                buttons: [{
                    ...
                    title: ('Route Head and Sub Route Head Mapping').bold().fontsize(5).toUpperCase(),
                    exportOptions: {
                        columns: [0, 1, 2, 3]
                    },
                    footer: false,
                    ...
                    extend: 'excel',
                    title: ('Route Head and Sub Route Head Mapping').bold().fontsize(5).toUpperCase(),
                    filename: 'RouteHeadandSubRouteHeadMappingDetails',

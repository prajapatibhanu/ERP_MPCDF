<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="RouteMaster.aspx.cs" Inherits="mis_Common_RouteMaster" %>
        ...
        <section class="content">
            ...
            <div class="box box-Manish">
                            ...
                            <div class="form-group">
                                ...
                                <span class="pull-right">
                                    <asp:RequiredFieldValidator ID="rfv1" ValidationGroup="a"
                                        ErrorMessage="Enter Route Name" Text="<i class='fa fa-exclamation-circle' title='Enter Route Name !'></i>"
                                        ControlToValidate="txtRouteName" ForeColor="Red" Display="Dynamic" runat="server">
                                    </asp:RequiredFieldValidator></span>
                                <asp:TextBox runat="server" autocomplete="off" CssClass="form-control" ID="txtRouteName" placeholder="Enter Route Name" ClientIDMode="Static"></asp:TextBox>
                            </div>
                        </div>
                            <div class="col-md-2">
                            <div class="form-group">
                                <label>Route Number<span style="color: red;"> *</span></label>
                                <span class="pull-right">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ValidationGroup="a"
                                        ErrorMessage="Enter Route Number" ForeColor="Red" Text="<i class='fa fa-exclamation-circle' title='Enter Route Number. !'></i>"
                                        ControlToValidate="txtRouteNo" Display="Dynamic" runat="server">
                                ...
                                <asp:TextBox runat="server" autocomplete="off" CssClass="form-control" ID="txtRouteNo" MaxLength="5" placeholder="Enter Route Number"></asp:TextBox>
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                ...
                <div class="col-md-12">
                    <div class="box box-Manish">
                        <div class="box-header">
                            <h3 class="box-title">Route Master Registration Details</h3>
                        </div>
                        <div class="box-body">
                            <div class="row">
                                  <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList ID="ddlLocationSearch" runat="server" CssClass="form-control select2">
                                            </asp:DropDownList>
                                        </div>
                                ...
                                <div class="col-md-12">
                                    <div class="table-responsive">
                                        <asp:GridView ID="GridView1" OnRowCommand="GridView1_RowCommand" runat="server" AutoGenerateColumns="false" CssClass="datatable table table-striped table-bordered table-hover"
                                            EmptyDataText="No Record Found." DataKeyNames="RouteId">
                                            <Columns>
                                                <asp:TemplateField HeaderText="S.No">
                                                 ...
                                                 <asp:TemplateField HeaderText="Route Name">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblRoute_Name" runat="server" Text='<%# Eval("RouteName") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
        ...
        $('.datatable').DataTable({
            ...
            buttons: {
                buttons: [{
                    ...
                    title: ('Route Master').bold().fontsize(5).toUpperCase(),
                    exportOptions: {
                        columns: [0, 1, 2,3,4]
                    },
                    footer: false,
                    ...
                    extend: 'excel',
                    title: ('Route Master').bold().fontsize(5).toUpperCase(),
                    filename: 'RouteMasterRegistrationDetails',

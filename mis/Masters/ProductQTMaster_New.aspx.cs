        ...
        try
        {
            ...
            if (ViewState["UPageTokan"].ToString() == Session["PageTokan"].ToString())
            {
                ...
                else if (btnSave.Text == "Update" && ViewState["QCParameterID"].ToString() != "0")
                {
                   ...
                   new string[] { "3", ViewState["QCParameterID"].ToString(), ViewState["Office_ID"].ToString(), ddlProduct.SelectedValue.ToString(), ddlParameter.SelectedItem.Text, ddlCalculationMethod.SelectedValue.ToString(), txtMinValue.Text, txtMaxValue.Text, ddlUnit.SelectedValue, ViewState["Emp_ID"].ToString(), "1" }, "dataset");

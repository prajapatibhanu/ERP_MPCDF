...
public partial class mis_Common_OfficeRegistration : System.Web.UI.Page
{
    ...
    private void GetOfficeDetails()
    {
        try
        {
            ds = objdb.ByProcedure("SpAdminOffice",
                    new string[] { "flag", "CreatedBy", "OfficeType_ID", "Office_Parant_ID" },
                    new string[] { "1", objdb.createdBy(), ddlOfficeType_flt.SelectedValue.ToString(),objdb.Office_ID()}, "dataset");
            if (ds.Tables[0].Rows.Count > 0)
            {
    ...
    private void GetDropdownOfDivisionOrDistrict()
    {
        try
        {
			 divSocietyCategory.Visible = false;
            ...
            else if (ddlOfficeType.SelectedValue == "5")
            {
                spanDivision.Visible = true;
                spanDistrict.Visible = true;
				divSocietyCategory.Visible = true;
                // txtOfficeName.Enabled = false;
                //spanUnit.Visible = true;
                spanCapacity.Visible = true;
                //GetOfficeWiselabelset();
            ...
            try
            {
                if (ViewState["UPageTokan"].ToString() == Session["PageTokan"].ToString())
                {
                    ...
                    if (btnSubmit.Text == "Save")
                    {
                        ...
                        {
                            if (txtProductionCapacity.Text == "" || txtProductionCapacity.Text == "")
                            {
                                txtProductionCapacity.Text = "0";
                                txtProcessingCapacity.Text = "0";
                            }
                            ds = objdb.ByProcedure("SpAdminOffice", 
                                new string[] { "flag", "Office_Parant_ID","OfficeType_ID","Office_Name","Office_Name_E",
                                               ...
                                               "District_ID","Block_ID", "Capacity","ProcessingCapacity",
                                               "ContactPerson","NoOfEmployees","NoOfParmanent_Concontractual","SanctionedMPEB",
                                               "ActualMPEB","ProductionCapacity","IsManufacturingUnit","ProductionName",
                                               "FSSILicenceNo","FactoryLicenceNo","BoilerLicenceNo","OfficerName",
                                               "OfficerMobileNo","Bank","Branch","IFSC",
                                               "BankAccountNo","AccountHolderName","CreatedBy","CreatedBy_IP", "Accounting" },
                       new string[] { "2", objdb.Office_ID(), ddlOfficeType.SelectedValue, txtOfficeName.Text.Trim() , txtOffice_Name_E.Text,
                                      ...
                                      ddlDistrict.SelectedValue,ddlBlock_ID.SelectedValue,txtCapacity.Text.Trim(), txtProcessingCapacity.Text.Trim(), 
                                      txtContactPerson.Text.Trim(), txtNoOfEmployees.Text.Trim(), txtParmanent_Concontractual.Text.Trim(), txtSanctionedMPEB.Text.Trim(), 
                                      txtActualMPEB.Text.Trim(), txtProductionCapacity.Text.Trim(), ddlManufacturing.SelectedValue.ToString(), txtProductionName.Text.Trim(),
                                      txtFSSI.Text.Trim(), txtFactoryLicence.Text.Trim(), txtBoilerLicence.Text.Trim(), txtOfficerName.Text.Trim(), 
                                      txtofficermobileNo.Text.Trim(), ddlBank.SelectedValue.ToString(),txtBranchName.Text.Trim(),txtIFSCCode.Text.Trim(),
                                      txtBankAccountNo.Text.Trim(),txtAccountHolderName.Text.Trim(), objdb.createdBy(), objdb.GetLocalIPAddress() + ":" + objdb.GetMACAddress(), rbAccounting.SelectedItem.Value}, "TableSave");
                        }
                        else if (ddlOfficeType.SelectedValue == "4") //CC
                        {
                            ds = objdb.ByProcedure("SpAdminOffice", 
                                new string[] { "flag", "Office_Parant_ID", "OfficeType_ID", "Office_Name", "Office_Name_E", 
                                              "Office_Code","SocietyCode", "Office_ContactNo", "Office_Email", "Division_ID","Assembly_ID", 
                                              "District_ID", "Block_ID", "Capacity", "ContactPerson", 
                                              "NoOfEmployees", "NoOfParmanent_Concontractual", "SanctionedMPEB ", "ActualMPEB", 
                                              "OfficerName", "OfficerMobileNo", "Bank", "Branch", 
                                              "IFSC", "BankAccountNo","AccountHolderName", "CreatedBy", "CreatedBy_IP", "Accounting" },
                                 new string[] { "2", objdb.Office_ID(), ddlOfficeType.SelectedValue, txtOfficeName.Text.Trim(), txtOffice_Name_E.Text, 
                                                txtOffice_Code.Text.Trim(),txtSocietyCode.Text.Trim(), txtOfficeContactNo.Text.Trim(), txtOffice_Email.Text.Trim(), ddlDivision.SelectedValue,ddlAssembly_ID.SelectedValue, 
                                                ddlDistrict.SelectedValue, ddlBlock_ID.SelectedValue, txtCapacity.Text.Trim(), txtContactPerson.Text.Trim(), 
                                                txtNoOfEmployees.Text.Trim(), txtParmanent_Concontractual.Text.Trim(), txtSanctionedMPEB.Text.Trim(), txtActualMPEB.Text.Trim(), 
                                                txtOfficerName.Text.Trim(), txtofficermobileNo.Text.Trim(), ddlBank.SelectedValue.ToString(), txtBranchName.Text.Trim(),
                                                txtIFSCCode.Text.Trim(), txtBankAccountNo.Text.Trim(),txtAccountHolderName.Text.Trim(), objdb.createdBy(), objdb.GetLocalIPAddress() + ":" + objdb.GetMACAddress(), rbAccounting.SelectedItem.Value }, "TableSave");
                        }
                        else if (ddlOfficeType.SelectedValue == "5") // BMC
                        {
                            ds = objdb.ByProcedure("SpAdminOffice", 
                                new string[] { "flag", "Office_Parant_ID", "OfficeType_ID", "Office_Name", "Office_Name_E", 
                                               "Office_Code","SocietyCode", "Office_ContactNo", "Office_Email", "Division_ID","Assembly_ID",
                                               "District_ID", "Block_ID", "ElectronicEquipment", "RegisteredProducersCount", 
                                               "MilkSupplyto", "supplyUnit", "WhetherCashless", "AICenter", 
                                               "AHWName", "AHWMobile", "AssetDetails", "Capacity", 
                                               "ContactPerson", "OfficerName", "OfficerMobileNo", "Bank",
                                               "Branch", "IFSC", "BankAccountNo","AccountHolderName", "CreatedBy", "CreatedBy_IP", "Accounting","SocietyCategory" },
                                new string[] { "2", objdb.Office_ID(), ddlOfficeType.SelectedValue, txtOfficeName.Text.Trim(), txtOffice_Name_E.Text, 
                                              txtOffice_Code.Text.Trim(),txtSocietyCode.Text.Trim(), txtOfficeContactNo.Text.Trim(), txtOffice_Email.Text.Trim(), ddlDivision.SelectedValue,ddlAssembly_ID.SelectedValue, 
                                              ddlDistrict.SelectedValue, ddlBlock_ID.SelectedValue, txtElectronicEquip.Text.Trim(), txtRegisteredProducers.Text.Trim(), 
                                              ddlMilkSupply.SelectedValue.ToString(), ddlSupplyUnit.SelectedValue.ToString(), ddlcashless.SelectedValue.ToString(), DdlAICenter.SelectedValue.ToString(),
                                              txtAhwName.Text.Trim(), txtAHWMobile.Text.Trim(), txtAssetDetail.Text.Trim(), txtCapacity.Text.Trim(), 
                                              txtContactPerson.Text.Trim(), txtOfficerName.Text.Trim(), txtofficermobileNo.Text.Trim(), ddlBank.SelectedValue.ToString(), 
                                              txtBranchName.Text.Trim(), txtIFSCCode.Text.Trim(), txtBankAccountNo.Text.Trim(),txtAccountHolderName.Text.Trim(), objdb.createdBy(), objdb.GetLocalIPAddress() + ":" + objdb.GetMACAddress(), rbAccounting.SelectedItem.Value,ddlSocietyCategory.SelectedValue }, "TableSave");
                        }
                        else if (ddlOfficeType.SelectedValue == "6") //DCS
                        {
                            ds = objdb.ByProcedure("SpAdminOffice", 
                                new string[] { "flag", "Office_Parant_ID", "OfficeType_ID", "Office_Name", "Office_Name_E", 
                                               "Office_Code","SocietyCode", "Office_ContactNo", "Office_Email", "Division_ID","Assembly_ID",
                                               "District_ID", "Block_ID", "ElectronicEquipment", "RegistrationNo", 
                                               "RegistrationDate", "RegisteredProducersCount", "MilkSupplyto", "supplyUnit", 
                                               "WhetherCashless", "AICenter", "AHWName", "AHWMobile", 
                                               "AssetDetails", "Capacity", "ContactPerson", "OfficerName", 
                                               "OfficerMobileNo", "SanctionedMPEB", "ActualMPEB", "SchemeName", 
                                               "WomenDcs", "BMCAvailable", "Bank", "Branch", "IFSC", 
                                               "BankAccountNo","AccountHolderName", "CreatedBy", "CreatedBy_IP", "Accounting","SocietyCategory" },
                               new string[] { "2", objdb.Office_ID(), ddlOfficeType.SelectedValue, txtOfficeName.Text.Trim(), txtOffice_Name_E.Text, 
                                              txtOffice_Code.Text.Trim(),txtSocietyCode.Text.Trim(), txtOfficeContactNo.Text.Trim(), txtOffice_Email.Text.Trim(), ddlDivision.SelectedValue,ddlAssembly_ID.SelectedValue, 
                                              ddlDistrict.SelectedValue, ddlBlock_ID.SelectedValue, txtElectronicEquip.Text.Trim(), txtRegistrationNo.Text, 
                                              Convert.ToDateTime(txtRegistrationDate.Text, cult).ToString("yyyy/MM/dd"), txtRegisteredProducers.Text.Trim(), ddlMilkSupply.SelectedValue.ToString(), ddlSupplyUnit.SelectedValue.ToString(), 
                                              ddlcashless.SelectedValue.ToString(), DdlAICenter.SelectedValue.ToString(), txtAhwName.Text.Trim(), txtAHWMobile.Text.Trim(), txtAssetDetail.Text.Trim(), 
                                              txtCapacity.Text.Trim(), txtContactPerson.Text.Trim(), txtOfficerName.Text.Trim(), txtofficermobileNo.Text.Trim(), 
                                              txtSanctionedMPEB.Text.Trim(), txtActualMPEB.Text.Trim(), txtScheme.Text.Trim(), ddlWomenDCS.SelectedValue.ToString(), 
                                              ddlBMCAvail.SelectedValue.ToString(), ddlBank.SelectedValue.ToString(), txtBranchName.Text.Trim(), txtIFSCCode.Text.Trim(),
                                              txtBankAccountNo.Text.Trim(),txtAccountHolderName.Text.Trim(), objdb.createdBy(), objdb.GetLocalIPAddress() + ":" + objdb.GetMACAddress(), rbAccounting.SelectedItem.Value,ddlSocietyCategory.SelectedValue }, "TableSave");
                        }
                    ...
                    if (btnSubmit.Text == "Update")
                    {
                        ...
                        if (ddlOfficeType.SelectedValue == "3") //MDP
                        {
                            ...
                            ds = objdb.ByProcedure("SpAdminOffice", 
                                new string[] { "flag", "Office_ID","OfficeType_ID","Office_Name","Office_Name_E",
                                    "Office_Code","SocietyCode","Office_ContactNo","Office_Email","Office_Address",
                                    "Division_ID","District_ID","Block_ID","Capacity",
                                    "ProcessingCapacity","ContactPerson","NoOfEmployees","NoOfParmanent_Concontractual",
                                    "SanctionedMPEB","ActualMPEB","ProductionCapacity","IsManufacturingUnit",
                                    "ProductionName","FSSILicenceNo","FactoryLicenceNo","BoilerLicenceNo",
                                    "OfficerName","OfficerMobileNo","Assembly_ID","Bank",
                                    "Branch","IFSC","BankAccountNo","AccountHolderName","CreatedBy","CreatedBy_IP","Accounting" },
                       new string[] { "3", ViewState["rowid"].ToString(), ddlOfficeType.SelectedValue, txtOfficeName.Text.Trim() ,txtOffice_Name_E.Text,
                           txtOffice_Code.Text.Trim() ,txtSocietyCode.Text.Trim(),txtOfficeContactNo.Text.Trim(),txtOffice_Email.Text.Trim(), txtAddress.Text ,
                           ddlDivision.SelectedValue,ddlDistrict.SelectedValue,ddlBlock_ID.SelectedValue, txtCapacity.Text.Trim(), 
                           txtProcessingCapacity.Text.Trim(), txtContactPerson.Text.Trim(), txtNoOfEmployees.Text.Trim(), txtParmanent_Concontractual.Text.Trim(), 
                           txtSanctionedMPEB.Text.Trim(), txtActualMPEB.Text.Trim(), txtProductionCapacity.Text.Trim(), ddlManufacturing.SelectedValue.ToString(), 
                           txtProductionName.Text.Trim(), txtFSSI.Text.Trim(), txtFactoryLicence.Text.Trim(), txtBoilerLicence.Text.Trim(), 
                           txtOfficerName.Text.Trim(), txtofficermobileNo.Text.Trim(),ddlAssembly_ID.SelectedValue, ddlBank.SelectedValue.ToString(),
                           txtBranchName.Text.Trim(),txtIFSCCode.Text.Trim(),txtBankAccountNo.Text.Trim(),txtAccountHolderName.Text.Trim(), objdb.createdBy(), objdb.GetLocalIPAddress() + ":" + objdb.GetMACAddress(), rbAccounting.SelectedItem.Value}, "TableSave");
                        }
                        else if (ddlOfficeType.SelectedValue == "4") //CC
                        {
                            ds = objdb.ByProcedure("SpAdminOffice", 
                                new string[] { "flag", "Office_ID", "OfficeType_ID", "Office_Name", "Office_Name_E", 
                                    "Office_Code","SocietyCode", "Office_ContactNo", "Office_Email", "Office_Address", "Division_ID", 
                                    "District_ID", "Block_ID", "Capacity", "ContactPerson", 
                                    "NoOfEmployees", "NoOfParmanent_Concontractual", "SanctionedMPEB ", "ActualMPEB", 
                                    "OfficerName", "OfficerMobileNo", "Assembly_ID", "Bank", 
                                    "Branch", "IFSC", "BankAccountNo","AccountHolderName", 
                                    "CreatedBy", "CreatedBy_IP", "Accounting" },
                                 new string[] { "3", ViewState["rowid"].ToString(), ddlOfficeType.SelectedValue, txtOfficeName.Text.Trim(), txtOffice_Name_E.Text, 
                                     txtOffice_Code.Text.Trim(),txtSocietyCode.Text.Trim(), txtOfficeContactNo.Text.Trim(), txtOffice_Email.Text.Trim(), txtAddress.Text,  ddlDivision.SelectedValue,
                                     ddlDistrict.SelectedValue, ddlBlock_ID.SelectedValue, txtCapacity.Text.Trim(), txtContactPerson.Text.Trim(),
                                     txtNoOfEmployees.Text.Trim(), txtParmanent_Concontractual.Text.Trim(), txtSanctionedMPEB.Text.Trim(),txtActualMPEB.Text.Trim(), 
                                     txtOfficerName.Text.Trim(), txtofficermobileNo.Text.Trim(), ddlAssembly_ID.SelectedValue, ddlBank.SelectedValue.ToString(), 
                                     txtBranchName.Text.Trim(), txtIFSCCode.Text.Trim(), txtBankAccountNo.Text.Trim(),txtAccountHolderName.Text.Trim(), 
                                     objdb.createdBy(), objdb.GetLocalIPAddress() + ":" + objdb.GetMACAddress(), rbAccounting.SelectedItem.Value }, "TableSave");
                        }
                        else if (ddlOfficeType.SelectedValue == "5") // BMC
                        {
                            ds = objdb.ByProcedure("SpAdminOffice", 
                                new string[] { "flag", "Office_ID", "OfficeType_ID", "Office_Name", "Office_Name_E",
                                              "Office_Code","SocietyCode", "Office_ContactNo", "Office_Email", "Office_Address", 
                                               "Division_ID","District_ID", "Block_ID","ElectronicEquipment",
                                              "RegisteredProducersCount", "MilkSupplyto", "supplyUnit", "WhetherCashless", 
                                              "AICenter", "AHWName", "AHWMobile", "AssetDetails", 
                                              "Capacity", "ContactPerson", "OfficerName", "OfficerMobileNo", 
                                              "Assembly_ID", "Bank", "Branch", "IFSC", 
                                              "BankAccountNo","AccountHolderName", "CreatedBy", "CreatedBy_IP", "Accounting","SocietyCategory" },
                              new string[] { "3", ViewState["rowid"].ToString(), ddlOfficeType.SelectedValue, txtOfficeName.Text.Trim(), txtOffice_Name_E.Text, 
                                            txtOffice_Code.Text.Trim(),txtSocietyCode.Text.Trim(), txtOfficeContactNo.Text.Trim(), txtOffice_Email.Text.Trim(), txtAddress.Text, 
                                            ddlDivision.SelectedValue, ddlDistrict.SelectedValue, ddlBlock_ID.SelectedValue, txtElectronicEquip.Text.Trim(),
                                            txtRegisteredProducers.Text.Trim(), ddlMilkSupply.SelectedValue.ToString(), ddlSupplyUnit.SelectedValue.ToString(), ddlcashless.SelectedValue.ToString(), 
                                            DdlAICenter.SelectedValue.ToString(), txtAhwName.Text.Trim(), txtAHWMobile.Text.Trim(), txtAssetDetail.Text.Trim(), 
                                            txtCapacity.Text.Trim(), txtContactPerson.Text.Trim(), txtOfficerName.Text.Trim(), txtofficermobileNo.Text.Trim(), 
                                            ddlAssembly_ID.SelectedValue, ddlBank.SelectedValue.ToString(), txtBranchName.Text.Trim(), txtIFSCCode.Text.Trim(), 
                                            txtBankAccountNo.Text.Trim(),txtAccountHolderName.Text.Trim(), objdb.createdBy(), objdb.GetLocalIPAddress() + ":" + objdb.GetMACAddress(), rbAccounting.SelectedItem.Value,ddlSocietyCategory.SelectedValue }, "TableSave");
                        }
                        else if (ddlOfficeType.SelectedValue == "6") //DCS
                        {
                            ...
                            ds = objdb.ByProcedure("SpAdminOffice", 
                                new string[] { "flag", "Office_ID", "OfficeType_ID", "Office_Name", "Office_Name_E", 
                                               "Office_Code","SocietyCode", "Office_ContactNo", "Office_Email", "Office_Address", 
                                               "Division_ID", "District_ID", "Block_ID", "ElectronicEquipment", 
                                               "RegistrationNo", "RegistrationDate", "RegisteredProducersCount", "MilkSupplyto", 
                                               "supplyUnit", "WhetherCashless", "AICenter", "AHWName", 
                                               "AHWMobile", "AssetDetails", "Capacity", "ContactPerson", 
                                               "OfficerName", "OfficerMobileNo", "Assembly_ID", "SchemeName",
                                               "WomenDcs", "BMCAvailable", "Bank", "Branch", 
                                               "IFSC", "BankAccountNo","AccountHolderName", "CreatedBy", "CreatedBy_IP", "Accounting","SocietyCategory" },
                              new string[] { "3", ViewState["rowid"].ToString(), ddlOfficeType.SelectedValue, txtOfficeName.Text.Trim(), txtOffice_Name_E.Text, 
                                            txtOffice_Code.Text.Trim(),txtSocietyCode.Text.Trim(), txtOfficeContactNo.Text.Trim(), txtOffice_Email.Text.Trim(), txtAddress.Text, 
                                            ddlDivision.SelectedValue, ddlDistrict.SelectedValue, ddlBlock_ID.SelectedValue, txtElectronicEquip.Text.Trim(),
                                            txtRegistrationNo.Text, RegistrationDate, txtRegisteredProducers.Text.Trim(), ddlMilkSupply.SelectedValue.ToString(),
                                            ddlSupplyUnit.SelectedValue.ToString(), ddlcashless.SelectedValue.ToString(), DdlAICenter.SelectedValue.ToString(), txtAhwName.Text.Trim(),
                                            txtAHWMobile.Text.Trim(), txtAssetDetail.Text.Trim(), txtCapacity.Text.Trim(), txtContactPerson.Text.Trim(),
                                            txtOfficerName.Text.Trim(), txtofficermobileNo.Text.Trim(), ddlAssembly_ID.SelectedValue, txtScheme.Text.Trim(),
                                            ddlWomenDCS.SelectedValue.ToString(), ddlBMCAvail.SelectedValue.ToString(), ddlBank.SelectedValue.ToString(), txtBranchName.Text.Trim(), 
                                            txtIFSCCode.Text.Trim(), txtBankAccountNo.Text.Trim(),txtAccountHolderName.Text.Trim(), objdb.createdBy(), objdb.GetLocalIPAddress() + ":" + objdb.GetMACAddress(), rbAccounting.SelectedItem.Value,ddlSocietyCategory.SelectedValue }, "TableSave");
                        }
                        if (ds.Tables[0].Rows[0]["Msg"].ToString() == "Ok")
                        {
                            GetOfficeDetails();
                ...
                if (ctrl != null)
                {
                    ...
                    if (ds1 != null && ds1.Tables[0].Rows.Count > 0)
                    {
                        ...
                        if (ds1.Tables[0].Rows[0]["OfficeType_ID"].ToString() == "3") //MDP
                        {
                            ...
                            {
                                if (ds1.Tables[0].Rows[0]["IsManufacturingUnit"].ToString() == "True")
                                {
                                    ddlManufacturing.SelectedValue = "1";
                                }
                                else
                                {
                                    ddlManufacturing.SelectedValue = "2";
                                }
                            }
                        ...
                        else if (ddlOfficeType.SelectedValue == "5") // BMC
                        {
                            ...
                            {
                                txtRegistrationDate.Text = ds1.Tables[0].Rows[0]["RegistrationDate"].ToString();//(Convert.ToDateTime(ds1.Tables[0].Rows[0]["RegistrationDate"].ToString(), cult).ToString("dd/MM/yyyy")).ToString();
                            }
                            ...
                            {
                                ddlBMCAvail.SelectedValue = ds1.Tables[0].Rows[0]["BMCAvailable"].ToString();
                            }
							ddlSocietyCategory.ClearSelection();

<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="SubRouteHeadandRouteMapping.aspx.cs" Inherits="mis_Masters_SubRouteHeadandRouteMapping" %>
        ...
        <section class="content">
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="box box-Manish">
                        <div class="box-header">
                            <h3 class="box-title">Sub Route Head & Route Mapping</h3>
                        </div>
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-12 ">
                            ...
                            <div class="row">
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label>Sub Route Head<span style="color: red;"> *</span></label>
                                        <span class="pull-right">
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ValidationGroup="a"
                                                ErrorMessage="Select SubRouteHead" Text="<i class='fa fa-exclamation-circle' title='Select Location !'></i>"
                                                ControlToValidate="ddlSubHeadRoute" InitialValue="0" ForeColor="Red" Display="Dynamic" runat="server">
                                            </asp:RequiredFieldValidator>
                                        </span>

                                        <asp:DropDownList ID="ddlSubHeadRoute" runat="server" CssClass="form-control select2">
                                        </asp:DropDownList>
                                    </div>
                                </div>
                                <div class="col-md-2">
                ...
                <div class="col-md-12">
                    <div class="box box-Manish">
                        <div class="box-header">
                            <h3 class="box-title">Sub Route Head & Route Mapping Details</h3>
                        </div>
                        <div class="box-body">
                            <div class="row">
                                 <div class="col-md-2">
                            <div class="form-group">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label>Sub Route Head Name</label>
                                        <asp:DropDownList ID="ddlSearchSubRouteHead" runat="server" CssClass="form-control select2">
                                        </asp:DropDownList>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="table-responsive">
                                        <asp:GridView ID="GridView1" OnRowCommand="GridView1_RowCommand" runat="server" AutoGenerateColumns="false" CssClass="datatable table table-striped table-bordered table-hover"
                                            EmptyDataText="No Record Found." DataKeyNames="SubRouteHeadandRouteId">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Sub Route Head Name">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblSubRouteHeadName" runat="server" Text='<%# Eval("SubRouteHeadName") %>'></asp:Label>
                                                ...
                                                <asp:TemplateField HeaderText="Action">
                                                    <ItemTemplate>
                                                        &nbsp;&nbsp;&nbsp;<asp:LinkButton ID="lnkDelete" CommandArgument='<%#Eval("SubRouteHeadandRouteId") %>' CommandName="RecordDelete" runat="server" ToolTip="Delete" Style="color: red;" OnClientClick="return confirm('Are you sure to Delete?')"><i class="fa fa-trash"></i></asp:LinkButton>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        </asp:GridView>
        ...
        $('.datatable').DataTable({
            ...
            buttons: {
                buttons: [{
                    ...
                    title: ('Sub Route Head and Route Mapping').bold().fontsize(5).toUpperCase(),
                    exportOptions: {
                        columns: [0, 1, 2, 3]
                    },
                    footer: false,

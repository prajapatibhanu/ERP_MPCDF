                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <%--    <asp:RegularExpressionValidator ID="RegularExpressionValidator2" ValidationGroup="a" 
                                            Display="Dynamic" runat="server" ControlToValidate="txtFat"
                                            ErrorMessage="Only alphabnumeric and space allow." ForeColor="Red"
                                             Text="<i class='fa fa-exclamation-circle' title='Only alphabnumeric and space allow. !'></i>"
                                            SetFocusOnError="true" ValidationExpression="^[a-zA-Z0-9\s]+$">
                                        </asp:RegularExpressionValidator>--%>
                                   </span>
                                  <asp:TextBox ID="txtFat" CssClass="form-control" MaxLength="90" runat="server"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                  ...
                                  <asp:TextBox ID="txtSNF" CssClass="form-control" MaxLength="90" runat="server"></asp:TextBox>
                                </div>
                            </div>
                                <div class="col-md-2" >
                                    <div class="form-group">
                                    ...
                                    <asp:GridView ID="GridView1" runat="server" OnRowCommand="GridView1_RowCommand" AutoGenerateColumns="false" CssClass="datatable table table-striped table-bordered table-hover"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="FAT">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblFat" runat="server" Text='<%# Eval("Fat_percent") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="SNF">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblSnf" runat="server" Text='<%# Eval("Snf_percent") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>

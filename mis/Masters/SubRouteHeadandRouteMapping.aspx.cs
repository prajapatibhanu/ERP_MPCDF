...
public partial class mis_Masters_SubRouteHeadandRouteMapping : System.Web.UI.Page
{
    ...
    protected void FillRouteHead()
    {
        try
        {
            ddlSubHeadRoute.DataTextField = "SubRouteHeadName";
            ddlSubHeadRoute.DataValueField = "SubRouteHeadId";
            ddlSubHeadRoute.DataSource = objdb.ByProcedure("USP_Mst_SubRouteHead", new string[] { "Flag", "Office_ID" },
                        new string[] { "1", objdb.Office_ID() }, "dataset");
            ddlSubHeadRoute.DataBind();
            ddlSubHeadRoute.Items.Insert(0, new ListItem("Select", "0"));
    ...
    protected void FillSearchSubRouteHead()
    {
        try
        {
            ddlSearchSubRouteHead.DataTextField = "SubRouteHeadName";
            ddlSearchSubRouteHead.DataValueField = "SubRouteHeadId";
            ddlSearchSubRouteHead.DataSource = objdb.ByProcedure("USP_Mst_SubRouteHead", new string[] { "Flag", "Office_ID" },
                        new string[] { "1", objdb.Office_ID() }, "dataset");
            ddlSearchSubRouteHead.DataBind();
            ddlSearchSubRouteHead.Items.Insert(0, new ListItem("All", "0"));
    ...
    private void GetRoute()
    {
        try
        {
            ...
            ddlRoute.DataSource = objdb.ByProcedure("USP_Mst_SubRouteHeadandRouteMapping",
    ...
    protected void RouteHeadandRouteMappingDetails()
    {
        try
        {
            ...
            GridView1.DataSource = objdb.ByProcedure("USP_Mst_SubRouteHeadandRouteMapping",
                         new string[] { "flag", "Office_ID", "SubRouteHeadId", "ItemCat_id" },
                        new string[] { "3", objdb.Office_ID(), ddlSearchSubRouteHead.SelectedValue, ddlSearchItemCategory.SelectedValue }, "dataset");
            GridView1.DataBind();
            GetDatatableHeaderDesign();
            ...
            if (e.CommandName == "RecordDelete")
            {
                if (ViewState["UPageTokan"].ToString() == Session["PageTokan"].ToString())
                {
                    ...
                    if (ctrl != null)
                    {
                        ...
                        lblMsg.Text = string.Empty;
                        ds6 = objdb.ByProcedure("USP_Mst_SubRouteHeadandRouteMapping",
                                    new string[] { "flag", "SubRouteHeadandRouteId", "CreatedBy", "CreatedByIP", "IsActive" },
    ...
    private void InsertSSDistMapping()
    {
        try
        {
            if (ViewState["UPageTokan"].ToString() == Session["PageTokan"].ToString())
            {
                ...
                {
                    string IPAddress = Request.ServerVariables["REMOTE_ADDR"];
                    ds5 = objdb.ByProcedure("USP_Mst_SubRouteHeadandRouteMapping",
                              new string[] { "flag", "SubRouteHeadId", "ItemCat_id", "AreaId", "Office_ID", "CreatedBy", "CreatedByIP" },
                             new string[] { "2", ddlSubHeadRoute.SelectedValue, ddlItemCategory.SelectedValue, ddlLocation.SelectedValue, objdb.Office_ID(), objdb.createdBy(), IPAddress },
                               new string[] { "type_SubRouteHeadandRouteMapping" },
    ...
    protected void btnClear_Click(object sender, EventArgs e)
    {
        ...
        GetDatatableHeaderDesign();
        ddlSubHeadRoute.SelectedIndex = 0;

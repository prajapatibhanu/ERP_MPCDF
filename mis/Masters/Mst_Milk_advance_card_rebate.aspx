<%@ Page Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="Mst_Milk_advance_card_rebate.aspx.cs" Inherits="mis_Masters_Mst_Milk_advance_card_rebate" %>
                ...
                <div class="col-md-12">
                    <div class="box box-Manish">
                        <div class="box-header">
                            <h3 class="box-title">Set Advance Card Rebate </h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            <fieldset>

                                <legend>Set Advance Card Rebate </legend>
                                <div class="row">
                                    <div class="col-lg-12">
                                ...
                                <div class="row" id="pnlproduct" runat="server" visible="false">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Item Name">
                                            <ItemTemplate>
                                                 <%--<asp:Label ID="lblProductRateTypeName" runat="server" Text='<%# Eval("ProductRateTypeName") %>'></asp:Label>--%> 
                                                  <asp:Label ID="lblItemRebate_id" Visible="false" runat="server" Text='<%# Eval("MorP_Advancedcard_Rebate_Id") %>'></asp:Label>                                                 
                                        ...
                                        <asp:TemplateField HeaderText="Rebate Amount">
                                            <ItemTemplate>
                                                <asp:TextBox ID="txtRebate_Amount" Text='<%# Eval("Rebate_Amount") %>' onkeypress="return validateDecTwoplace(this,event)"  Width="100%" MaxLength="10" onpaste="return false;" placeholder="Enter Rebate Amount" runat="server" autocomplete="off" CssClass="form-control"  ClientIDMode="Static"></asp:TextBox>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <%-- <asp:TemplateField>
                                              <HeaderTemplate>
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <asp:Button runat="server" CssClass="btn btn-primary" ValidationGroup="a" ID="btnSubmit" OnClick="btnSubmit_Click"  OnClientClick="return ValidatePage();" AccessKey="S" />
                                    </div>
                                </div>
                            </div>
                            </fieldset>

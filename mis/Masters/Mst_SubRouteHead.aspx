<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="Mst_SubRouteHead.aspx.cs" Inherits="mis_Masters_Mst_SubRouteHead" %>
        ...
        <section class="content">
            ...
            <div class="box box-Manish">
                <div class="box-header">
                    <h3 class="box-title">Sub Route Head Master</h3>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="form-group">
                                <label>Sub Route Head Name<span style="color: red;"> *</span></label>
                                <span class="pull-right">
                                    <asp:RequiredFieldValidator ID="rfv1" ValidationGroup="a"
                                        ErrorMessage="Enter Route Head Name" Text="<i class='fa fa-exclamation-circle' title='Enter Route Head Name !'></i>"
                                        ControlToValidate="txtSubRouteHeadName" ForeColor="Red" Display="Dynamic" runat="server">
                                    </asp:RequiredFieldValidator></span>
                                <asp:TextBox runat="server" autocomplete="off" CssClass="form-control" ID="txtSubRouteHeadName" placeholder="Enter Sub Route Head Name" ClientIDMode="Static"></asp:TextBox>
                            </div>
                        </div>
                ...
                <div class="col-md-12">
                    <div class="box box-Manish">
                        <div class="box-header">
                            <h3 class="box-title">Sub Route Head Master Registration Details</h3>
                        </div>
                        <div class="box-body">
                            <div class="row">
                                  <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList ID="ddlSubRouteHead" runat="server" CssClass="form-control select2">
                                            </asp:DropDownList>
                                        </div>
                                ...
                                <div class="col-md-12">
                                    <div class="table-responsive">
                                        <asp:GridView ID="GridView1" OnRowCommand="GridView1_RowCommand" runat="server" AutoGenerateColumns="false" CssClass="datatable table table-striped table-bordered table-hover"
                                            EmptyDataText="No Record Found." DataKeyNames="SubRouteHeadId">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Action">
                                                    <ItemTemplate>
                                                        <asp:LinkButton ID="lnkUpdate" CommandName="RecordUpdate" CommandArgument='<%#Eval("SubRouteHeadId") %>' runat="server" ToolTip="Update"><i class="fa fa-pencil"></i></asp:LinkButton>
                                                        &nbsp;&nbsp;&nbsp;
                                            &nbsp;&nbsp;&nbsp;<asp:LinkButton ID="lnkDelete" CommandArgument='<%#Eval("SubRouteHeadId") %>' CommandName="RecordDelete" runat="server" ToolTip="Delete" Style="color: red;" OnClientClick="return confirm('Are you sure to Delete?')"><i class="fa fa-trash"></i></asp:LinkButton>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        </asp:GridView>

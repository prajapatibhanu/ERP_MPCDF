<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="Mst_MorPItemSection.aspx.cs" Inherits="mis_Masters_Mst_MorPItemSection" %>
            ...
            <div class="col-md-6">
                 <div class="box box-Manish">
                    ...
                    <div class="box-header">
                        <h3 class="box-title">Item Section Master </h3>
                    </div>
                    <!-- /.box-header -->
                    <div class="card-body">
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <span class="pull-right">
                                        <asp:RequiredFieldValidator ID="rfv1" ValidationGroup="a"
                                            ErrorMessage="Enter Section Name" Text="<i class='fa fa-exclamation-circle' title='Enter Section Name !'></i>"
                                            ControlToValidate="txtSectionName" ForeColor="Red" Display="Dynamic" runat="server">
                                        </asp:RequiredFieldValidator>
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator4" ValidationGroup="a" Display="Dynamic" runat="server" ControlToValidate="txtSectionName"
                                    ...
                                    <asp:TextBox ID="txtSectionName" CssClass="form-control" MaxLength="100" runat="server"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-md-4">
                            <div class="form-group">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <asp:GridView ID="GridView1" runat="server" OnRowCommand="GridView1_RowCommand" AutoGenerateColumns="false" CssClass="datatable table table-striped table-bordered table-hover"
                                        EmptyDataText="No Record Found." DataKeyNames="MOrPSection_id">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Section Name">
                                             ...
                                             <asp:TemplateField HeaderText="Sequence No">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblSequenceNo" runat="server" Text='<%# Eval("SequenceNo") %>' />
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            ...
                                            <asp:TemplateField HeaderText="Actions">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnkUpdate" CommandName="RecordUpdate" CommandArgument='<%#Eval("MOrPSection_id") %>' runat="server" ToolTip="Update"><i class="fa fa-pencil"></i></asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                    </asp:GridView>

<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="MilkItemRateMaster.aspx.cs" Inherits="mis_Masters_MilkItemRateMaster" %>
        ...
        <section class="content">
            ...
            <div class="box box-success">
                <div class="box-header">
                    <h3 class="box-title">Item Rate Master </h3>
                </div>
                ...
                <div class="box-body">
                    ...
                    <div class="box box-Manish">
                        <div class="box-header">
                            <h3 class="box-title">Item Rate Details</h3>
                        </div>
                        <!-- /.box-header -->
                        <div class="box-body">
                            ...
                            <div class="row">
                                <div class="table-responsive">
                                    ...
                                    <asp:GridView ID="gvItemSaleRate" DataKeyNames="ItemSaleRate_Id" runat="server" EmptyDataText="No records Found" AutoGenerateColumns="false" CssClass="datatable table table-striped table-bordered table-hover">
                                        <Columns>
                                            <asp:TemplateField HeaderText="S.No.">
                                                <ItemTemplate>
                                                    <%#Container.DataItemIndex+1 %>
                                                    <asp:Label ID="lblItemSaleRate_Id" runat="server" Text='<%#Eval("ItemSaleRate_Id") %>' Visible="false"></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>

<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="MPR_Of_TS_Allocated_expenses.aspx.cs" Inherits="mis_DCSInformationSystem_MPR_Of_TS_Allocated_expenses" %>
        ...
        <section class="content">
            ...
            <div class="box box-body">
                <div class="box-header">
                    <h3 class="box-title">Allocated Expenses</h3>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <asp:Label ID="lblMsg" runat="server"></asp:Label>
                              <asp:Label ID="lblAE_id" Visible="false" runat="server"></asp:Label>
                        </div>
                    </div>
                    <%--<fieldset>
                            ...
                            <fieldset>
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <span class="pull-right">
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ValidationGroup="a"
                                            ErrorMessage="Please select Month" ForeColor="Red" Text="<i class='fa fa-exclamation-circle' title='Enter DCS Code !'></i>"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <span class="pull-right">
                                            ...
                                            ErrorMessage="Please Select Year" ForeColor="Red" Text="<i class='fa fa-exclamation-circle' title='Enter DCS Code !'></i>"
                                            ...
                                            <asp:GridView runat="server" ID="gvtanker" CssClass="table table-bordered" OnDataBound="gvtanker_DataBound" ShowHeader="true" ShowFooter="false" AllowPaging="false" AutoGenerateColumns="false" OnRowDeleting="gvtanker_RowDeleting">
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText=" Road">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtRoad" Text='<%# Eval("Road").ToString()%>' runat="server" Height="10%"  class="form-control" />
                                                          <asp:RequiredFieldValidator ID="rfvRoad" ValidationGroup="a"
                                                    ErrorMessage="Enter Road" ForeColor="Red" Text="<i class='fa fa-exclamation-circle' title='Enter Road !'></i>"
                                                    ControlToValidate="txtRoad" Display="Dynamic" runat="server">
                                                </asp:RequiredFieldValidator>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Permit">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtPermit" Text='<%# Eval("Permit").ToString()%>' runat="server" Height="10%"  class="form-control" />
                                                        <asp:RequiredFieldValidator ID="rfvPermit" ValidationGroup="a"
                                                    ErrorMessage="Enter Permit" ForeColor="Red" Text="<i class='fa fa-exclamation-circle' title='Enter Permit !'></i>"
                                                    ControlToValidate="txtPermit" Display="Dynamic" runat="server">
                                                </asp:RequiredFieldValidator>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    ...
                                                    <asp:TemplateField HeaderText="Insurance">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtInsurance" Text='<%# Eval("Insurance").ToString()%>' runat="server" class="form-control" />
                                                       <asp:RequiredFieldValidator ID="rfvInsurance" ValidationGroup="a"
                                                    ErrorMessage="Enter Insurance" ForeColor="Red" Text="<i class='fa fa-exclamation-circle' title='Enter Insurance !'></i>"
                                                    ControlToValidate="txtInsurance" Display="Dynamic" runat="server">
                                                </asp:RequiredFieldValidator>
                                                             </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Tyre">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtTyre" Text='<%# Eval("Tyre").ToString()%>' runat="server" class="form-control" MaxLength="10" />
                                                       <asp:RequiredFieldValidator ID="rfvTyre" ValidationGroup="a"
                                                    ErrorMessage="Enter Tyre" ForeColor="Red" Text="<i class='fa fa-exclamation-circle' title='Enter Tyre !'></i>"
                                                    ControlToValidate="txtTyre" Display="Dynamic" runat="server">
                                                </asp:RequiredFieldValidator>
                                                             </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Battery">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtBattery" Text='<%# Eval("Battery").ToString()%>' runat="server" class="form-control" />
                                                       <asp:RequiredFieldValidator ID="rfvBattery" ValidationGroup="a"
                                                    ErrorMessage="Enter Battery" ForeColor="Red" Text="<i class='fa fa-exclamation-circle' title='Enter Battery !'></i>"
                                                    ControlToValidate="txtBattery" Display="Dynamic" runat="server">
                                                </asp:RequiredFieldValidator>
                                                             </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:TemplateField HeaderText="Major Repairs">
                                                        <ItemTemplate>
                                                            <asp:TextBox ID="txtMajorRepairs" Text='<%# Eval("MajorRepairs").ToString()%>' runat="server" class="form-control" ClientIDMode="Static" MaxLength="9"  />
                                                       <asp:RequiredFieldValidator ID="rfvMajorRepairs" ValidationGroup="a"
                                                    ErrorMessage="Enter Major Repairs" ForeColor="Red" Text="<i class='fa fa-exclamation-circle' title='Enter Major Repairs !'></i>"
                                                    ControlToValidate="txtMajorRepairs" Display="Dynamic" runat="server">
                                                </asp:RequiredFieldValidator>
                                                             </ItemTemplate>
                                                    </asp:TemplateField>
                                ...
                                <div class="row" id="divbutton" runat="server" visible="false">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <a class="btn btn-block btn-default" href="MPR_Of_TS_Allocated_expenses.aspx">Clear</a>
                                        </div>
                                    </div>
                                </div>
            ...
            <div class="box box-body" >
                <div class="box-header">
                    <h3 class="box-title"> Allocated Expenses Detail</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    <div class="table-responsive">
                         ...
                         <asp:Button runat="server" BackColor="#2e9eff" CssClass="btn btn-success" Text="Search" ID="btnSearch" OnClick="btnSearch_Click" Style="margin-top: 20px; width: 80px;" />
                                ...
                                <div class="col-md-12">
                        <asp:GridView runat="server" ID="gvAEdetail" Visible="false"  CssClass="table table-bordered"   ShowHeader="true" ShowFooter="false" AllowPaging="false" AutoGenerateColumns="false"  OnRowCommand="gvAEdetail_RowCommand" >
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="ID" Visible="false">
                                                        <ItemTemplate>
                                                               <asp:Label Visible="false" ID="lblAE_Id" Text='<%# Eval("AE_Id").ToString()%>' runat="server" />
                                                  ...
                                                  <asp:TemplateField HeaderText="Creation Date">
                                                    ...
                                                    <asp:TemplateField HeaderStyle-Width="60px" ItemStyle-CssClass="text-center" Visible="true">
                                                                    <ItemTemplate>
                                                                        <asp:ImageButton ID="EDIT" runat="server" Width="100%" CausesValidation="False"  ImageUrl="~/mis/image/edit.png" CommandName="select" CommandArgument='<%# Bind("AE_Id") %>'></asp:ImageButton>
                                                                    </ItemTemplate>
                                                     </asp:TemplateField>

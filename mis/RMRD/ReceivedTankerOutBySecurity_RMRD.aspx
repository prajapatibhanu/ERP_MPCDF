<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="ReceivedTankerOutBySecurity_RMRD.aspx.cs" Inherits="mis_RMRD_ReceivedTankerOutBySecurity_RMRD" %>
                ...
                <div class="box-body">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Sample No.">
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:Label ID="lblChallanNo" runat="server" Text='<%# Eval("V_SampleNo") %>'></asp:Label>
                                                    </ItemTemplate>
                                                    <FooterTemplate>
                                                        <b>Grand Total</b>
                                                    </FooterTemplate>
                    ...
                    <fieldset id="fs_action" runat="server" visible="false">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-1">
                                <div class="form-group">
                                    <a class="btn btn-default" style="margin-top: 20px;" href="ReceivedTankerOutBySecurity_RMRD.aspx">Clear</a>
                                </div>
                            </div>
                        </div>
                    </fieldset>
                            ...
                            <asp:GridView ID="gv_TodayReceivedTankerDetails" ShowHeader="true" EmptyDataText="No Record Found" EmptyDataRowStyle-ForeColor="Red" AutoGenerateColumns="false" CssClass="table table-bordered" runat="server">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Challan No/Status">
                                        <ItemTemplate>
                                            <asp:Label ID="lblChallan_No" runat="server" Text='<%# Eval("V_SampleNo") %>'></asp:Label>
                                            <asp:Label ID="lbltcs" ForeColor="Red" Font-Bold="true" runat="server" Text='<%# Eval("V_SampleNo").ToString() == "" ? "Pending" : "" %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

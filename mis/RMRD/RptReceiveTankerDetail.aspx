<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="RptReceiveTankerDetail.aspx.cs" Inherits="mis_MilkCollection_mcms_home" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentBody" runat="Server">
    <div class="content-wrapper">
        <section class="content">
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <asp:GridView runat="server" ID="gvReceivedEntry" CssClass="table table-bordered" AutoGenerateColumns="false" ShowHeaderWhenEmpty="true" ShowHeader="true" EmptyDataText="No Record Found." OnRowCommand="gvDispatchEntry_RowCommand">
                                <Columns>
                                    <asp:BoundField DataField="DT_TankerArrivalDate" DataFormatString="{0:dd-MMM-yyyy}" HeaderText="Date" />
                                    ...
                                    <asp:BoundField DataField="DT_TankerArrivalDate" DataFormatString="{0:hh:mm tt}" HeaderText="Arrival Time" />
                                    <asp:BoundField DataField="V_MilkType" HeaderText="Milk Type" />
                                    <asp:BoundField DataField="D_NetWeight" HeaderText="Milk Quantity (In KG)" />
									<asp:BoundField DataField="V_VehicleType" HeaderText="Tanker Type" />
                                   <asp:BoundField DataField="TotalSeal" HeaderText="Total Seals" />
                                    <asp:TemplateField HeaderText="More Info">
                                        <ItemTemplate>
                                            <asp:LinkButton ID="LinkButton1" Style="padding: 3px; border-radius: 3px;" CommandArgument='<%# Eval("BI_MilkInOutRMRDRefID") %>' CommandName="ViewEntry" runat="server"  Text="View" CssClass="label label-warning"></asp:LinkButton>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                </Columns>
                            </asp:GridView>
            ...
            <div class="modal fade" id="RMRD_QCDetails" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="myModalLabel"><span style="font-size: medium;">Reference No. :</span>
                                    ...
                                    <asp:GridView ID="gvQCDetailsForDS" runat="server" CssClass="table table-bordered" Width="100%" AutoGenerateColumns="false" EmptyDataRowStyle-ForeColor="Red" EmptyDataText="No Data Found">
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="Seal Location">
                                             ...
                                             <asp:BoundField DataField="Office_Name" HeaderText="Received From" />

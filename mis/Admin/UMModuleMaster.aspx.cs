...
public partial class mis_Admin_UMModuleMaster : System.Web.UI.Page
{
    DataSet ds;
                ...
                if (btnSave.Text == "Save" && ViewState["Module_ID"].ToString() == "0" && ds.Tables[0].Rows.Count == 0)
                    {
                        ...
                        new string[] { "flag", "Module_IsActive", "Module_Name", "Module_UpdatedBy" },
                        new string[] { "0", Module_IsActive, txtModule_Name.Text.Trim(), ViewState["Emp_ID"].ToString() }, "dataset");
                    ...
                    {
                        objdb.ByProcedure("SpUMModuleMaster",
                        new string[] { "flag", "Module_ID", "Module_Name", "Module_UpdatedBy" },
                        new string[] { "5", ViewState["Module_ID"].ToString(), txtModule_Name.Text.Trim(), ViewState["Emp_ID"].ToString() }, "dataset");
    ...
    protected void chkSelect_CheckedChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            objdb.ByProcedure("SpUMModuleMaster",
                       new string[] { "flag", "Module_IsActive", "Module_ID", "Module_UpdatedBy" },
                       new string[] { "6", Module_IsActive, Module_ID, ViewState["Emp_ID"].ToString() }, "dataset");
        }
        catch (Exception ex)
        {
            lblMsg.Text = objdb.Alert("fa-ban", "alert-danger", "Sorry!", ex.Message.ToString());

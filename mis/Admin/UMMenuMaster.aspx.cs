...
public partial class mis_Admin_UMMenuMaster : System.Web.UI.Page
{
    DataSet ds;
        ...
        try
        {
            ...
            if (msg.Trim() == "")
            {
                ...
                if (btnSave.Text == "Save" && ViewState["Menu_ID"].ToString() == "0" && ds.Tables[0].Rows.Count == 0)
                {
                    ...
                    new string[] { "flag", "Menu_IsActive", "Menu_Name", "Module_ID", "Menu_Icon", "OrderBy", "Menu_UpdatedBy" },
                    new string[] { "0", Menu_IsActive, txtMenu_Name.Text.Trim(), ddlModule_Name.SelectedValue, Menu_Icon, txtOrderBy.Text.Trim(), ViewState["Emp_ID"].ToString() }, "dataset");
                ...
                {
                    objdb.ByProcedure("SpUMMenuMaster",
                    new string[] { "flag", "Menu_ID", "Menu_Name", "Module_ID", "Menu_Icon", "OrderBy", "Menu_UpdatedBy" },
                    new string[] { "7", ViewState["Menu_ID"].ToString(), txtMenu_Name.Text.Trim(), ddlModule_Name.SelectedValue, Menu_Icon, txtOrderBy.Text.Trim(), ViewState["Emp_ID"].ToString() }, "dataset");
    ...
    protected void chkSelect_CheckedChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            objdb.ByProcedure("SpUMMenuMaster",
                       new string[] { "flag", "Menu_IsActive", "Menu_ID", "Menu_UpdatedBy" },
                       new string[] { "8", Menu_IsActive, Menu_ID, ViewState["Emp_ID"].ToString() }, "dataset");
        }
        catch (Exception ex)
        {
            lblMsg.Text = objdb.Alert("fa-ban", "alert-danger", "Sorry!", ex.Message.ToString());

        ...
        <section class="content">
            ...
            <div class="box box-Manish">
                ...
                <div class="box-header">
                    <h3 class="box-title">HSN Master</h3>
                </div>
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtHSNCode" runat="server" placeholder="HSN/SAC Code" CssClass="form-control"></asp:TextBox>
                            </div>
                        </div>
                        ...
                        <%--<div class="col-md-3">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddlTaxability" runat="server" CssClass="form-control select2" AutoPostBack="true" OnSelectedIndexChanged="ddlTaxability_SelectedIndexChanged">
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <div class="form-group">
                                <asp:Button ID="btnSave" runat="server" CssClass="btn btn-block btn-primary" Text="Save" OnClick="btnSubmit_Click" OnClientClick="return validateform();" />
                            </div>
                        </div>
                        <div class="col-md-2">
                            <div class="form-group">
                    ...
                    <asp:GridView ID="GridView1" DataKeyNames="HSN_ID" runat="server" class="datatable table table-hover table-bordered" ShowHeaderWhenEmpty="True" AutoGenerateColumns="False" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
                        <Columns>
                            ...
                            <%--<asp:BoundField DataField="HSN_EffectiveDate" HeaderText="HSN/SAC Effective Date" />--%>

...
public partial class mis_Admin_UMFormMaster : System.Web.UI.Page
{
    DataSet ds;
        ...
        try
        {
            ...
            if (msg.Trim() == "")
            {
                ...
                if (btnSave.Text == "Save" && ViewState["Form_ID"].ToString() == "0" && ds.Tables[0].Rows.Count == 0)
                {
                    ...
                    new string[] { "flag", "Form_IsActive", "Form_Name", "Module_ID", "Form_Path", "OrderBy", "Form_UpdatedBy" },
                    new string[] { "0", Form_IsActive, txtForm_Name.Text.Trim(), ddlModule_Name.SelectedValue, txtForm_Path.Text.Trim(), txtOrderBy.Text.Trim(), ViewState["Emp_ID"].ToString() }, "dataset");
                ...
                {
                    objdb.ByProcedure("SpUMFormMaster",
                    new string[] { "flag", "Form_ID", "Form_Name", "Module_ID", "Form_Path", "OrderBy", "Form_UpdatedBy" },
                    new string[] { "7", ViewState["Form_ID"].ToString(), txtForm_Name.Text.Trim(), ddlModule_Name.SelectedValue, txtForm_Path.Text.Trim(), txtOrderBy.Text.Trim(), ViewState["Emp_ID"].ToString() }, "dataset");
    ...
    protected void chkSelect_CheckedChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            objdb.ByProcedure("SpUMFormMaster",
                       new string[] { "flag", "Form_IsActive", "Form_ID", "Form_UpdatedBy" },
                       new string[] { "8", Form_IsActive, Form_ID, ViewState["Emp_ID"].ToString() }, "dataset");
        }
        catch (Exception ex)
        {
            lblMsg.Text = objdb.Alert("fa-ban", "alert-danger", "Sorry!", ex.Message.ToString());

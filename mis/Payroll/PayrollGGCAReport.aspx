<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="PayrollGGCAReport.aspx.cs" Inherits="mis_Payroll_PayrollEDLIRenewReport" %>
        ...
        <section class="content">
            <div class="box box-success">
                <div class="box-header">
                    <h3 class="box-title">GGCA Renewal Report</h3>
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <asp:GridView ID="GridView1" PageSize="50" runat="server" class="datatable table table-hover table-bordered table-striped" ShowHeaderWhenEmpty="true" ClientIDMode="Static" AutoGenerateColumns="TRUE">
                                <Columns>

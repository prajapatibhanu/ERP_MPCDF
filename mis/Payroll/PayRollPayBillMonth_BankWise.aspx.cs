...
public partial class mis_Payroll_PayRollPayBillMonth_BankWise : System.Web.UI.Page
{
    ...
    protected void GetOfficeDetails()
    {
        try
        {
            ds3 = objdb.ByProcedure("USP_Trn_MilkOrProductDemandForSupply", new string[] { "flag", "Office_ID" }, new string[] { "9", Session["Office_ID"].ToString() }, "dataset");
    ...
    protected void FillBank()
    {
        try
        {
            ...
            ds = objdb.ByProcedure("SpPayrollSalaryDetail", new string[] { "flag", "Office_ID", "Month", "Year" }, new string[] { "39", ddlOffice.SelectedValue, ddlMonth.SelectedValue.ToString(), ddlFinancialYear.SelectedValue }, "dataset");
            if (ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
            {
    ...
    private void GetMonthlyPayBillBankwise(string bn)
    {
        try
        {
            ...
            ds5 = objdb.ByProcedure("SpPayrollSalaryDetail",
                new string[] { "flag", "Office_ID", "Salary_Year", "Salary_Month", "Emp_TypeOfPost", "Bank_Name" },
                new string[] { "40", ddlOffice.SelectedValue.ToString(), ddlFinancialYear.SelectedValue.ToString(), 
                    ddlMonth.SelectedValue.ToString(), ddlEmp_TypeOfPost.SelectedValue.ToString(),bn.ToString() }, "dataset");
            ...
            if (ds5.Tables[0].Rows.Count > 0)
            {
                ...
                sb.Append("</tr>");
                sb.Append("<tr>");
                sb.Append("<td colspan='3' style='text-align: left;border:1px solid black;'>Bank :<b>" + bn + "</b></td>");

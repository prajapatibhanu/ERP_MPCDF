<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="PayRollPayBillMonth_BankWise.aspx.cs" Inherits="mis_Payroll_PayRollPayBillMonth_BankWise" %>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-success">
                        <div class="box-header with-border">
                            <h3 class="box-title" id="Label1">Monthly Pay Bill Bankwise</h3>
                        </div>

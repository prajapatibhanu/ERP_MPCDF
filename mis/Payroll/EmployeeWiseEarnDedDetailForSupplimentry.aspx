<%@ Page Language="C#" AutoEventWireup="true" CodeFile="EmployeeWiseEarnDedDetailForSupplimentry.aspx.cs" Inherits="mis_Payroll_EmployeeWiseEarnDedDetailForSupplimentry" %>
                ...
                <section class="content watermark" id="DivSlip" runat="server" style="padding-top: 0px; height: 60px;">
                    ...
                    <div class="box box-default">
                        ...
                        &nbsp;&nbsp; MP STATE CO OPERATIVE DAIRY FEDERATION<br />
							<br>
                                <span id="subheading-salary">Supplementary Earning Deduction Detail</span></h3>
                        </div>
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-12">

<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="PayrollEmpArrearDetail.aspx.cs" Inherits="mis_Payroll_PayrollEmpArrearDetail" %>
        ...
        <section class="content">
            ...
            <div class="box box-success">
                <div class="box-header">
                    <h3 class="box-title">Arrear Detail</h3>
                </div>
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <asp:DropDownList ID="ddlSearchYear" runat="server" CssClass="form-control"></asp:DropDownList>
                            </div>
                        </div>
                         <div class="col-md-3">
                            <div class="form-group">
                                <label>Arrear Type<span style="color: red;">*</span></label>
                                <asp:DropDownList ID="ddlArrearType" runat="server" CssClass="form-control">
                                       <asp:ListItem Value="0">Select</asp:ListItem>
                                       <asp:ListItem Value="1">Salary Arrear</asp:ListItem>
                                    <asp:ListItem Value="2">DA Arrear</asp:ListItem>
                                     <asp:ListItem Value="3">Increment Arrear</asp:ListItem>
                                     <asp:ListItem Value="4">Medical Reimbursement Arrear</asp:ListItem>
                                    <asp:ListItem Value="5">Overtime Arrear</asp:ListItem>
                                </asp:DropDownList>
                            </div>
                              </div>
                        <div class="col-md-2">
                    ...
                    <div id="DivDetail" runat="server">
                                ...
                                <fieldset>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtOrderNo" runat="server" CssClass="form-control" placeholder="Oredr No."></asp:TextBox>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                        ...
                        <div class="row">
                            <div class="col-md-8" style="color: teal;">
                                <asp:CheckBox ID="chkFullSalary" runat="server" CssClass="checkboxarrear" Checked="false" Text="&nbsp;&nbsp;<small> कृपया इस चेकबॉक्स को चेक करे , यदि यह पूरे महीने की सैलरी है |</small>" />
                            </div>
                            <div class="col-md-2">
            ...
            <div class="box box-success">
                <div class="box-header">
                    <h3 class="box-title">Arrear Paid Detail</h3>
                </div>
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="table-responsive">
                               <asp:GridView ID="GridView1" DataKeyNames="EmpArrearID" OnRowCommand="GridView1_RowCommand" runat="server" class="table table-bordered table-striped" AutoGenerateColumns="False">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Arrear Type">
                                            <ItemTemplate>
                                                <asp:Label ID="lblArrearTypeName" runat="server" Text='<%# Eval("ArrearTypeName").ToString()%>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="From Year">
                                            <ItemTemplate>
                                                <asp:Label ID="lblFromYear" runat="server" Text='<%# Eval("FromYear").ToString()%>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="To Year">
                                            <ItemTemplate>
                                                <asp:Label ID="lblToYear" runat="server" Text='<%# Eval("ToYear").ToString()%>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Order Date">
                                            <ItemTemplate>
                                                <asp:Label ID="lblOrderDate" runat="server" Text='<%# Eval("OrderDate").ToString()%>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Arrear Earning">
                                            <ItemTemplate>
                                                <asp:Label ID="lblTotalEarning" runat="server" Text='<%# Eval("TotalEarning").ToString()%>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Arrear Deduction">
                                            <ItemTemplate>
                                                <asp:Label ID="lblTotalDeduction" runat="server" Text='<%# Eval("TotalDeduction").ToString()%>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Arrear Net Payment Amount">
                                            <ItemTemplate>
                                                <asp:Label ID="lblNetPaymentAmount" runat="server" Text='<%# Eval("NetPaymentAmount").ToString()%>'></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Earn Deduction Detail">
                                            <ItemTemplate>
                                                ...
                                                <asp:LinkButton ID="lnkDelete" CommandArgument='<%#Eval("EmpArrearID") %>' CommandName="RecordDelete" Text="Delete" CssClass="label label-danger" runat="server" ToolTip="Delete" OnClientClick="return confirm('Are you sure to Delete?')"></asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                    </Columns>
                                </asp:GridView>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentFooter" runat="Server">
    <script type="text/javascript">
        ...
        function validateSearch() {
            ...
            if (document.getElementById('<%=ddlSearchYear.ClientID%>').selectedIndex == 0) {
                msg = msg + "Select Year. \n";
            }

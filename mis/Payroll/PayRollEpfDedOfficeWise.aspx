<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="PayRollEpfDedOfficeWise.aspx.cs" Inherits="mis_Payroll_PayRollEpfDedOfficeWise" %>
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label>&nbsp;</label>
                                        <a href="PayRollEpfDedOfficeWise.aspx" class="btn btn-block btn-default">Clear</a>
                                    </div>
                                    ...
                                    <asp:GridView ID="GridView1" runat="server" class="datatable table table-hover table-bordered pagination-ys" AutoGenerateColumns="False" ShowHeaderWhenEmpty="true"  ShowFooter="true">
                                        <Columns>
                                          ...
                                          <%--  <asp:BoundField DataField="Salary_EarningTotal" HeaderText="GROSS_WAGES" />--%>
                                            <asp:BoundField DataField="EPFWAGES" HeaderText="TOTAL WAGES" />
                                          <%--  <asp:BoundField DataField="EPS_WAGES" HeaderText="EPS_WAGES" />--%>
                                           <%-- <asp:BoundField DataField="EDLI_WAGES" HeaderText="EDLI_WAGES" />--%>
                                            <asp:BoundField DataField="EPF" HeaderText="TOTAL EPF EMPLOYEES" />
                                             <asp:BoundField DataField="REFUND_OF_ADVANCES" HeaderText="TOTAL A.D.A." />
                                             <asp:BoundField DataField="EPF_EPS_DIFF_REMITTED" HeaderText="TOTAL EPF EMPLOYERS" />
                                            <asp:BoundField DataField="EPS_CONTRI_REMITTED" HeaderText="PENSION EMPLOYERS" />

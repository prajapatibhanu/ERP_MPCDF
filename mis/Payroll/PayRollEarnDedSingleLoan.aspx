<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="PayRollEarnDedSingleLoan.aspx.cs" Inherits="mis_Payroll_PayRollEarnDedSingleLoan" %>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-success">
                        <div class="box-header with-border">
                            <div class="row">
                                <div class="col-md-10">
                                    <h3 class="box-title" id="Label1">Set Single Head Earning/Deduction &nbsp;&nbsp;&nbsp; <small style="padding:2px; background:yellow"><a href="PayRollEarnDedSingleLoanAuto.aspx" target="_blank">Click Here Auto Transfer Loan Balance</a></small></h3>
                                </div>
                            </div>
                        </div>

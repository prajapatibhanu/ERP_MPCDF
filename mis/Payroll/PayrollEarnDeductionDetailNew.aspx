<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="PayrollEarnDeductionDetailNew.aspx.cs" Inherits="mis_Payroll_PayrollEarnDeductionDetailNew" %>
                    ...
                    <div class="row" runat="server" id="divDetail">
                        ...
                        <div class="col-md-12">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    <asp:GridView ID="GridView1" runat="server" class="table table-bordered table-striped Grid" AutoGenerateColumns="False" AllowPaging="false" DataKeyNames="ID_1">
                                        <Columns>
                                ...
                                <div class="box-body">
                                    <asp:GridView ID="GridView2" runat="server" class="table table-bordered table-striped Grid" AutoGenerateColumns="False" AllowPaging="false" DataKeyNames="ID_1" ShowFooter="true">
                                        <Columns>
                                            <asp:TemplateField HeaderText="SNo." ItemStyle-Width="10">
                                                <ItemTemplate>

<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="PayRollEarnDedSingleOther.aspx.cs" Inherits="mis_Payroll_PayRollEarnDedSingleOther" %>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-success">
                        ...
                        <div class="box-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div id="HeadingOFSelection" style="color: #123456; font-size: 15px;" runat="server" visible="false">

                                        <asp:Label ID="lblDeductionDetails" CssClass="lblDeductionDetails" runat="server" Text=""></asp:Label>
                                        <p></p>
                                        <p><b>Note: </b>इस हेड में सभी के लिए एक जैसी राशि रखने के लिए:-</p>
                                        <p style="color: teal">=> सभी कर्मचारियों का एक जैसा डाटा अपडेट करने क लिए निचे दिए हुए टेक्स्ट बॉक्स में डाटा/संख्या  भरें और सेव बटन में क्लिक  'Set Same Amount For All' बटन में क्लिक करें।  उदाहरण के लिए यदि इस माह किसी का भी प्रोफेशनल टैक्स  नहीं काटना है तो टेक्स्ट बॉक्स में शून्य भरकर पास के बटन को क्लिक करें। </p>

                                        <div class="row">
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <asp:TextBox ID="txtAllAmount" onkeypress="return validateNum(event)" CssClass="form-control" runat="server"></asp:TextBox>
                                                </div>
                                            </div>
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <asp:Button runat="server" CssClass="btn btn-warning btn-block" Text="Set Same Amount For All" ID="btnUpdateAll" OnClientClick="return validateform2();" OnClick="btnUpdateAll_Click" />
                                                </div>
                                            </div>
                                        </div>
                                        <p><b>Note: </b>इस हेड में सभी के लिए अलग-2 राशि रखने के लिए:-</p>
                                        <p style="color: tomato">
                                            => यदि किसी भी कर्मचारी का डाटा अपडेट करना है तो उसके सामने लगे चेक बॉक्स को चेक करें, उसके उपरांत उसमे कुछ परिवर्तन करें। और अंत में जाकर सबसे नीचे सेव बटन को क्लिक करें।  
यदि आपने चेक बॉक्स चेक नहीं किया है या सेव बटन नहीं क्लिक किया है तो , जो भी संख्या/रकम सामने प्रदर्शित होरही है वह ही वेतन में आएगी।
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="table table-responsive" style="max-height: 400px; overflow-y: scroll">
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentFooter" runat="Server">
    ...
    <script>
        ...
        function validateform2() {
            ...
            if (confirm("Do you really want to update all employees head with this amount ? you cannot roll back these values.")) {
                return true;
            }
            else {
                return false;

...
public partial class mis_Payroll_PayrollEarDedSummary : System.Web.UI.Page
{
    DataSet ds;
    ...
    protected void FillDetail()
    {
        try
        {
            ...
            ds = objdb.ByProcedure("SpPayrollSalaryFinalSummary", 
                ...
                new string[] { "0", ddlOffice.SelectedValue.ToString(), ddlFinancialYear.SelectedValue.ToString(), ddlMonth.SelectedValue.ToString() }, "dataset");

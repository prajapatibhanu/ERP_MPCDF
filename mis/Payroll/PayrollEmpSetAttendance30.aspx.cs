...
public partial class mis_Payroll_PayrollEmpSetAttendance : System.Web.UI.Page
{
    ...
    protected void FillGrid()
    {
        try
        {
            string startDateYear = ddlYear.SelectedValue.ToString();
            string startDateMonth = (int.Parse(ddlMonth.SelectedValue.ToString()) - 1).ToString();
            if (ddlMonth.SelectedItem.ToString() == "January")
            {
                startDateYear = (int.Parse(ddlYear.SelectedValue.ToString()) - 1).ToString();
                startDateMonth = "12";
            }
            ...
            ds = objdb.ByProcedure("SpPayrollEmpAttendance30", new string[] { "flag", "Year", "MonthNo", "Office_ID", "Emp_TypeOfPost" }, new string[] { "1", ddlYear.SelectedValue.ToString(), ddlMonth.SelectedValue.ToString(), ddlOfficeName.SelectedValue.ToString(), ddlEmp_TypeOfPost.SelectedValue.ToString() }, "dataset");
            if (ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
            {
                ...
                lblSelectedItems.Text = "Attendance of office <b>" + ddlOfficeName.SelectedItem.ToString() + "</b> from 16/" + startDateMonth + "/" + startDateYear + " To 15/" + ddlMonth.SelectedValue.ToString() + "/" + ddlYear.SelectedValue.ToString() + "  ( " + ddlEmp_TypeOfPost.SelectedItem.ToString() + " )";
            ...
            lblNotify.Text = "<br/>Note :- Set Attendance from 16/" + startDateMonth + "/" + startDateYear + " To 15/" + ddlMonth.SelectedValue.ToString() + "/" + ddlYear.SelectedValue.ToString();
        }
        catch (Exception ex)
        {
            lblMsg.Text = objdb.Alert("fa-ban", "alert-danger", "Sorry!", ex.Message.ToString());
            ...
            if (msg == "")
            {
                ...
                foreach (GridViewRow gr in GridView1.Rows)
                {
                    ...
                    if (chkSelect.Checked == true && lblGenerateStatus.Text == "Not Generated")
                    {
                        ...
                        objdb.ByProcedure("SpPayrollEmpAttendance30",

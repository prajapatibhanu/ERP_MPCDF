<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="PayrollFYSalaryLedger.aspx.cs" Inherits="mis_Payroll_PayrollFYSalaryLedger" %>
        ...
        <section class="content noprint">
            ...
            <div class="box box-success">
                <div class="box-header">
                    <h3 class="box-title print_hidden">Payroll Salary Ledger</h3>
                </div>

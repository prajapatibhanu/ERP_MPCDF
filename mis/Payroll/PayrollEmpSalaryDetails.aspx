<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="PayrollEmpSalaryDetails.aspx.cs" Inherits="mis_Payroll_PayrollEmpSalaryDetails" %>
                ...
                <div class="box-body">
                    ...
                    <div id="DivDetail" runat="server">
                                    ...
                                    <asp:GridView ID="GridView1" runat="server" class="table table-bordered table-striped Grid" ClientIDMode="Static" AutoGenerateColumns="False" AllowPaging="false" DataKeyNames="Emp_ID">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="UserName" HeaderText="Employee-ID" />
                                             <asp:TemplateField HeaderText="Employee Name [Attendance Status]">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblEmployeeName" runat="server" Text='<%# Eval("Emp_Name").ToString()%>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                           <%-- <asp:BoundField DataField="Emp_Name" HeaderText="Employee Name (Attendance Status)" />--%>
                                            ...
                                            <asp:TemplateField HeaderText="Basic Pay Scale" ControlStyle-CssClass="hidden" HeaderStyle-CssClass="hidden" ItemStyle-CssClass="hidden">
                                                <ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Net Salary">
                                                <ItemTemplate>
                                                    ...
                                                    <asp:Label ID="lblSalary_NoDayEarnAmt" runat="server" CssClass="hidden" Text='<%# Eval("Salary_NoDayEarnAmt").ToString()%>'></asp:Label>
                                                    <asp:Label ID="lblSalary_NoDayDeduAmt" runat="server" CssClass="hidden" Text='<%# Eval("Salary_NoDayDeduAmt").ToString()%>'></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Salary Status">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblStatus" runat="server" Text='<%# Eval("Status").ToString()%>' ForeColor="Red" />
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <asp:Button ID="btnGenerated" CssClass="btn btn-block btn-success" runat="server" Text="Generated" OnClick="btnGenerated_Click" />
                            </div>
<%--                            <div class="col-md-2">

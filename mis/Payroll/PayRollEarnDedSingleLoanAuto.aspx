<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="PayRollEarnDedSingleLoanAuto.aspx.cs" Inherits="mis_Payroll_PayRollEarnDedSingleLoanAuto" %>
                    ...
                    <div class="box box-success">
                        ...
                        <div class="box-body">
                            ...
                            <div class="row" id="pnldata" runat="server" visible="false">
                               <p style="color:red;"> नोट : </p>
                                <div class="table-responsive">
                                <div class="col-md-12">
                                    <div class="form-group">
                                       
                                    
                          <p style="font:bold;"> लोन डाटा सेव किया जा चुका है </p><span id="txtUsed" runat="server" class="ddd"></span>
                                       <%-- <asp:TextBox ID="txtUsed" CssClass="form-control" runat="server"></asp:TextBox>--%>
                                    </div>
                                </div>
                                    </div>
                                <div class="table-responsive">
                                ...
                                <p style="font:bold;">   लोन डाटा अभी सेव नहीं हुआ है  </p><span id="txtNotUsed" runat="server" class="dddd"></span>
                                       <%-- <asp:TextBox ID="txtNotUsed" CssClass="form-control" runat="server"></asp:TextBox>--%>
                                    </div>
                                </div>
                                    </div>
                            </div>
                                            ...
                                            <Columns>
                                                <asp:TemplateField>
                                                    ...
                                                    <ItemTemplate>
                                                         ...
                                                         <asp:Label ID="lblContributionType" runat="server" CssClass="hidden" Text='<%# Eval("ContributionType").ToString()%>' />
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:TemplateField HeaderText="Emploee Name" ItemStyle-Wrap="True" ControlStyle-Font-Size="Smaller" ControlStyle-Width="200px" ControlStyle-CssClass="sd">
                                                    <ItemTemplate>
                                                ...
                                                <asp:TemplateField HeaderText="Amount">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtAmount" Enabled='<%# Eval("GenStatus").ToString() == "Generated" ? false : true %>' runat="server" Text='<%# Eval("Amount") %>' CssClass="form-control txtDaRemainingArrearAmount" onkeypress="return validateNum(event)" placeholder="Amount"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>           
                                                <asp:TemplateField HeaderText="Install No">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtInstallNo" Enabled='<%# Eval("GenStatus").ToString() == "Generated" ? false : true %>' runat="server" Text='<%# Eval("InstallNo") %>' CssClass="form-control txtInstallNo" onkeypress="return validateNum(event)" placeholder="Install No"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>    
                                                <asp:TemplateField HeaderText="Balance">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtBalance" Enabled='<%# Eval("GenStatus").ToString() == "Generated" ? false : true %>' runat="server" Text='<%# Eval("BalanceAmount") %>' CssClass="form-control txtBalance" onkeypress="return validateNum(event)" placeholder="Balance"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>                                         
                                                <asp:BoundField DataField="SetAmount" HeaderText="SetAmount" />
                                                <asp:BoundField DataField="SetInstallNo" HeaderText="SetInstall No" />
                                                <asp:BoundField DataField="SetBalanceAmount" HeaderText="SetBalance" />
                                                <asp:BoundField DataField="LastMonthSalaryStatus" HeaderText="LastMonthSalary" />

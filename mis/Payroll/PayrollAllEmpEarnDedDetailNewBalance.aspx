<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="PayrollAllEmpEarnDedDetailNewBalance.aspx.cs" Inherits="mis_Payroll_PayrollAllEmpEarnDedDetailNewBalance" %>
        ...
        <section class="content">
            <div class="box box-success">
                <div class="box-header Hiderow">
                    <h3 class="box-title">Balance Paysheet Sheet</h3>
                        ...
                        <div class="col-md-12">
                            <div runat="server" id="DivHead" class="header_div" style="text-align: center;">
                                <h5>
                                    ...
                                    <br />
                                    Loan Balance - Pay Sheet For the Month of

<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="SendMailEmpSalarySlip.aspx.cs" Inherits="mis_Payroll_SendMailEmpSalarySlip" %>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <div class="form-group pull-left">
                                <asp:Button ID="btnSendSMS" runat="server" Text="Send Email" CssClass="btn btn-success" OnClick="btnSendSMS_Click" OnClientClick="return SendEmail();" />
                            </div>
                        </div>
                    </div>
                </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentFooter" runat="Server">
    <script>
        ...
        function SendEmail() {
            if (document.getElementById('<%=btnSendSMS.ClientID%>').value.trim() == "Send Email") {

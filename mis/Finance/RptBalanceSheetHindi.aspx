<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="RptBalanceSheetHindi.aspx.cs" Inherits="mis_Finance_RptBalanceSheetHindi" %>
                                     ...
                                     <div style="width:50%; float:left">
                                        ...
                                        <asp:GridView ID="GridBalanceSheetLeft" runat="server" ClientIDMode="Static" AutoGenerateColumns="false" class="dataTable table table-hover table-bordered" Style="margin-top: 0px;" OnRowCommand="GridBalanceSheetLeft_RowCommand">
                                            <Columns>
                                                ...
                                                <asp:ButtonField ButtonType="Link" ControlStyle-CssClass="Aselect1" CommandName="View" HeaderText="Group Name" DataTextField="Head_Name_Hindi" />

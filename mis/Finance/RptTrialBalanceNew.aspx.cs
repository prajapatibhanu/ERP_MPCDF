...
using System.IO;
using System.Text;
public partial class mis_Finance_RptTrialBalanceNew : System.Web.UI.Page
{
    DataSet ds;
    ...
    protected void FillGrid()
    {
        try
        {
            ...
            ShowColumn();
            ds = objdb.ByProcedure("SpFinRptTrialBalanceNewF", new string[] { "flag", "Office_ID_Mlt", "FromDate", "ToDate" }, new string[] { "1", Office, Convert.ToDateTime(txtFromDate.Text, cult).ToString("yyyy/MM/dd"), Convert.ToDateTime(txtToDate.Text, cult).ToString("yyyy/MM/dd") }, "dataset");
            if (ds.Tables.Count != 0 && ds.Tables[0].Rows.Count != 0)
            {
    ...
    protected void GridView2_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            ...
            if (e.CommandName == "ViewBill")
            {
                ...
                ds = objdb.ByProcedure("SpFinRptTrialBalanceNewF", new string[] { "flag", "Ledger_ID", "Office_ID_Mlt", "ToDate" }, new string[] { "13", Ledger_ID, Office, Convert.ToDateTime(txtToDate.Text, cult).ToString("yyyy/MM/dd") }, "dataset");

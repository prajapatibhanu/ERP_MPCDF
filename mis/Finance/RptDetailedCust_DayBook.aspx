<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="RptDetailedCust_DayBook.aspx.cs" Inherits="mis_Finance_RptDetailedCust_DayBook" EnableEventValidation="false" %>
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <asp:TextBox ID="txtSearch" placeholder="Search" CssClass="hide_print" onkeyup="Search_Gridview(this, 'GridView1')" runat="server" />
                                <hr />

<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="RptGroupSummary.aspx.cs" Inherits="mis_Finance_RptGroupSummary" %>
                            ...
                            <div class="col-md-3">
                              ...
                              <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <asp:DropDownList runat="server" ID="ddlGroup" CssClass="form-control select2" >
                                    </asp:DropDownList>
                                </div>
                            </div>
                            <div class="col-md-2">

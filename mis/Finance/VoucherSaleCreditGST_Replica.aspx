<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="VoucherSaleCreditGST_Replica.aspx.cs" Inherits="mis_Finance_VoucherSaleCreditGST" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentBody" runat="Server">
    ...
    <div class="content-wrapper">
                ...
                <div class="col-md-12">
                    <div class="box box-success" style="background-color: #faf4c7">
                        <div class="box-header">
                            <div class="row">
                                <div class="col-md-4">
                                    <h3 class="box-title">GST Sale Voucher</h3>
                                </div>
                                <div class="col-md-8">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6" style="margin-left: -32px;">
                                                <asp:TextBox runat="server" CssClass="form-control" ID="txtVoucherTx_No" placeholder="Enter Voucher/Bill No." ClientIDMode="Static" MaxLength="5" onkeypress="return validateNum(event)" autocomplete="off"></asp:TextBox>
        ...
        <asp:HiddenField ID="hfstatusvalue" runat="server" />
    </div>
</asp:Content>
    ...
    <script>
        ...
        function ValidateItemAdd() {
            ...
            if (document.getElementById('<%=txtAmount.ClientID%>').value.trim() == "") {
                msg = msg + "Enter Amount  Testing . \n";
            }
            if (document.getElementById('<%=hfstatusvalue.ClientID%>').value.trim() == "0")
            {
                if (document.getElementById('<%=txtAmount.ClientID%>').value.trim() != "") {

<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="FinCostCentreBreakupReport.aspx.cs" Inherits="mis_Finance_FinCostCentreBreakupReport" %>
        ...
        <section class="content">
            ...
            <div class="box box-success">
                <div class="box-header Hiderow hide_print">
                    <h3 class="box-title">Cost Centre Break Up Report</h3>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <asp:DropDownList ID="ddlSubCategory" runat="server" CssClass="form-control select2">
                    ...
                    <div id="tableData">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <%-- Month Wise Detail--%>
                                <asp:GridView ID="GridView3" runat="server" ShowFooter="true" ClientIDMode="Static" AutoGenerateColumns="false" class="datatable table table-hover table-bordered" Style="margin-bottom: 0px;" OnRowCommand="GridView3_RowCommand">
                                    <Columns>
                                        <asp:TemplateField HeaderText="SNo." ItemStyle-Width="10" Visible="false">
                                            <ItemTemplate>
                                                <asp:Label ID="lblRowNumber" Text='<%# Container.DataItemIndex + 1 %>' runat="server" />

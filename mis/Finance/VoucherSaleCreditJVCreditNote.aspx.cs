...
public partial class mis_Finance_VoucherSaleCreditJVCreditNote : System.Web.UI.Page
{
    DataSet ds;
    ...
    protected void FillVoucherNo()
    {
        try
        {
            ...
            string VoucherTx_Names_ForSno = "JV Credit Note Voucher";
            //string VoucherTx_Names_ForSno = "Sales Voucher";
            ...
            lblVoucherTx_No.Text = Office_Code + FinancialYear.ToString().Substring(2) + "JCN";
    ...
    protected void Save(string Type)
    {
        try
        {
            ...
            string VoucherTx_Type = "JV Credit Note Voucher";
            string VoucherTx_Name = "CreditNote Voucher";
            //string VoucherTx_Ref = txtInvoice.Text;
            string VoucherTx_Ref ="";
                        ...
                        if (ds != null && ds.Tables[0].Rows.Count > 0)
                        {
                            if (ds.Tables[0].Rows[0]["InventoryAffected"].ToString() == "Yes")
                            {
                                ...
                                objdb.ByProcedure("SpFinItemTx",
                                   ...
                                   , new string[] { "4", lblItemID.Text, "0", iQuantity, lblRate.Text, VoucherTx_ID, "JV Credit Note Voucher", VoucherTx_No, ViewState["Office_ID"].ToString(), lblWarehouse_id.Text, ViewState["Emp_ID"].ToString(), Convert.ToDateTime(txtVoucherTx_Date.Text, cult).ToString("yyyy/MM/dd"), iAmount }, "dataset");
                            }
                        }
                    ...
                    if (ds != null && ds.Tables[0].Rows.Count > 0)
                    {
                        if (ds.Tables[0].Rows[0]["InventoryAffected"].ToString() == "Yes")
                        {
                            objdb.ByProcedure("SpFinItemTx",
                               ...
                               , new string[] { "4", lblItemID.Text, lblQuantity.Text, "0", lblRate.Text, ViewState["VoucherTx_ID"].ToString(), "JV Credit Note Voucher", VoucherTx_No, ViewState["Office_ID"].ToString(), lblWarehouse_id.Text, ViewState["Emp_ID"].ToString(), Convert.ToDateTime(txtVoucherTx_Date.Text, cult).ToString("yyyy/MM/dd") }, "dataset");
                        }
                    }
                    string Amount = lblAmount.Text;
                    Amount = "-" + Amount;
        ...
        try
        {
            ...
            if (ds != null)
            {
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    //var rx = new System.Text.RegularExpressions.Regex("JCN");
                    ...
                    //lblVoucherTx_No.Text = array[0] + "JCN";
                    ...
                    else
                    {
                        ...
                        {
                            Fstring = str.Substring(0, 12);
                            Lstring = str.Substring(12, str.Length - 12);
                        }
                        else
                        {
    ...
    protected void btnNarration_Click(object sender, EventArgs e)
    {
        ds = objdb.ByProcedure("SpFinVoucherTx",
                 ...
                 new string[] { "14", "JV Credit Note Voucher", ViewState["Office_ID"].ToString() }, "dataset");
    ...
    protected void lnkPreviousVoucher_Click(object sender, EventArgs e)
    {
        ...
        {
            lblMsg.Text = "";
            ds = objdb.ByProcedure("SpFinVoucherTx", new string[] { "flag", "Office_ID", "VoucherTx_Type" }, new string[] { "33", ViewState["Office_ID"].ToString(), "JV Credit Note Voucher" }, "dataset");
            if (ds != null && ds.Tables[0].Rows.Count > 0)
            {
        ...
        try
        {
            ...
            if (ds != null && ds.Tables[0].Rows.Count > 0)
            {
                ...
                if (ViewState["Office_ID"].ToString() != "1")
                {
                    ...
                    if (ViewState["Office_Code"].ToString().Length == 4)
                    {
                        Fstring = PrvVoucherNo.Substring(0, 12);
                        Lstring = PrvVoucherNo.Substring(12, PrvVoucherNo.Length - 12);
                    }
                    else
                    {

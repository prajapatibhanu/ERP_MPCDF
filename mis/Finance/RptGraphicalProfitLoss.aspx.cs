...
public partial class mis_Finance_RptGraphicalProfitLoss : System.Web.UI.Page
{
    DataSet ds;
            ...
            if (Session["Emp_ID"] != null)
            {
                if (!IsPostBack)
                {
                    ...
                    if (Request.QueryString["OfficeID"] != null && Request.QueryString["FromDate"] != null && Request.QueryString["ToDate"] != null)
                    {
                        ...
                        if (Session["headingPL"].ToString() != null)
                        {
                            lblheadingFirst.Text = Session["headingPL"].ToString();
                        }
    ...
    {
        ds = objdb.ByProcedure("SpFinRptGraphicalProfitLoss", new string[] { "flag", "Office_ID_Mlt", "FromDate", "ToDate" }, new string[] { "1", ViewState["OfficeID"].ToString(), Convert.ToDateTime(ViewState["FromDate"].ToString(), cult).ToString("yyyy/MM/dd"), Convert.ToDateTime(ViewState["ToDate"].ToString(), cult).ToString("yyyy/MM/dd") }, "dataset");
        if (ds != null && ds.Tables[0].Rows.Count > 0)
        {
            ...
            sb.Append("title: { text: 'Transaction(In Cr)'},");
            ...
            sb.Append("series: [{name: 'Transaction',colorByPoint: true,data: [");

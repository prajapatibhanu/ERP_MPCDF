...
public partial class mis_Finance_LedgerDetailBForPurchase : System.Web.UI.Page
{
    static DataSet ds6;
    DataSet ds;
    ...
    protected void GVLedgerDetail_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            Response.Redirect("LedgerMasterForPurchase.aspx?Ledger_ID=" + objdb.Encrypt(Ledger_ID) + "&Mode=" + objdb.Encrypt("Edit"));
        }
        catch (Exception ex)
        {
            lblMsg.Text = objdb.Alert("fa-ban", "alert-danger", "Sorry!", ex.Message.ToString());
    ...
    protected void GetLedgerName()
    {
        try
        {
            ...
            DataSet ds4 = objdb.ByProcedure("SpFinLedgerMaster", new string[] { "flag", "Office_ID" }, new string[] { "64", Office_ID }, "dataset");
            ds6 = ds4;
        }
        catch (Exception ex)
        {

<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="RptPurchaseRegister.aspx.cs" Inherits="mis_Finance_RptPurchaseRegister" %>
            ...
            <div class="box box-success">
                ...
                <div class="box-body">
                    <div class="row no-print">
                        ...
                        <div class="col-md-2">
                            <asp:Button ID="btnSearch" runat="server" CssClass="btn btn-block btn-success no-print" Style="margin-top: 24px;" Text="Search" OnClick="btnSearch_Click" OnClientClick="return validateform();" />
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-10">

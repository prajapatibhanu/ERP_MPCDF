<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="VoucherBankPayment.aspx.cs" Inherits="mis_Finance_VoucherBankPayment" %>
                ...
                <div class="col-md-12">
                    <div class="box box-success" style="background-color: #fffed9">
                        <div class="box-header">
                            <div class="row">
                                <div class="col-md-4">
                                    <h3 class="box-title">Cash Payment Voucher</h3>
                        ...
                        <div class="box-body">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6" style="margin-left: -32px;">
                                            <asp:TextBox runat="server" CssClass="form-control" ID="txtVoucherTx_No" placeholder="Enter Voucher No..." ClientIDMode="Static" MaxLength="6" onkeypress="return validateNum(event)" autocomplete="off"></asp:TextBox>
                                                ...
                                                <asp:GridView runat="server" CssClass="table table-bordered" DataKeyNames="RowNo" ShowHeaderWhenEmpty="True" AutoGenerateColumns="False" ID="GridViewLedgerDetail" ShowFooter="True" OnSelectedIndexChanged="GridViewLedgerDetail_SelectedIndexChanged" OnRowDeleting="GridViewLedgerDetail_RowDeleting">
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="Bill By Bill Detail" ShowHeader="False">
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="LinkButton1" runat="server" OnClick="LinkButton1_Click" CausesValidation="False" CommandName="Select" CssClass="label label-info" Text='<%# Eval("LedgerTx_MaintainType").ToString()=="None"?"":"View" %>'></asp:LinkButton>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox runat="server" TextMode="MultiLine" ClientIDMode="Static" CssClass="form-control" ID="txtVoucherTx_Narration"></asp:TextBox>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <a href="VoucherBankPayment.aspx" id="btnClear" runat="server" class="btn btn-block btn-default" style="margin-top: 21px;">Clear</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <asp:DropDownList runat="server" ClientIDMode="Static" CssClass="form-control select2" Visible="false" ID="ddlBillByBillTx_Ref" onchange="ChangeRef()">
                                </asp:DropDownList>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentFooter" runat="Server">
    ...
    function onchange() {
        debugger;
        var RefType = document.getElementById('<%=ddlBillByBillTx_Ref.ClientID%>').selectedIndex;
            //var billbybillrefSelect = $("#ddlBillByBillTx_Ref option:selected").text();
            <%--var billbybillrefSelect = document.getElementById('<%=ddlBillByBillTx_Ref.ClientID%>');
            var selectedText = skillsSelect.options[billbybillrefSelect.selectedIndex].text;--%>

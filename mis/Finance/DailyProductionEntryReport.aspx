<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="DailyProductionEntryReport.aspx.cs" Inherits="mis_Finance_DailyProductionEntryReport" %>
                    ...
                    <div class="row" id="tableData">
                         <div class="col-md-12">
                            <table style="width:100%;">
                                <tr>                                    
                                     <td colspan="4"  style="text-align:center;"><asp:Label ID="lblheadingFirst" style="font-size:18px;"  runat="server" Text=""></asp:Label></td>
                                     <td colspan="3" style="float:right;">
                                           <div id="piechart_3" style="width: 360px; height: 200px;"></div>
                                     </td>
                                </tr>
                            </table>

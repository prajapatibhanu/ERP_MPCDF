<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="RptReceiptCashRegister.aspx.cs" Inherits="mis_Finance_RptReceiptCashRegister" EnableEventValidation="false" %>
        ...
        <section class="content">
            <div class="box box-success">
                <div class="box-header Hiderow">
                    <h3 class="box-title">Cash Receipt Register</h3>

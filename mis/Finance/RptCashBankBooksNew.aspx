<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="RptCashBankBooksNew.aspx.cs" Inherits="mis_Finance_RptCashBankBooksNew" %>
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="box box-success">
                <div class="box-header Hiderow btnPrint hide_print">
                    <h3 class="box-title">Cash / Bank Book(s)</h3>
                ...
                <div class="box-body">
                        ...
                        <div class="col-md-12">
                            <strong style="height: 40px;">
                                ...
                                <div class="hide_print">
                                    ...
                                    <asp:LinkButton ID="btnDayBookPrint" runat="server" CssClass="btn btn-default" Text="Print" OnClientClick="PrintPage();"><i class="fa fa-print"></i> Print</asp:LinkButton>
                                </div>
                    ...
                    <div class="row">
                        <div class="col-md-2">
                           ...
                           <%-- <asp:Button ID="btnShowDetailBook" runat="server" CssClass="hidden" Text="Show Bank Detail" OnClientClick="ShowLedgerDetail();" AccessKey="Q" />--%>
                            <%-- <button type="button" onclick="ShowLedgerDetail();"  AccessKey="Q" >Show Bank Detail</button>--%>
                        </div>
                        <div class="col-md-12">
                            <%--HEAD--%>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="table-responsive">
                                ...
                                <asp:GridView ID="GridView4" runat="server" ClientIDMode="Static" AutoGenerateColumns="false" class="DailyDetaileddatatable table table-hover table-bordered">
                                    <Columns>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentFooter" runat="Server">
    ...
    <script>
        ...
        $('.DailyDetaileddatatable').DataTable({
            paging: false,
            dom: 'Bfrtip',
            ordering: false,
            buttons: [
    ...
    <script>
        ...
        function ShowLedgerDetail() {
            ...
            if ($('.Daybook').css('display') == 'none') {

                $('.Daybook').css('display', 'block');
                $('.Monthbook').css('display', 'none');
            }
            else if ($('.Monthbook').css('display') == 'none') {

                $('.Monthbook').css('display', 'block');

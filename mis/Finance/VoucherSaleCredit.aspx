<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="VoucherSaleCredit.aspx.cs" Inherits="mis_Finance_VoucherSaleCredit" %>
                    ...
                    <div class="box box-success" style="background-color: #faf4c7">
                        ...
                        <div class="box-body">
                            ...
                            <asp:Panel ID="panel1" runat="server">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <asp:CheckBox ID="chkitem" Checked="true" ClientIDMode="Static" runat="server" OnCheckedChanged="chkitem_CheckedChanged" AutoPostBack="true" />&nbsp;&nbsp;<label>Add Item</label>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtVoucherTx_Narration" runat="server" TextMode="MultiLine" CssClass="form-control" autocomplete="off" placeholder="Enter Narration  |  Location : Location Name"></asp:TextBox>
                                        </div>
                                    </div>

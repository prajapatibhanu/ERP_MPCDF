...
public partial class mis_Finance_RptMisProgressiveDistrictSingleMonth : System.Web.UI.Page
{
    DataSet ds;
    ...
    protected void FillGrid()
    {
        try
        {
            ds = objdb.ByProcedure("SpFinMisProgressiveNew", new string[] { "flag", "Office_ID", "Year", "Month_ID" }, new string[] { "10", ViewState["Office_ID"].ToString(), ddlYear.SelectedValue, ddlMonth.SelectedValue }, "dataset");

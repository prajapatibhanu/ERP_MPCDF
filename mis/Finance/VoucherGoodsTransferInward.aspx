<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="VoucherGoodsTransferInward.aspx.cs" Inherits="mis_Finance_VoucherGoodsTransferInward" %>
        ...
        <section class="content">
            ...
            <div class="box box-success" style="background-color: #f7e3c6">
                <div class="box-header">
                    <h3 class="box-title">Daily Production From Plant</h3>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <asp:TextBox runat="server" ID="txtVoucherTx_Narration" ClientIDMode="Static" TextMode="MultiLine" CssClass="form-control" placeholder="Enter Narration | Scrap Qty. : ..."></asp:TextBox>

<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="RptDaybook.aspx.cs" Inherits="mis_Finance_RptDaybook" %>
        ...
        <section class="content">
            <div class="box box-success">
                <div class="box-header Hiderow">
                    ...
                    <a href="RptDaybookWithoutCash.aspx" class="btn btn-primary pull-right" >Day Book Without Cash</a>
                    <asp:HyperLink ID="btnDtlDayBook" NavigateUrl="RptDetailedDaybook.aspx" Text="Detailed DayBook" Target="_blank" runat="server" CssClass="btn btn-primary pull-right"></asp:HyperLink><asp:Button ID="btngraphical" runat="server" Style="margin-right: 10px;" CssClass="btn btn-primary pull-right" Text="Graphical Report" OnClick="btngraphical_Click"></asp:Button>

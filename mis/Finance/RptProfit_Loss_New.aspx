<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="RptProfit_Loss_New.aspx.cs" Inherits="mis_Finance_RptProfit_Loss_New" %>
                    ...
                    <div class="hide_print">
                        <div class="row">
                            ...
                            <div class="col-md-6 ">
                                ...
                                <asp:CheckBox ID="chkOpeningBal" runat="server" Checked="true" Text="Opening Bal.&nbsp;&nbsp;" />
                                    <asp:CheckBox ID="chkTransactionAmt" runat="server" Checked="true" Text="Transaction&nbsp;&nbsp;" />
                            ...
                            <asp:Panel ID="PnlLevel1" runat="server">
                                <div class="row">
                                    <div style="width: 50%; float: left">
                                        <asp:GridView ID="GridProfit_LossLeft" runat="server" ClientIDMode="Static" AutoGenerateColumns="false" class="dataTable table table-hover table-bordered" Style="margin-top: 0px;" OnRowCommand="GridProfit_LossLeft_RowCommand">
                                            <Columns>
                                    ...
                                    <div style="width: 50%; float: right;">
                                        <asp:GridView ID="GridProfit_LossRight" runat="server" ClientIDMode="Static" AutoGenerateColumns="false" class="dataTable table table-hover table-bordered" Style="margin-top: 0px;" OnRowCommand="GridProfit_LossRight_RowCommand">
                                            <Columns>
                                                <asp:TemplateField HeaderText="SNo." ItemStyle-Width="10" Visible="false">
                                                    <ItemTemplate>
                                                        <asp:Label ID="lblRowNumber" Text='<%# Container.DataItemIndex + 1 %>' runat="server" />
                                        ...
                                        <table class="dataTable table table-hover table-bordered">
                                            <tr>
                                                ...
                                                <td class="align-right" style="width: 25%;">
                                                    <asp:Label ID="lblTotalLeft" runat="server" Text="64646"></asp:Label>
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
                                    <div style="width: 50%; float: right;">
                                        <table class="dataTable table table-hover table-bordered">
                                            <tr>
                                                <td>Total</td>
                                                <td class="align-right" style="width: 25%;">
                                                    <asp:Label ID="lblTotalRight" runat="server" Text="4654644"></asp:Label>
                                                </td>
                                            </tr>
                                        </table>
                                    </div>

<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="VoucherBankReceipt.aspx.cs" Inherits="mis_Finance_VoucherBankReceipt" %>
                ...
                <div class="col-md-12">
                    <div class="box box-success" style="background-color: #e3dcc5">
                        <div class="box-header">
                            <div class="row">
                                <div class="col-md-4">
                                    <h3 class="box-title">Bank Receipt Voucher</h3>
                                </div>
                                <div class="col-md-8">

<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="RptSalesRegister.aspx.cs" Inherits="mis_Finance_RptSalesRegister" %>
                            ...
                            <div class="col-md-12">
                                ...
                                <asp:GridView ID="GridView4" DataKeyNames="VoucherTx_ID" runat="server" AutoGenerateColumns="false" class="table table-hover table-bordered" OnRowDeleting="GridView4_RowDeleting" OnRowCommand="GridView1_RowCommand" ShowFooter="true">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Action" ItemStyle-Width="13%" FooterStyle-CssClass="no-print" HeaderStyle-CssClass="no-print" ItemStyle-CssClass="no-print">
                                            <ItemTemplate>

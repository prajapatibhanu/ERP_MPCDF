...
public partial class mis_Finance_RptTrialBalanceNewF : System.Web.UI.Page
{
    DataSet ds;
    ...
    protected void FillGrid()
    {
        try
        {
            ...
            ShowColumn();
            ds = objdb.ByProcedure("SpFinRptTrialBalanceNewFF", new string[] { "flag", "Office_ID_Mlt", "FromDate", "ToDate" }, new string[] { "1", Office, Convert.ToDateTime(txtFromDate.Text, cult).ToString("yyyy/MM/dd"), Convert.ToDateTime(txtToDate.Text, cult).ToString("yyyy/MM/dd") }, "dataset");
            if (ds.Tables.Count != 0 && ds.Tables[0].Rows.Count != 0)
            {
            ...
            ViewState["Ledger_ID_Mlt"] = ds.Tables[1].Rows[0]["Ledger_ID_Mlt"].ToString();
    ...
    protected void FillGridNext(string Head_ID)
    {
        try
        {
            ...
            ShowColumn();
            DataSet ds1 = objdb.ByProcedure("SpFinRptTrialBalanceNewFF", new string[] { "flag", "Head_ID" }, new string[] { "9", Head_ID }, "dataset");
            ...
            ds = objdb.ByProcedure("SpFinRptTrialBalanceNewFF", new string[] { "flag", "Office_ID_Mlt", "Head_ID", "FromDate", "ToDate", "Ledger_ID_Mlt" }, new string[] { "3", Office, Head_ID, Convert.ToDateTime(txtFromDate.Text, cult).ToString("yyyy/MM/dd"), Convert.ToDateTime(txtToDate.Text, cult).ToString("yyyy/MM/dd"), ViewState["Ledger_ID_Mlt"].ToString() }, "dataset");
            if (ds.Tables.Count != 0 && ds.Tables[0].Rows.Count != 0)
            {
                btnHeadExcel.Visible = true;
                spnAltB.Visible = true;
    ...
    protected void FillGridNextLedger(string Ledger_ID)
    {
        try
        {
            ...
            ds = objdb.ByProcedure("SpFinRptTrialBalanceNewFF", new string[] { "flag", "Office_ID_Mlt", "Ledger_ID", "FromDate", "ToDate", "Ledger_ID_Mlt" }, new string[] { "4", Office, Ledger_ID, Convert.ToDateTime(txtFromDate.Text, cult).ToString("yyyy/MM/dd"), Convert.ToDateTime(txtToDate.Text, cult).ToString("yyyy/MM/dd"), ViewState["Ledger_ID_Mlt"].ToString() }, "dataset");
            if (ds.Tables.Count != 0 && ds.Tables[0].Rows.Count != 0)
            {
    ...
    protected void FillGridNextLedgerMonth(string Ledger_ID, string MonthID)
    {
        try
        {
            ...
            GridView3.DataSource = new string[] { };
            ds = objdb.ByProcedure("SpFinRptTrialBalanceNewFF", new string[] { "flag", "Office_ID_Mlt", "Ledger_ID", "LedgerTx_Month", "FromDate", "ToDate", "Ledger_ID_Mlt" }, new string[] { "6", Office, Ledger_ID, MonthID, Convert.ToDateTime(txtFromDate.Text, cult).ToString("yyyy/MM/dd"), Convert.ToDateTime(txtToDate.Text, cult).ToString("yyyy/MM/dd"), ViewState["Ledger_ID_Mlt"].ToString() }, "dataset");
            if (ds.Tables.Count != 0 && ds.Tables[0].Rows.Count != 0)
            {
    ...
    protected void GridView2_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            ...
            if (e.CommandName == "ViewBill")
            {
                ...
                ds = objdb.ByProcedure("SpFinRptTrialBalanceNewFF", new string[] { "flag", "Ledger_ID", "Office_ID_Mlt", "ToDate" }, new string[] { "13", Ledger_ID, Office, Convert.ToDateTime(txtToDate.Text, cult).ToString("yyyy/MM/dd") }, "dataset");
    ...
    protected void btngraphical_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            if (Office != "")
            {
                ...
                headingFirst = "<p class='text-center' style='font-weight:600'>Trial Balance <br /> MP State Agro Industries Development Corporation, <br/> [ " + OfficeName + " ] <br />  " + Convert.ToDateTime(txtFromDate.Text, cult).ToString("dd-MM-yyyy") + "  To " + Convert.ToDateTime(txtToDate.Text, cult).ToString("dd-MM-yyyy") + "</p>";

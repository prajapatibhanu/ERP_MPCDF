<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="VoucherReceiptD.aspx.cs" Inherits="mis_Finance_VoucherReceiptD" %>
                ...
                <div class="col-md-12">
                    <div class="box box-success" style="background-color: #e3dcc5">
                        <div class="box-header">
                            <div class="row">
                                <div class="col-md-4">
                                    <h3 class="box-title">Cash Receipt Voucher</h3>
                                    &nbsp;&nbsp;&nbsp;&nbsp;<asp:CheckBox ID="chkboxreverse" runat="server" OnCheckedChanged="chkboxreverse_CheckedChanged" AutoPostBack="true" />(Reverse Voucher)
                                </div>
                                <div class="col-md-8">
                        ...
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <asp:Label ID="lblPreviousVoucherNo" Text="" Font-Bold="true" Style="color: blue" runat="server"></asp:Label>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <asp:Button runat="server" CssClass="btn btn-block btn-success" Style="margin-top: 23px;" ClientIDMode="Static" ID="btnAccept" Text="Accept" OnClientClick="return validateform();" OnClick="btnAccept_Click" />
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <a href="VoucherReceiptD.aspx" id="btnClear" runat="server" style="margin-top: 23px;" class="btn btn-block btn-default">Clear</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtChequeTx_No" runat="server" placeholder="Enter Cheque/ DD No." MaxLength="25" CssClass="form-control" autocomplete="off"></asp:TextBox>

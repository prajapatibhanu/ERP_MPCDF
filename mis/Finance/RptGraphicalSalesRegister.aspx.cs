...
public partial class mis_Finance_RptGraphicalSalesRegister : System.Web.UI.Page
{
    DataSet ds;
            ...
            if (Session["Emp_ID"] != null)
            {
                if (!IsPostBack)
                {
                    ...
                    if (Request.QueryString["OfficeID"] != null && Request.QueryString["FromDate"] != null && Request.QueryString["ToDate"] != null)
                    {
                        ...
                        if (Session["SalesHeading"].ToString() != null)
                        {
                            lblheadingFirst.Text = Session["SalesHeading"].ToString();
                        } 
    ...
    {
        ds = objdb.ByProcedure("SpFinRptGraphicalSalesRegister", new string[] { "flag", "Office_ID_Mlt", "FromDate", "ToDate" }, new string[] { "0", ViewState["OfficeID"].ToString(), Convert.ToDateTime(ViewState["FromDate"].ToString(), cult).ToString("yyyy/MM/dd"), Convert.ToDateTime(ViewState["ToDate"].ToString(), cult).ToString("yyyy/MM/dd") }, "dataset");

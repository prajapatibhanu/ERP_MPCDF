<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="VoucherSaleCredit_New.aspx.cs" Inherits="mis_Finance_VoucherSaleCredit_New" %>
                        ...
                        <div class="box-body">
                            ...
                            <asp:Panel ID="panel1" runat="server">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Party A/c Name (DR)<span style="color: red;"> *</span></label>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <a href="VoucherSaleCredit_New.aspx" id="btn_Clear" runat="server" class="btn btn-default btn-block">Clear</a>

...
public partial class mis_Finance_RptMisProgressiveBranchWise : System.Web.UI.Page
{
    ...
    protected void FillGrid()
    {
        try
        {
            ds = objdb.ByProcedure("SpFinMisProgressiveNew", new string[] { "flag", "Division_ID", "Year", "Month_ID" }, new string[] { "15", ddlOffice.SelectedValue, ddlYear.SelectedValue, ddlMonth.SelectedValue }, "dataset");

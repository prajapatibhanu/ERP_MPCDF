<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" EnableEventValidation="false" CodeFile="RptStockSummaryItem.aspx.cs" Inherits="mis_Finance_RptStockSummaryItem" %>
                        ...
                        <div class="col-md-12">
                            <fieldset class="box-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <asp:CheckBox ID="chkconsumption" runat="server" Text="&nbsp;Consumption" Checked="true" />
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <asp:CheckBox ID="chkGrossProfit" runat="server" Text="&nbsp;Gross Profit" Checked="true"  />
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <asp:CheckBox ID="chkPercentage" runat="server" Text="&nbsp;Percentage(%)" Checked="true"  />
                                        </div>
                                    </div>
                                    <div class="clearfix"></div>
                                ...
                                <div class="row" id="DivGrid1" runat="server">
                                    <div class="col-md-12">
                                        <fieldset class="box-body">
                                            <div class="table-responsive FirstPrint">
                                                <asp:HyperLink ID="hyperlink1" runat="server" NavigateUrl="ItemCostingMethod.aspx" CssClass="badge bg-teal">Click Here to Change Item's Costing Method</asp:HyperLink>

                                                <asp:Label ID="lblheadingmain" runat="server" Text=""></asp:Label>
                                                <asp:GridView ID="GridView1" runat="server" ShowFooter="True" AutoGenerateColumns="False" class="table table-hover table-bordered GridView1" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" ShowHeaderWhenEmpty="True" EmptyDataText="No Record Found">
                                                    <Columns>
                                    ...
                                    <div class="col-md-12">
                                        <fieldset class="box-body">
                                            <div class="table-responsive">
                                                <asp:HyperLink ID="hyperlink" runat="server" NavigateUrl="ItemCostingMethod.aspx" CssClass="badge bg-teal">Click Here to Change Item's Costing Method</asp:HyperLink>
                                                <asp:Label ID="lblheadingFirst" runat="server" Text=""></asp:Label>
                                                <asp:GridView ID="GridView2" runat="server" ShowFooter="True" AutoGenerateColumns="False" class="table table-hover table-bordered GridView2" OnSelectedIndexChanged="GridView2_SelectedIndexChanged" ShowHeaderWhenEmpty="True" EmptyDataText="No Record Found">
                                                    <Columns>
                                                        <asp:TemplateField HeaderText="Particular">
                                                            <ItemTemplate>
                                    ...
                                    <div class="col-md-12">
                                        <fieldset class="box-body">
                                            <div class="table-responsive">
                                                ...
                                                <asp:GridView ID="GridView4" runat="server" ShowFooter="True" AutoGenerateColumns="False" class="table table-hover table-bordered GridView4" ShowHeaderWhenEmpty="True" EmptyDataText="No Record Found">
                                                    <Columns>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentFooter" runat="Server">
    ...
    <script>
        $('.GridView4, .GridView2, .GridView3, .GridView1').DataTable({
            paging: false,
            ordering: false,

<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="PurchaseMaster.aspx.cs" Inherits="mis_Finance_PurchaseMaster" %>
            ...
            <div class="box box-success">
                ...
                <div class="box-body">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="TextBox2" runat="server" placeholder="Enter Order No." CssClass="form-control"></asp:TextBox>
                            </div>
                        </div>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Date</label>
                                <asp:TextBox ID="txtDate" runat="server" Text="22/08/2018" CssClass="form-control"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <fieldset>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox runat="server" ReadOnly="true" CssClass="form-control"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label>GR No./Chalan No.</label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtSGST" runat="server" Text="12" CssClass="form-control"></asp:TextBox>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtCGST" runat="server" Text="12" CssClass="form-control"></asp:TextBox>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtTotalAmount" ReadOnly="true" runat="server" placeholder="Total Amount" CssClass="form-control"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                        ...
                        <fieldset>
                            <legend>Other Ledger Detail</legend>
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label>&nbsp;</label>
                                        <asp:Button CssClass="btn btn-info btn-block" runat="server" Text="Add" />
                                    </div>
                                </div>
                            </div>
                        </fieldset>

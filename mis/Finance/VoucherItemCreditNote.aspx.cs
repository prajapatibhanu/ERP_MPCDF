...
public partial class mis_Finance_VoucherItemCreditNote : System.Web.UI.Page
{
    DataSet ds;
    ...
    protected void FillVoucherNo()
    {
        try
        {
            ...
            string VoucherTx_Names_ForSno = "Item Credit Note Voucher";
            //string VoucherTx_Names_ForSno = "Sales Voucher";
            ...
            lblVoucherTx_No.Text = Office_Code + FinancialYear.ToString().Substring(2) + "ICN";
    ...
    protected void Save(string Type)
    {
        try
        {
            ...
            string VoucherTx_Type = "Item Credit Note Voucher";
                        ...
                        if (ds != null && ds.Tables[0].Rows.Count > 0)
                        {
                            if (ds.Tables[0].Rows[0]["InventoryAffected"].ToString() == "Yes")
                            {
                                ...
                                objdb.ByProcedure("SpFinItemTx",
                                   ...
                                   , new string[] { "4", lblItemID.Text, "0", iQuantity, lblRate.Text, VoucherTx_ID, "Item Credit Note Voucher", VoucherTx_No, ViewState["Office_ID"].ToString(), lblWarehouse_id.Text, ViewState["Emp_ID"].ToString(), Convert.ToDateTime(txtVoucherTx_Date.Text, cult).ToString("yyyy/MM/dd"), iAmount }, "dataset");
                            }
                        }
                    ...
                    if (ds != null && ds.Tables[0].Rows.Count > 0)
                    {
                        if (ds.Tables[0].Rows[0]["InventoryAffected"].ToString() == "Yes")
                        {
                            objdb.ByProcedure("SpFinItemTx",
                               ...
                               , new string[] { "4", lblItemID.Text, lblQuantity.Text, "0", lblRate.Text, ViewState["VoucherTx_ID"].ToString(), "Item Credit Note Voucher", VoucherTx_No, ViewState["Office_ID"].ToString(), lblWarehouse_id.Text, ViewState["Emp_ID"].ToString(), Convert.ToDateTime(txtVoucherTx_Date.Text, cult).ToString("yyyy/MM/dd") }, "dataset");
                        }
                    }
                    string Amount = lblAmount.Text;
                    Amount = "-" + Amount;
        ...
        try
        {
            ...
            if (ds != null)
            {
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    //var rx = new System.Text.RegularExpressions.Regex("ICN");
                    ...
                    //lblVoucherTx_No.Text = array[0] + "ICN";
    ...
    protected void btnNarration_Click(object sender, EventArgs e)
    {
        ds = objdb.ByProcedure("SpFinVoucherTx",
                 ...
                 new string[] { "14", "Item Credit Note Voucher", ViewState["Office_ID"].ToString() }, "dataset");
    ...
    protected void lnkPreviousVoucher_Click(object sender, EventArgs e)
    {
        ...
        {
            lblMsg.Text = "";
            ds = objdb.ByProcedure("SpFinVoucherTx", new string[] { "flag", "Office_ID", "VoucherTx_Type" }, new string[] { "33", ViewState["Office_ID"].ToString(), "Item Credit Note Voucher" }, "dataset");
            if (ds != null && ds.Tables[0].Rows.Count > 0)
            {

<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" EnableEventValidation="false" CodeFile="RptStockSummaryItemFull.aspx.cs" Inherits="mis_Finance_RptStockSummaryItemFull" %>
                        ...
                        <div class="col-md-12">
                            <fieldset class="box-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>Stock Groups</label><span style="color: red">*</span>
                                            <%--<asp:DropDownList runat="server" ID="ddlOffice" CssClass="form-control select2" AutoPostBack="true">
                                            </asp:DropDownList>--%>
                                            <asp:ListBox runat="server" ID="ddlStockGroups" ClientIDMode="Static" CssClass="form-control select2" AutoPostBack="true" OnSelectedIndexChanged="ddlStockGroups_SelectedIndexChanged"></asp:ListBox>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label>Stock Items</label><span style="color: red">*</span>
                                            <%--<asp:DropDownList runat="server" ID="ddlOffice" CssClass="form-control select2" AutoPostBack="true">
                                            </asp:DropDownList>--%>
                                            <asp:ListBox runat="server" ID="ddlStockItems" ClientIDMode="Static" CssClass="form-control" SelectionMode="Multiple" ></asp:ListBox>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="table-responsive FirstPrint">
                                                ...
                                                <asp:GridView ID="GridView2" runat="server" ShowFooter="True" AutoGenerateColumns="False" class="table table-hover table-bordered GridView2" OnSelectedIndexChanged="GridView2_SelectedIndexChanged" ShowHeaderWhenEmpty="True" EmptyDataText="No Record Found" OnRowCreated="grvMergeHeader_RowCreated">
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="ItemGroup" HeaderText="Stock Group" ControlStyle-CssClass="lastinfo"/>
                                                        <asp:BoundField DataField="Office_Name" HeaderText="Office / Branch" ControlStyle-CssClass="lastinfo"/>
                                                        <asp:BoundField DataField="CostingMethod" HeaderText="Costing Method" ControlStyle-CssClass="lastinfo"/>

                                                        <%--<asp:TemplateField Visible="false">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblStockType" runat="server" Text='<%# Eval("StockType") %>' CssClass="hidden" ></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>--%>
                                                    </Columns>
                                                </asp:GridView>

...
public partial class mis_Finance_VoucherGoodsTransferInward : System.Web.UI.Page
{
    ...
    protected void FillVoucherNo()
    {
        try
        {
            if (ViewState["VoucherTx_ID"].ToString() == "0")
            {
                ...
                string VoucherTx_Names_ForSno = "Daily Production From Plant";
                ...
                //ViewState["PreVoucherNo"] = Office_Code + FinancialYear.ToString().Substring(2) + "PS" + VoucherTx_SNo.ToString();
                VoucherTx_SNo = VoucherTx_SNo + 1;

                //ViewState["VoucherTx_SNo"] = VoucherTx_SNo;

                //txtVoucherTx_No.Text = Office_Code + FinancialYear.ToString().Substring(2) + "PS" + VoucherTx_SNo.ToString();
                lblVoucherTx_No.Text = Office_Code + FinancialYear.ToString().Substring(2) + "PS";
    ...
    protected void FillParticularsDropDown()
    {
        try
        {
            ...
            if (ds != null && ds.Tables[0].Rows.Count > 0)
            {
                ...
                ddlLedgerCr.SelectedValue = "79104";
            }
            else
            {
            ...
            if (ds != null && ds.Tables[0].Rows.Count > 0)
            {
                ...
                ddlLedgerDr.SelectedValue = "79105";
    ...
    protected void btnNarration_Click(object sender, EventArgs e)
    {
        ds = objdb.ByProcedure("SpFinVoucherTx",
                 ...
                 new string[] { "14", "Daily Production From Plant", ViewState["Office_ID"].ToString() }, "dataset");
            ...
            if (msg == "")
            {
                ...
                if (btnAccept.Text == "Accept" && ViewState["VoucherTx_ID"].ToString() == "0" && Status == 0)
                {
                    ...
                    ds = objdb.ByProcedure("SpFinVoucherTx", new string[] { "flag", "VoucherTx_Date", "VoucherTx_Name", "VoucherTx_Type", "VoucherTx_No", "VoucherTx_Narration",
                      ...
                      new string[] { "0", Convert.ToDateTime(txtVoucherTx_Date.Text, cult).ToString("yyyy/MM/dd"), "Daily Production From Plant", "Daily Production From Plant", VoucherTx_No, txtVoucherTx_Narration.Text,
                    ...
                    if (ds != null && ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        new string[] { "0", ddlLedgerCr.SelectedValue.ToString(), VoucherTx_ID, "Daily Production From Plant", txtLedgerCr_Amount.Text, Month.ToString(), Year.ToString(), FinancialYear.ToString(), ViewState["Office_ID"].ToString(), "1", ViewState["Emp_ID"].ToString(), "1", "Main Ledger", "None" }, "dataset");
                        ...
                        foreach (GridViewRow rows in GridViewItem.Rows)
                        {
                            ...
                            objdb.ByProcedure("SpFinItemTx", new string[] { "flag", "VoucherTx_ID", "VoucherTx_Name", "VoucherTx_Type", "Ledger_ID", "Item_id", "Unit_id", "Quantity", "Rate", "Amount", "Office_ID", "ItemTx_FY", "ItemTx_IsActive", "ItemTx_InsertedBy", "ItemTx_OrderBy" },
                                                             new string[] { "0", VoucherTx_ID, "Daily Production From Plant", "Daily Production From Plant", ddlLedgerCr.SelectedValue.ToString(), lblItemID.Text, lblUnitID.Text, lblQuantity.Text, lblRate.Text, lblAmount.Text, ViewState["Office_ID"].ToString(), FinancialYear.ToString(), ItemTx_IsActive, ViewState["Emp_ID"].ToString(), (i).ToString() }, "dataset");
                       ...
                       , new string[] { "4", lblItemID.Text, lblQuantity.Text, "0", lblRate.Text, VoucherTx_ID, "Daily Production From Plant", VoucherTx_No, ViewState["Office_ID"].ToString(), ViewState["Emp_ID"].ToString(), Convert.ToDateTime(txtVoucherTx_Date.Text, cult).ToString("yyyy/MM/dd"), lblAmount.Text }, "dataset");
                        ...
                        objdb.ByProcedure("SpFinLedgerTx",
                                new string[] { "flag", "Ledger_ID", "VoucherTx_ID", "VoucherTx_Type", "LedgerTx_Amount", "LedgerTx_Month", "LedgerTx_Year", "LedgerTx_FY", "Office_ID", "LedgerTx_IsActive", "LedgerTx_InsertedBy", "LedgerTx_OrderBy", "LedgerTx_Type", "LedgerTx_MaintainType" },
                                new string[] { "0", ddlLedgerDr.SelectedValue.ToString(), VoucherTx_ID, "Daily Production From Plant", DebitAmount, Month.ToString(), Year.ToString(), FinancialYear.ToString(), ViewState["Office_ID"].ToString(), "1", ViewState["Emp_ID"].ToString(), "2", "Main Ledger", "None" }, "dataset");
        ...
        try
        {
            ...
            if (ds != null)
            {
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    var rx = new System.Text.RegularExpressions.Regex("PS");
                    ...
                    lblVoucherTx_No.Text = array[0] + "PS";
    ...
    protected void GetPreviousVoucherNo()
    {
        try
        {
            ...
            string VoucherTx_Type = "Daily Production From Plant";

<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="VoucherPurchaseGoodsGSTTaxFree.aspx.cs" Inherits="mis_Finance_VoucherPurchaseGoodsGSTTaxFree" %>
                ...
                <div class="col-md-12">
                    <div class="box box-success" style="background-color: #faf4c7">
                        <div class="box-header">
                            <div class="row">
                                <div class="col-md-4">
                                    <h3 class="box-title">Purchase Voucher(Tax Free)</h3>
                                </div>
                                <div class="col-md-8">
                                    ...
                                    <asp:LinkButton ID="lnkPreviousVoucher" class="btn btn-primary pull-right" Style="margin-right: 10px;" runat="server" Visible="false" OnClick="lnkPreviousVoucher_Click">Copy Previous Voucher</asp:LinkButton>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="box-body">
                            ...
                            <asp:Panel ID="panel1" runat="server">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Party A/c Name (CR)<span style="color: red;"> *</span></label>
                                                ...
                                                <div class="table-responsive">
                                                    <asp:GridView ID="GridViewItem" runat="server" DataKeyNames="ID" ClientIDMode="Static" class="table table-bordered customCSS" Style="margin-bottom: 0px;" AutoGenerateColumns="False" ShowHeaderWhenEmpty="true" OnRowDeleting="GridViewItem_RowDeleting" ShowFooter="true">
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderStyle-HorizontalAlign="Center" HeaderText="CGST" Visible="false">
                                                                <HeaderStyle />
                                                                <ItemStyle HorizontalAlign="Right" />
                                                                <ItemTemplate>
                                                            ...
                                                            <asp:TemplateField HeaderText="Cess Tax" Visible="false">
                                                                <HeaderStyle />
                                                                <ItemStyle HorizontalAlign="Right" />
                                                                <ItemTemplate>

<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="RptOutstandingAgeWiseCustom.aspx.cs" Inherits="mis_Finance_RptOutstandingAgeWiseCustom" %>
                ...
                <div class="box-body">
                    <div class="hide_print">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <asp:Button ID="btnSearch" runat="server" CssClass="btn btn-block btn-success btn-flat" Style="margin-top: 24px;" Text="Search" OnClientClick="return validateform();" />
                            </div>
                        </div>

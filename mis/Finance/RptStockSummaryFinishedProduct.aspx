<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="RptStockSummaryFinishedProduct.aspx.cs" Inherits="mis_Finance_RptStockSummaryFinishedProduct" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentBody" runat="Server">
    ...
    <div class="content-wrapper">
        <section class="content-header">
            <h1>Stock Summary Finished Product
                   <small></small>
            </h1>
        </section>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <fieldset class="box-body">
                                <legend>Stock Summary Finished Product</legend>
                                <div class="row">
                                    <div class="col-md-2">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList ID="ddlReportType" runat="server" class="form-control">  
                                                 <asp:ListItem Value="Item Wise" Selected="True">Item Wise</asp:ListItem>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <asp:Button ID="btn" CssClass="btn btn-md btn-primary show_detail" runat="server" Text="Show Stock Summary Finished Product" OnClick="btn_Click" OnClientClick="return validateform();" />
                                            ...
                                            <div class="table-responsive FirstPrint" stye="max-height:700px;">
                                                ...
                                                <asp:GridView ID="GridView1" runat="server" ShowFooter="True" AutoGenerateColumns="False" class="GridView1" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" ShowHeaderWhenEmpty="True" EmptyDataText="No Record Found">
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="InwardQuantity" HeaderText="Production Quantity" ItemStyle-HorizontalAlign="Right">
                                                            <FooterStyle BackColor="#cfdcc1" />
                                                            <HeaderStyle BackColor="#cfdcc1" />
                                                            <ItemStyle BackColor="#cfdcc1" />
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="InwardRate" HeaderText="Production Rate" ItemStyle-HorizontalAlign="Right">
                                                            <FooterStyle BackColor="#cfdcc1" />
                                                            <HeaderStyle BackColor="#cfdcc1" />
                                                            <ItemStyle BackColor="#cfdcc1" />
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="InwardValue" HeaderText="Production Value" ItemStyle-HorizontalAlign="Right">
                                                        ...
                                                        <asp:BoundField DataField="OutwardQuantity" HeaderText="Sale Quantity" ItemStyle-HorizontalAlign="Right">
                                                            <FooterStyle BackColor="#ffb88f" />
                                                            <HeaderStyle BackColor="#ffb88f" />
                                                            <ItemStyle BackColor="#ffb88f" />
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="OutwardRate" HeaderText="Sale Rate" ItemStyle-HorizontalAlign="Right">
                                                            <FooterStyle BackColor="#ffb88f" />
                                                            <HeaderStyle BackColor="#ffb88f" />
                                                            <ItemStyle BackColor="#ffb88f" />
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="OutwardValue" HeaderText="Sale Value" ItemStyle-HorizontalAlign="Right">
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                <asp:GridView ID="GridView4" runat="server" ShowFooter="True" AutoGenerateColumns="False" class="GridView4" ShowHeaderWhenEmpty="True" EmptyDataText="No Record Found">
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="InwardQuantity" HeaderText="Production Quantity">
                                                            <FooterStyle BackColor="#cfdcc1" />
                                                            <HeaderStyle BackColor="#cfdcc1" />
                                                            <ItemStyle BackColor="#cfdcc1" />
                                                        </asp:BoundField>

<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="RptMisProgressiveDistrict.aspx.cs" Inherits="mis_Finance_RptMisProgressiveBranchWise" %>
        ...
        <section class="content">
            <div class="box box-success">
                <div class="box-header">
                    <h1 class="box-title">MIS Progressive Report (Branch)</h1>
                    ...
                    <div class="row hide-print">
                         <div class="col-md-3">
                            <div class="form-group">
                                <label>Branch</label>
                                <asp:DropDownList ID="ddlOffice" runat="server" CssClass="form-control Select2" Enabled="true"></asp:DropDownList>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">

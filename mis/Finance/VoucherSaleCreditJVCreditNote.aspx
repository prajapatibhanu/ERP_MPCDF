<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="VoucherSaleCreditJVCreditNote.aspx.cs" Inherits="mis_Finance_VoucherSaleCreditJVCreditNote" %>
                ...
                <div class="col-md-12">
                    <div class="box box-success" style="background-color: #faf4c7">
                        <div class="box-header">
                            <div class="row">
                                <div class="col-md-4">
                                    <h3 class="box-title">JV Credit Note Voucher</h3>
                                </div>
                                <div class="col-md-8">

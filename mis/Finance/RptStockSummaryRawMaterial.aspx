<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="RptStockSummaryRawMaterial.aspx.cs" Inherits="mis_Finance_RptStockSummaryRawMaterial" %>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <fieldset class="box-body">
                                <legend>Stock Summary Raw Material</legend>
                                <div class="row">
                                    <div class="col-md-2">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <asp:Button ID="btn" CssClass="btn btn-md btn-primary show_detail" runat="server" Text="Show Stock Summary Raw Material" OnClick="btn_Click" OnClientClick="return validateform();" />
                                            ...
                                            <div class="table-responsive FirstPrint" stye="max-height:700px;">
                                                ...
                                                <asp:GridView ID="GridView1" runat="server" ShowFooter="True" AutoGenerateColumns="False" class="GridView1" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" ShowHeaderWhenEmpty="True" EmptyDataText="No Record Found">
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="InwardQuantity" HeaderText="Purchase Quantity" ItemStyle-HorizontalAlign="Right">
                                                            <FooterStyle BackColor="#cfdcc1" />
                                                            <HeaderStyle BackColor="#cfdcc1" />
                                                            <ItemStyle BackColor="#cfdcc1" />
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="InwardRate" HeaderText="Purchase Rate" ItemStyle-HorizontalAlign="Right">
                                                            <FooterStyle BackColor="#cfdcc1" />
                                                            <HeaderStyle BackColor="#cfdcc1" />
                                                            <ItemStyle BackColor="#cfdcc1" />
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="InwardValue" HeaderText="Purchase Value" ItemStyle-HorizontalAlign="Right">
                                                        ...
                                                        <asp:BoundField DataField="OutwardQuantity" HeaderText="Consumed Quantity" ItemStyle-HorizontalAlign="Right">
                                                            <FooterStyle BackColor="#ffb88f" />
                                                            <HeaderStyle BackColor="#ffb88f" />
                                                            <ItemStyle BackColor="#ffb88f" />
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="OutwardRate" HeaderText="Consumed Rate" ItemStyle-HorizontalAlign="Right">
                                                            <FooterStyle BackColor="#ffb88f" />
                                                            <HeaderStyle BackColor="#ffb88f" />
                                                            <ItemStyle BackColor="#ffb88f" />
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="OutwardValue" HeaderText="Consumed Value" ItemStyle-HorizontalAlign="Right">
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                <asp:GridView ID="GridView4" runat="server" ShowFooter="True" AutoGenerateColumns="False" class="GridView4" ShowHeaderWhenEmpty="True" EmptyDataText="No Record Found">
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="InwardQuantity" HeaderText="Purchase Quantity">
                                                            <FooterStyle BackColor="#cfdcc1" />
                                                            <HeaderStyle BackColor="#cfdcc1" />
                                                            <ItemStyle BackColor="#cfdcc1" />
                                                        </asp:BoundField>

<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="RptTrialBalanceNewF.aspx.cs" Inherits="mis_Finance_RptTrialBalanceNewF" %>
            ...
            <div class="box box-success">
                <div class="box-header Hiderow hide_print">
                    ...
                    <a class="btn btn-primary pull-right" target="_blank" href="RptLedgerTrialBalance.aspx">Alphabetical Trial Balance</a>
                     <a class="btn btn-primary pull-right" target="_blank" href="RptTrialBalanceDetailed.aspx">Detailed Trial Balance</a>

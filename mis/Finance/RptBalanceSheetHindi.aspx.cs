...
public partial class mis_Finance_RptBalanceSheetHindi : System.Web.UI.Page
{
    DataSet ds;
    ...
    protected void FillGrid()
    {
        try
        {
            ...
            ds = objdb.ByProcedure("SpFinRptBalanceSheet_Hindi", new string[] { "flag", "Office_ID_Mlt", "FromDate", "ToDate" }, new string[] { "1", Office, Convert.ToDateTime(txtFromDate.Text, cult).ToString("yyyy/MM/dd"), Convert.ToDateTime(txtToDate.Text, cult).ToString("yyyy/MM/dd") }, "dataset");
            if (ds.Tables.Count != 0 && ds.Tables[0].Rows.Count != 0)
            {
    ...
    protected void FillGridNextMltHead()
    {
        try
        {
            ...
            ds = objdb.ByProcedure("SpFinRptBalanceSheet_Hindi", new string[] { "flag", "Office_ID_Mlt", "FromDate", "ToDate" }, new string[] { "3", Office, Convert.ToDateTime(txtFromDate.Text, cult).ToString("yyyy/MM/dd"), Convert.ToDateTime(txtToDate.Text, cult).ToString("yyyy/MM/dd") }, "dataset");
            if (ds.Tables.Count != 0 && ds.Tables[0].Rows.Count != 0)
            {
    ...
    protected void FillGridNext(string Head_ID)
    {
        try
        {
            ...
            ShowColumn();
            DataSet ds1 = objdb.ByProcedure("SpFinRptBalanceSheet_Hindi", new string[] { "flag", "Head_ID" }, new string[] { "9", Head_ID }, "dataset");
            ...
            ds = objdb.ByProcedure("SpFinRptBalanceSheet_Hindi", new string[] { "flag", "Office_ID_Mlt", "Head_ID", "FromDate", "ToDate" }, new string[] { "2", Office, Head_ID, Convert.ToDateTime(txtFromDate.Text, cult).ToString("yyyy/MM/dd"), Convert.ToDateTime(txtToDate.Text, cult).ToString("yyyy/MM/dd") }, "dataset");
            if (ds.Tables.Count != 0 && ds.Tables[0].Rows.Count != 0)
            {
                //btnHeadExcel.Visible = true;
                spnAltB.Visible = true;
                ...
                else
                {
                    ...
                    GridView1.FooterRow.Cells[7].Text = TotalClosingCreditAmt.ToString();
                    GridView1.FooterRow.Cells[6].Text = Math.Abs(TotalClosingDebitAmt).ToString();
            ...
            ds = objdb.ByProcedure("SpFinRptBalanceSheet_Hindi", new string[] { "flag", "Office_ID_Mlt", "Head_ID", "FromDate", "ToDate" }, new string[] { "5", Office, Head_ID, Convert.ToDateTime(txtFromDate.Text, cult).ToString("yyyy/MM/dd"), Convert.ToDateTime(txtToDate.Text, cult).ToString("yyyy/MM/dd") }, "dataset");
            if (ds.Tables.Count != 0 && ds.Tables[0].Rows.Count != 0)
            {
                //btnHeadExcel.Visible = true;
                spnAltB.Visible = true;
                ...
                for (int i = 0; i < rowcount; i++)
                {
                    ...
                    else
                    {
                        ...
                        GridView2.Rows[i].Cells[7].Text = ClosingCreditAmt.ToString();// + " Cr";
                        GridView2.Rows[i].Cells[6].Text = Math.Abs(ClosingDebitAmt).ToString();// + " Dr";
                    }
                ...
                else
                {
                    ...
                    GridView2.FooterRow.Cells[7].Text = TotalClosingCreditAmt.ToString();
                    GridView2.FooterRow.Cells[6].Text = Math.Abs(TotalClosingDebitAmt).ToString();
                }
    ...
    protected void FillGridNextLedger(string Ledger_ID)
    {
        try
        {
            ...
            DataSet ds1 = objdb.ByProcedure("SpFinRptBalanceSheet_Hindi", new string[] { "flag", "Ledger_ID" }, new string[] { "10", Ledger_ID }, "dataset");
            if (ds1.Tables.Count != 0 && ds1.Tables[0].Rows.Count != 0)
            {
            ...
            ds = objdb.ByProcedure("SpFinRptBalanceSheet_Hindi", new string[] { "flag", "Office_ID_Mlt", "Ledger_ID", "FromDate", "ToDate" }, new string[] { "4", Office, Ledger_ID, Convert.ToDateTime(txtFromDate.Text, cult).ToString("yyyy/MM/dd"), Convert.ToDateTime(txtToDate.Text, cult).ToString("yyyy/MM/dd") }, "dataset");
            if (ds.Tables.Count != 0 && ds.Tables[0].Rows.Count != 0)
            {
    ...
    protected void FillGridNextLedgerMonth(string Ledger_ID, string MonthID)
    {
        try
        {
            ...
            GridView3.DataSource = new string[] { };
            ds = objdb.ByProcedure("SpFinRptBalanceSheet_Hindi", new string[] { "flag", "Office_ID_Mlt", "Ledger_ID", "LedgerTx_Month", "FromDate", "ToDate" }, new string[] { "6", Office, Ledger_ID, MonthID, Convert.ToDateTime(txtFromDate.Text, cult).ToString("yyyy/MM/dd"), Convert.ToDateTime(txtToDate.Text, cult).ToString("yyyy/MM/dd") }, "dataset");
            if (ds.Tables.Count != 0 && ds.Tables[0].Rows.Count != 0)
            {
                ...
                for (int i = 0; i < Count; i++)
                {
                    ...
                    // Inner Transaction
                    ds1 = null;
                    ds1 = objdb.ByProcedure("SpFinRptBalanceSheet_Hindi", new string[] { "flag", "VoucherTx_ID", "Ledger_ID", }, new string[] { "12", ds.Tables[0].Rows[i]["VoucherTx_ID"].ToString(), Ledger_ID }, "dataset");
        ...
        try
        {
            ...
            if (e.CommandName == "View")
            {
                ...
                else if (Head_ID == "00")
                {
                    ...
                    Response.Redirect("RptProfit_Loss.aspx.aspx?FromDate=" + objdb.Encrypt(txtFromDate.Text) + "&ToDate=" + objdb.Encrypt(txtToDate.Text) + "&MltOfficeID=" + objdb.Encrypt(Office));
                }
        ...
        try
        {
            ...
            if (e.CommandName == "View")
            {
                ...
                else if (Head_ID == "00")
                {
                    ...
                    //   Response.Redirect("RptStockSummaryItem.aspx?FromDate=" + objdb.Encrypt(txtFromDate.Text) + "&ToDate=" + objdb.Encrypt(txtToDate.Text) + "&MltOfficeID=" + objdb.Encrypt(Office));
                    Response.Redirect("RptProfit_Loss.aspx?FromDate=" + objdb.Encrypt(txtFromDate.Text) + "&ToDate=" + objdb.Encrypt(txtToDate.Text) + "&MltOfficeID=" + objdb.Encrypt(Office));
                }
            }
            watch.Stop();
            var elapsedMs = watch.ElapsedMilliseconds;

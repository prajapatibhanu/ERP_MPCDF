<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="VoucherItemDebitNote.aspx.cs" Inherits="mis_Finance_VoucherItemDebitNote" %>
                ...
                <div class="col-md-12">
                    <div class="box box-success" style="background-color: #faf4c7">
                        <div class="box-header">
                            <div class="row">
                                <div class="col-md-4">
                                    <h3 class="box-title">Item Debit Note Voucher</h3>
                                </div>
                                <div class="col-md-8">
                                    <a target="_blank" href="LedgerMasterB.aspx" class="btn btn-primary pull-right">Add Ledger</a>

                                    <asp:LinkButton ID="lnkPreviousVoucher" Visible="false" class="btn btn-primary pull-right" Style="margin-right: 10px;" runat="server" OnClick="lnkPreviousVoucher_Click">Copy Previous Voucher</asp:LinkButton>
                            ...
                            <%-- <asp:ImageButton ID="btnRefreshLedgerList" runat="server" ImageUrl="css/btnRefresh.png" CssClass="pull-right Aselect1" Style="height: 28px; border-radius:3px; border-color:white; margin-right: 10px;" OnClick="btnRefreshLedgerList_Click" />--%>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group date">
                                                ...
                                                <asp:TextBox ID="txtVoucherTx_Date" runat="server" CssClass="form-control DateAdd" data-date-end-date="0d" autocomplete="off" OnTextChanged="txtVoucherTx_Date_TextChanged" AutoPostBack="true"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6 hidden">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtSupplyTo" runat="server" CssClass="form-control" autocomplete="off" placeholder="Enter Supply To" MaxLength="500"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            <label>Party A/c Name (DR)<span style="color: red;"> *</span></label>&nbsp;&nbsp; (<asp:Label ID="lblPAN_Status" runat="server" Style="color: red" Text=""></asp:Label>)
                                    ...
                                    <div class="col-md-4 hidden">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtLocation" runat="server" CssClass="form-control" autocomplete="off" placeholder="Enter Location..." MaxLength="50"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                                ...
                                                <div class="table-responsive">
                                                    <asp:GridView ID="GridViewItem" runat="server" DataKeyNames="ID" ClientIDMode="Static" class="table table-bordered customCSS" Style="margin-bottom: 0px;" AutoGenerateColumns="False" ShowHeaderWhenEmpty="true" OnRowDeleting="GridViewItem_RowDeleting" ShowFooter="true">
                                                        <Columns>
                                                            ...
                                                            <asp:TemplateField HeaderText="Purchase Ledger">
                                                                <ItemTemplate>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtVoucherTx_Narration" runat="server" TextMode="MultiLine" CssClass="form-control" autocomplete="off" placeholder="Enter Narration  "></asp:TextBox>
                                        </div>
                                    </div>
                                ...
                                <div class="row hidden">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <asp:TextBox ID="txtTruckNo" runat="server" MaxLength="100" CssClass="form-control" autocomplete="off" placeholder="Enter Truck No"></asp:TextBox>
                                        </div>
                                    </div>
                                     <div class="col-md-3">
                                        <div class="form-group">
                                            <label>Transporter Name </label>
                                            <asp:TextBox ID="txtTransporterName" runat="server" MaxLength="100" CssClass="form-control" autocomplete="off" placeholder="Enter Transporter Name"></asp:TextBox>
                                        </div>
                                    </div>
                                     <div class="col-md-3">
                                        <div class="form-group">
                                            <label>MR No</label>
                                            <asp:TextBox ID="txtMRNo" runat="server" MaxLength="100" CssClass="form-control" autocomplete="off" placeholder="Enter MR No"></asp:TextBox>
                                        </div>
                                    </div>
                                     <div class="col-md-3">
                                        <div class="form-group">
                                            <label>MR Date </label>
                                            <asp:TextBox ID="txtMRDate" runat="server" MaxLength="100" CssClass="form-control" autocomplete="off" placeholder="Enter MR Date"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <a href="VoucherSaleCredit.aspx" id="btn_Clear" runat="server" class="btn btn-default btn-block" style="margin-top: 21px;">Clear</a>

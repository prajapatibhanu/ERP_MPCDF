...
public partial class mis_Finance_RptStockSummary : System.Web.UI.Page
{
    DataSet ds;
    ...
    private void fill_details()
    {
        try
        {
            ...
            //string headingFirst = "<p class='text-center' style='font-weight:600'>Group Wise Stock Summary <br />  [Offices:  " + OfficeName + " ] <br/>-------<br/> [Groups: " + itemgroupname + " ] <br />  " + Convert.ToDateTime(txtFromDate.Text, cult).ToString("dd-MM-yyyy") + "  To " + Convert.ToDateTime(txtToDate.Text, cult).ToString("dd-MM-yyyy") + "</p>";

            //string headingFirst = "<p class='text-center hide_print' style='font-weight:600'>Group Wise Stock Summary <br />  [Offices:  " + OfficeName + " ] <br/>-------<br/> " + Convert.ToDateTime(txtFromDate.Text, cult).ToString("dd-MM-yyyy") + "  To " + Convert.ToDateTime(txtToDate.Text, cult).ToString("dd-MM-yyyy") + "</p>";
            string headingFirst = "<p class='text-center hide_print' style='font-weight:600'>Group Wise Stock Summary <br />   " + ViewState["Office_FinAddress"].ToString() + "  <br/>-------<br/> " + Convert.ToDateTime(txtFromDate.Text, cult).ToString("dd-MM-yyyy") + "  To " + Convert.ToDateTime(txtToDate.Text, cult).ToString("dd-MM-yyyy") + "</p>";

           

            lblheadingmain.Text = headingFirst;

            //lblprinttext.ToolTip = "<p class='text-center' style='font-size:18px'>Group Wise Stock Summary <br />  [Offices:  " + OfficeName + " ] <br/>[Groups: " + itemgroupname + " ] <br />  " + Convert.ToDateTime(txtFromDate.Text, cult).ToString("dd-MM-yyyy") + "  To " + Convert.ToDateTime(txtToDate.Text, cult).ToString("dd-MM-yyyy") + "</p>";

            lblprinttext.ToolTip = "<p class='text-center' style='font-size:18px'>Group Wise Stock Summary <br />   " + ViewState["Office_FinAddress"].ToString() + "  <br/> " + Convert.ToDateTime(txtFromDate.Text, cult).ToString("dd-MM-yyyy") + "  To " + Convert.ToDateTime(txtToDate.Text, cult).ToString("dd-MM-yyyy") + "</p>";

            //lblexceltext.ToolTip = "Group Wise Stock Summary-" + OfficeName + "-" + itemgroupname + "-" + Convert.ToDateTime(txtFromDate.Text, cult).ToString("dd-MM-yyyy") + " To " + Convert.ToDateTime(txtToDate.Text, cult).ToString("dd-MM-yyyy");
            lblexceltext.ToolTip = "Group Wise Stock Summary-" + OfficeName + "-" + Convert.ToDateTime(txtFromDate.Text, cult).ToString("dd-MM-yyyy") + " To " + Convert.ToDateTime(txtToDate.Text, cult).ToString("dd-MM-yyyy");
    ...
    private void fill_details1(int itemgroup, string item_name)
    {
        try
        {
            ...
            string headingFirst = "<p class='text-center' style='font-weight:600'>Stock Summary (" + item_name + ")<br />  " + ViewState["Office_FinAddress"].ToString() + " <br />  " + Convert.ToDateTime(txtFromDate.Text, cult).ToString("dd-MM-yyyy") + "  To " + Convert.ToDateTime(txtToDate.Text, cult).ToString("dd-MM-yyyy") + "</p>";
            lblheadingFirst.Text = headingFirst;

            lblprinttext.ToolTip = "<p class='text-center' style='font-size:18px'>Stock Summary (" + item_name + ")<br />" + ViewState["Office_FinAddress"].ToString() + " " + Convert.ToDateTime(txtFromDate.Text, cult).ToString("dd-MM-yyyy") + "  To " + Convert.ToDateTime(txtToDate.Text, cult).ToString("dd-MM-yyyy") + "</p>";
    ...
    private void fill_details2()
    {
        ...
        try
        {
            ...
            string headingFirst = "<p class='text-center' style='font-weight:600'>Stock Summary <br />   " + ViewState["Office_FinAddress"].ToString() + "  <br />  " + Convert.ToDateTime(txtFromDate.Text, cult).ToString("dd-MM-yyyy") + "  To " + Convert.ToDateTime(txtToDate.Text, cult).ToString("dd-MM-yyyy") + "</p>";
            lblheadingFirst.Text = headingFirst;
            //GridView1.DataSource = null;
            GridView2.DataSource = null;

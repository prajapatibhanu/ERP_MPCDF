<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="Credit-Note.aspx.cs" Inherits="mis_Finance_Credit_Note" %>
            ...
            <div class="box box-pramod">
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>Name of Debtor <span style="color: red;">*</span></label>

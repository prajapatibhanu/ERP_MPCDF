                    ...
                    <div class="box box-success" style="background-color: #fffed9">
                        <div class="box-header">
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    &nbsp;&nbsp;<asp:CheckBox runat="server" ID="chkbox" Text="Show Party Details For GST" onclick="ShowHideDiv(this)"></asp:CheckBox>
                                </div>
                                <div class="col-md-8">
                        ...
                        <div class="box-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <asp:TextBox runat="server" CssClass="form-control" ID="txtLedgerTx_Amount" placeholder="Enter Amount..." MaxLength="12" ClientIDMode="Static" onkeypress="return validateDec(this,event);" autocomplete="off" onblur="return validateAmount(this);"></asp:TextBox>
                                                ...
                                                <asp:GridView runat="server" CssClass="table table-bordered" DataKeyNames="RowNo" ShowHeaderWhenEmpty="True" AutoGenerateColumns="False" ID="GridViewLedgerDetail" ShowFooter="True" OnSelectedIndexChanged="GridViewLedgerDetail_SelectedIndexChanged" OnRowDeleting="GridViewLedgerDetail_RowDeleting">
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="Bill By Bill Detail" ShowHeader="False">
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="LinkButton1"  OnClick="LinkButton1_Click" runat="server" CausesValidation="False" CommandName="Select" CssClass="label label-info" Text='<%# Eval("LedgerTx_MaintainType").ToString()=="None"?"NA":"View" %>'></asp:LinkButton>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <a href="VoucherPaymentD.aspx" id="btnClear" runat="server" class="btn btn-block btn-default" style="margin-top: 21px;">Clear</a>
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <div class="modal fade" id="ModalChequeDetail" role="dialog">
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                     <span style="color: red;">Note : If checkbox of "Cheque" is ticked then user have to enter details in Favouring Name and Cheque/ DD Date.</span>
                    <div class="row">
                        ...
                        <div class="col-md-5">
                            <div class="form-group">
                                <label>Favouring Name</label>
                                <asp:TextBox ID="txtFavouringName" runat="server" placeholder="Enter Favouring Name.." MaxLength="200" CssClass="form-control" autocomplete="off"></asp:TextBox>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                            ...
                            <div class="table-responsive">
                                <asp:GridView runat="server" CssClass="table table-bordered" ShowHeaderWhenEmpty="true" ID="GVFinChequeTx" AutoGenerateColumns="false" ClientIDMode="Static">
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="FavouringName" HeaderText="Favouring Name" /> 

...
public partial class mis_Finance_RptGroupSummaryNew : System.Web.UI.Page
{
    DataSet ds;
        ...
        try
        {
            if (Session["Emp_ID"] != null)
            {
                if (!IsPostBack)
                {
                    ...
                    chkTransactionAmt.Checked = false;
    ...
    protected void FillGridNext(string Head_ID)
    {
        try
        {
          ...
          //  ds = objdb.ByProcedure("SpFinRptTrialBalanceNewFF", new string[] { "flag", "Office_ID_Mlt", "Head_ID", "FromDate", "ToDate" }, new string[] { "2", Office, Head_ID, Convert.ToDateTime(txtFromDate.Text, cult).ToString("yyyy/MM/dd"), Convert.ToDateTime(txtToDate.Text, cult).ToString("yyyy/MM/dd") }, "dataset");
          ...
          //  ds = objdb.ByProcedure("SpFinRptTrialBalanceNewFF", new string[] { "flag", "Office_ID_Mlt", "Head_ID", "FromDate", "ToDate" }, new string[] { "3", Office, Head_ID, Convert.ToDateTime(txtFromDate.Text, cult).ToString("yyyy/MM/dd"), Convert.ToDateTime(txtToDate.Text, cult).ToString("yyyy/MM/dd") }, "dataset");
    ...
    protected void FillGridNextLedgerMonth(string Ledger_ID, string MonthID)
    {
        try
        {
            ...
            if (ds.Tables.Count != 0 && ds.Tables[0].Rows.Count != 0)
            {
                ...
                htmlStr.Append("<th style='width:50px !important'>Type</th>");
                ...
                for (int i = 0; i < Count; i++)
                {
                    ...
                    htmlStr.Append("<td>" + ds.Tables[0].Rows[i]["Type"].ToString() + "</td>");
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        ...
        if (Office != "")
        {
           ...
           // string headingFirst = "<p class='text-center' style='font-weight:600'>Group Summary <br /> Madhya Pradesh State Cooperative Dairy Federation Ltd. <br/> [ " + OfficeName + " ] <br />  " + Convert.ToDateTime(txtFromDate.Text, cult).ToString("dd-MM-yyyy") + "  To " + Convert.ToDateTime(txtToDate.Text, cult).ToString("dd-MM-yyyy") + "</p>";

            string headingFirst = "<p class='text-center' style='font-weight:600'>" + ViewState["Office_FinAddress"].ToString() + " <br />  Group Summary<br />" + Convert.ToDateTime(txtFromDate.Text, cult).ToString("dd-MM-yyyy") + "  To " + Convert.ToDateTime(txtToDate.Text, cult).ToString("dd-MM-yyyy") + "</p>";

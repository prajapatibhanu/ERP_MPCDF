<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="LedgerDetailBForPurchase.aspx.cs" Inherits="mis_Finance_LedgerDetailBForPurchase" %>
                ...
                <div class="col-md-12">
                    <div class="box box-success">
                        <div class="box-header">
                            ...
                            <asp:HyperLink ID="lnkotherledger" runat="server" NavigateUrl="LedgerDetailBOther.aspx" Target="_blank" CssClass="hidden btn btn-primary pull-right">Other Office Ledgers (Only Sundry Creditors)</asp:HyperLink>

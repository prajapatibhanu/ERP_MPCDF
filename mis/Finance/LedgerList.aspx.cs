...
public partial class mis_Finance_LedgerList : System.Web.UI.Page
{
    DataSet ds;
    ...
    protected void FillGrid()
    {
        try
        {
            ...
            ds = objdb.ByProcedure("SpRptLedgerList",
            ...
            //                 new string[] { "2", Ledger_ID.ToString(), ViewState["Office_ID"].ToString() }, "dataset");
    ...
    protected void GVLedgerDetail_RowDeleting(object sender, GridViewDeleteEventArgs e)
    {
        try
        {
            ...
            objdb.ByProcedure("SpFinLedgerMaster", new string[] { "flag", "Ledger_ID", "Ledger_UpdatedBy" }, new string[] { "47", Ledger_ID.ToString(), ViewState["Emp_ID"].ToString()}, "dataset");
            FillGrid();

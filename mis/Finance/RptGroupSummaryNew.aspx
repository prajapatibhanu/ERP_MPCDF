<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="RptGroupSummaryNew.aspx.cs" Inherits="mis_Finance_RptGroupSummaryNew" %>
        ...
        <section class="content">
            <div class="box box-success">
                <div class="box-header Hiderow hide_print">
                    <h3 class="box-title">Group Summary</h3>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <asp:CheckBox ID="chkTransactionAmt" runat="server" Text="Transaction&nbsp;&nbsp;" />
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="hide_print">
                                ...
                                <asp:Button ID="btnMonthExcel" runat="server" CssClass="btn btn-default hidden" Text="Excel" OnClick="btnMonthExcel_Click" />

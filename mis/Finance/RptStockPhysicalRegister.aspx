<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="RptStockPhysicalRegister.aspx.cs" Inherits="mis_Finance_RptStockPhysicalRegister" %>
        ...
        <section class="content">
            <div class="box box-success">
                <div class="box-header Hiderow">
                    <h3 class="box-title">Physical Stock Register</h3>
                ...
                <div class="box-body">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <%--LEDGER DETAIL MONTH WISE--%>
                            <asp:GridView ID="GridView4" DataKeyNames="VoucherTx_ID" runat="server" AutoGenerateColumns="false" class="table table-hover table-bordered" ShowHeaderWhenEmpty="true" OnRowDeleting="GridView4_RowDeleting">
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Particulars">
                                        <ItemTemplate>
                                            <asp:Label ID="lblLedger_Name" Text='<%# Eval("Item_Name").ToString() %>' runat="server" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Branch/Office">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Vch No.">
                                        <ItemTemplate>
                                            <asp:Label ID="lblVoucherTx_No" Text='<%# Eval("VoucherTx_ID").ToString() %>' runat="server" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Reference No.">
                                        <ItemTemplate>
                                            <asp:Label ID="lblVoucherIvoice_No" Text='<%# Eval("InvoiceNo").ToString() %>' runat="server" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Inward Quantity">
                                        <ItemTemplate>
                                            <asp:Label ID="lblVoucherIvoice_No" Text='<%# Eval("Inward").ToString() %>' runat="server" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Outward Quantity">
                                        <ItemTemplate>
                                            <asp:Label ID="lblVoucherIvoice_No" Text='<%# Eval("Outward").ToString() %>' runat="server" />
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="Warehouse">
                                        <ItemTemplate>
                                            <asp:Label ID="lblWarehouse" Text='<%# Eval("WarehouseName").ToString() %>' runat="server" />
                                        </ItemTemplate>
                                    </asp:TemplateField>

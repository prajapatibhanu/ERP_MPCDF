<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="RptCreditNotePaymentRegister.aspx.cs" Inherits="mis_Finance_RptCreditNotePaymentRegister" EnableEventValidation="false" %>
        ...
        <section class="content">
            <div class="box box-success">
                <div class="box-header Hiderow">
                    <h3 class="box-title">Credit Note Register</h3>

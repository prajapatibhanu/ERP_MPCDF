<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="RptContraRegister.aspx.cs" Inherits="mis_Finance_RptContraRegister" EnableEventValidation="false" %>
        ...
        <section class="content">
            <div class="box box-success">
                <div class="box-header Hiderow">
                    <h3 class="box-title">Contra Register</h3>

<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="VoucherCreditNote.aspx.cs" Inherits="mis_Finance_VoucherCreditNote" %>
                ...
                <div class="col-md-12">
                    <div class="box box-success" style="background-color: #fffed9">
                        <div class="box-header">
                            <div class="row">
                                <div class="col-md-4">
                                    <h3 class="box-title" id="vname" runat="server">Credit Note</h3>
                                </div>
                                <div class="col-md-8">
                        ...
                        <div class="box-body">
                                                ...
                                                <asp:GridView runat="server" CssClass="table table-bordered" DataKeyNames="RowNo" ShowHeaderWhenEmpty="True" AutoGenerateColumns="False" ID="GridViewLedgerDetail" ShowFooter="True" OnSelectedIndexChanged="GridViewLedgerDetail_SelectedIndexChanged" OnRowDeleting="GridViewLedgerDetail_RowDeleting">
                                                    ...
                                                    <ItemTemplate>
                                                        ...
                                                        <asp:TemplateField HeaderText="Bill By Bill Detail" ShowHeader="False">
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="LinkButton1" runat="server" CausesValidation="False" CommandName="Select" CssClass="label label-info" Text='<%# Eval("LedgerTx_MaintainType").ToString()=="None"?"NA":"View" %>'></asp:LinkButton>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <a href="VoucherCreditNote.aspx" id="btnClear" runat="server" class="btn btn-block btn-default">Clear</a>
                                    </div>
                                </div>
                            </div>
                        </div>

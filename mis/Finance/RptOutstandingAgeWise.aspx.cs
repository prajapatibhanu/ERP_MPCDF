...
public partial class mis_Finance_RptOutstandingAgeWise : System.Web.UI.Page
{
    DataSet ds, ds2, ds22;
        ...
        try
        {
            ...
            if (ddlBillType.SelectedValue.ToString() == "Cr")
            {
                ds = objdb.ByProcedure("SpFinRptOutstanding",
                   ...
                   new string[] { "9", Office, Convert.ToDateTime(txtToDate.Text, cult).ToString("yyyy/MM/dd"), Convert.ToDateTime(txtFromDate.Text, cult).ToString("yyyy/MM/dd"), Head_ID, ddlBillType.SelectedValue.ToString() }, "dataset");
            }
            else if (ddlBillType.SelectedValue.ToString() == "Dr")
            {
                ds = objdb.ByProcedure("SpFinRptOutstanding",
                   new string[] { "flag", "Office_ID_Mlt", "ToDate", "FromDate", "Head_ID", "BillType" },
                   new string[] { "10", Office, Convert.ToDateTime(txtToDate.Text, cult).ToString("yyyy/MM/dd"), Convert.ToDateTime(txtFromDate.Text, cult).ToString("yyyy/MM/dd"), Head_ID, ddlBillType.SelectedValue.ToString() }, "dataset");
            }
            else if (ddlBillType.SelectedValue.ToString() == "AllBill")
            {
                ds = objdb.ByProcedure("SpFinRptOutstanding",
                   new string[] { "flag", "Office_ID_Mlt", "ToDate", "FromDate", "Head_ID", "BillType" },
                   new string[] { "11", Office, Convert.ToDateTime(txtToDate.Text, cult).ToString("yyyy/MM/dd"), Convert.ToDateTime(txtFromDate.Text, cult).ToString("yyyy/MM/dd"), Head_ID, ddlBillType.SelectedValue.ToString() }, "dataset");
            }
        ...
        try
        {
            ...
            if (ddlBillType.SelectedValue.ToString() == "Cr")
            {
                ds = objdb.ByProcedure("SpFinRptOutstanding",
                   ...
                   new string[] { "12", Office, Convert.ToDateTime(txtToDate.Text, cult).ToString("yyyy/MM/dd"), Convert.ToDateTime(txtFromDate.Text, cult).ToString("yyyy/MM/dd"), Head_ID }, "dataset");
            }
            else if (ddlBillType.SelectedValue.ToString() == "Dr")
            {
                ds = objdb.ByProcedure("SpFinRptOutstanding",
                   new string[] { "flag", "Office_ID_Mlt", "ToDate", "FromDate", "Head_ID" },
                   new string[] { "13", Office, Convert.ToDateTime(txtToDate.Text, cult).ToString("yyyy/MM/dd"), Convert.ToDateTime(txtFromDate.Text, cult).ToString("yyyy/MM/dd"), Head_ID }, "dataset");
            }
            else if (ddlBillType.SelectedValue.ToString() == "AllBill")
            {
                ds = objdb.ByProcedure("SpFinRptOutstanding",
                   new string[] { "flag", "Office_ID_Mlt", "ToDate", "FromDate", "Head_ID" },
                   new string[] { "14", Office, Convert.ToDateTime(txtToDate.Text, cult).ToString("yyyy/MM/dd"), Convert.ToDateTime(txtFromDate.Text, cult).ToString("yyyy/MM/dd"), Head_ID }, "dataset");
            }

<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="FarmersPayment.aspx.cs" Inherits="mis_Payment_FarmersPayment" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentBody" Runat="Server">
    ...
    <asp:ValidationSummary ID="vs" runat="server" ValidationGroup="a" ShowMessageBox="true" ShowSummary="false" />
            <div class="content-wrapper">
                    ...
                    <div class="col-md-12">
                        <div class="box box-primary">
                            <div class="box-header">
                                <h3 class="box-title">Producer's Payment</h3>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                       <div class="form-group">
                                        ...
                                        <span class="pull-right">
                                            <asp:RequiredFieldValidator ID="rfvProducerName" ForeColor="Red" Display="Dynamic" ValidationGroup="a" runat="server" ControlToValidate="ddlProducerName" InitialValue="0" ErrorMessage="Select Producer Name" Text="<i class='fa fa-exclamation-circle' title='Select Producer Name !'></i>">
                                            </asp:RequiredFieldValidator>
                                        </span>
                                        <asp:DropDownList ID="ddlProducerName" runat="server" CssClass="form-control select2" ClientIDMode="Static">
                                            <asp:ListItem>Select</asp:ListItem>
                                            <asp:ListItem>Laxman Sahu</asp:ListItem>
                                            <asp:ListItem>Ram Kisen Sen</asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
                                    </div>
                                    <div class="col-md-4">
                                        ...
                                        <asp:DropDownList ID="ddlDCSName" runat="server" CssClass="form-control select2" disabled  ClientIDMode="Static">
                                            <asp:ListItem>Select</asp:ListItem>
                ...
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Producer's Payment Detail </h3>
                    </div>
                    <div class="box-body">
                        <div class="row">
                            <div class="col-md-12">
                                        ...
                                        <table class="datatable table table-striped table-bordered table-hover" cellspacing="0" rules="all" border="1" id="ctl00_ContentBody_gvOpeningStock" style="border-collapse:collapse;">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th scope="col">Producer ID<br /></th>
                                                    <th scope="col">DCS Name </th>
                                                    <th scope="col">Date <br /></th>
                                                    <th scope="col">Milk Type <br /></th>
                                                    <th scope="col">Milk Qt (KG) <br /></th>
                                                    <th scope="col">Fat % <br /></th>
                                                    <th scope="col">SNF % <br /></th>
                                                    <th scope="col">Value(INR) <br /></th>
                                                    <th scope="col">UTR No/Voucher No <br /></th>
                                                    <th scope="col">Bonus Amount <br /></th>
                                                    <th scope="col">Payment Status <br /></th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <label>
                                        <input type="checkbox" style="margin-top:26px;font-size:20px;" name="eligibleforbonous" value="eligibleforbonous" id="myCheck" onclick="myFunction()"> Eligible for Bonus
                                    </label>
                            ...
                            <div class="col-md-4" id="bamt" style="display:none">
                                <div class="form-group">

                                    <label>Bonus Amount<span class="text-danger">*</span></label>
                                    <input name="ctl00$ContentBody$txtemail" type="text" maxlength="50" id="ctl00_ContentBody_txtemail" class="form-control" placeholder="Bonus Amount" />
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input name="ctl00$ContentBody$txtemail" type="text" maxlength="50" id="ctl00_ContentBody_txtemail" class="form-control" placeholder="Total Amount" />
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>UTR No/Voucher No<span class="text-danger">*</span></label>
                                    <input name="ctl00$ContentBody$txtemail" type="text" maxlength="50" id="ctl00_ContentBody_txtemail" class="form-control" placeholder="UTR No/Voucher No" />
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentFooter" Runat="Server"> 
     <script type="text/javascript">
         function myFunction() {
             ...
             // Get the output text
             var text = document.getElementById("bamt");

...
public partial class mis_Garage_GrgVehicleReport_Headoffice : System.Web.UI.Page
{
    ...
    protected void FillGrid()
    {
        try
        {
            ...
            ds = objdb.ByProcedure("spGrgVehicleMaster", new string[] { "flag", "Office_ID", "VehicleOwnedType", "VehicleID" },
                new string[] { "13", ViewState["Office_ID"].ToString(), ddlVehicleOwnedType.SelectedValue.ToString(), ddlVehicleNo.SelectedValue.ToString() }, "dataset");

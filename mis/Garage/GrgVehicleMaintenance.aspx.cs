...
public partial class mis_Garage_GrgVehicleMaintenance : System.Web.UI.Page
{
    DataSet ds;
    ...
    protected void FillVehicle()
    {
        try
        {
            ...
            ds = objdb.ByProcedure("spGrgVehicleMaster", new string[] { "flag", "VehicleOwnedType", "Office_ID" }, new string[] { "3", rbtVehicleOwnedType.SelectedValue.ToString(), ViewState["Office_ID"].ToString() }, "dataset");
            if (ds != null && ds.Tables[0].Rows.Count > 0)
            {

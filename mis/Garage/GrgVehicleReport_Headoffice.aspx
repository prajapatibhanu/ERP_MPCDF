<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="GrgVehicleReport_Headoffice.aspx.cs" Inherits="mis_Garage_GrgVehicleReport_Headoffice" %>
                ...
                <div class="box-body">
                    <div class="hide_print">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <asp:Button ID="btnSearch" runat="server" Style="margin-top:20px;" CssClass="btn btn-block btn-success" Text="Search" OnClick="btnSearch_Click" />
                            </div>
                        </div>
                                ...
                                <Columns>
                                   ...
                                   <%-- <asp:BoundField DataField="VehicleOwnedType" HeaderText="Vehicle Owned Type" />--%>
                                    <asp:BoundField DataField="VehicleNo" HeaderText="Vehicle No" />
                                     <asp:BoundField DataField="VehicleCategory" HeaderText="Vehicle Category" />
                                    ...
                                    <asp:BoundField DataField="VehicleChechisNo" HeaderText="Vehicle Chechis No" />
                                    <asp:BoundField DataField="VehicleRegistrationNo" HeaderText="Vehicle Registration No" />
                                     <asp:BoundField DataField="VehicleInsuranceNo" HeaderText="Vehicle Insurance No" />
                                    ...
                                    <asp:BoundField DataField="InsuranceValidTill" HeaderText="Insurance Valid Till" />
                                     <asp:BoundField DataField="InsuranceCompany" HeaderText="Insurance Company" />
                                    ...
                                    <asp:TemplateField HeaderText="Action" ShowHeader="False">
                                        <ItemTemplate>
                                            ...
                                            <asp:HyperLink ID="HL_Edit" CssClass="label label-info" Target="_blank" NavigateUrl='<%# "~/mis/Garage/GrgVehicleMaster_Headoffice.aspx?Action=" + APIProcedure.Client_Encrypt(Eval("VehicleID").ToString())%>' runat="server">Edit</asp:HyperLink>
                                        </ItemTemplate>
                                    </asp:TemplateField>

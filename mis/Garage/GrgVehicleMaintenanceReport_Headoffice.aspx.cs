...
using System.Text;
using System.IO;
public partial class mis_Garage_GrgVehicleMaintenanceReport_Headoffice : System.Web.UI.Page
{
    DataSet ds;
    ...
    protected void FillVehicle()
    {
        try
        {
            ...
            ds = objdb.ByProcedure("spGrgVehicleMaster", new string[] { "flag", "VehicleOwnedType", "Office_ID" },
                new string[] { "12", "0", ViewState["Office_ID"].ToString() }, "dataset");
        ...
        try
        {
            ...
            if (ddlYear.SelectedIndex > 0 && ddlMonth.SelectedIndex > 0)
            {
                ds = objdb.ByProcedure("spGrgVehicleMaster", new string[] { "flag", "Office_ID", "Year", "MonthNo", "VehicleOwnedType", "VehicleID" },
                    new string[] { "8", ViewState["Office_ID"].ToString(), ddlYear.SelectedValue.ToString(), ddlMonth.SelectedValue.ToString(), "0", ddlVehicleNo.SelectedValue.ToString() }, "dataset");

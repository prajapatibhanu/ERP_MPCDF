<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="GrgVehicleMaintenanceReport.aspx.cs" Inherits="mis_Garage_GrgVehicleMaintenanceReport" %>
                ...
                <div class="box-body">
                    <div class="hide_print">
                            ...
                            <div class="col-md-3">
                                ...
                                <div class="form-group">
                                    <asp:RadioButtonList ID="rbtVehicleOwnedType" runat="server" RepeatColumns="2" CssClass="form-control" OnSelectedIndexChanged="rbtVehicleOwnedType_SelectedIndexChanged" AutoPostBack="true">
                                        <asp:ListItem Value="Hired" Selected="True">&nbsp;Hired&nbsp;&nbsp;</asp:ListItem>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <a class="btn btn-block btn-default" href="GrgVehicleMaintenanceReport.aspx" style="margin-top: 18px;">Cancel</a>
                            </div>
                        </div>
                    </div>

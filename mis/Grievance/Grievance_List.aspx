<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="Grievance_List.aspx.cs" Inherits="mis_Grievance_Grievance_List" %>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-success">
                        <div class="box-header with-border">
                            <h3 class="box-title" id="Label1">Grievance List</h3>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="table-responsive">
                                        <asp:GridView ID="GridView1" DataKeyNames="Application_ID" runat="server" AutoGenerateColumns="False" class="datatable  table table-hover table-bordered pagination-ys" OnPageIndexChanging="GridView1_PageIndexChanging">
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="Application_GrievanceType" HeaderText="Grievance Type" />
                                                ...
                                                <%--<asp:BoundField DataField="Application_Descritption" HeaderText="Application Descritption" />--%>
                                                ...
                                                <asp:TemplateField HeaderText="View More Detail">
                                                    <ItemTemplate>
                                                        <a id="a1" runat="server" style="label label-default" target="_blank" href='<%# "ViewStatus.aspx?Application_ID=" +APIProcedure.Client_Encrypt(Eval("Application_ID").ToString()) %>'>View More</a>

<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="ViewStatus.aspx.cs" Inherits="mis_Grievance_ViewStatus" %>
                                    ...
                                    <div class="col-md-12">
                                        <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="false" class="table table-striped table-bordered">
                                            <Fields>
                                                ...
                                                <asp:BoundField DataField="Application_RefNo" HeaderText="Reference No" HeaderStyle-Font-Bold="true" />
                                                <asp:BoundField DataField="Application_Subject" HeaderText="Subject" HeaderStyle-Font-Bold="true" />

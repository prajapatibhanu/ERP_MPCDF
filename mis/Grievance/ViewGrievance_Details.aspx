<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="ViewGrievance_Details.aspx.cs" Inherits="mis_Grievance_ViewGrievance_Details" %>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-success">
                        <div class="box-header with-border">
                           <%-- <h3 class="box-title" id="Label1">Grievance Requests (Internal Discussion)</h3>--%>
                        </div>
                        <div class="box-body">
                            <div class="row">
                                <asp:Label ID="Label2" runat="server" Text="" Visible="true"></asp:Label>
                                <div class="col-md-12">
                                    <asp:Label ID="lblMsg" runat="server" Text="" Visible="true" Style="color: red; font-size: 17px;"></asp:Label>
                                    <div class="table-responsive">
                                        <asp:GridView ID="GridView1" DataKeyNames="Application_ID" runat="server" AutoGenerateColumns="False" class="datatable table table-striped table-bordered" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
                                            <Columns>

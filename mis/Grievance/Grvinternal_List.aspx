<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="Grvinternal_List.aspx.cs" Inherits="mis_Grievance_Grvinternal_List" %>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="table-responsive">
                                        <asp:GridView ID="GridView1" DataKeyNames="Application_ID" runat="server" AutoGenerateColumns="False" class="table table-striped table-bordered" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="Forward_UpdatedOn" HeaderText="Forward Date" />

<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="GrievanceOtherSuggestionReport.aspx.cs" Inherits="mis_Grievance_GrievanceOtherSuggestionReport" %>
                ...
                <div class="col-md-12">
                    <div class="box box-success">
                        <div class="box-header with-border">
                            <div class="row">
                                <div class="col-md-10">
                                    <h3 class="box-title" id="Label1">Other Suggestions Report (Complaints)</h3>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="box-body">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <asp:Button ID="btnSearch" runat="server" Style="margin-top: 20px;" Text="Search" CssClass="btn btn-success" OnClick="btnSearch_Click" />
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <asp:GridView ID="GrvDetail" runat="server" EmptyDataText="No Record Found!!" CssClass="datatable table table-bordered table-hover table-striped" AutoGenerateColumns="false">
                                        <Columns>
                                            ...
                                            <asp:BoundField DataField="Application_Descritption" HeaderText="Descritption" />

...
public partial class mis_DCSInformation_UnionWiseDCSReport : System.Web.UI.Page
{
    ...
    protected void FillGrid()
    {
        try
        {
            ...
            gvDetails.DataBind();
            ds = objdb.ByProcedure("SpKCCReports", new string[] { "flag", "FromDate", "ToDate", "Office_ID" }, new string[] { "3", Convert.ToDateTime(txtFromDate.Text, cult).ToString("yyyy/MM/dd"), Convert.ToDateTime(txtToDate.Text, cult).ToString("yyyy/MM/dd"), objdb.Office_ID() }, "dataset");

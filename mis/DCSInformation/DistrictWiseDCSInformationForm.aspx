<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="DistrictWiseDCSInformationForm.aspx.cs" Inherits="mis_DCSInformation_DistrictWiseDCSInformationForm" %>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <asp:DropDownList ID="ddlDistrict" runat="server" CssClass="form-control select2">
                                        ...
                                        <asp:ListItem>Ashok Nagar</asp:ListItem>
                                    </asp:DropDownList>
                                </div>
                            </div>
                            <div class="col-md-2">

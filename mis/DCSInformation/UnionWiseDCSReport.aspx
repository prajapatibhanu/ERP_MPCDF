<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="UnionWiseDCSReport.aspx.cs" Inherits="mis_DCSInformation_UnionWiseDCSReport" %>
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Union Wise DCS Information Report</h3>
                    </div>
                    <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <table id="tblExport" runat="server" style="width:100%">
                                        <tr><td>
                                            ...
                                            <asp:GridView ID="gvDetails" runat="server" EmptyDataText="No Record Found" CssClass="table table-bordered" AutoGenerateColumns="false" ShowFooter="true">
                                                <Columns>

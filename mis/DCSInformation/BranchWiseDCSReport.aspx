<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="BranchWiseDCSReport.aspx.cs" Inherits="mis_DCSInformation_BranchWiseDCSReport" %>
            ...
            <div class="col-md-12">
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">Branch Wise DCS Information Report</h3>
                    </div>
                    <div class="box-body">
                        ...
                        <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="ddlBranchName" runat="server" CssClass="form-control select2">                                           
                            ...
                            <div class="form-group">
                                ...
                                <asp:GridView ID="gvDetails" ShowHeaderWhenEmpty="true" runat="server" CssClass="table table-bordered" EmptyDataText="No Record Found" AutoGenerateColumns="false" ShowFooter="true">
                                            <Columns>
                                                ...
                                                <asp:BoundField HeaderText="Name of Branch" DataField="BranchName" />

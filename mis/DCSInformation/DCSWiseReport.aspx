<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="DCSWiseReport.aspx.cs" Inherits="mis_DCSInformation_DCSWiseReport" %>
                ...
                <div class="box box-primary">
                    ...
                    <div class="box-body">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>District</label>
                                 <asp:ListBox runat="server" ID="ddlDistrict" ClientIDMode="Static" CssClass="form-control" SelectionMode="Multiple" OnSelectedIndexChanged="ddlDistrict_SelectedIndexChanged1" AutoPostBack="true"></asp:ListBox>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                <label>DCS</label>
                                 <asp:ListBox runat="server" ID="ddlDCS" ClientIDMode="Static" CssClass="form-control" SelectionMode="Multiple"></asp:ListBox>
                                ...
                                <div class="table-responsive">
                                    <asp:GridView ID="gvDetails" ShowHeaderWhenEmpty="true" runat="server" CssClass="table table-bordered" EmptyDataText="No Record Found" AutoGenerateColumns="false" ShowFooter="true">
                                        <Columns>
                                            ...
                                            <asp:BoundField HeaderText="Name of DCS" DataField="DCSName" ItemStyle-Width="30%" />

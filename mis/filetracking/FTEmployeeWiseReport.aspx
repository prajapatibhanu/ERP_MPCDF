<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="FTEmployeeWiseReport.aspx.cs" Inherits="mis_filetracking_FTEmployeeWiseReport" %>
                            ...
                            <div class="row no-print">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="ddlEmployeeName" CssClass="form-control select2" runat="server" OnSelectedIndexChanged="ddlEmployeeName_SelectedIndexChanged" AutoPostBack="true"></asp:DropDownList>
                                    </div>
                                </div>
                            </div>
                            <div class="row">

...
public partial class mis_filetracking_FTLetterOrFileReport : System.Web.UI.Page
{
    DataSet ds;
    ...
    protected void FillDetail()
    {
        try
        {
            ...
            GridView1.DataBind();
            ds = objdb.ByProcedure("SpFTForwardFile",
                    new string[] { "Flag", "Department_ID", "StatusOfFile" },
                    new string[] { "23", ddlDepartment.SelectedValue.ToString(), ddlType.SelectedValue.ToString() }, "dataset");
            if (ds != null && ds.Tables[0].Rows.Count > 0)
            {

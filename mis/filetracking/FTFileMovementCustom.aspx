<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="FTFileMovementCustom.aspx.cs" Inherits="mis_filetracking_FTFileMovementCustom" %>
                ...
                <div class="col-md-12">
                    ...
                    <div class="box box-success">
                        <div class="box-header with-border">
                            ...
                            <div class="row">
                                <div class="col-md-10">
                                    <h3 class="box-title" id="Label1">File Movement Detail <small>DateWise</small></h3>
                                </div>
                            </div>
                        </div>
                        <!-- /.box-header -->
                            ...
                            <div class="row">
                                ...
                                <div id="FileDetail" runat="server">
                                    <div class="col-md-12">
                                        ...
                                        <asp:GridView ID="GridView1" runat="server" DataKeyNames="File_ID" PageSize="100" class="datatable table table-striped table-hover table-bordered pagination-ys" AutoGenerateColumns="False" ShowHeaderWhenEmpty="True">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="File Priority">
                                                    <EditItemTemplate>
                                                        <asp:Label ID="lblfilepriority" runat="server" Text='<%# Bind("File_Priority") %>'></asp:Label>
                                                    </EditItemTemplate>
                                                    <ItemTemplate>
                                                        <asp:Label ID="Label1" runat="server" Text='<%# Bind("File_Priority") %>'></asp:Label>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                                ...
                                                <asp:BoundField DataField="Forwarded_UpdatedOn" HeaderText="FORWARDED DATE" />

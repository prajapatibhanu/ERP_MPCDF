<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="OverAllSearchFile.aspx.cs" Inherits="mis_filetracking_OverAllSearchFile" %>
                ...
                <div class="col-md-12">
                    <div class="box box-success">
                        ...
                        <div class="box-header">
                            <h3 class="box-title">फ़ाइल / पत्र / क्यूआर कोड / शीर्षक / विवरण खोजें</h3>
                        </div>
                        <div class="box-body">
                            <div class="row">
                                <div class="col-md-5">
                                    <div class="form-group">
                                        <label>File/ Letter No. / QR Code/ File Tilte/ File Desc<span style="color: red;">*</span></label>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <asp:GridView ID="GridView1" PageSize="50" runat="server" class="table table-hover table-bordered pagination-ys" ShowHeaderWhenEmpty="true" AutoGenerateColumns="False" DataKeyNames="File_ID" EmptyDataText="No Record Found" OnSelectedIndexChanged="GridView1_SelectedIndexChanged">
                                        <Columns>

...
public partial class mis_E_Invoice_BRptB2B_Details : System.Web.UI.Page
{
    DataSet ds;
    ...
    protected void FillGrid()
    {
        try
        {
            ...
            //{
            ds = objdb.ByProcedure("SpFinE_Invoice", new string[] { "flag", "Office_ID", "FromDate", "ToDate" }, new string[] { "1", ddlOffice.SelectedValue.ToString(), Convert.ToDateTime(txtFromDate.Text, cult).ToString("yyyy/MM/dd"), Convert.ToDateTime(txtToDate.Text, cult).ToString("yyyy/MM/dd") }, "dataset");
            if (ds.Tables.Count != 0 && ds.Tables[0].Rows.Count != 0)
            {

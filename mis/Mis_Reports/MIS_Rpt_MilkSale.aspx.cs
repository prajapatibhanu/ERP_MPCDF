...
public partial class mis_Mis_Reports_MIS_Rpt_MilkSale : System.Web.UI.Page
{
    ...
    protected void GetOfficeDetails()
    {
        ...
        {
            lblMsg.Text = objdb.Alert("fa-ban", "alert-danger", "Sorry! : Error Office Details ", ex.Message.ToString());
        }
        finally
        {
    ...
    protected void GenerateReport()
    {
        try
        {
            ...
            ds2 = objdb.ByProcedure("USP_Trn_Manage_MIS_Data"
                ...
                , new string[] { "5", fromnonth, tomonth }, "dataset");
            if (ds2 != null && ds2.Tables.Count > 0)
            {
                ...
                sb1.Append("<thead>");
                sb1.Append("<tr>");
                sb1.Append("<td colspan='" + (ColCount) + "' style='text-align: center;border:1px solid black;'><b>MILK SALE (" + fmonth.ToString("MMM-yyyy") + ") </b></td>");
                sb1.Append("</tr>");
                sb1.Append("<tr>");
    ...
    protected void btnExcel_Click(object sender, EventArgs e)
    {
        ...
        {
            Response.Clear();
            Response.AddHeader("content-disposition", "attachment; filename=" + "MontylyMilkSaleRpt_" + txtMonth.Text + "_" + DateTime.Now + ".xls");
            Response.Charset = "";
        ...
        {
            lblMsg.Text = objdb.Alert("fa-ban", "alert-danger", "Sorry! : Error Export ", ex.Message.ToString());
        }
    }

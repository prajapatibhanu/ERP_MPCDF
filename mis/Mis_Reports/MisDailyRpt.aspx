<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="MisDailyRpt.aspx.cs" Inherits="mis_MisDailyRpt" %>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <asp:ListBox runat="server" ID="ddlOfficeName" ClientIDMode="Static" CssClass="form-control" SelectionMode="Multiple"></asp:ListBox>

<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="MIS_DLYRPTReport.aspx.cs" Inherits="mis_Mis_Reports_MIS_DLYRPTReport" %>
            ...
            <div class="row">
                <div class="box box-primary">
                    <div class="box-header">
                        <h3 class="box-title">DAILY INFORMATION REPORT</h3>
                    ...
                    <div class="box-body">
                        <div class="row no-print">
                            <div class="col-md-12">
                                <fieldset>
                                    <legend>DAILY INFORMATION REPORT</legend>
                                    <div class="row">
                                        <div class="col-md-4">
                        ...
                        <div class="row">
                            <div class="col-md-2 pull-right">
                                <div runat="server" id="divExcel">
                                    <input type="button" class="btn btn-primary no-print" onclick="tableToExcel('tableData', 'W3C Example Table')" value="Export to Excel">
                                    <input type="button" class="btn btn-default no-print" onclick="window.print()" value="Print">
                                </div>

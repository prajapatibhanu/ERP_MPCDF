...
public partial class mis_Mis_Reports_MIS_DailyFReport : System.Web.UI.Page
{
    ...
    protected void FillDetail()
    {
        try
        {
            lblMsg.Text = "";
            int RowNo = 1;
            ds = objdb.ByProcedure("USP_MIS_DLYFRptReport",
            ...
            if (ds != null && ds.Tables.Count > 0)
            {
                ...
                sb.Append("</tr>");
                sb.Append("<tr>");
                sb.Append("<td colspan='9' style='text-align:center; font-size:18px;'><b>Daily F Report of : " + Convert.ToDateTime(txtToDate.Text, cult).ToString("dd/MM/yyyy") + "</b></td>");
                sb.Append("</tr>");
                sb.Append("</thead>");
                sb.Append("<tr>");
                        ...
                        for (int j = 0; j < ds.Tables[2].Columns.Count; j++)
                        {
                            if (ds.Tables[2].Columns[j].ToString() != "ColumnName" && ds.Tables[2].Columns[j].ToString() != "Header")
                            {
                                ...
                                else
                                {
                                    ...
                                    Total1 += Convert.ToDecimal(ds.Tables[2].Rows[i][Columns].ToString());
                                }
                            }
                        }
                        sb.Append("<td><b>" + Total1.ToString() + "</b></td>");
                        sb.Append("</tr>");
                    }
                }
                sb.Append("</table>");

...
public partial class mis_MisDailyRptOfficeWise : System.Web.UI.Page
{
    ...
    protected void FillOffice()
    {
        try
        {
            ...
            ds = objdb.ByProcedure("sp_Mis_ReportDaily",
                            ...
                            new string[] { "7", ViewState["Office_ID"].ToString() }, "dataset");
    ...
    protected void FillGrid()
    {
        try
        {
            ...
            if (msg.Trim() == "")
            {
                ds = objdb.ByProcedure("SP_MIS_Report_OfficeWise",
                            new string[] { "flag", "OfficeID", "Tmc_FromDate" },
                            new string[] { "0", ddlOfficeName.SelectedValue, rptDate }, "dataset");

                //DataSet ds2 = objdb.ByProcedure("SP_MIS_Report_OfficeWise",
                //                new string[] { "flag", "OfficeID", "Tmc_FromDate" },
                //            new string[] { "1", ddlOfficeName.SelectedValue, rptDate }, "dataset");

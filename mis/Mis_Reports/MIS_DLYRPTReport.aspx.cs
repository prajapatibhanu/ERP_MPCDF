...
public partial class mis_Mis_Reports_MIS_DLYRPTReport : System.Web.UI.Page
{
    ...
    protected void FillDetail()
    {
        try
        {
            lblMsg.Text = "";
            int RowNo = 1;
            ds = objdb.ByProcedure("USP_MIS_DLYRptReport",
            ...
            if (ds != null && ds.Tables.Count > 0)
            {
                ...
                sb.Append("</tr>");
                sb.Append("<tr>");
                sb.Append("<td colspan='9' style='text-align:center; font-size:18px;'><b>DAILY INFORMATION REPORT of : " + Convert.ToDateTime(txtToDate.Text, cult).ToString("dd/MM/yyyy") + "</b></td>");
                sb.Append("</tr>");
                sb.Append("</thead>");
                sb.Append("<tr>");
                ...
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                    {
                        ...
                        {
                            RowNo = RowNo + 1;
                            ViewState["MainHeader"] = "Yes";
                            sb.Append("<td><b>" + (RowNo).ToString() + "</b></td>");
                        }
                        else
                        {
                            ViewState["MainHeader"] = "No";
                            sb.Append("<td></td>");
                        }
                ...
                if (ds.Tables[2].Rows.Count > 0)
                {
                    ...
                    {
                        sb.Append("<tr>");
                        if (ds.Tables[2].Rows[i]["Header"].ToString() == "MainHeader")
                        {
                            RowNo = RowNo + 1;
                            ViewState["MainHeader"] = "Yes";
                            sb.Append("<td><b>" + (RowNo).ToString() + "</b></td>");
                        ...
                        sb.Append("<td>" + ds.Tables[2].Rows[i]["ColumnName"].ToString() + "</td>");
                        for (int j = 0; j < ds.Tables[2].Columns.Count; j++)
                        {
                            if (ds.Tables[2].Columns[j].ToString() != "ColumnName" && ds.Tables[2].Columns[j].ToString() != "Header")
                            {
                                string Columns = ds.Tables[2].Columns[j].ToString();
                                if (ds.Tables[2].Rows[i][Columns] == DBNull.Value || ds.Tables[2].Rows[i][Columns].ToString() == null)
                                {
                                    if (ViewState["MainHeader"] == "Yes")
                                    {
                                        sb.Append("<td>-</td>");
                                ...
                                {
                                    sb.Append("<td>" + ds.Tables[2].Rows[i][Columns].ToString() + "</td>");
                                }
                            }
                        }
                        sb.Append("<td></td>");
                ...
                if (ds.Tables[3].Rows.Count > 0)
                {
                    ...
                    {
                        sb.Append("<tr>");
                        if (ds.Tables[3].Rows[i]["Header"].ToString() == "MainHeader")
                        {
                            ViewState["MainHeader"] = "Yes";
                            RowNo = RowNo + 1;
                            sb.Append("<td><b>" + (RowNo).ToString() + "</b></td>");
                        ...
                        sb.Append("<td>" + ds.Tables[3].Rows[i]["ColumnName"].ToString() + "</td>");
                        for (int j = 0; j < ds.Tables[3].Columns.Count; j++)
                        {
                            if (ds.Tables[3].Columns[j].ToString() != "ColumnName" && ds.Tables[3].Columns[j].ToString() != "Header")
                            {
                                string Columns = ds.Tables[3].Columns[j].ToString();
                                if (ds.Tables[3].Rows[i][Columns] == DBNull.Value || ds.Tables[3].Rows[i][Columns].ToString() == null)
                                {
                                    if (ViewState["MainHeader"] == "Yes")
                                    {
                                        sb.Append("<td>-</td>");
                                ...
                                {
                                    sb.Append("<td>" + ds.Tables[3].Rows[i][Columns].ToString() + "</td>");
                                }
                            }
                        }
                        sb.Append("<td></td>");

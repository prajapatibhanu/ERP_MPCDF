...
public partial class mis_Mis_Reports_FRM_MilkWBCosumtion : System.Web.UI.Page
{
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            ds = objdb.ByProcedure("USP_MIS_Trn_CommoditiesConsumption", new string[] { "Flag", "Year", "Month" },
                new string[] { "3", ddlYear.SelectedValue.ToString(), ddlMonth.SelectedValue.ToString() }, "dataset");

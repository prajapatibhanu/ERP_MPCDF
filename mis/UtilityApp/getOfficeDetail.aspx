<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="getOfficeDetail.aspx.cs" Inherits="mis_UtilityApp_getOfficeDetail" %>
        ...
        <section class="content">
            ...
            <div class="box box-success">
                ...
                <div class="box-header">
                    <h3 class="box-title">Get CC Wise Office Details</h3>
                </div>
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-12">

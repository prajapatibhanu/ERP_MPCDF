<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="CCWiseInsertOfficeDetail.aspx.cs" Inherits="mis_UtilityApp_CCWiseInsertOfficeDetail" %>
        ...
        <section class="content">
            ...
            <div class="box box-success">
                ...
                <div class="box-header">
                    <h3 class="box-title">CC Wise Insert Office Details</h3>
                </div>
                <div class="box-body">
                    <div class="row">
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <div class="col-md-12">
                                <p>
                                    ...
                                    M_SNo,M_SOC_CD, M_SOC_NAM,M_SOC_NAM_H, M_BANK_AC, M_IFSC_CD
                                </p>
                            </div>
                        </div>
                    </div>-

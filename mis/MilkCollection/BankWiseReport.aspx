<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="BankWiseReport.aspx.cs" Inherits="mis_MilkCollection_BankWiseReport" %>
                ...
                <div class="col-md-12">
                    <div class="box box-success">
                        <div class="box-header">
                            <h3 class="box-title">Bank Wise Report</h3>
                        </div>
                                   ...
                                   <%-- <span class="pull-right">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ValidationGroup="a"
                                            InitialValue="0" ErrorMessage="Select Bank" Text="<i class='fa fa-exclamation-circle' title='Select Bank !'></i>"

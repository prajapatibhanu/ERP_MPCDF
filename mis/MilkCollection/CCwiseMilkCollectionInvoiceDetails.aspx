<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="CCwiseMilkCollectionInvoiceDetails.aspx.cs" Inherits="mis_MilkCollection_CCwiseMilkCollectionInvoiceDetails" %>
                                    ...
                                    <asp:TemplateField HeaderText="Invoice No">
                                        <ItemTemplate>
                                            <asp:Label ID="lblMilkCollectionInvoiceNo" runat="server" Text='<%# Eval("MilkCollectionInvoiceNo") %>'></asp:Label>
											 ...
											 <asp:Label ID="lblGenerateTo_Office_ID" Visible="false" runat="server" Text='<%# Eval("GenerateTo_Office_ID") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

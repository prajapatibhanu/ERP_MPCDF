<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="SocietywiseMilkCollectionInvoice.aspx.cs" Inherits="mis_MilkCollection_SocietywiseMilkCollectionInvoice" %>
        ...
        <section class="content">
            ...
            <div class="box box-success">
                <div class="box-header">
                    <h3 class="box-title">Generate Society Milk Invoice</h3>
                </div>
                                ...
                                <asp:GridView ID="gv_SocietyMilkDispatchDetail" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-bordered table-hover"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Date">
                                            <ItemTemplate>
                                                <asp:Label ID="lblDt_Date" runat="server" Text='<%# (Convert.ToDateTime(Eval("DT_DispatchDate"))).ToString("dd") %>'></asp:Label>
                                                <asp:Label ID="lbllblDt_Date_F" Visible="false" runat="server" Text='<%# Eval("DT_DispatchDate") %>'></asp:Label>
                                            </ItemTemplate>
                            ...
                            <div class="col-md-12">
                                ...
                                <asp:GridView ID="gv_SocietyBufData" runat="server" OnRowDataBound="gv_SocietyMorningData_RowDataBound" AutoGenerateColumns="false" CssClass="table table-striped table-bordered table-hover"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Rate">
                                            <ItemTemplate>
                                                <asp:Label ID="lblBufRate" runat="server"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                ...
                                <asp:GridView ID="gv_SocietyCowData" OnRowDataBound="gv_SocietyEveningData_RowDataBound" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-bordered table-hover"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Rate">
                                            <ItemTemplate>
                                                <asp:Label ID="lblCowRate" runat="server"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                                            ...
                                                            <fieldset>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-md-3">
                                                                        <div class="form-group">
                                                                            <label>Remark</label>                                                                       
                                                                            <asp:TextBox autocomplete="off" ClientIDMode="Static"  MaxLength="100" runat="server" CssClass="form-control" ID="txtRemark" placeholder="Enter Remark"></asp:TextBox>
                                                                        </div>
                                                                    </div>
                                                                        ...
                                                                        <asp:GridView ID="gv_HeadDetails" ShowFooter="true" ShowHeader="true" AutoGenerateColumns="false" CssClass="table table-bordered" runat="server">
                                                                            <Columns>
                                                                                ...
                                                                                <asp:TemplateField HeaderText="Head Name">
                                                                                 ...
                                                                                 <asp:TemplateField HeaderText="Head Remark">
                                                                                    <ItemTemplate>
                                                                                        <asp:Label ID="lblItemBillingHead_Remark" runat="server" Text='<%# Eval("ItemBillingHead_Remark") %>'></asp:Label>
                                                                                    </ItemTemplate>
                                                                                    <FooterTemplate>
                                                                                        <div>
                                                                                            <asp:Label Text="Grand Total" runat="server" />

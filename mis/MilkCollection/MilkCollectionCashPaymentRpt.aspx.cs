...
public partial class mis_MilkCollection_MilkCollectionCashPaymentRpt : System.Web.UI.Page
{
    DataSet ds;
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            ds = objdb.ByProcedure("Usp_MilkCollectionBillingReports", new string[] { "flag", "FromDate", "ToDate", "Office_ID","GenerateFrom_Office_ID"}, new string[] { "18", Convert.ToDateTime(txtFdt.Text, cult).ToString("yyyy/MM/dd"), Convert.ToDateTime(txtTdt.Text, cult).ToString("yyyy/MM/dd"), ddlccbmcdetail.SelectedValue,objdb.Office_ID()}, "dataset");
            if (ds != null && ds.Tables.Count > 0)
            {
				sb.Append("<table class='table table-responsive'>");
				sb.Append("<tr>");
				sb.Append("<td colspan='8'  style='text-align:center; font-size:18px;'><b>CASH PAYMENT REPORT</b></td>");
				sb.Append("</tr>");
                    sb.Append("<tr>");
                    ...
                    sb.Append("</tr>");
                    sb.Append("<tr>");
                    sb.Append("<td colspan='4' style='text-align:left; font-size:18px;'><b></b></td>");

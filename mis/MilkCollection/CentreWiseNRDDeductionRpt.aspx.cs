...
public partial class mis_MilkCollection_CentreWiseNRDDeductionRpt : System.Web.UI.Page
{
    DataSet ds;
    ...
    protected void FillDetail()
    {
        try
        {
            ...
            ds = objdb.ByProcedure("Usp_MilkCollectionBillingReports", new string[] { "flag", "GenerateFrom_Office_ID", "Month", "Year" }, new string[] { "42", ddlOffice.SelectedValue, Month, Year }, "dataset");
            if(ds != null && ds.Tables.Count > 0)
            {
                if(ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    sb.Append("</tr>");
                    sb.Append("<tr>");
                    sb.Append("<td colspan='" + (Colcount + 1) + "' style='text-align:center; font-size:18px;'><b>Centre wise NRD Amt Deduction : " + MonthName + "(" + Year + ")   Amt in Rs</b></td>");
                    sb.Append("</tr>");
                    sb.Append("<tr>");
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Response.Clear();
            Response.AddHeader("content-disposition", "attachment;filename=" + "CentrewiseNRDAmtDeductionReport" + DateTime.Now + ".xls");
            Response.Charset = "";

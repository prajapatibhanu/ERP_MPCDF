...
public partial class mis_MilkCollection_AdditionChargesMaster : System.Web.UI.Page
{
    DataSet ds;
    ...
    protected void FillGrid()
    {
        try
        {
            ...
            gvDetail.DataBind();
            ds = objdb.ByProcedure("Usp_AdditionalChargesMaster", new string[] { "flag", "Office_Parant_ID", "CC_ID" }, new string[] { "2", objdb.Office_ID(),ddlccbmcdetail_flt.SelectedValue }, "dataset");
            if (ds != null && ds.Tables.Count > 0)
            {
                if (ds.Tables[0].Rows.Count > 0)
                {
    ...
    protected void gvDetail_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        try
        {
            ...
            string AdditionalCharges_ID = e.CommandArgument.ToString();
            ViewState["AdditionalCharges_ID"] = AdditionalCharges_ID;
            ...
            Label lblRateperkg = (Label)gvr.FindControl("lblRateperkg");
            ...
            if(e.CommandName == "EditRecord")
            {
                ...
                txtRateperkg.Text = lblRateperkg.Text;

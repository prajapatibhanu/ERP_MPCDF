...
public partial class mis_MilkCollection_SocietyMilkNotdispatchRecoveryReport : System.Web.UI.Page
{
    DataSet ds;
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            ds = objdb.ByProcedure("Usp_MilkCollectionBillingReports", new string[] { "flag", "FromDate", "ToDate", "OfficeType_ID", "Office_ID", "ItemBillingHead_Type" }, new string[] { "6", Convert.ToDateTime(txtFdt.Text, cult).ToString("yyyy/MM/dd"), Convert.ToDateTime(txtTdt.Text, cult).ToString("yyyy/MM/dd"), ddlMilkCollectionUnit.SelectedValue, objdb.Office_ID(), ddlHeadType.SelectedValue }, "dataset");
			 divshow.Visible = true;
				 sb.Append("<table class='table table-responsive'>");
                    ...
                    sb.Append("</tr>");
                    sb.Append("<tr>");
                    sb.Append("<td colspan='2' style='text-align:left; font-size:14px;'><b>PERIOD : " + txtFdt.Text + " - " + txtTdt.Text + "</b></td>");
                    sb.Append("</tr>");
            if(ds != null && ds.Tables.Count > 0)
            {
                ...
                if(ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    //sb.Append("<tr>");
                    //sb.Append("<td colspan='" + ColumnCount + "' style='border-top:1px dashed black; border-bottom:1px dashed black;'></td>");
                    //sb.Append("</tr>");

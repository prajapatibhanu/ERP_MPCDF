<%@ Page Language="C#" AutoEventWireup="true" Culture="en-IN" CodeFile="GatePassReferenceDetails.aspx.cs" Inherits="mis_MilkCollection_GatePassReferenceDetails" %>
                    ...
                    <div class="row">
                        <div class="col-xs-12" style="border-bottom: 1px solid #eee;">
                            ...
                            <div class="col-xs-9 col-md-6">
                                <h2 class="page-header text-center" style="border-bottom: 1px solid #FFF!important;"><asp:Label ID="lblOfficeName" runat="server"></asp:Label><br />
                                    <small>&nbsp;
                                        <span style="margin-top: 10px"><asp:Label ID="lblOfficeAddress" runat="server"></asp:Label></span></small><br />
                        ...
                        <div class="col-xs-12 table-responsive">
                            ...
                            <asp:GridView ID="gvProductDetails" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-bordered table-hover"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Sequence No" HeaderStyle-Font-Size="14px" HeaderStyle-BackColor="#a9a9a9" HeaderStyle-ForeColor="White">
                                        <ItemTemplate>
                                            <asp:Label ID="lblTI_SequenceNo" runat="server" Text='<%#Eval("TI_SequenceNo") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="Chilling Centers" HeaderStyle-Font-Size="14px" HeaderStyle-BackColor="#a9a9a9" HeaderStyle-ForeColor="White">
                                        <ItemTemplate>

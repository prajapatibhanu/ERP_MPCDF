<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="BMCGenerateGatePass.aspx.cs" Inherits="mis_MilkCollection_BMCGenerateGatePass" %>
        ...
        <section class="content">
            ...
            <div class="box box-Manish">
                <div class="box-header">
                    <h3 class="box-title">Generate Gate Pass For BMC</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    <div class="row">
                    ...
                    <div class="row">
                               ...
                               <div class="col-md-6">
                                ...
                                <%--<asp:GridView ID="gv_CCDetails" ShowHeader="true" AutoGenerateColumns="false" CssClass="table table-bordered" runat="server">
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Sequence No." Visible="false">
                                            <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Dispatch Time">
                                        <ItemTemplate>
                        ...
                        <div class="col-lg-6">
                            <fieldset>
                                <legend>Tanker Valve Seal Details</legend>
                                <i style="color: red; font-size: 12px;">Note:- Valve Seal Details are mandatory.</i>
                                <hr />
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>Seal No.<span style="color: red;"> *</span></label>
                                        <span class="pull-right">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>Seal Color <span style="color: red;">*</span></label>
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <fieldset>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <span class="pull-right">
                                            ...
                                            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" Display="Dynamic" ValidationExpression="^[^'@%#$&=^!~?]+$" ValidationGroup="a" runat="server" ControlToValidate="txtV_DriverName" ErrorMessage="Enter Valid Driver Name." Text="<i class='fa fa-exclamation-circle' title='Enter Valid Driver Name. !'></i>"></asp:RegularExpressionValidator>
                                        </span>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <label>Enter Driver Licence No.</label>
                                        
                                        <asp:TextBox autocomplete="off" runat="server" CssClass="form-control" ID="txtNV_DriverDrivingLicenceNo" MaxLength="20" placeholder="Enter Driver Mobile"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <span class="pull-right">
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ValidationGroup="a"
                                                ...
                                                ControlToValidate="txtTesterName" Display="Dynamic" runat="server">
                                            </asp:RequiredFieldValidator>
                                        </span>
                                        <asp:TextBox autocomplete="off" runat="server" CssClass="form-control" ID="txtTesterName" MaxLength="20" placeholder="Enter Tester Name"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <span class="pull-right">
                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator5" ValidationGroup="a"
                                                ErrorMessage="Enter Tester Mobile No" ForeColor="Red" Text="<i class='fa fa-exclamation-circle' title='Enter Tester Mobile No!'></i>"
                                                ControlToValidate="txtTesterMobileNo" Display="Dynamic" runat="server">
                                            </asp:RequiredFieldValidator>
                                             <asp:RegularExpressionValidator ID="RegularExpressionValidator5" Display="Dynamic" ValidationExpression="^[6789]\d{9}$" ValidationGroup="a" runat="server" ControlToValidate="txtTesterMobileNo" ErrorMessage="Enter Driver Mobile Number." Text="<i class='fa fa-exclamation-circle' title='Enter Tester Mobile Number. !'></i>"></asp:RegularExpressionValidator>
                                        </span>
                                        <asp:TextBox autocomplete="off" runat="server" CssClass="form-control" ID="txtTesterMobileNo" MaxLength="20" placeholder="Enter Tester Mobile No"></asp:TextBox>
                                    </div>
                                </div>
                                ...
                                <Columns>
                                   ...
                                   <%-- <asp:TemplateField HeaderText="Challan No/Status">
                                    ...
                                    <asp:TemplateField HeaderText="Tester Name">
                                        <ItemTemplate>
                                            <asp:Label ID="lblV_TesterName" runat="server" Text='<%# Eval("V_TesterName") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="Tester Mobile No">
                                        <ItemTemplate>
                                            <asp:Label ID="lblV_TesterMobileNo" runat="server" Text='<%# Eval("V_TesterMobileNo") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Action">
                                        <ItemTemplate>
                                            <a href='../MilkCollection/BMCGatePassReferenceDetails.aspx?BMCRid=<%# new APIProcedure().Encrypt(Eval("BI_MilkInOutRefID").ToString()) %>' target="_blank" title="Print Gate Pass"><i class="fa fa-print"></i></a>
                                        </ItemTemplate>
                                    </asp:TemplateField>

<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="CCWiseDCShavingmorethantwice.aspx.cs" Inherits="mis_MilkCollection_CCWiseDCShavingmorethantwice" %>
                ...
                <div class="col-md-12">
                    <div class="box box-success">
                        <div class="box-header">
                            <h3 class="box-title">CC Wise DCS HAVING MORE THAN TWICE</h3>
                        </div>

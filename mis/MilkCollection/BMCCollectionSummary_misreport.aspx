<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="BMCCollectionSummary_misreport.aspx.cs" Inherits="mis_MilkCollection_BMCCollectionSummary_misreport" %>
        ...
        <section class="content noprint">
            <div class="box box-primary">
                <div class="box-header">
                    <h3 class="box-title">BMC Collection Summary(MIS Report)</h3>
                </div>
                                ...
                                <div class="form-group">
                                    <label>CC<span style="color: red;"> *</span></label>   
                                     <span class="pull-right">
                                            <asp:RequiredFieldValidator ID="rfvccbmcdetail" InitialValue="0" runat="server" ValidationGroup="a" Display="Dynamic" ControlToValidate="ddlccbmcdetail" ErrorMessage="Please Select CC." Text="<i class='fa fa-exclamation-circle' title='Please Select CC !'></i>"></asp:RequiredFieldValidator>

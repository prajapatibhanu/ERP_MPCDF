...
public partial class mis_MilkCollection_SocietyWsieSummarySheet_DayWise : System.Web.UI.Page
{
    DataSet ds;
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            ds = objdb.ByProcedure("Usp_MilkCollectionBillingReports", new string[] { "flag", "FromDate", "ToDate", "Office_ID" }, new string[] { "3", Convert.ToDateTime(txtFdt.Text, cult).ToString("yyyy/MM/dd"), Convert.ToDateTime(txtTdt.Text, cult).ToString("yyyy/MM/dd"), ddlSociety.SelectedValue }, "dataset");
            if (ds != null && ds.Tables.Count > 0)
            {
                ...
                sb.Append("<td colspan='3' style='text-align:left; font-size:16px;'><b>Society : -" + ddlSociety.SelectedItem.Text + "</b></td>");
                sb.Append("</tr>");
                sb.Append("<tr>");
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Response.Clear();
            Response.AddHeader("content-disposition", "attachment;filename=" + "SocietyWiseSummarySheet(DayWise)" + DateTime.Now + ".xls");
            Response.Charset = "";

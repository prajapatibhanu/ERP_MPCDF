<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="CCWiseSocietyTotalBalancesReport.aspx.cs" Inherits="mis_MilkCollection_CCWiseSocietyTotalBalancesReport" %>
                ...
                <div class="col-md-12">
                    <div class="box box-success">
                        <div class="box-header">
                            <h3 class="box-title">CC wise Society Negative Balances Report</h3>
                        </div>
                                        ...
                                        <div class="table-responsive">
                                            <asp:GridView ID="GridView1" ShowFooter="true" runat="server" CssClass="datatable table table-bordered" AutoGenerateColumns="false" EmptyDataText="No Record Found">
                                                <Columns>
                                                    ...
                                                    <%-- <asp:BoundField HeaderText="Billing Cycle Date" DataField="BillingFromDate" />--%>
                                                    <asp:BoundField HeaderText="Society" DataField="Office_Name" />
                                                   <%-- <asp:BoundField HeaderText="Head Type" DataField="ItemBillingHead_Type" />
                                                    <asp:BoundField HeaderText="Head Name" DataField="ItemBillingHead_Name" />--%>
                                                     <%-- <asp:BoundField HeaderText="Current Cycle Amount" DataField="CycleAmount" />
                                                    <asp:BoundField HeaderText="PreviousAmount" DataField="PrevoiusAmount" />
                                                    <asp:TemplateField HeaderText="Total Deduction">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblOffice_Name" runat="server" Text='<%# (Convert.ToDecimal(Eval("CycleAmount")) + Convert.ToDecimal(Eval("PrevoiusAmount"))) %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                    <asp:BoundField HeaderText="Deducted" DataField="DeductedAmount" />--%>                                             
											     <asp:BoundField HeaderText="Gross Earning(A)" DataField="GrossEarning" />
                                               <asp:BoundField HeaderText="Negative Payment(Rs)(B)" DataField="BalanceAmount" />
                                                    <asp:TemplateField HeaderText="High Risk Negative Amount(B - A)">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblDiff" runat="server" Text='<%# Eval("HighRiskNegativePayment") %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
            ...
            buttons: {
                buttons: [{
                    ...
                    text: '<i class="fa fa-print"></i> Print',
                     title: document.getElementById('<%= hfvalue.ClientID%>').value + '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; CC:-' + $("#ddlccbmcdetail option:selected").text() + '<br/><span style="margin-top:50px;"> CC wise Society Negative Balances Report&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' + 'PERIOD :' + document.getElementById('<%= txtFdt.ClientID%>').value + ' -  ' + document.getElementById('<%= txtTdt.ClientID%>').value + "</span>",

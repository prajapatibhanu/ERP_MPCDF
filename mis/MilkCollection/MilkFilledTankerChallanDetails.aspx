<%@ Page Language="C#" AutoEventWireup="true" Culture="en-IN" CodeFile="MilkFilledTankerChallanDetails.aspx.cs" Inherits="mis_MilkCollection_MilkFilledTankerChallanDetails" %>
...
<head runat="server">
    ...
    <title>Generated Gate Pass Details</title>
            ...
            <div style="width: 90%; margin: auto; border-radius: 5px; border: 1px solid #b5b5b5; padding: 5px">
                        ...
                        <div class="col-xs-12" style="border-bottom: 1px solid #eee;">
                            ...
                            <div class="col-xs-9 col-md-6">
                                <h2 class="page-header text-center" style="border-bottom: 1px solid #FFF!important;">
                                    ...
                                    <br />
                                    <p style="font-size: 20px;"><b><span id="spn" runat="server"></span></b></p>
                                </h2>
                            </div>
              ...
              <asp:Label ID="lblRPuContactNo" runat="server"></asp:Label><br />
                        ...
                        <div class="col-sm-4 invoice-col">
                            ...
                            <b><span id="spndate" runat="server"></span></b>
                    ...
                    <div class="row">
                        <div class="col-xs-12 table-responsive">
                            <b>Milk Collection Deatils</b>
                            <br />
                            <br />
                            <asp:GridView ID="gvfillDetails"  OnRowDataBound="gvfillDetails_RowDataBound" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-bordered table-hover"
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Arrival Time" HeaderStyle-Font-Size="14px" HeaderStyle-BackColor="#a9a9a9" HeaderStyle-ForeColor="White">
                                        <ItemTemplate>
                                            <asp:Label ID="lblDT_ArrivalDateTime" runat="server" Text='<%#Eval("DT_ArrivalDateTime") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Dispatch Time" HeaderStyle-Font-Size="14px" HeaderStyle-BackColor="#a9a9a9" HeaderStyle-ForeColor="White">
                                        <ItemTemplate>
                                            <asp:Label ID="lblDT_DispatchDateTime" runat="server" Text='<%#Eval("DT_DispatchDateTime") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                     <asp:TemplateField HeaderText="Plant Dispatch Time" HeaderStyle-Font-Size="14px" HeaderStyle-BackColor="#a9a9a9" HeaderStyle-ForeColor="White">
                                        <ItemTemplate>
                                            <asp:Label ID="lblDT_TankerDispatchDate" runat="server" Text='<%#Eval("DT_TankerDispatchDate") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="Milk Type" HeaderStyle-Font-Size="14px" HeaderStyle-BackColor="#a9a9a9" HeaderStyle-ForeColor="White">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Tanker Compartment" HeaderStyle-Font-Size="14px" HeaderStyle-BackColor="#a9a9a9" HeaderStyle-ForeColor="White">
                                        <ItemTemplate>
                                            <asp:Label ID="lblSealLocation" runat="server" Text='<%#Eval("SealLocation") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                    ...
                    <div class="row">
                        <div class="col-xs-6 table-responsive">
                            ...
                            <br />
                            <br />
                            <asp:GridView ID="gvSealDetails"   runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-bordered table-hover"
                                EmptyDataText="No Record Found.">
                                <Columns>

                                    <asp:TemplateField HeaderText="Sr. No." HeaderStyle-Font-Size="14px" HeaderStyle-Width="8%" HeaderStyle-BackColor="#a9a9a9" HeaderStyle-ForeColor="White">
                                        <ItemTemplate>
                                            <%#Container.DataItemIndex+1 %>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-6">
                            .................................................<br />
                            Representative Details<br />
                           <b>Name</b> : <asp:Label ID="lblRepresentativename" runat="server"></asp:Label><br />
                            <b>Mobile No</b> : <asp:Label ID="lblRepresentativemobile" runat="server"></asp:Label><br />
                            .................................................
                        </div>
                        <div class="col-xs-6">
                            <p class="pull-right">

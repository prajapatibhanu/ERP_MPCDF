<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="CCWiseDCSSummary.aspx.cs" Inherits="mis_MilkCollection_CCWiseDCSSummary" %>
                ...
                <div class="col-md-12">
                    <div class="box box-success">
                        <div class="box-header">
                            <h3 class="box-title">CC Wise DCS Summary</h3>
                        </div>
                        ...
                        <div class="box-body">
                            <fieldset>
                                ...
                                <div class="form-group">
                                 ...
                                 <asp:ListBox runat="server" ID="ddlccbmcdetail" ClientIDMode="Static" CssClass="form-control" SelectionMode="Multiple"></asp:ListBox>
                                </div>
                            </div>                                   
                                   <div class="col-md-2">
                                    <div class="form-group">

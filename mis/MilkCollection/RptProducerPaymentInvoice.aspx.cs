...
public partial class mis_MilkCollection_RptProducerPaymentInvoice : System.Web.UI.Page
{
    DataSet ds;
        ...
        try
        {
            ...
            if(ddlPaymentType.SelectedValue.ToString() == "1")
            {
                ...
                ds = objdb.ByProcedure("USP_Trn_ProducerPaymentDetails",
                            ...
                            new string[] { "8", Fdate, Tdate, ddlSociety.SelectedValue}, "dataset");
            }
            if (ddlPaymentType.SelectedValue.ToString() == "2")
            {
                ds = null;
                ds = objdb.ByProcedure("USP_Trn_ProducerPaymentDetails",
                            new string[] { "flag", "PaymentFromDt", "PaymentToDt", "Office_ID" },
                            new string[] { "13", Fdate, Tdate, ddlSociety.SelectedValue }, "dataset");
            }

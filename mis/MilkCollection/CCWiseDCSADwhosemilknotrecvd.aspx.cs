...
public partial class mis_MilkCollection_CCWiseDCSADwhosemilknotrecvd : System.Web.UI.Page
{
    DataSet ds;
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            ds = objdb.ByProcedure("Usp_MilkCollectionBillingReports", new string[] { "flag", "FromDate", "ToDate", "Office_ID","Office_Parant_ID"}, new string[] { "14", Convert.ToDateTime(txtFdt.Text, cult).ToString("yyyy/MM/dd"), Convert.ToDateTime(txtTdt.Text, cult).ToString("yyyy/MM/dd"), ddlccbmcdetail.SelectedValue,objdb.Office_ID()}, "dataset");
            if(ds != null && ds.Tables.Count > 0)
            {
                ...
                sb.Append("</tr>");
                sb.Append("<tr>");
                sb.Append("<td colspan='4' style='text-align:left; font-size:18px;'><b>LIST OF DCS A/D WHOSE MILK NOT RECEIVED</b></td>");
                ...
                if(ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    //sb.Append("<tr>");
                    //sb.Append("<td colspan='4' style='border-top:1px dashed black'>Total</td>");
                    //sb.Append("<td colspan='4' style='border-top:1px dashed black'>" + TotalAmount + "</td>");
                    //sb.Append("</tr>");
                    //sb.Append("<tr>");
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Response.Clear();
            Response.AddHeader("content-disposition", "attachment;filename=" + "CCWiseDCSADWhose notreceivedmilk" + DateTime.Now + ".xls");
            Response.Charset = "";

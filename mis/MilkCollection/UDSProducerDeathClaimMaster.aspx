<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="UDSProducerDeathClaimMaster.aspx.cs" Inherits="mis_MilkCollection_UDSProducerDeathClaimMaster" %>
                    ...
                    <div class="box box-primary">
                        ...
                        <div class="box-body">
                            <fieldset>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <asp:GridView id="gvCategory" runat="server" CssClass="table table-bordered" AutoGenerateColumns="false">
                                            <Columns>
                                                <asp:TemplateField HeaderText="S.No">
                                                 ...
                                                 <asp:TemplateField HeaderText="Category">
                                                   ...
                                                   <asp:TemplateField HeaderText="Death Claim Amount">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtDeathClaimAmount" CssClass="form-control" runat="server" Text='<%# Eval("DeathClaimAmount") %>'></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>
                                            </Columns>
                                        </asp:GridView>

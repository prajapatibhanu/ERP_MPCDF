...
public partial class mis_MilkCollection_CCWiseBMCChillingCostReport : System.Web.UI.Page
{
    DataSet ds;
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            ds = objdb.ByProcedure("Usp_MilkCollectionRoutWiseAdditionsDeductionsEntry", new string[] { "flag", "FromDate", "ToDate", "CC_Id", "Rate" }, new string[] { "24", Fdate, Tdate, ddlccbmcdetail.SelectedValue,txtRate.Text}, "dataset");
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            lblMsg.Text = "";
            string FileName = Session["Office_Name"].ToString() + "_" + "CCWiseBMCChillingCostReport_" + ddlccbmcdetail.SelectedItem.Text + "_";
            Response.Clear();

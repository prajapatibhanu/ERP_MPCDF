                            ...
                            if (dt3.Rows.Count > 0) //Check Milk Sample details filled atleast 1 row
                            {
                                ...
                                if (dt2.Rows.Count == AdType) //Check adulteration details filled all row of adulteration test
                                {
                                    if ((dt.Select("SealLocation = 'S'").Length > 0 && dt.Select("SealLocation = 'VB'").Length > 0 && ddlTankerType.SelectedValue == "S")
                                        ||
                                        (dt.Select("SealLocation = 'F'").Length > 0 && dt.Select("SealLocation = 'R'").Length > 0 && dt.Select("SealLocation = 'VB'").Length > 0 && ddlTankerType.SelectedValue == "D")) //Check seal details filled atleast 8 row
                                    {
                                        ...
                                        if (ds.Tables[0].Rows[0]["Msg"].ToString() == "Ok")
                                        {
                                            ...
                                            Page.ClientScript.RegisterStartupScript(this.GetType(), "CallMyFunction", "alert('Record Inserted Successfully');", true);
                                            Response.Redirect("MilkOutwardEntry.aspx", false);

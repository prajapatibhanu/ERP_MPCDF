...
public partial class mis_MilkCollection_ReceiveTankerChallan_ReTest : System.Web.UI.Page
{
    DataSet ds;
    ...
    private void GetReferenceInfo()
    {
        ...
        DataSet ds1 = apiprocedure.ByProcedure("USP_Trn_MilkInwardOutwardReferenceDetailsReTest",
                                  new string[] { "flag", "I_OfficeID", "V_EntryType" },
                                  new string[] { "1", apiprocedure.Office_ID(), "In" }, "dataset");
        ...
        try
        {
            ...
            if (ddlReferenceNo.SelectedValue != "0")
            {
                DataSet ds1 = apiprocedure.ByProcedure("USP_Trn_MilkInwardOutwardReferenceDetailsReTest",
                               ...
                               new string[] { "2", ddlReferenceNo.SelectedValue, "In" }, "dataset");
    ...
    protected void ddlchallanno_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            if (ddlReferenceNo.SelectedValue != "0" && ddlchallanno.SelectedValue != "0")
            {
                ...
                DataSet ds1 = apiprocedure.ByProcedure("USP_Trn_MilkInwardOutwardReferenceDetailsReTest",
                               new string[] { "flag", "BI_MilkInOutRefID", "V_ReferenceCode" },
                               new string[] { "3", ddlReferenceNo.SelectedValue, ddlchallanno.SelectedItem.Text }, "dataset");
    ...
    //                           new string[] { "40", apiprocedure.Office_ID(), "In", date }, "dataset");
                    ...
                    if (dt3.Rows.Count > 0) //Check Milk Sample details filled atleast 1 row
                    {
                        ...
                        if (dt2.Rows.Count == AdType) //Check adulteration details filled all row
                        {
                            ...
                            if (ds.Tables[0].Rows[0]["Msg"].ToString() == "Ok")
                            {
                                ...
                                Response.Redirect("ReceiveTankerChallan_ReTest.aspx", false);

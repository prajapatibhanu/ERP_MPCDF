...
public partial class mis_MilkCollection_CCwiseMilkCollectionInvoiceDetails : System.Web.UI.Page
{
    DataSet ds;
            ...
            if (ds != null)
            {
                if (ds.Tables.Count > 0)
                {
                    if (ds.Tables[0].Rows.Count > 0)
                    {
                        ...
                        if (objdb.Office_ID() == "2" || objdb.Office_ID() == "4" || objdb.Office_ID() == "6")
                        {
    ...
    protected void btnh2hFile_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            else if (objdb.Office_ID() == "7")
            {
				...
				String FDate = Convert.ToDateTime(txtFdt.Text, cult).ToString();
                ...
                String TDate = Convert.ToDateTime(txtTdt.Text, cult).ToString();
                ...
                if(ddlccbmcdetail.SelectedItem.Text == "All")
                {
                    ClientCode = "BKSDS31ICICI";
                }
                else
                {
                    string Code = ddlccbmcdetail.SelectedItem.Text;
                    //ClientCode = Code.Substring(0,2) + Fdy + Tdy + Fmn + Fyy+ "31ICICI";
                    ClientCode = Code.Substring(0, 2) + Fdy + Tdy + Fmn + Fyy ;
                }
            }
                ...
                if (ds != null)
                {
                    if (ds.Tables.Count > 0)
                    {
                        if (ds.Tables[0].Rows.Count > 0)
                        {
                            ...
                            if (objdb.Office_ID() == "2" || objdb.Office_ID() == "4" || objdb.Office_ID() == "7" || objdb.Office_ID() == "5")
                            {
    ...
    protected void btnPrintInvoice_Click(object sender, EventArgs e)
    {
        ...
        DataSet ds2 = objdb.ByProcedure("USP_SocietywiseMilkCollectionInvoice",
                  new string[] { "flag", "FromDate", "ToDate", "CC_Id" },
                   new string[] { "25", Fdate, Tdate,ddlccbmcdetail.SelectedValue }, "dataset");
        int DSCount = ds2.Tables.Count;
        ...
        foreach (GridViewRow rows in gv_SocietyMilkDispatchDetail.Rows)
        {
            ...
            Label lblGenerateTo_Office_ID = (Label)rows.FindControl("lblGenerateTo_Office_ID");
            ...
            if (CheckBox1.Checked == true)
            {
                ...
                for (int i = 0; i < DSCount; i++)
                {
                    ...
                    else if (i ==8)
                    {
                        ...
                        ds2.Tables[i].DefaultView.RowFilter = "GenerateTo_Office_ID = '" + lblGenerateTo_Office_ID.Text + "'";
                        dt = ds2.Tables[i].DefaultView.ToTable();
                    }
                    else
                    {
                        ds2.Tables[i].DefaultView.RowFilter = "MilkCollectionInvoice_ID = '" + MilkCollectionInvoice_ID.Text + "'";
                        dt = ds2.Tables[i].DefaultView.ToTable();
                    }
                ...
                if (ds1 != null)
                {
                    if (ds1.Tables.Count > 0)
                    {
                        if (ds1.Tables[0].Rows.Count > 0)
                        {
                            ...
                            sb.Append("</tr>");
                            sb.Append("<tr>");
                            sb.Append("<td>Society Name And Code: " + ds1.Tables[0].Rows[0]["Office_Name"].ToString() + "  /  " + ds1.Tables[0].Rows[0]["Office_Code"].ToString() + "");
                            sb.Append("</td>");
                            sb.Append("<td style='text-align:right'>CC: " + ddlccbmcdetail.SelectedItem.Text + "");
                            sb.Append("</td>");
                            sb.Append("</tr>");
                            sb.Append("<tr >");
                            sb.Append("<td >Bank Name / IFSC / Account  : " + ds1.Tables[0].Rows[0]["BankName"].ToString() + " /" + ds1.Tables[0].Rows[0]["IFSC"].ToString() + " /" + ds1.Tables[0].Rows[0]["BankAccountNo"].ToString());
                            sb.Append("</td>");
                            sb.Append("<td style='text-align:right'>Billing Period  : " + ds1.Tables[0].Rows[0]["FromDate"].ToString() + " To " + ds1.Tables[0].Rows[0]["ToDate"].ToString() + "");
                            sb.Append("</td>");
                            sb.Append("</tr>");
                            sb.Append("</table>");
                            ...
                            {
                                sb.Append("<tr>");
                                sb.Append("<td>" + ds1.Tables[1].Rows[i]["DispDate"].ToString() + "</td>");
                                sb.Append("<td>" + ds1.Tables[1].Rows[i]["Shift"].ToString() + "</td>");
                                sb.Append("<td>" + ds1.Tables[1].Rows[i]["MilkType"].ToString() + "</td>");
                                sb.Append("<td>" + ds1.Tables[1].Rows[i]["MilkQuantity"].ToString() + "</td>");
                                sb.Append("<td>" + ds1.Tables[1].Rows[i]["FatPer"].ToString() + "</td>");
                                sb.Append("<td>" + ds1.Tables[1].Rows[i]["CLR"].ToString() + "</td>");
                                sb.Append("<td>" + ds1.Tables[1].Rows[i]["SnfPer"].ToString() + "</td>");

                                sb.Append("<td>" + ds1.Tables[1].Rows[i]["FatInKg"].ToString() + "</td>");
                                sb.Append("<td>" + ds1.Tables[1].Rows[i]["SnfInKg"].ToString() + "</td>");
                                sb.Append("<td>" + ds1.Tables[1].Rows[i]["MilkValue"].ToString() + "</td>");

                                sb.Append("<td>" + ds1.Tables[1].Rows[i]["MilkQuality"].ToString() + "</td>");
                                sb.Append("<td>" + ds1.Tables[1].Rows[i]["RatePerLtr"].ToString() + "</td>");
                                sb.Append("</tr>");
                            }
                            decimal FatPer = ds1.Tables[1].AsEnumerable().Sum(row => row.Field<decimal>("FatPer"));
                            decimal SnfPer = ds1.Tables[1].AsEnumerable().Sum(row => row.Field<decimal>("SnfPer"));
                            decimal MilkQuantity = ds1.Tables[1].AsEnumerable().Sum(row => row.Field<decimal>("MilkQuantity"));
                            decimal FatInKg = ds1.Tables[1].AsEnumerable().Sum(row => row.Field<decimal>("FatInKg"));
                            decimal SnfInKg = ds1.Tables[1].AsEnumerable().Sum(row => row.Field<decimal>("SnfInKg"));
                            decimal MilkValue = ds1.Tables[1].AsEnumerable().Sum(row => row.Field<decimal>("MilkValue"));
                            decimal RatePerLtr = ds1.Tables[1].AsEnumerable().Sum(row => row.Field<decimal>("RatePerLtr"));
                            sb.Append("<tr style='border-top:dashed; padding-top:20px;'>");
                            sb.Append("<td>Total</td>");
                            sb.Append("<td></td>");
                            sb.Append("<td></td>");
                            ...
                            {
                                RateBuff = decimal.Parse(ds1.Tables[6].Rows[0]["BuffRate"].ToString());
                                RateCow = decimal.Parse(ds1.Tables[6].Rows[0]["CowRate"].ToString());
                            }
                            int BufCount = ds1.Tables[2].Rows.Count;

                            for (int j = 0; j < BufCount; j++)
                            {
                                if (j == 0)
                                {
                                    sb.Append("<td>" + ds1.Tables[2].Rows[j]["MilkType"].ToString() + "</td>");
                                }
                                else
                                {
                                    sb.Append("<td></td>");
                                }
                                sb.Append("<td>" + ds1.Tables[2].Rows[j]["MilkQuality"].ToString() + "</td>");
                                sb.Append("<td>" + ds1.Tables[2].Rows[j]["MilkQuantity"].ToString() + "</td>");
                                sb.Append("<td>" + ds1.Tables[2].Rows[j]["FatPer"].ToString() + "</td>");
                                sb.Append("<td>" + ds1.Tables[2].Rows[j]["CLR"].ToString() + "</td>");
                                sb.Append("<td>" + ds1.Tables[2].Rows[j]["SnfPer"].ToString() + "</td>");
                                sb.Append("<td>" + ds1.Tables[2].Rows[j]["FatInKg"].ToString() + "</td>");
                                sb.Append("<td>" + ds1.Tables[2].Rows[j]["SnfInKg"].ToString() + "</td>");
                                sb.Append("<td>" + ds1.Tables[2].Rows[j]["MilkValue"].ToString() + "</td>");
                                if (ds1.Tables[2].Rows[j]["MilkQuality"].ToString() == "Good")
                                {
                                    sb.Append("<td>" + RateBuff + "</td>");

                                }
                                else if (ds1.Tables[2].Rows[j]["MilkQuality"].ToString() == "Sour")
                                {
                                    sb.Append("<td>" + ((RateBuff) * 50 / 100) + "</td>");
                            ...
                            int CowCount = ds1.Tables[3].Rows.Count;

                            for (int j = 0; j < CowCount; j++)
                            {
                                if (j == 0)
                                {
                                    sb.Append("<td>" + ds1.Tables[3].Rows[j]["MilkType"].ToString() + "</td>");
                                }
                                else
                                {
                                    sb.Append("<td></td>");
                                }
                                sb.Append("<td>" + ds1.Tables[3].Rows[j]["MilkQuality"].ToString() + "</td>");
                                sb.Append("<td>" + ds1.Tables[3].Rows[j]["MilkQuantity"].ToString() + "</td>");
                                sb.Append("<td>" + ds1.Tables[3].Rows[j]["FatPer"].ToString() + "</td>");
                                sb.Append("<td>" + ds1.Tables[3].Rows[j]["CLR"].ToString() + "</td>");
                                sb.Append("<td>" + ds1.Tables[3].Rows[j]["SnfPer"].ToString() + "</td>");
                                sb.Append("<td>" + ds1.Tables[3].Rows[j]["FatInKg"].ToString() + "</td>");
                                sb.Append("<td>" + ds1.Tables[3].Rows[j]["SnfInKg"].ToString() + "</td>");
                                sb.Append("<td>" + ds1.Tables[3].Rows[j]["MilkValue"].ToString() + "</td>");
                                if (ds1.Tables[3].Rows[j]["MilkQuality"].ToString() == "Good")
                                {
                                    sb.Append("<td>" + RateCow + "</td>");

                                }
                                else if (ds1.Tables[3].Rows[j]["MilkQuality"].ToString() == "Sour")
                                {
                                    sb.Append("<td>" + ((RateCow) * 50 / 100) + "</td>");
                            ...
                            {
                                sb.Append("<tr>");
                                //sb.Append("<td colspan='8'>" + ds1.Tables[5].Rows[0]["CommissionNarration"].ToString() + "" + ds1.Tables[0].Rows[0]["Commission"].ToString() + "</td>");
                                sb.Append("<td colspan='8'>" + ds1.Tables[5].Rows[0]["CommissionNarration"].ToString() + "</td>");
                                sb.Append("<td colspan='2'>Commission - :</td>");
                                sb.Append("<td colspan='2'>" + ds1.Tables[0].Rows[0]["Commission"].ToString() + "</td>");
                                sb.Append("</tr>");
                                sb.Append("<tr>");
                                sb.Append("<td colspan='2'>MilkValue:</td>");
                                sb.Append("<td colspan='2'>" + ds1.Tables[0].Rows[0]["MilkValue"].ToString() + "</td>");
                            ...
                            int HeadTypeCount = ds1.Tables[4].Rows.Count;
                            sb.Append("<tr style='border-top:dashed; padding:20px;'>");
                            sb.Append("<td>");
                            sb.Append("<table>");
                            sb.Append("<tr>");
                            ...
                            for (int i = 0; i < HeadTypeCount; i++)
                            {
                                ...
                                if (ds1.Tables[4].Rows[i]["HeadType"].ToString() == "ADDITION")
                                {

                                    sb.Append("<td style='width:30%'>" + ds1.Tables[4].Rows[i]["HeadName"].ToString() + "</td>");
                                    sb.Append("<td style='width:10%'>" + ds1.Tables[4].Rows[i]["HeadAmount"].ToString() + "</td>");
                                    sb.Append("<td style='width:10%'>" + ds1.Tables[4].Rows[i]["HeadRemark"].ToString() + "</td>");
                                    //sb.Append("<td ></td>");
                                    //sb.Append("<td ></td>");
                                    //sb.Append("<td colspan='4'></td>");
                                    //sb.Append("<td ></td>");
                                ...
                                //else if (ds1.Tables[4].Rows[i]["HeadType"].ToString() == "DEDUCTION")
                                //{

                                //    sb.Append("<td ></td>");
                                //    sb.Append("<td></td>");
                                //    sb.Append("<td colspan='4'></td>");
                                //    sb.Append("<td>" + ds1.Tables[4].Rows[i]["HeadName"].ToString() + "</td> ");
                                //    sb.Append("<td >" + ds1.Tables[4].Rows[i]["HeadAmount"].ToString() + "</td>");
                                //    sb.Append("<td colspan='4'>" + ds1.Tables[4].Rows[i]["HeadRemark"].ToString() + "</td>");
                                //    sb.Append("<td ></td>");
                                //}
                            ...
                            for (int i = 0; i < HeadTypeCount; i++)
                            {
                                ...
                                if (ds1.Tables[4].Rows[i]["HeadType"].ToString() == "DEDUCTION")
                                {
                            ...
                            sb.Append("<td> GROSS EARNING:&nbsp;&nbsp;&nbsp;&nbsp" + ds1.Tables[0].Rows[0]["GrossEarning"].ToString() + "</td>");
                            //sb.Append("<td>" + ds1.Tables[0].Rows[0]["GrossEarning"].ToString() + "</td>");
                            sb.Append("<td >Deductions:&nbsp;&nbsp;&nbsp;&nbsp;" + Math.Abs(decimal.Parse(ds1.Tables[0].Rows[0]["DeductionAdditionValue"].ToString())).ToString() + "</td>");
                            //sb.Append("<td>" + ds1.Tables[0].Rows[0]["DeductionAdditionValue"].ToString() + "</td>");
                            //sb.Append("<td >Producer Payment:&nbsp;&nbsp;&nbsp;&nbsp;" + ds1.Tables[0].Rows[0]["ProducerPayment"].ToString() + "</td>");
                            //sb.Append("<td>" + ds1.Tables[0].Rows[0]["ProducerPayment"].ToString() + "</td>");
                            //sb.Append("<td style='width:40%'>Producer Adj Amount:&nbsp;&nbsp;" + ds1.Tables[0].Rows[0]["ProducerAdjPayment"].ToString() + "</td>");
                            //sb.Append("<td>" + ds1.Tables[0].Rows[0]["ProducerAdjPayment"].ToString() + "</td>");
                            //sb.Append("</tr>");

                            // sb.Append("<tr>");

                            // sb.Append("<td style='width:40%'>Society Adjust Amount:&nbsp;&nbsp;&nbsp;&nbsp;" + ds1.Tables[0].Rows[0]["ProducerAdjPayment"].ToString() + "</td>");
                            // sb.Append("<td>" + ds1.Tables[0].Rows[0]["SocietyAdjPayment"].ToString() + "</td>");
                            sb.Append("<td >Chilling Cost:&nbsp;&nbsp;&nbsp;&nbsp;" + ds1.Tables[0].Rows[0]["ChillingCost"].ToString() + "</td>");
                            //  sb.Append("<td>" + ds1.Tables[0].Rows[0]["ChillingCost"].ToString() + "</td>");



                            sb.Append("<td >Head Load Charges:&nbsp;&nbsp;&nbsp;&nbsp;" + ds1.Tables[0].Rows[0]["HeadLoadCharges"].ToString() + "</td>");
                            //sb.Append("<td>" + ds1.Tables[0].Rows[0]["HeadLoadCharges"].ToString() + "</td>");

                            sb.Append("<td >Net:&nbsp;&nbsp;&nbsp;&nbsp;" + ds1.Tables[0].Rows[0]["NetAmount"].ToString() + "</td>");
                            //sb.Append("<td >" + ds1.Tables[0].Rows[0]["NetAmount"].ToString() + "</td>");
                            ...
                            //    sb.Append("<td>Remark:   " + ds1.Tables[8].Rows[0]["Remark"].ToString() + "</td>");
                            //    sb.Append("</tr>");
                            //    sb.Append("</table>");
                            //}
                            if (objdb.Office_ID() == "2" || objdb.Office_ID() == "4" || objdb.Office_ID() == "6")
                            {
                                if (ds1.Tables[7].Rows.Count > 0)
                                {
                                    ...
                                    sb.Append("<td>* A M O U N T *</td>");
                                    sb.Append("</tr>");
                                    int LedgerCount = ds1.Tables[7].Rows.Count;
                                    for (int i = 0; i < LedgerCount; i++)
                                    {
                                        sb.Append("<tr>");
                                        sb.Append("<td>" + ds1.Tables[7].Rows[i]["ItemBillingHead_Name"].ToString() + "</td>");
                                        sb.Append("<td>" + ds1.Tables[7].Rows[i]["BalanceAmount"].ToString() + "</td>");
                                        sb.Append("</tr>");
                                    }
									sb.Append("<tr>");
                                    sb.Append("<td>Total</td>");
                                    sb.Append("<td>"+ds1.Tables[7].AsEnumerable().Sum(row => row.Field<decimal>("BalanceAmount")).ToString()+"</td>");
                                    sb.Append("</tr>");
    ...
    protected void btnProducerMsg_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            ds = objdb.ByProcedure("USP_SocietywiseMilkCollectionInvoice", new string[] { "flag", "CC_Id", "BillingCycleFromDate", "BillingCycleToDate","AdiwasiSociety" },
                                                                            new string[] { "23", ddlccbmcdetail.SelectedValue, Convert.ToDateTime(txtFdt.Text, cult).ToString("yyyy/MM/dd"), Convert.ToDateTime(txtTdt.Text, cult).ToString("yyyy/MM/dd"),"0" }, "dataset");

...
public partial class mis_MilkCollection_CCWiseAdditionDeductionReport : System.Web.UI.Page
{
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            ds = objdb.ByProcedure("Usp_MilkCollectionBillingReports", new string[] { "flag", "FromDate", "ToDate", "Office_ID","Office_Parant_ID", "ItemBillingHead_Type" }, new string[] { "2", Convert.ToDateTime(txtFdt.Text, cult).ToString("yyyy/MM/dd"), Convert.ToDateTime(txtTdt.Text, cult).ToString("yyyy/MM/dd"), ddlccbmcdetail.SelectedValue,objdb.Office_ID(), ddlHeadType.SelectedValue }, "dataset");

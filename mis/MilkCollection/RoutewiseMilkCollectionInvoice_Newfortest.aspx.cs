...
public partial class mis_MilkCollection_RoutewiseMilkCollectionInvoice_Newfortest : System.Web.UI.Page
{
    DataSet ds;
                ...
                if (dsFillGrid.Tables[0].Rows.Count > 0)
                {
                    ...
                    for (int i = 0; i < Count; i++)
                    {
                        if (dsFillGrid.Tables[0].Rows[i]["MilkCollectionInvoice_ID"].ToString() == "")
                        {
                            ...
                            dtGrid.Rows.Add(MilkCollectionInvoice_ID, I_OfficeID, Office_Name,Quantity, MilkValue, Commission, GrossEarning, DeductionAdditionValue, ProducerPayment, ProducerAdjPayment, SocietyAdjPayment, HeadLoadCharges, ChillingCost, NetAmount);
                    ...
                    GridView1.FooterRow.Cells[2].Text = "<b>" + TotalMilkQty.ToString() + "</b>";
                    GridView1.FooterRow.Cells[3].Text = "<b>" + TotalMilkValue.ToString() + "</b>";
                    GridView1.FooterRow.Cells[4].Text = "<b>" + TotalCommission.ToString() + "</b>";
                    GridView1.FooterRow.Cells[5].Text = "<b>" + TotalGrossEarning.ToString() + "</b>";
                    GridView1.FooterRow.Cells[6].Text = "<b>" + TotalDeductionAdditionValue.ToString() + "</b>";
                    ...
                    GridView1.FooterRow.Cells[7].Text = "<b>" + TotalHeadLoadCharges.ToString() + "</b>";
                    GridView1.FooterRow.Cells[8].Text = "<b>" + TotalChillingCost.ToString() + "</b>";
                    GridView1.FooterRow.Cells[9].Text = "<b>" + TotalNetAmount.ToString() + "</b>";
                }
            }
    ...
    protected void GetData()
    {
        ...
        for (int j = 0; j < ds1Count; j++)
        {
            ...
            ds = objdb.ByProcedure("Usp_RouteWiseMilkColllectionInvoice",
                        new string[] { "flag", "FDT", "TDT", "OfficeId", "Office_ID" },
                        new string[] { "1", Convert.ToDateTime(txtFdt.Text, cult).ToString("yyyy/MM/dd"), Convert.ToDateTime(txtTdt.Text, cult).ToString("yyyy/MM/dd"), OfficeId, objdb.Office_ID() }, "dataset");

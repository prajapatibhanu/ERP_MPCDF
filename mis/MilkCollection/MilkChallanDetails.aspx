<%@ Page Language="C#" AutoEventWireup="true" Culture="en-IN" CodeFile="MilkChallanDetails.aspx.cs" Inherits="mis_MilkCollection_MilkChallanDetails" %>
                        ...
                        <div class="col-xs-12" style="border-bottom: 1px solid #eee;">
                            ...
                            <div class="col-xs-9 col-md-6">
                                <h2 class="page-header text-center" style="border-bottom: 1px solid #FFF!important;">
                                    ...
                                    <br />
                                    <p style="font-size: 20px;"><b>Milk Tanker Dispatch Delivery Challan</b></p>
                                </h2>
                            </div>

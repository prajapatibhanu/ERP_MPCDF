<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="SocietywiseMilkCollectionInvoiceDetails.aspx.cs" Inherits="mis_MilkCollection_SocietywiseMilkCollectionInvoiceDetails" %>
        ...
        <section class="content noprint">
            ...
            <div class="box box-success">
                <div class="box-header">
                    <h3 class="box-title">
                        <asp:Label ID="lblUnitName" Text="Society Payment Process" ForeColor="White" ClientIDMode="Static" Font-Size="Medium" Font-Bold="true" runat="server"></asp:Label></h3>
                </div>

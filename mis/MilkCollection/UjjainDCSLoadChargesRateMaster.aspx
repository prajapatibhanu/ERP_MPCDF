<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="UjjainDCSLoadChargesRateMaster.aspx.cs" Inherits="mis_MilkCollection_UjjainDCSLoadChargesRateMaster" %>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList ID="ddlMilkQuantity" runat="server" CssClass="form-control select2">
                                                ...
                                                <asp:ListItem Value="201-400">201-400</asp:ListItem>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <span class="pull-right">
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" Display="Dynamic"
                                                        ...
                                                        gvReportsText="<i class='fa fa-exclamation-circle' title='Select Distance In Km!'></i>"
                                                ...
                                                <asp:DropDownList ID="ddlDistanceInKm" runat="server" CssClass="form-control select2">
                                                    ...
                                                    <asp:ListItem Value="Above 40.1">28.1 कि.मी प्रतिदिन तक(7.1 कि.मी एक तरफ से)</asp:ListItem>
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                        <div class="col-md-2">

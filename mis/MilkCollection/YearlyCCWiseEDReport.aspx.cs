...
public partial class mis_MilkCollection_YearlyCCWiseEDReport : System.Web.UI.Page
{
    DataSet ds;
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
        ...
        try
        {
            ...
            ds = objdb.ByProcedure("Usp_MilkCollectionBillingReports", new string[] { "flag", "FromDate", "ToDate", "Office_ID" }, new string[] { "45", Convert.ToDateTime(txtFdt.Text, cult).ToString("yyyy/MM/dd"), Convert.ToDateTime(txtTdt.Text, cult).ToString("yyyy/MM/dd"), ddlccbmcdetail.SelectedValue }, "dataset");
            if (ds != null && ds.Tables.Count > 0)
            {
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    sb.Append("<tr>");
                    sb.Append("<td style='text-align:center;' colspan='6'><b>" + Session["Office_Name"].ToString() + "</b></td>");

                    sb.Append("</tr>");

                    sb.Append("<tr>");
                    sb.Append("<td style='text-align:center;' colspan='6'><b>Earning Deduction Statement</b></td>");
                    sb.Append("</tr>");
                    sb.Append("<tr>");

                    sb.Append("<td style='text-align:center;' colspan='6' ><b>Period : " + txtFdt.Text + " to  " + txtTdt.Text + "</b></td>");
                    sb.Append("</tr>");
                    sb.Append("<tr>");
                    sb.Append("<td style='text-align:left;' colspan='6'><b>Name of CC:-" + ddlccbmcdetail.SelectedItem.Text + "</b></td>");
                    sb.Append("</tr>");
                    sb.Append("<tr>");
                    sb.Append("<td><b>S.No</b></td>");
                    sb.Append("<td><b>Soc Code</b></td>");
                    sb.Append("<td><b>Soc Name</b></td>");
                    sb.Append("</tr>");
                    sb.Append("</thead>");
                                ...
                                else
                                {
                                    if (K <= 2)
                                    {
                                        ...
                                        if (K == 2)
                                        {
                                            ...
                                            sb.Append("<td></td>");
                                            sb.Append("<td></td>");
                                            sb.Append("<td><b>Net Amount  </b>" + (TotalEarning - TotalDeduction).ToString() + "</td>");
                                        }
                                        else
                                        {
                                            sb.Append("<td><b>Net Amount  </b>" + (TotalEarning - TotalDeduction).ToString() + "</td>");

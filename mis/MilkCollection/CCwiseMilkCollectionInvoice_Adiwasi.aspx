<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="CCwiseMilkCollectionInvoice_Adiwasi.aspx.cs" Inherits="mis_MilkCollection_CCwiseMilkCollectionInvoice_Adiwasi" %>
        ...
        <section class="content noprint ">
            ...
            <div class="box box-success">
                <div class="box-header">
                    <h3 class="box-title">Generate CC Wise Society Milk Invoice(Adiwasi Societies)</h3>
                </div>
                                ...
                                <Columns>
                                  ...
                                  <%--  <asp:TemplateField HeaderText="Producer Payment">
                                    ...
                                    <asp:TemplateField HeaderText="Status">
                                        <ItemTemplate>
                                            <asp:Label ID="lblStatus" runat="server" Text='<%# Eval("MilkCollectionInvoice_ID").ToString()=="0"?"Not generated":"Generated" %>'></asp:Label>
                                            <asp:Label ID="lblMilkCollectionInvoice_ID" CssClass="hidden" runat="server" Text='<%# Eval("MilkCollectionInvoice_ID").ToString() %>'></asp:Label>
                                            <asp:Label ID="lblFinalSubmitStatus" runat="server" CssClass="hidden" Text='<%# Eval("FinalSubmitStatus").ToString() %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

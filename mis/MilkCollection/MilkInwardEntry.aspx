<%@ Page Title="" Culture="en-IN" Language="C#" MasterPageFile="~/mis/MainMaster.master" MaintainScrollPositionOnPostback="true" AutoEventWireup="true" CodeFile="MilkInwardEntry.aspx.cs" Inherits="mis_CCDS_MilkInwardEntry" %>
        ...
        <section class="content">
            ...
            <div class="box box-body">
                <div class="box-header">
                    <h3 class="box-title">Milk Received Entry</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="row" style="border: 1px solid #ced4da; padding: 10px 5px;">
                                ...
                                <div class="col-md-4" id="dv_TankerType" runat="server" visible="false">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="txtClosingBalanceAfterDispatch" CssClass="form-control" Enabled="false" MaxLength="10" runat="server"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <asp:TextBox ID="txtNextTankerRequiredDate" autocomplete="off" Enabled="false" CssClass="form-control DateAdd" data-date-start-date="0d" runat="server"></asp:TextBox>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="mb-1">
                                        <i style="color: red;">(Note:-
                                            <br />
                                            (a)Single : Minimum no. of seal required 1 and maximum 10. & Min. 1 and Max. 2 valve box seal)
                                            <br />
                                            (b)Dual : Minimum no. of seal required 2 and maximum 10. & Min. 1 and Max. 2 valve box when Front & Rear Chamber has filled.)</i>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                        ...
                        <div class="col-md-6" style="border: 1px solid #ced4da; padding: 10px 5px;">
                            ...
                            <div class="row" style="margin-top: 36px;">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <asp:TextBox ID="txtTemprature" CssClass="form-control" placeholder="Temperature" runat="server"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <asp:TextBox ID="txtAcidity" CssClass="form-control" placeholder="Acidity %" runat="server"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <asp:TextBox ID="txtFat" Width="100%" CssClass="form-control" placeholder="Fat %" runat="server" AutoPostBack="true" OnTextChanged="txtCLR_TextChanged"></asp:TextBox>
                                </div>
                                ...
                                <div class="col-md-4">
                                    ...
                                    <asp:TextBox ID="txtCLR" Width="100%" CssClass="form-control" placeholder="CLR" runat="server" AutoPostBack="true" OnTextChanged="txtCLR_TextChanged"></asp:TextBox>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-1" runat="server" id="dv_gvMilkQualityDeailsAddButton" visible="false">
                                    <div class="form-group">
                                        <asp:Button ID="btnAddQualityDetails" CssClass="btn btn-dark button-mini" Style="margin-top: 23px;" runat="server" Text="Add" OnClick="btnAddQualityDetails_Click" ValidationGroup="AddQuality" />
                                    </div>
                                </div>

<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="CCWiseAdditionDeductionReport(AfterInv).aspx.cs" Inherits="mis_MilkCollection_CCWiseAdditionDeductionReport" %>
                ...
                <div class="col-md-12">
                    <div class="box box-success">
                        <div class="box-header">
                            <h3 class="box-title">CC Wise Addidtion/Deduction Report (After Invoice Generation)</h3>
                        </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <asp:DropDownList ID="ddlHeadType" runat="server" CssClass="form-control select2" >

<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="RMRD_Challan_EntryForDirectBMC.aspx.cs" Inherits="mis_MilkCollection_RMRD_Challan_EntryForDirectBMC" %>
        ...
        <section class="content">
            ...
            <div class="box box-success noprint">
                <div class="box-header noprint">
                    <h3 class="box-title">BMC/DCS RMRD Challan Entry(Via QC)</h3>
                </div>
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <span class="pull-right">
                                          <asp:RegularExpressionValidator ID="RegularExpressionValidator1" ControlToValidate="txtFAT" Display="Dynamic" ValidationExpression="^[0-9]\d*(\.\d{1,1})?$" runat="server" Text="<i class='fa fa-exclamation-circle' title='Invalid Input!'></i>" ErrorMessage="Invalid Input" SetFocusOnError="true" ForeColor="Red" ValidationGroup="b"></asp:RegularExpressionValidator>

                                            <asp:RangeValidator ID="RangeValidator1" runat="server" ErrorMessage="Minimum FAT % required 2.8 and maximum 10." Display="Dynamic" ControlToValidate="txtFAT" Text="<i class='fa fa-exclamation-circle' title='Minimum FAT % required 2.8 and maximum 10.!'></i>" SetFocusOnError="true" ForeColor="Red" ValidationGroup="b" Type="Double" MinimumValue="2.8" MaximumValue="10"></asp:RangeValidator>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ValidationGroup="b"
                                    ...
                                    <asp:TextBox autocomplete="off" ClientIDMode="Static" onkeypress="return validateDec(this,event)" MaxLength="10" runat="server" CssClass="form-control" ID="txtFAT" placeholder="Enter FAT"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <span class="pull-right">
                                           <asp:RegularExpressionValidator ID="RegularExpressionValidator2" ControlToValidate="txtLR" Display="Dynamic" ValidationExpression="^[0-9]\d*(\.\d+)?$" runat="server" Text="<i class='fa fa-exclamation-circle' title='Invalid Input!'></i>" ErrorMessage="Invalid Input" SetFocusOnError="true" ForeColor="Red" ValidationGroup="b"></asp:RegularExpressionValidator>
                                            ...
                                            <asp:RangeValidator ID="RangeValidator3" runat="server" ErrorMessage="Minimum CLR % required 20 and maximum 30." Display="Dynamic" ControlToValidate="txtLR" Text="<i class='fa fa-exclamation-circle' title='Minimum FAT % required 20 and maximum 30.!'></i>" SetFocusOnError="true" ForeColor="Red" ValidationGroup="b" Type="Double" MinimumValue="20" MaximumValue="30"></asp:RangeValidator>
                    ...
                    <div class="row noprint">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <span class="pull-right">
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator10" runat="server" Display="Dynamic" ControlToValidate="txtEntryDate" Text="<i class='fa fa-exclamation-circle' title='Enter Date!'></i>" ErrorMessage="Enter Date" SetFocusOnError="true" ForeColor="Red" ValidationGroup="Save"></asp:RequiredFieldValidator>
                                </span>
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text">
                                    ...
                                    <asp:TextBox ID="txtEntryDate" autocomplete="off" AutoPostBack="true"  OnTextChanged="txtEntryDate_TextChanged" CssClass="form-control DateAdd" data-date-end-date="0d" runat="server"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                    </div>

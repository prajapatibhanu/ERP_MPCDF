<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="SocietyWiseEarningDeductionsReport.aspx.cs" Inherits="mis_MilkCollection_SocietyWiseEarningDeductionsReport" %>
                ...
                <div class="col-md-12">
                    <div class="box box-success">
                        <div class="box-header">
                            <h3 class="box-title">CC wise Society Balances Report</h3>
                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="table-responsive">
                                            <asp:GridView ID="GridView1" ShowFooter="true" runat="server" CssClass="datatable table table-bordered" AutoGenerateColumns="false" EmptyDataText="No Record Found" onsorting="GridView1_Sorting" AllowSorting="True">
                                                <Columns>
                                                    <asp:TemplateField HeaderText="S.No">
                                                        <ItemTemplate>
                                                            <asp:Label ID="lblRowNo" runat="server" Text='<%# Container.DataItemIndex +1  %>' Visible='<%# Eval("Office_Name") != "" ? true : false  %>'></asp:Label>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
													...
													<asp:TemplateField HeaderText="Society Code" SortExpression="Office_Code">
                                                       
                                                        <ItemTemplate>
                                                            <%# Convert.ToInt64(Eval("Office_Code")) %>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                   ...
                                                   <asp:BoundField HeaderText="Balance(-ve)" DataField="BalanceAmount" />

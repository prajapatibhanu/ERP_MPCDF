...
public partial class mis_MilkCollection_ProducerPaymentInvoice : System.Web.UI.Page
{
    DataSet ds;
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            ds = objdb.ByProcedure("USP_Trn_ProducerPaymentDetails",
                        ...
                        new string[] { "8", Fdate, Tdate, ViewState["Office_ID"].ToString() }, "dataset");
            if (ds != null)
            {
                if (ds.Tables.Count > 0)
                {
                    if (ds.Tables[1].Rows.Count > 0)
                    {
                        ...
                        sb.Append("<table class='table2' style='max-width:100%'>");
                        ...
                        //TotalAvg_Fat = TotalAvg_Fat / Count;
                        //TotalAvg_SNF = TotalAvg_SNF / Count;
                        //TotalAvg_CLR = TotalAvg_CLR / Count;
                        ...
                        TotalEarningValue = ds.Tables[1].AsEnumerable().Sum(row => row.Field<decimal>("EarningValue"));

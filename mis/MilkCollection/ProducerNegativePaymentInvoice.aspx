<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="ProducerNegativePaymentInvoice.aspx.cs" Inherits="mis_MilkCollection_ProducerNegativePaymentInvoice" %>
                ...
                <div class="col-md-12">
                    <div class="box box-primary">
                        <div class="box-header">
                            <h3 class="box-title">Producer Negative Payment Invoice</h3>
                        </div>

...
public partial class mis_MilkCollection_CCwiseMilkCollectionInvoice : System.Web.UI.Page
{
    DataSet ds;
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            DataSet dsFillGrid = objdb.ByProcedure("Usp_RouteWiseMilkColllectionInvoice",
                       ...
                       new string[] { "6", ddlccbmcdetail.SelectedValue, Convert.ToDateTime(txtFdt.Text, cult).ToString("yyyy/MM/dd"), Convert.ToDateTime(txtTdt.Text, cult).ToString("yyyy/MM/dd"),"0" }, "dataset");
        ...
        foreach (GridViewRow rows in GridView1.Rows)
        {
            ...
            for (int i = 0; i < DSCount; i++)
            {
                ...
                else if (i == 8)
                {
                    ...
                    ds2.Tables[i].DefaultView.RowFilter = "GenerateTo_Office_ID = '" + lblI_OfficeID.Text + "'";
                    dt = ds2.Tables[i].DefaultView.ToTable();
                }
                else
                {
                    ds2.Tables[i].DefaultView.RowFilter = "MilkCollectionInvoice_ID = '" + MilkCollectionInvoice_ID.CommandArgument.ToString() + "'";
                    dt = ds2.Tables[i].DefaultView.ToTable();
                }

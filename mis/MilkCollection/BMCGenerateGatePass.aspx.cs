...
public partial class mis_MilkCollection_BMCGenerateGatePass : System.Web.UI.Page
{
    ...
    protected void GetTankerDetail()
    {
        try
        {
            ...
            ds = objdb.ByProcedure("Usp_TankerDetail",
                     ...
                     new string[] { "6", objdb.Office_ID(), "BMC", objdb.OfficeType_ID() }, "dataset");
    ...
    protected void ddlTankerDetail_SelectedIndexChanged(object sender, EventArgs e)
    {
        try
        {
            ...
            ds = objdb.ByProcedure("Usp_TankerDetail",
                    ...
                    new string[] { "7", ddlTankerDetail.SelectedValue, objdb.Office_ID() }, "dataset");
    ...
    {
        Response.Redirect("BMCGenerateGatePass.aspx", false);
    }
                    ...
                    if (dtsealF.Rows.Count > 0)
                    {
                        ds = objdb.ByProcedure("USP_Trn_MilkInwardOutwardReferenceDetails_MCU",
                                               ...
                                               new string[] { "2" ,
                                                ...
                                                txtTesterName.Text.TrimEnd().TrimStart(),
                                                txtTesterMobileNo.Text,
                                                "Web",
                                                "22.888",
                                                "22.888",
                                                objdb.createdBy(),
                                              ...
                                              new string[] { 
                                                  //"type_Trn_MilkInwardOfficeSequenceDetails_MCU", 
                                        "type_Trn_TankerValveSealDetails_MCU"},
                                              new DataTable[] { 
                                                  //dtccF,
                                                  dtsealF }, "TableSave");
    ...
    //            {
    //                gv_CCDetails.DataSource = ds;
    //                gv_CCDetails.DataBind();

    //            } 
    //            else
    //            {
    //                gv_CCDetails.DataSource = null;
    //                gv_CCDetails.DataBind();

...
public partial class mis_MilkCollection_DSAdditionDeductionReport : System.Web.UI.Page
{
    DataSet ds;
        ...
        try
        {
            ...
            if(ds != null && ds.Tables.Count > 0)
            {
                if(ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    {
                        sb.Append("<td style='border-bottom:1px dashed black; border-top:1px dashed black; font-size:15px; border-left:1px dashed black; border-right:1px dashed black;'><b>Gross Amount</b></td>");  
                    }
                    else
                    {
                        sb.Append("<td style='border-bottom:1px dashed black; border-top:1px dashed black; font-size:15px; border-left:1px dashed black; border-right:1px dashed black;'><b>Net Amount</b></td>");  
                    }  
                    sb.Append("</tr>");
					sb.Append("</thead>");
                            ...
                            for (int j = 0; j < ColumnCount; j++)
                            {
                                if (ds.Tables[0].Columns[j].ToString() != "Office_Name")
                                {
                                    ...
                                    else
                                    {
                                        ...
                                        if (Columns == "Quantity" || Columns == "KGFAT" || Columns == "KGSNF" || Columns == "TotalDeduction" || Columns == "TotalEarning" || Columns == "GrossAmount")
                                        {
    ...
    protected void btnExport_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            Response.Clear();
            Response.AddHeader("content-disposition", "attachment;filename=" + "UnionWiseAdditionDeductionReport_AftInv" + DateTime.Now + ".xls");
            Response.Charset = "";

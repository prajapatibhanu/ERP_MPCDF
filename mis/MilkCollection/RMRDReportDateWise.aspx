<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="RMRDReportDateWise.aspx.cs" Inherits="mis_MilkCollection_RMRDReport" %>
        ...
        <section class="content">
            <div class="row">
                ...
                <div class="box-header noprint">
                    <h3 class="box-title">RMRD Milk Collection Report</h3>
                </div>

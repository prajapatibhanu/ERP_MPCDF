<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="NegativePaymentDCSReport.aspx.cs" Inherits="mis_MilkCollection_NegativePaymentDCSReport" %>
                ...
                <div class="col-md-12">
                    <div class="box box-success">
                        <div class="box-header">
                            <h3 class="box-title">LIST OF NEGATIVE PAYMENT DCS</h3>
                        </div>

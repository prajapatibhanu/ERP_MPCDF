<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="AdditionChargesMaster.aspx.cs" Inherits="mis_MilkCollection_AdditionChargesMaster" %>
                ...
                <div class="col-md-12">
                    <div class="box box-success">
                        <div class="box-header">
                            <h3 class="box-title">Additional Charges Master</h3>
                        </div>
                        ...
                        <div class="box-body">
                            <fieldset>
                                ...
                                <div class="col-md-2">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label> Rate per Kg<span style="color: red">*</span></label>
                                            <span class="pull-right">
                                            <asp:RequiredFieldValidator ID="rfvRateperkg" runat="server" ValidationGroup="Save" Display="Dynamic" ControlToValidate="txtRateperkg" ErrorMessage="Please Enter Amount." Text="<i class='fa fa-exclamation-circle' title='Please Enter Rate !'></i>"></asp:RequiredFieldValidator>  
                                        </span>
                                             <asp:TextBox ID="txtRateperkg" runat="server" CssClass="form-control"></asp:TextBox>
                                        </div>
                                    </div>
                        ...
                        <div class="box-body">
                            <fieldset>
                                <legend>Additional Charges Detail</legend>
                                <div class="row">
                                   <div class="col-md-2">
                                <div class="form-group">
                                    <label>CC<span style="color: red;"> *</span></label>

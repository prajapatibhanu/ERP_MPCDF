<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="BMC_CancelGatePass.aspx.cs" Inherits="mis_MilkCollection_BMC_CancelGatePass" %>
        ...
        <section class="content"> 
            ...
            <div class="box box-Manish">
                <div class="box-header">
                    <h3 class="box-title">BMC Gate Pass Details</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    <div class="row">
                    ...
                    <div class="table-responsive">
                        ...
                        <asp:GridView ID="gv_viewreferenceno" style="font-size:12px;" ShowHeader="true" AutoGenerateColumns="false" CssClass="datatable table table-hover table-bordered pagination-ys" runat="server">
                            <Columns>
								...
								<asp:TemplateField HeaderText="Challan No / Status">
								 ...
								 <asp:TemplateField HeaderText="Gross Weight Entry Status">
                                    <ItemTemplate>
                                         <asp:Label ID="lblGWEntryStatus" runat="server" Text='<%# Eval("GWEntryStatus") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
  
								<asp:TemplateField HeaderText="QA Entry Status">
                                    <ItemTemplate>
                                        <asp:Label ID="lblQAEntryStatus" runat="server" Text='<%# Eval("QAEntryStatus") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
								
								<asp:TemplateField HeaderText="Net Weight Entry Status">
                                    <ItemTemplate>
                                        <asp:Label ID="lblNWEntryStatus" runat="server" Text='<%# Eval("NWEntryStatus") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                ...
                                <asp:TemplateField HeaderText="Reference Status">
                                    <ItemTemplate>
                                        ...
                                        <asp:Label ID="lblRefCancelStatusF" Visible="false"
                                            runat="server" Text='<%# Eval("RefCancelStatusF") %>'></asp:Label>

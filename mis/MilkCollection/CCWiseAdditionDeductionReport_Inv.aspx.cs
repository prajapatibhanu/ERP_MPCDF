...
public partial class mis_MilkCollection_CCWiseAdditionDeductionReport_Inv : System.Web.UI.Page
{
    DataSet ds;
    ...
    protected void btnSearch_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            ds = objdb.ByProcedure("Usp_MilkCollectionBillingReports", new string[] { "flag", "FromDate", "ToDate", "Office_ID", "ItemBillingHead_Type", "GenerateFrom_Office_ID","OfficeType_ID" }, new string[] { "38", Convert.ToDateTime(txtFdt.Text, cult).ToString("yyyy/MM/dd"), Convert.ToDateTime(txtTdt.Text, cult).ToString("yyyy/MM/dd"), ddlccbmcdetail.SelectedValue, ddlHeadType.SelectedValue,objdb.Office_ID() ,objdb.OfficeType_ID()}, "dataset");
            if(ds != null && ds.Tables.Count > 0)
            {
                if(ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    sb.Append("</tr>");
                    sb.Append("<tr>");
                    sb.Append("<td colspan='4' style='text-align:left; font-size:14px;'><b>DCS WISE " + ddlHeadType.SelectedValue + " SUMMARY</b></td>");
                    ...
                    {
                        sb.Append("<td style='border-bottom:1px dashed black; border-top:1px dashed black; font-size:15px; border-left:1px dashed black; border-right:1px dashed black;'><b>Net</b></td>");  
                    }
                    else
                    {

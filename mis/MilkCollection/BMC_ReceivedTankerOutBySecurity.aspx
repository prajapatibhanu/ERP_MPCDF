<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="BMC_ReceivedTankerOutBySecurity.aspx.cs" Inherits="mis_MilkCollection_BMC_ReceivedTankerOutBySecurity" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentBody" runat="Server">
        ...
        <section class="content">
            ...
            <div class="box box-Manish" style="min-height: 250px;">
                <div class="box-header">
                    <h3 class="box-title">Update Net Weight of Received Milk For BMC/MDP</h3>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
                    <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <span class="pull-right">
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" ValidationGroup="a"
                                            ErrorMessage="Enter Net Weight" Text="<i class='fa fa-exclamation-circle' title='Enter Net Weight !'></i>"
                                            ControlToValidate="txtNetWeight" ForeColor="Red" Display="Dynamic" runat="server">
                                        </asp:RequiredFieldValidator>
                                    </span>
                                    <asp:RangeValidator ID="RangeValidator1" runat="server" ControlToValidate="txtNetWeight" Type="Double" ErrorMessage="Required Minimum Value 999!" Text="<i class='fa fa-exclamation-circle' title='Required Minimum Value 999!'></i>" SetFocusOnError="true" ForeColor="Red" Display="Dynamic" ValidationGroup="a" MinimumValue="999" MaximumValue="9999999999"></asp:RangeValidator>

                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator1" ForeColor="Red" ValidationGroup="a" Display="Dynamic" runat="server" ControlToValidate="txtNetWeight" ErrorMessage="Net Weight Required" Text="<i class='fa fa-exclamation-circle' title='Net Weight Required !'></i>" SetFocusOnError="true" ValidationExpression="((\d+)((\.\d{1,2})?))$"></asp:RegularExpressionValidator>

                                    <asp:TextBox runat="server" Enabled="true" autocomplete="off" CssClass="form-control" ID="txtNetWeight" ClientIDMode="Static" onkeypress="return validateDec(this,event)" MaxLength="10" placeholder="Enter Gross Weight"></asp:TextBox>
                                </div>
                            </div>--%>
                        </div>
                    </fieldset>
                    <div class="row">
                        <div class="col-md-12">
                            <fieldset>
                                <legend>Update Net Weight</legend>
                                <asp:GridView ID="gvUpdateNetWeight" runat="server" AutoGenerateColumns="false" CssClass="table table-bordered">
                                    <Columns>
                                        <asp:TemplateField HeaderText="S.No.">
                                         ...
                                         <asp:TemplateField HeaderText="Chamber Type">
                                                ...
                                                <asp:TemplateField HeaderText="Milk Quantity (In KG)">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtI_MilkQuantity" OnTextChanged="txtI_MilkQuantity_TextChanged" AutoPostBack="true" onkeypress="return validateDec(this,event)" runat="server" Text='<%# Eval("I_MilkQuantity") %>'></asp:TextBox>
                                        ...
                                        <asp:GridView ID="gv_ViewChallanDetail" Visible="false" ShowHeader="true" ShowFooter="true" AutoGenerateColumns="false" CssClass="table table-bordered" runat="server">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Challan No.">
                                                    <ItemTemplate>
                                                         <asp:Label ID="lblI_QualityEntryID" Visible="false" runat="server" Text='<%# Eval("I_QualityEntryID") %>'></asp:Label>
                    ...
                    <div class="row">
                        <div class="col-md-3 pull-left noprint">
                            <div class="form-group">
                                ...
                                <asp:Button ID="btnExport" Visible="false" runat="server" CssClass="btn btn-default" Text="Excel" OnClick="btnExport_Click" />
                        ...
                        <div class="table-responsive">
                            ...
                            <asp:GridView ID="gv_TodayReceivedTankerDetails" ShowHeader="true" EmptyDataText="No Record Found" EmptyDataRowStyle-ForeColor="Red" AutoGenerateColumns="false" CssClass="table table-bordered" runat="server" OnRowCommand="gv_TodayReceivedTankerDetails_RowCommand" OnRowDataBound="gv_TodayReceivedTankerDetails_RowDataBound">
                                <Columns>
                                    <asp:TemplateField HeaderText="S.No.">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Arrival Date">
                                        <ItemTemplate>
                                            <asp:Label ID="Label2" runat="server" Text='<%# (Convert.ToDateTime(Eval("DT_TankerArrivalDate"))).ToString("dd-MM-yyyy hh:mm:ss tt") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="Reference No">
                                        <ItemTemplate>
                                            <asp:Label ID="Label3" runat="server" Text='<%# Eval("C_ReferenceNo") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Office Name">
                                        <ItemTemplate>
                                            <asp:Label ID="Label4" runat="server" Text='<%# Eval("Office_Name") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>--%>

                                    <asp:TemplateField HeaderText="Vehicle No">
                                        <ItemTemplate>
                                            <asp:Label ID="Label5" runat="server" Text='<%# Eval("V_VehicleNo") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="Driver Name">
                                        <ItemTemplate>
                                            <asp:Label ID="Label6" runat="server" Text='<%# Eval("V_DriverName") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>

                                    <asp:TemplateField HeaderText="Driver Mobile No">
                                        <ItemTemplate>
                                            <asp:Label ID="Label7" runat="server" Text='<%# Eval("V_DriverMobileNo") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="Gross Weight (In KG)">
                                        <ItemTemplate>
                                            <asp:Label ID="Label8" runat="server" Text='<%# Eval("D_GrossWeight") %>'></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lnkViewMore" CssClass="label label-success" CommandName="ViewMore" runat="server" CommandArgument='<%# Eval("BI_MilkInOutRefID") %>'>View More</asp:LinkButton>
                                    </ItemTemplate>
                                </asp:TemplateField>
    ...
    <div class="modal fade" id="Viewmoremodal" role="dialog">

<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="CCWiseSocietyHeadBalancesReport.aspx.cs" Inherits="mis_MilkCollection_CCWiseSocietyHeadBalancesReport" %>
                ...
                <div class="col-md-12">
                    <div class="box box-success">
                        <div class="box-header">
                            <h3 class="box-title">CC wise Society Head Balances Report</h3>
                        </div>
            ...
            buttons: {
                buttons: [{
                    ...
                    text: '<i class="fa fa-print"></i> Print',
                     title: document.getElementById('<%= hfvalue.ClientID%>').value + '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; CC:-' + $("#ddlccbmcdetail option:selected").text() + '<br/><span style="margin-top:50px;"> CC wise Society Head Balances Report&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;' + 'PERIOD :' + document.getElementById('<%= txtFdt.ClientID%>').value + ' -  ' + document.getElementById('<%= txtTdt.ClientID%>').value + "</span>",

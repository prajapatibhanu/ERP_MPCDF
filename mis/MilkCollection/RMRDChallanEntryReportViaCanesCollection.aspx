<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="RMRDChallanEntryReportViaCanesCollection.aspx.cs" Inherits="mis_MilkCollection_RMRDChallanEntryReportViaCanesCollection" %>
                ...
                <div class="col-md-12">
                    <div class="box box-Manish">
                        <div class="box-header noprint">
                            <h3 class="box-title">CC Wise Canes Collection Report</h3>
                        </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-12">
                                            <div class="table-responsive">
                                                ...
                                                <div class="col-md-12">
                                                    <h3 style="text-align: center">संघ द्वारा भरी जाने वाली जानकारी</h3>
                                                </div>
                                                <div class="col-md-12">
                                                ...
                                                <asp:GridView ID="gv_MilkCollectionChallanEntryDetails"  ShowFooter="true" ShowHeader="true" EmptyDataText="No Record Found" EmptyDataRowStyle-ForeColor="Red" AutoGenerateColumns="false" CssClass="datatable table table-bordered" runat="server" OnRowCreated="gv_MilkCollectionChallanEntryDetails_RowCreated">
												   ...
												   <asp:TemplateField HeaderText="क्रमांक" ItemStyle-Width="5%">
                                                        ...
                                                        <asp:TemplateField HeaderText="फैट">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblBFat" runat="server" Text='<%# Eval("BD_FAT").ToString()=="0.00"?"":Eval("BD_FAT") %>'></asp:Label>
                                                            </ItemTemplate>

                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="सी.एल.आर">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblBClr" runat="server" Text='<%# Eval("BD_CLR").ToString()=="0.00"?"":Eval("BD_CLR") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="एस.एन.एफ प्रतिशित">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblBSnf" runat="server" Text='<%# Eval("BD_SNF").ToString()=="0.00"?"":Eval("BD_SNF") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>

                                                        <asp:TemplateField HeaderText="अच्छा दूध">
                                                            <ItemTemplate>
                                                               <%-- <asp:Label ID="lblCMilkQuantity" runat="server" Text='<%# Eval("CMilkQuality").ToString()=="Good"?Eval("CMilkQuantity"):"" %>'></asp:Label>--%>
                                                        ...
                                                        <asp:TemplateField HeaderText="फैट">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblCFat" runat="server" Text='<%# Eval("CD_FAT").ToString()=="0.00"?"":Eval("CD_FAT") %>'></asp:Label>
                                                            </ItemTemplate>

                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="सी.एल.आर">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblCClr" runat="server" Text='<%# Eval("CD_CLR").ToString()=="0.00"?"":Eval("CD_CLR") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>
                                                        <asp:TemplateField HeaderText="एस.एन.एफ प्रतिशित">
                                                            <ItemTemplate>
                                                                <asp:Label ID="lblCSnf" runat="server" Text='<%# Eval("CD_SNF").ToString()=="0.000"?"":Eval("CD_SNF") %>'></asp:Label>
                                                            </ItemTemplate>
                                                        </asp:TemplateField>

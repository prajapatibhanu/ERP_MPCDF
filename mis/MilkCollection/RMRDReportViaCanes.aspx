<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="RMRDReportViaCanes.aspx.cs" Inherits="mis_MilkCollection_RMRDReportViaCanes" %>
        ...
        <section class="content">
            <div class="row">
                ...
                <div class="box-header noprint">
                    <h3 class="box-title">Canes Collection Report</h3>
                </div>
                                ...
                                <Columns>
                                    ...
                                    <asp:TemplateField HeaderText="Society">
                                     ...
                                     <asp:TemplateField HeaderText="Milk Quality">
                                            <ItemTemplate>
                                                <asp:Label ID="lblQuality" runat="server" Text='<%# Eval("V_MilkQuality") %>'></asp:Label>
                                            </ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="Total Can">
                                     ...
                                     <asp:TemplateField HeaderText="Milk Quantity">
                                            <ItemTemplate>
                                                <asp:Label ID="lblI_MilkSupplyQty" runat="server" Text='<%# Eval("I_MilkQuantity") %>'></asp:Label>
                                            </ItemTemplate>

...
public partial class mis_MilkCollection_ProducerNonNegativePaymentInvoice : System.Web.UI.Page
{
    DataSet ds;
    ...
    protected void btnSubmit_Click(object sender, EventArgs e)
    {
        try
        {
            ...
            ds = objdb.ByProcedure("USP_Trn_ProducerPaymentDetails",
                        ...
                        new string[] { "13", Fdate, Tdate, ViewState["Office_ID"].ToString() }, "dataset");
            if (ds != null)
            {
                if (ds.Tables.Count > 0)
                {

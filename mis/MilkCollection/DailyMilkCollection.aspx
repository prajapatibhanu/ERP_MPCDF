<%@ Page Title="" Language="C#" MaintainScrollPositionOnPostback="true" MasterPageFile="~/mis/MainMaster.master" Culture="en-IN" AutoEventWireup="true" CodeFile="DailyMilkCollection.aspx.cs" Inherits="mis_MilkCollection_DailyMilkCollection" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentBody" runat="Server">
        ...
        <section class="content noprint">
            ...
            <div class="box box-success">
                <div class="box-header">
                    <h3 class="box-title">Daily Milk Collection (दैनिक दूध संग्रह)</h3>
                </div>
                ...
                <div class="box-body">
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <%-- <div class="input-group">
                                ...
                                <asp:TextBox ID="txtDate" CssClass="form-control DateAdd" runat="server"></asp:TextBox>--%>
                    ...
                    <div class="col-md-3">
                        <div class="form-group">
                            ...
                            <div class="form-group">
                                <asp:DropDownList ID="ddlShift" OnInit="ddlShift_Init" OnSelectedIndexChanged="ddlShift_SelectedIndexChanged" AutoPostBack="true" CssClass="form-control select2" runat="server">
					...
					<div class="col-md-3">
                        <div class="form-group">
                            ...
                            <asp:DropDownList ID="ddlMilkType" CssClass="form-control select2" runat="server">
                                ...
                                <asp:ListItem Value="Mix" Selected="True">Mix</asp:ListItem>
                            </asp:DropDownList>
                        </div>
                    </div>
                       <div class="col-md-3">
                    ...
                    <%--<div class="col-md-3">
                        <div class="form-group">
                            <label>Milk Quantity(प्रदाय मात्रा) Ltr.<span style="color: red;">*</span></label>
                            <span class="pull-right">
                                <asp:RequiredFieldValidator ID="rfvLiter" runat="server" Display="Dynamic" ControlToValidate="txtSupplyqty" Text="<i class='fa fa-exclamation-circle' title='Enter Milk Supply Quantity!'></i>" ErrorMessage="Enter Milk Supply Quantity" SetFocusOnError="true" ForeColor="Red" ValidationGroup="Submit"></asp:RequiredFieldValidator>
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" ValidationGroup="Submit" runat="server" ControlToValidate="txtSupplyqty" ForeColor="Red" Display="Dynamic"
                                    ValidationExpression="^[0-9]\d*(\.\d+)?$" ErrorMessage="*Invalid Milk Qty. Exp - 00.00 ." Text="<i class='fa fa-exclamation-circle' title='Invalid Milk Qty. Exp - 00.00 !'></i>" />
                            </span>
                            <asp:TextBox ID="txtSupplyqty" autocomplete="off" onkeypress="return validateDec(this,event)" CssClass="form-control" MaxLength="8" runat="server" placeholder="Milk Supply Quantity"></asp:TextBox>
                        </div>
                    </div>--%>
                                <fieldset>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtI_MilkQuantity" OnTextChanged="txtI_MilkQuantity_TextChanged" AutoPostBack="true" autocomplete="off" Width="100%" onkeypress="return validateDec(this,event)" CssClass="form-control" placeholder="Milk Quantity" runat="server" MaxLength="12"></asp:TextBox>
                            </div>
                      ...
                      <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <span class="pull-right">
                                    ...
                                    <asp:RangeValidator ID="RangeValidator2" runat="server" ErrorMessage="Minimum FAT % required 2.0 and maximum 12." Display="Dynamic" ControlToValidate="txtNetFat" Text="<i class='fa fa-exclamation-circle' title='Minimum FAT % required 20. and maximum 12!'></i>" SetFocusOnError="true" ForeColor="Red" ValidationGroup="Submit" Type="Double" MinimumValue="2.0" MaximumValue="12"></asp:RangeValidator>

                                </span>
                                <asp:TextBox ID="txtNetFat" autocomplete="off" Width="100%" onkeypress="return validateDec(this,event)" OnTextChanged="txtNetFat_TextChanged" AutoPostBack="true" CssClass="form-control" placeholder="Fat %" runat="server" MaxLength="6"></asp:TextBox>
 ...
 <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtNetCLR" Enabled="true" autocomplete="off" Width="100%" onkeypress="return validateDec(this,event)" OnTextChanged="txtNetCLR_TextChanged" AutoPostBack="true" CssClass="form-control" placeholder="CLR" runat="server" MaxLength="6"></asp:TextBox>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="txtnetsnf" Enabled="false" Width="100%" onkeypress="return validateDec(this,event)" CssClass="form-control"  placeholder="SNF %" runat="server" MaxLength="6"></asp:TextBox>
                        ...
                        <div class="form-group">
                            <label>Remark</label>
                           <%-- <span class="pull-right">
                                <asp:RegularExpressionValidator ID="RegularExpressionValidator2" ValidationGroup="Submit" runat="server" ControlToValidate="txtRemark" ForeColor="Red" Display="Dynamic"
                                    ValidationExpression="[a-zA-Z ]*$" ErrorMessage="*Valid characters: Alphabets and Numbers." Text="<i class='fa fa-exclamation-circle' title='Only alphabet and Numbers Allowed !'></i>" />
                            </span>--%>
                            <asp:TextBox ID="txtRemark" CssClass="form-control" placeholder="Remark" TextMode="MultiLine" Rows="2" runat="server"></asp:TextBox>
                        </div>
                    </div>
            ...
            <div class="box box-success" runat="server" visible="false" id="div_milkdetails">
                <div class="box-header">
                    <h3 class="box-title">Daily Milk Collection Detail (दैनिक दूध संग्रह विवरण)</h3>
                </div>
                <div class="box-body">
                    <div class="col-md-12">

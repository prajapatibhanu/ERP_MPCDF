<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="ComparativeDCSWiseMilkProcurement.aspx.cs" Inherits="mis_MilkCollection_ComparativeDCSWiseMilkProcurement" %>
                ...
                <div class="col-md-12">
                    <div class="box box-success">
                        <div class="box-header">
                            <h3 class="box-title">Comparative DCS Wise Milk Procurement</h3>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date">
                                            ...
                                            <asp:textbox id="txtFdt" onkeypress="javascript: return false;" width="100%" maxlength="10" onpaste="return false;" placeholder="Select From Date" runat="server" autocomplete="off" cssclass="form-control" data-provide="datepicker" data-date-format="mm/yyyy" data-date-autoclose="true" clientidmode="Static" OnTextChanged="txtFdt_TextChanged" AutoPostBack="true"></asp:textbox>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-2">
                                <div class="form-group">
                                    <label>Billing Cycle 1</label>
                                   
                                    <asp:DropDownList ID="ddlBillingCycle1"  runat="server" CssClass="form-control select2" ClientIDMode="Static"></asp:DropDownList>
                                </div>
                            </div>
                                 <div class="col-md-2">
                                <div class="form-group">
                                    <label>Billing Cycle 2</label>
                                   
                                    <asp:DropDownList ID="ddlBillingCycle2"  runat="server" CssClass="form-control select2" ClientIDMode="Static"></asp:DropDownList>
                                </div>
                            </div>

...
public partial class mis_MilkCollection_RMRDReport : System.Web.UI.Page
{
    ...
    protected void FillGrid()
    {
        try
        {
            ...
            ds = objdb.ByProcedure("Usp_MilkCollectionChallanEntry", new string[] { "flag", "FromDate", "ToDate", "Created_Office_ID", "BMCTankerRoot_Id" }, new string[] { "4", FromDate, ToDate, objdb.Office_ID(), ddlBMCTankerRootName.SelectedValue }, "dataset");
            if (ds != null && ds.Tables.Count > 0)
            {
                if (ds.Tables[0].Rows.Count > 0)
                {
                    ...
                    gv_MilkCollectionChallanEntryDetails.FooterRow.Cells[6].Text = "<b>" + TotalMilkQuantity.ToString() + "</b>";
                    gv_MilkCollectionChallanEntryDetails.FooterRow.Cells[10].Text = "<b>" + TotalFATInKg.ToString() + "</b>";
                    gv_MilkCollectionChallanEntryDetails.FooterRow.Cells[11].Text = "<b>" + TotalSnfInKg.ToString() + "</b>";
                    gv_MilkCollectionChallanEntryDetails.FooterRow.Cells[6].HorizontalAlign = HorizontalAlign.Right;
                    gv_MilkCollectionChallanEntryDetails.FooterRow.Cells[10].HorizontalAlign = HorizontalAlign.Right;

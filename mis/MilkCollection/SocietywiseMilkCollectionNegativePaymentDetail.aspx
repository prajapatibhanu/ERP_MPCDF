<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="SocietywiseMilkCollectionNegativePaymentDetail.aspx.cs" Inherits="mis_MilkCollection_SocietywiseMilkCollectionNegativePaymentDetail" %>
        ...
        <section class="content noprint">
            ...
            <div class="box box-success">
                <div class="box-header">
                    <h3 class="box-title">
                        <asp:Label ID="lblUnitName" Text="Society wise Negative Payment Detail" ForeColor="White" ClientIDMode="Static" Font-Size="Medium" Font-Bold="true" runat="server"></asp:Label></h3>
                </div>
                        ...
                        <div class="row" id="div_print">
                            ...
                            <div class="col-md-12">
                                <div class="table-responsive">
                                    <asp:GridView ID="gv_SocietyMilkDispatchDetail" ShowHeaderWhenEmpty="true" EmptyDataText="No Record Found" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-bordered table-hover">
                                        <Columns>

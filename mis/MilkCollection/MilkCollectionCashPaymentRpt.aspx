<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="MilkCollectionCashPaymentRpt.aspx.cs" Inherits="mis_MilkCollection_MilkCollectionCashPaymentRpt" %>
        ...
        <div class="content">
            <div class="box box-success">
                <div class="box-header">
                    <h3 class="box-title">Cash Payment Report</h3>
                </div>

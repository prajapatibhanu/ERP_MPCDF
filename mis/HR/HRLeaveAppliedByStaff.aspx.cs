...
public partial class mis_HR_HRLeaveAppliedByStaff : System.Web.UI.Page
{
    DataSet ds, ds2;
    ...
    protected void FillGrid()
    {
        try
        {
            ...
            GridView1.DataBind();
            ds = objdb.ByProcedure("SpHRLeaveApplication", new string[] { "flag", "Year", "Office_ID", "LeaveApproveAuthority" },
                   new string[] { "23", ddlFinancialYear.SelectedValue.ToString(), ViewState["Office_ID"].ToString(), ViewState["Emp_ID"].ToString() }, "datatset");

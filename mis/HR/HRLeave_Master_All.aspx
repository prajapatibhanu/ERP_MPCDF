<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="HRLeave_Master_All.aspx.cs" Inherits="mis_HR_HRLeave_Master_All" %>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList runat="server" ID="ddlOffice" CssClass="form-control select2" Enabled="false">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="ddlFinancial_Year" runat="server" CssClass="form-control">
                                            <asp:ListItem>select</asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <asp:DropDownList ID="ddlLeave_Type" runat="server" CssClass="form-control">
                                            <asp:ListItem>select</asp:ListItem>
                                        </asp:DropDownList>
                                    </div>
                                </div>
                                        ...
                                        <asp:GridView ID="GridView1" runat="server" class="datatable table table-hover table-bordered pagination-ys " AutoGenerateColumns="False" DataKeyNames="Emp_ID">
                                            ...
                                            <asp:TemplateField HeaderText="Logout Time" ItemStyle-CssClass="RemovePadding" ItemStyle-Width="300">
                                                ...
                                                <asp:TemplateField HeaderText="Closing of last year (Days)" ItemStyle-CssClass="RemovePadding LeaveColumn" ItemStyle-Width="100">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtLastYearLeave" runat="server" CssClass="form-control txtwidth" Text="0" onkeypress="ondecimalrun(this)" onpaste="return false"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>                                                
                                                <asp:TemplateField HeaderText="Days credited in this year (Days)" ItemStyle-CssClass="RemovePadding LeaveColumn" ItemStyle-Width="100">
                                                    <ItemTemplate>
                                                        <asp:TextBox ID="txtAvailableLeave" runat="server" CssClass="form-control txtwidth" Text="0" onkeypress="ondecimalrun(this)" onpaste="return false"></asp:TextBox>
                                                    </ItemTemplate>
                                                </asp:TemplateField>

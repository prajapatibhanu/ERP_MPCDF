<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="HREmpDetailView.aspx.cs" Inherits="mis_HR_HREmpDetailView" %>
                                ...
                                <div class="table table-responsive">
                                    <asp:DetailsView ID="DVOfficialDetail" runat="server" AutoGenerateRows="false" CssClass="table table-bordered table-hover table-striped">
                                        <Fields>
                                            ...
                                            <asp:BoundField DataField="GradePay_Name" HeaderText="Grade Pay" />

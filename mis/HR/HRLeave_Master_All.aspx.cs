...
public partial class mis_HR_HRLeave_Master_All : System.Web.UI.Page
{
    DataSet ds, ds2;
            ...
            foreach (GridViewRow row in GridView1.Rows)
            {
                ...
                if (ds2 != null && ds2.Tables[0].Rows.Count > 0)
                {
                   ...
                   // int TotalAvailableLeave = int.Parse(ds2.Tables[0].Rows[0]["Leave_Days"].ToString()) + int.Parse(ds2.Tables[0].Rows[0]["Leave_LastYearClosing"].ToString());
				    decimal TotalAvailableLeave = decimal.Parse(ds2.Tables[0].Rows[0]["Leave_Days"].ToString()) + decimal.Parse(ds2.Tables[0].Rows[0]["Leave_LastYearClosing"].ToString());
                    lblAvailableSelectYear.Text = (TotalAvailableLeave == null) ? "0.0" : TotalAvailableLeave.ToString() + " Day(s)";

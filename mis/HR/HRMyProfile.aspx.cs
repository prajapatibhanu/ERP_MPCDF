...
public partial class mis_HR_HRMyProfile : System.Web.UI.Page
{
    DataSet ds;
    ...
    protected void FillPersonalDetail()
    {
        ...
        {
            ds = null;
            ds = objdb.ByProcedure("SpHREmployee", new string[] { "flag", "Emp_ID" }, new string[] { "24", ViewState["Emp_ID"].ToString() }, "dataset");

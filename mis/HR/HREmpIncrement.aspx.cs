...
public partial class mis_HR_HREmpIncrement : System.Web.UI.Page
{
    DataSet ds;
    ...
    protected void FillGrid()
    {
        try
        {
            ...
            //ds = objdb.ByProcedure("SpHREmpIncreament", new string[] { "flag" }, new string[] { "4" }, "dataset");
    ...
    protected void ClearText()
    {
        try
        {
            ...
            ddlNewBasicSalary.Items.Insert(0, new ListItem("Select Basic", "0"));
    ...
    protected void FillDropDown()
    {
        try
        {
            ...
            ddlNewLevel.Items.Insert(0, new ListItem("Select Level", "0"));
            ddlOldLevel.Items.Insert(0, new ListItem("Select Level", "0"));
    ...
    protected void FillNewLevel()
    {
        try
        {

            ds.Reset();
            ds = objdb.ByProcedure("SpHRLevelMaster", new string[] { "flag", "Level_ID" }, new string[] { "7", ddlOldLevel.SelectedValue.ToString() }, "dataset");
            if (ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
            {
                ddlNewLevel.DataSource = ds;
                ddlNewLevel.DataTextField = "Level_Name";
                ...
                ddlNewLevel.DataBind();
                ddlNewLevel.Items.Insert(0, new ListItem("Select Level", "0"));
                ddlNewLevel.SelectedValue = ddlOldLevel.SelectedValue.ToString();
            }
    ...
    protected void fillNewBasicSalary()
    {
        try
        {
            lblMsg.Text = "";
            if (ddlNewLevel.SelectedIndex > 0)
            {
                ds = objdb.ByProcedure("SpHRLevelPayMaster", new string[] { "flag", "Level_ID", "PayScale" }, new string[] { "10", ddlNewLevel.SelectedValue.ToString(),txtOldBasicSalary.Text }, "dataset");
                if (ds.Tables.Count > 0 && ds.Tables[0].Rows.Count > 0)
                {

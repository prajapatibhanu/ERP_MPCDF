<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="HRLoginPermissionList.aspx.cs" Inherits="HRLoginPermissionList" %>
                ...
                <div class="col-md-12 ">
                    ...
                    <div class="box box-success">
                        <div class="box-header with-border">
                            <h3 class="box-title" id="Label1">Login-Logout Intimation List</h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        <div class="box-body ">
                                                ...
                                                <Columns>
                                                 ...
                                                 <asp:BoundField DataField="DiffTime" HeaderText="Difference(In min)" />--%>
                                                    ...
                                                    <asp:TemplateField HeaderText="Action" ShowHeader="False">
                                                        <ItemTemplate>
                                                            <asp:LinkButton ID="lnkSelect" runat="server" CssClass="label label-danger" CausesValidation="False" CommandName="Select" Text="Delete" ToolTip='<%# Eval("Per_ID").ToString()%>' Visible='<%# Eval("PermissionStatus").ToString()=="Approved" ? false : true %>'></asp:LinkButton>
                                                        </ItemTemplate>
                                                    </asp:TemplateField>
                                                </Columns>
                                            </asp:GridView>

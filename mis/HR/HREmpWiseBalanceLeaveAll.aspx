<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="HREmpWiseBalanceLeaveAll.aspx.cs" Inherits="mis_HR_HREmpWiseBalanceLeaveAll" %>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="table table-responsive">
                                ...
                                <asp:GridView ID="GridView1" class="table table-hover table-bordered" AutoGenerateColumns="False" runat="server">
                                    <Columns>

<%@ Page Title="" Language="C#" MasterPageFile="~/mis/MainMaster.master" AutoEventWireup="true" CodeFile="HREnquiry_Status.aspx.cs" Inherits="mis_HR_HREnquiry_Status" %>
                                        ...
                                        <asp:GridView ID="GridView1" DataKeyNames="EnquiryID" runat="server" AutoGenerateColumns="False" class="datatable  table table-hover table-bordered pagination-ys">
                                            <Columns>
                                                ...
                                                <asp:TemplateField HeaderText="Action">
                                                    <ItemTemplate>
                                                        <a id="a1" runat="server" style="label label-default" target="_blank" href='<%# "HREnquiry_Detail.aspx?EnquiryID=" +APIProcedure.Client_Encrypt(Eval("EnquiryID").ToString()) %>'>View More</a>
